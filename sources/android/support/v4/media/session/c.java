...
public class c {
    ...
    public static class b<T extends a> extends MediaController.Callback {
        ...
        public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
            this.f3155a.d(playbackInfo.getPlaybackType(), C0034c.c(playbackInfo), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
        }

        @Override // android.media.session.MediaController.Callback
        public void onExtrasChanged(Bundle bundle) {
            MediaSessionCompat.b(bundle);
            this.f3155a.o(bundle);
        }

        @Override // android.media.session.MediaController.Callback
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            this.f3155a.b(mediaMetadata);
        }

        @Override // android.media.session.MediaController.Callback
        public void onPlaybackStateChanged(PlaybackState playbackState) {
            this.f3155a.e(playbackState);
        }
    ...
    public static class C0034c {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final int f3156a = 4;

        /* renamed from: b, reason: collision with root package name */
        public static final int f3157b = 6;

        /* renamed from: c, reason: collision with root package name */
        public static final int f3158c = 7;
    ...
    public static class d {
        ...
        public static void g(Object obj, long j11) {
            ((MediaController.TransportControls) obj).seekTo(j11);
        }
        ...
        public static void l(Object obj, long j11) {
            ((MediaController.TransportControls) obj).skipToQueueItem(j11);
        }
    ...
    public static void a(Object obj, int i11, int i12) {
        ((MediaController) obj).adjustVolume(i11, i12);
    }
    ...
    public static void u(Object obj, int i11, int i12) {
        ((MediaController) obj).setVolumeTo(i11, i12);
    }
