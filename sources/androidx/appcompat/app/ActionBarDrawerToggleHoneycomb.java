...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo setIndicatorInfo, Activity activity, int i11) {
        if (setIndicatorInfo == null) {
            setIndicatorInfo = new SetIndicatorInfo(activity);
        }
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                setIndicatorInfo.setHomeActionContentDescription.invoke(activity.getActionBar(), Integer.valueOf(i11));
                return setIndicatorInfo;
            } catch (Exception e11) {
                Log.w(TAG, "Couldn't set content description via JB-MR2 API", e11);
            }
        }
        return setIndicatorInfo;
    }

    public static SetIndicatorInfo setActionBarUpIndicator(Activity activity, Drawable drawable, int i11) {
        ...
        try {
            ...
            setIndicatorInfo.setHomeActionContentDescription.invoke(actionBar, Integer.valueOf(i11));
            return setIndicatorInfo;
        } catch (Exception e11) {
            Log.w(TAG, "Couldn't set home-as-up indicator via JB-MR2 API", e11);
            return setIndicatorInfo;
        }
    }
}
