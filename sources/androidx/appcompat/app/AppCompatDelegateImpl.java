...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            f.a(obj).registerOnBackInvokedCallback(1000000, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            f.a(obj).unregisterOnBackInvokedCallback(e.a(obj2));
        }
    }
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onMenuOpened(int i11, Menu menu) {
            ...
            AppCompatDelegateImpl.this.onMenuOpened(i11);
            return true;
        }
        ...
        public void onPanelClosed(int i11, Menu menu) {
            if (this.mOnPanelClosedBypassEnabled) {
                ...
                AppCompatDelegateImpl.this.onPanelClosed(i11);
            }
        }
        ...
        public boolean onPreparePanel(int i11, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean z11 = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(i11);
            if (!z11) {
        ...
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i11) {
            return (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && i11 == 0) ? startAsSupportActionMode(callback) : super.onWindowStartingActionMode(callback, i11);
        }
    }
    ...
    public class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        public AutoBatteryNightModeManager(@NonNull Context context) {
            super();
            this.mPowerManager = (PowerManager) context.getApplicationContext().getSystemService(c6.d.f8118j);
        }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z11) {
            ...
            boolean z12 = rootMenu != menuBuilder;
            AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
            if (z12) {
            ...
            if (findMenuPanel != null) {
                if (!z12) {
                    AppCompatDelegateImpl.this.closePanel(findMenuPanel, z11);
                } else {
    ...
    private void invalidatePanelMenu(int i11) {
        this.mInvalidatePanelMenuFeatures = (1 << i11) | this.mInvalidatePanelMenuFeatures;
    ...
    private boolean onKeyDownPanel(int i11, KeyEvent keyEvent) {
        ...
        PanelFeatureState panelState = getPanelState(i11, true);
    ...
    private boolean onKeyUpPanel(int i11, KeyEvent keyEvent) {
        boolean z11;
        ...
        boolean z12 = true;
        PanelFeatureState panelState = getPanelState(i11, true);
        if (i11 != 0 || (decorContentParent = this.mDecorContentParent) == null || !decorContentParent.canShowOverflowMenu() || ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
            boolean z13 = panelState.isOpen;
            if (z13 || panelState.isHandled) {
                ...
                if (panelState.isPrepared) {
                    if (panelState.refreshMenuContent) {
                        ...
                        z11 = preparePanel(panelState, keyEvent);
                    } else {
                        z11 = true;
                    }
                    if (z11) {
            ...
            z12 = this.mDecorContentParent.hideOverflowMenu();
        } else {
            if (!this.mDestroyed && preparePanel(panelState, keyEvent)) {
                z12 = this.mDecorContentParent.showOverflowMenu();
            }
            z12 = false;
        }
        if (z12) {
    ...
    */
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (panelFeatureState.createdPanelView == null && (!z11 || !(peekSupportActionBar() instanceof ToolbarActionBar))) {
            ...
            panelFeatureState.menu.setQwertyMode(z12);
            panelFeatureState.menu.startDispatchingItemsChanged();
        }
    ...
    */
    ...
    private void updateResourcesConfiguration(int i11, @Nullable LocaleListCompat localeListCompat, boolean z11, @Nullable Configuration configuration) {
        ...
        if (z11 && (this.mHost instanceof Activity)) {
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        if (sCanApplyOverrideConfiguration && (context instanceof ContextThemeWrapper)) {
            context2 = context;
            try {
                ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration((ContextThemeWrapper) context2, createOverrideAppConfiguration(context2, mapNightMode, calculateApplicationLocales, null, false));
                return context2;
    ...
    public void callOnPanelClosed(int i11, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
        ...
        if ((panelFeatureState == null || panelFeatureState.isOpen) && !this.mDestroyed) {
            this.mAppCompatWindowCallback.bypassOnPanelClosed(this.mWindow.getCallback(), i11, menu);
        }
    }
    ...
    public void closePanel(int i11) {
        closePanel(getPanelState(i11, true), true);
    }
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (z12) {
            ...
            if (this.mLayoutIncludeDetector.detect(attributeSet)) {
                z11 = true;
                return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z11, z12, true, VectorEnabledTintResources.shouldBeUsed());
            }
            if (!(attributeSet instanceof XmlPullParser)) {
                z13 = shouldInheritContext((ViewParent) view);
    ...
    public void doInvalidatePanelMenu(int i11) {
        PanelFeatureState panelState;
        PanelFeatureState panelState2 = getPanelState(i11, true);
        ...
        if ((i11 != 108 && i11 != 0) || this.mDecorContentParent == null || (panelState = getPanelState(0, false)) == null) {
            return;
        }
        panelState.isPrepared = false;
    ...
    public <T extends View> T findViewById(@IdRes int i11) {
        ensureSubDecor();
        return (T) this.mWindow.findViewById(i11);
    }
    ...
    public PanelFeatureState getPanelState(int i11, boolean z11) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i11) {
        ...
        return (sanitizeWindowFeatureId != 1 ? sanitizeWindowFeatureId != 2 ? sanitizeWindowFeatureId != 5 ? sanitizeWindowFeatureId != 10 ? sanitizeWindowFeatureId != 108 ? sanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar : this.mHasActionBar : this.mOverlayActionMode : this.mFeatureIndeterminateProgress : this.mFeatureProgress : this.mWindowNoTitle) || this.mWindow.hasFeature(i11);
    }
    ...
    public int mapNightMode(@NonNull Context context, int i11) {
        if (i11 == -100) {
            return -1;
        }
        if (i11 != -1) {
    ...
    */
    ...
    public void onMenuOpened(int i11) {
        ActionBar supportActionBar;
    ...
    public void onPanelClosed(int i11) {
        if (i11 == 108) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
    ...
    */
    ...
    private boolean applyApplicationSpecificConfig(boolean z11, boolean z12) {
        ...
        if (!z12 && calculateApplicationLocales != null) {
            calculateApplicationLocales = getConfigurationLocales(this.mContext.getResources().getConfiguration());
        }
        boolean updateAppConfiguration = updateAppConfiguration(mapNightMode, calculateApplicationLocales, z11);
    ...
    public void closePanel(PanelFeatureState panelFeatureState, boolean z11) {
        ViewGroup viewGroup;
        DecorContentParent decorContentParent;
        if (z11 && panelFeatureState.featureId == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.isOverflowMenuShowing()) {
