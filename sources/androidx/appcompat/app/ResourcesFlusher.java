    ...
    private static void flushLollipops(@NonNull Resources resources) {
        ...
        if (!sDrawableCacheFieldFetched) {
            try {
                ...
                Log.e(TAG, "Could not retrieve Resources#mDrawableCache field", e11);
            }
        ...
        if (field != null) {
            try {
                ...
                Log.e(TAG, "Could not retrieve value from Resources#mDrawableCache", e12);
                map = null;
            }
            if (map != null) {
                map.clear();
    ...
    private static void flushNougats(@NonNull Resources resources) {
        ...
        if (!sResourcesImplFieldFetched) {
            try {
                ...
                Log.e(TAG, "Could not retrieve Resources#mResourcesImpl field", e11);
            }
        ...
        try {
            ...
            Log.e(TAG, "Could not retrieve value from Resources#mResourcesImpl", e12);
            obj = null;
        }
        if (obj == null) {
            return;
        ...
        if (!sDrawableCacheFieldFetched) {
            try {
                ...
                Log.e(TAG, "Could not retrieve ResourcesImpl#mDrawableCache field", e13);
            }
            sDrawableCacheFieldFetched = true;
        }
        ...
        if (field2 != null) {
            try {
                ...
                Log.e(TAG, "Could not retrieve value from ResourcesImpl#mDrawableCache", e14);
            }
        }
        if (obj2 != null) {
    ...
    private static void flushThemedResourcesCache(@NonNull Object obj) {
        ...
        if (!sThemedResourceCacheClazzFetched) {
            try {
                ...
                Log.e(TAG, "Could not find ThemedResourceCache class", e11);
            }
        ...
        if (!sThemedResourceCache_mUnthemedEntriesFieldFetched) {
            try {
                ...
                Log.e(TAG, "Could not retrieve ThemedResourceCache#mUnthemedEntries field", e12);
            }
        ...
        try {
            ...
            Log.e(TAG, "Could not retrieve value from ThemedResourceCache#mUnthemedEntries", e13);
