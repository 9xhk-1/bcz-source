...
class ToolbarActionBar extends ActionBar {
    ...
    */
    ...
    public void setElevation(float f11) {
        ViewCompat.setElevation(this.mDecorToolbar.getViewGroup(), f11);
    }
    ...
    public void setDisplayOptions(int i11, int i12) {
        this.mDecorToolbar.setDisplayOptions((i11 & i12) | ((~i12) & this.mDecorToolbar.getDisplayOptions()));
    }
    ...
    public void setCustomView(int i11) {
        setCustomView(LayoutInflater.from(this.mDecorToolbar.getContext()).inflate(i11, this.mDecorToolbar.getViewGroup(), false));
    }
