...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j11, double d11, double d12) {
        double d13 = (0.01720197f * ((j11 - UTC_2000) / 8.64E7f)) + 6.24006f;
        double sin = (Math.sin(d13) * 0.03341960161924362d) + d13 + (Math.sin(2.0f * r3) * 3.4906598739326E-4d) + (Math.sin(r3 * 3.0f) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
        double round = Math.round((r2 - J0) - r6) + J0 + ((-d12) / 360.0d) + (Math.sin(d13) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
