...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void setSubtitle(int i11) {
            setSubtitle(WindowDecorActionBar.this.mContext.getResources().getString(i11));
        }

        @Override // androidx.appcompat.view.ActionMode
        public void setTitle(int i11) {
            setTitle(WindowDecorActionBar.this.mContext.getResources().getString(i11));
        }
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        public ActionBar.Tab setContentDescription(int i11) {
            return setContentDescription(WindowDecorActionBar.this.mContext.getResources().getText(i11));
        }
        ...
        public ActionBar.Tab setCustomView(View view) {
            ...
            if (i11 >= 0) {
                WindowDecorActionBar.this.mTabScrollView.updateTab(i11);
            }
            return this;
        }
        ...
        public ActionBar.Tab setIcon(int i11) {
            return setIcon(AppCompatResources.getDrawable(WindowDecorActionBar.this.mContext, i11));
        }

        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setText(int i11) {
            return setText(WindowDecorActionBar.this.mContext.getResources().getText(i11));
        }
    }
    ...
    private void init(View view) {
        ...
        boolean z11 = (this.mDecorToolbar.getDisplayOptions() & 4) != 0;
        if (z11) {
    ...
    private void setHasEmbeddedTabs(boolean z11) {
        ...
        this.mDecorToolbar.setCollapsible(!this.mHasEmbeddedTabs && z12);
    ...
    public void doHide(boolean z11) {
        ...
        ViewPropertyAnimatorCompat translationY = ViewCompat.animate(this.mContainerView).translationY(f11);
    ...
    public void setCustomView(int i11) {
        setCustomView(LayoutInflater.from(getThemedContext()).inflate(i11, this.mDecorToolbar.getViewGroup(), false));
    }
    ...
    public void setDisplayOptions(int i11) {
        ...
        this.mDecorToolbar.setDisplayOptions(i11);
    }
    ...
    public void setElevation(float f11) {
        ViewCompat.setElevation(this.mContainerView, f11);
    }
    ...
    public void setHomeButtonEnabled(boolean z11) {
        this.mDecorToolbar.setHomeButtonEnabled(z11);
    }
    ...
    public void setNavigationMode(int i11) {
        ...
        if (navigationMode != i11 && !this.mHasEmbeddedTabs && (actionBarOverlayLayout = this.mOverlayLayout) != null) {
            ViewCompat.requestApplyInsets(actionBarOverlayLayout);
        }
        this.mDecorToolbar.setNavigationMode(i11);
        boolean z11 = false;
        if (i11 == 2) {
            ensureTabsExist();
        ...
        this.mDecorToolbar.setCollapsible(i11 == 2 && !this.mHasEmbeddedTabs);
    ...
    public void setSelectedNavigationItem(int i11) {
        int navigationMode = this.mDecorToolbar.getNavigationMode();
        if (navigationMode == 1) {
            this.mDecorToolbar.setDropdownSelectedPosition(i11);
        } else {
            if (navigationMode != 2) {
    ...
    public void setHomeActionContentDescription(int i11) {
        this.mDecorToolbar.setNavigationContentDescription(i11);
    }

    @Override // androidx.appcompat.app.ActionBar
    public void setHomeAsUpIndicator(int i11) {
        this.mDecorToolbar.setNavigationIcon(i11);
    }
    ...
    public void addTab(ActionBar.Tab tab, boolean z11) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, z11);
    ...
    public void setDisplayOptions(int i11, int i12) {
        ...
        this.mDecorToolbar.setDisplayOptions((i11 & i12) | ((~i12) & displayOptions));
    }
    ...
    public void addTab(ActionBar.Tab tab, int i11, boolean z11) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i11, z11);
