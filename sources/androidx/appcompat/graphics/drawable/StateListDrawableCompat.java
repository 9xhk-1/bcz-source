...
public class StateListDrawableCompat extends DrawableContainerCompat {
    ...
    public static class StateListState extends DrawableContainerCompat.DrawableContainerState {
        ...
        public void growArray(int i11, int i12) {
            ...
            System.arraycopy(this.mStateSets, 0, iArr, 0, i11);
    ...
    public Drawable getStateDrawable(int i11) {
        return this.mStateListState.getChild(i11);
    }
    ...
    public int[] getStateSet(int i11) {
        return this.mStateListState.mStateSets[i11];
    }
