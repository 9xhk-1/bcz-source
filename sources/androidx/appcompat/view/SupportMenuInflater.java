...
public class SupportMenuInflater extends MenuInflater {
    ...
    public class MenuState {
        ...
        private void setItem(MenuItem menuItem) {
            ...
            int i12 = this.itemActionViewLayout;
            if (i12 > 0) {
                if (z11) {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i11)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(i11, false) ? 1 : 0;
            } else {
            ...
            if (z11 && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
            ...
            if (obtainStyledAttributes.hasValue(i12)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i12, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i13 = R.styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i13)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i13);
            } else {
