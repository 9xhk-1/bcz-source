...
public class WindowCallbackWrapper implements Window.Callback {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static android.view.ActionMode onWindowStartingActionMode(Window.Callback callback, ActionMode.Callback callback2, int i11) {
    ...
    public static class Api24Impl {
        ...
        @DoNotInline
        public static void onProvideKeyboardShortcuts(Window.Callback callback, List<KeyboardShortcutGroup> list, Menu menu, int i11) {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static void onPointerCaptureChanged(Window.Callback callback, boolean z11) {
    ...
    public void onPointerCaptureChanged(boolean z11) {
        Api26Impl.onPointerCaptureChanged(this.mWrapped, z11);
    }
    ...
    public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int i11) {
        Api24Impl.onProvideKeyboardShortcuts(this.mWrapped, list, menu, i11);
    }
    ...
    public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i11) {
        return Api23Impl.onWindowStartingActionMode(this.mWrapped, callback, i11);
    }
}
