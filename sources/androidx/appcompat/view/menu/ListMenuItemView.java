...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void setGroupDividerEnabled(boolean z11) {
        ImageView imageView = this.mGroupDivider;
        if (imageView != null) {
            imageView.setVisibility((this.mHasListDivider || !z11) ? 8 : 0);
        }
    }

    @Override // androidx.appcompat.view.menu.MenuView.ItemView
    public void setIcon(Drawable drawable) {
        boolean z11 = this.mItemData.shouldShowIcon() || this.mForceShowIcon;
    ...
    public void setShortcut(boolean z11, char c11) {
        int i11 = (z11 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (i11 == 0) {
