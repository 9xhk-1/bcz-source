...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        int i11 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
    ...
    public void setCheckedInt(boolean z11) {
        int i11 = this.mFlags;
    ...
    public MenuItem setVisible(boolean z11) {
        if (setVisibleInt(z11)) {
            this.mMenu.onItemVisibleChanged(this);
        }
        return this;
    }

    public boolean setVisibleInt(boolean z11) {
        int i11 = this.mFlags;
    ...
    public MenuItem setTitle(int i11) {
        return setTitle(this.mMenu.getContext().getString(i11));
    }
