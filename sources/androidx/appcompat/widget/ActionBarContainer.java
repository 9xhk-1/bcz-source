...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onLayout(boolean z11, int i11, int i12, int i13, int i14) {
        ...
        if (this.mIsSplit) {
            ...
            this.mIsStacked = z14;
            if (z14 && (drawable = this.mStackedBackground) != null) {
    ...
    public void onMeasure(int i11, int i12) {
        int i13;
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i12) == Integer.MIN_VALUE && (i13 = this.mHeight) >= 0) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min((!isCollapsed(this.mActionBarView) ? getMeasuredHeightWithMargins(this.mActionBarView) : !isCollapsed(this.mContextView) ? getMeasuredHeightWithMargins(this.mContextView) : 0) + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i12) : Integer.MAX_VALUE));
    }
