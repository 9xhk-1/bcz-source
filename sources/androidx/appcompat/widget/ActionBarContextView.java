...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z11, int i11, int i12, int i13, int i14) {
        ...
        int paddingRight = isLayoutRtl ? (i13 - i11) - getPaddingRight() : getPaddingLeft();
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            int next = AbsActionBarView.next(paddingRight, i15, isLayoutRtl);
            paddingRight = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, isLayoutRtl), i16, isLayoutRtl);
        }
        int i17 = paddingRight;
        LinearLayout linearLayout = this.mTitleLayout;
        if (linearLayout != null && this.mCustomView == null && linearLayout.getVisibility() != 8) {
            i17 += positionChild(this.mTitleLayout, i17, paddingTop, paddingTop2, isLayoutRtl);
        }
        View view2 = this.mCustomView;
        if (view2 != null) {
            positionChild(view2, i17, paddingTop, paddingTop2, isLayoutRtl);
        }
        int paddingLeft = isLayoutRtl ? getPaddingLeft() : (i13 - i11) - getPaddingRight();
    ...
    public void onMeasure(int i11, int i12) {
        ...
        if (linearLayout != null && this.mCustomView == null) {
            if (this.mTitleOptional) {
                ...
                this.mTitleLayout.setVisibility(z11 ? 0 : 8);
            } else {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i16), View.MeasureSpec.makeMeasureSpec(i14, i18));
        }
