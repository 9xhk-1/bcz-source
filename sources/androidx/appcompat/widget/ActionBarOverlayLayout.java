...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void onMeasure(int i11, int i12) {
        int measuredHeight;
        pullChildren();
        measureChildWithMargins(this.mActionBarTop, i11, 0, i12, 0);
    ...
    public void setActionBarHideOffset(int i11) {
        haltActionBarHideOffsetAnimations();
        this.mActionBarTop.setTranslationY(-Math.max(0, Math.min(i11, this.mActionBarTop.getHeight())));
    }
    ...
    public void setOverlayMode(boolean z11) {
        ...
        this.mIgnoreWindowContentOverlay = z11 && getContext().getApplicationInfo().targetSdkVersion < 19;
    }
    ...
    public boolean onStartNestedScroll(View view, View view2, int i11) {
        if ((i11 & 2) == 0 || this.mActionBarTop.getVisibility() != 0) {
            return false;
        }
        return this.mHideOnContentScroll;
    }
