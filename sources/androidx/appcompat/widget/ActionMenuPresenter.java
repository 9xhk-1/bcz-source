...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z12 || i18 + i17 > i15)) {
            i15--;
        }
        int i21 = i15 - i17;
        ...
        while (i23 < i11) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i13 -= ActionMenuView.measureChildForCells(itemView, i12, i13, makeMeasureSpec, r32);
                } else {
                ...
                boolean z14 = (i21 > 0 || z13) && i16 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i13 > 0);
                boolean z15 = z14;
                i14 = i11;
                if (z14) {
                    ...
                    z14 = z16 & (!actionMenuPresenter.mStrictWidthLimit ? i16 + i24 <= 0 : i16 < 0);
                }
                if (z14 && groupId2 != 0) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        int i11;
        MenuItem findItem;
        if ((parcelable instanceof SavedState) && (i11 = ((SavedState) parcelable).openSubMenuId) > 0 && (findItem = this.mMenu.findItem(i11)) != null) {
