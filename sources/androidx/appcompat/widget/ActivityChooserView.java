...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int i11) {
            return (this.mShowFooterView && i11 == getCount() - 1) ? 1 : 0;
        }
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i11, long j11) {
            ...
            if (activityChooserView.mIsSelectingDefaultActivity) {
                if (i11 > 0) {
                    activityChooserView.mAdapter.getDataModel().setDefaultActivity(i11);
                    return;
                }
                return;
            }
            ...
            Intent chooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(i11);
            if (chooseActivity != null) {
                chooseActivity.addFlags(524288);
                ActivityChooserView.this.getContext().startActivity(chooseActivity);
            }
    ...
    public void setInitialActivityCount(int i11) {
        this.mInitialActivityCount = i11;
    }
    ...
    public void showPopupUnchecked(int i11) {
        ...
        if (i11 == Integer.MAX_VALUE || activityCount <= i11 + r02) {
            this.mAdapter.setShowFooterView(false);
            this.mAdapter.setMaxActivityCount(i11);
        } else {
            this.mAdapter.setShowFooterView(true);
            this.mAdapter.setMaxActivityCount(i11 - 1);
        }
