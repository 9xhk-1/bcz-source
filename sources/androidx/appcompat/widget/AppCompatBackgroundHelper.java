...
class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i11) {
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(i14)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i14, -1), null));
            }
    ...
    public void onSetBackgroundResource(int i11) {
        this.mBackgroundResId = i11;
        AppCompatDrawableManager appCompatDrawableManager = this.mDrawableManager;
        setInternalBackgroundTint(appCompatDrawableManager != null ? appCompatDrawableManager.getTintList(this.mView.getContext(), i11) : null);
        applySupportBackgroundTint();
    }
