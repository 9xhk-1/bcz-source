...
public class AppCompatRatingBar extends RatingBar {
    ...
    public synchronized void onMeasure(int i11, int i12) {
        ...
        if (sampleTile != null) {
            setMeasuredDimension(View.resolveSizeAndState(sampleTile.getWidth() * getNumStars(), i11, 0), getMeasuredHeight());
        }
    }
    ...
    public AppCompatRatingBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        appCompatProgressBarHelper.loadFromAttributes(attributeSet, i11);
    }
}
