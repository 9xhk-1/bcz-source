    ...
    public class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i11) {
            ...
            if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                AppCompatSpinner.this.performItemClick(null, i11, this.mListAdapter.getItemId(i11));
            }
            dismiss();
        }
        ...
        public void show(int i11, int i12) {
            ...
            Api17Impl.setTextDirection(listView, i11);
            Api17Impl.setTextAlignment(listView, i12);
            this.mPopup.show();
        }
    }
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.AppCompatSpinner.DropdownPopup.1
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i12, long j11) {
                    ...
                    if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                        ...
                        AppCompatSpinner.this.performItemClick(view, i12, dropdownPopup.mAdapter.getItemId(i12));
                    }
        ...
        public void computeContentWidth() {
            ...
            if (background != null) {
                ...
                i11 = ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? AppCompatSpinner.this.mTempRect.right : -AppCompatSpinner.this.mTempRect.left;
            } else {
            ...
            setHorizontalOffset(ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? i11 + (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) : i11 + paddingLeft + getHorizontalOriginalOffset());
        }
