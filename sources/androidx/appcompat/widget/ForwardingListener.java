...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    */
    ...
    private static boolean pointInView(View view, float f11, float f12, float f13) {
        float f14 = -f13;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        boolean z11;
        boolean z12 = this.mForwarding;
        if (z12) {
            z11 = onTouchForwarded(motionEvent) || !onForwardingStopped();
        } else {
            z11 = onTouchObserved(motionEvent) && onForwardingStarted();
            if (z11) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
