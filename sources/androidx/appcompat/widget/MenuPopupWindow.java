...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setTouchModal(PopupWindow popupWindow, boolean z11) {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onKeyDown(int i11, KeyEvent keyEvent) {
            ...
            if (listMenuItemView != null && i11 == this.mAdvanceKey) {
                if (listMenuItemView.isEnabled() && listMenuItemView.getItemData().hasSubMenu()) {
                    performItemClick(listMenuItemView, getSelectedItemPosition(), getSelectedItemId());
                }
                return true;
            }
            if (listMenuItemView == null || i11 != this.mRetreatKey) {
    ...
    public void setTouchModal(boolean z11) {
        if (Build.VERSION.SDK_INT > 28) {
            Api29Impl.setTouchModal(this.mPopup, z11);
            return;
        }
