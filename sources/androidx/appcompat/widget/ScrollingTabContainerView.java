...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int i11) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(i11)).getTab();
        }
        ...
        public View getView(int i11, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(i11), true);
            }
    ...
    public class TabClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = ScrollingTabContainerView.this.mTabLayout.getChildAt(i11);
        ...
        */
        ...
        public void onMeasure(int i11, int i12) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
                ...
                int i13 = ScrollingTabContainerView.this.mMaxTabWidth;
    ...
    public void animateToVisibility(int i11) {
        ...
        if (i11 != 0) {
            ...
            alpha.setListener(this.mVisAnimListener.withFinalVisibility(alpha, i11));
            alpha.start();
            return;
        }
        if (getVisibility() != 0) {
        ...
        alpha2.setListener(this.mVisAnimListener.withFinalVisibility(alpha2, i11));
        alpha2.start();
    }

    public TabView createTabView(ActionBar.Tab tab, boolean z11) {
        TabView tabView = new TabView(this, getContext(), tab, z11);
        if (z11) {
    ...
    public void onMeasure(int i11, int i12) {
        ...
        if (childCount <= 1 || !(mode == 1073741824 || mode == Integer.MIN_VALUE)) {
            ...
            if (childCount > 2) {
                this.mMaxTabWidth = (int) (View.MeasureSpec.getSize(i11) * 0.4f);
            } else {
                this.mMaxTabWidth = View.MeasureSpec.getSize(i11) / 2;
            }
        ...
        if (z11 || !this.mAllowCollapse) {
            ...
            if (this.mTabLayout.getMeasuredWidth() > View.MeasureSpec.getSize(i11)) {
                performCollapse();
            } else {
                performExpand();
            }
    ...
    public void removeTabAt(int i11) {
        this.mTabLayout.removeViewAt(i11);
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void updateTab(int i11) {
        ((TabView) this.mTabLayout.getChildAt(i11)).update();
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void addTab(ActionBar.Tab tab, int i11, boolean z11) {
        TabView createTabView = createTabView(tab, false);
        this.mTabLayout.addView(createTabView, i11, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
