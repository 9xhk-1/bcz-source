...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int i11) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + com.alipay.sdk.m.u.i.f11099d;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    z12 = this.mDelegateTargeted;
                    if (z12 && !this.mSlopBounds.contains(x11, y11)) {
                        z13 = z12;
                        z11 = false;
                    }
                } else {
                ...
                if (this.mTargetBounds.contains(x11, y11)) {
            ...
            if (!z11 || this.mActualBounds.contains(x11, y11)) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i11, String str) {
        ...
        try {
            ...
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i11, str);
    ...
    public void setQueryRefinementEnabled(boolean z11) {
        ...
        if (cursorAdapter instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) cursorAdapter).setQueryRefinement(z11 ? 2 : 1);
        }
    }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int i12, KeyEvent keyEvent) {
                ...
                if (searchView.mSearchSrcTextView.isPopupShowing() && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
                    return SearchView.this.onSuggestionsKey(view, i12, keyEvent);
                }
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || i12 != 66) {
                    return false;
                }
        ...
        AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i12, long j11) {
                SearchView.this.onItemClicked(i12, 0, null);
            }
        };
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.appcompat.widget.SearchView.9
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i12, long j11) {
                SearchView.this.onItemSelected(i12);
            }
        ...
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(i12));
        ...
        if (findViewById3 != null) {
            findViewById3.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.appcompat.widget.SearchView.4
                ...
                public void onLayoutChange(View view, int i15, int i16, int i17, int i18, int i19, int i21, int i22, int i23) {
