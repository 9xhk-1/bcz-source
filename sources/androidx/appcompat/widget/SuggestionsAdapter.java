...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error closing icon stream for " + uri, e112);
                }
            }
        } catch (FileNotFoundException e12) {
            Log.w(LOG_TAG, "Icon not found: " + uri + j2.O + e12.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + j2.O + e12.getMessage());
        return null;
    ...
    private Drawable getIcon2(Cursor cursor) {
        int i11 = this.mIconName2Col;
        if (i11 == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(i11));
    }
    ...
    private static String getStringOrNull(Cursor cursor, int i11) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "unexpected error retrieving valid column from cursor, did the remote process die?", e11);
            return null;
        }
    }
    ...
    public void changeCursor(Cursor cursor) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "error changing cursor and caching columns", e11);
        }
    }
    ...
    public View getDropDownView(int i11, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e11);
            View newDropDownView = newDropDownView(this.mProviderContext, getCursor(), viewGroup);
            if (newDropDownView != null) {
                ((ChildViewCache) newDropDownView.getTag()).mText1.setText(e11.toString());
            }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i11) {
    ...
    public View getView(int i11, View view, ViewGroup viewGroup) {
        try {
            ...
            if (newView != null) {
                ((ChildViewCache) newView.getTag()).mText1.setText(e11.toString());
            }
            return newView;
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.mSearchView.getVisibility() == 0 && this.mSearchView.getWindowVisibility() == 0) {
            try {
                ...
                Log.w(LOG_TAG, "Search suggestions query threw an exception.", e11);
            }
        }
        return null;
    }
