...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public static class Api18Impl {
        ...
        @DoNotInline
        public static void setAutoCancel(ObjectAnimator objectAnimator, boolean z11) {
    ...
    private boolean hitThumb(float f11, float f12) {
        ...
        Rect rect = this.mTempRect;
        return f11 > ((float) i14) && f11 < ((float) (((i15 + rect.left) + rect.right) + i12)) && f12 > ((float) i13) && f12 < ((float) (this.mSwitchBottom + i12));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                DrawableCompat.setHotspotBounds(background, i26, i14, i27, i16);
            }
        }
        super.draw(canvas);
    }
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i11) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i11, androidx.appcompat.R.styleable.TextAppearance);
