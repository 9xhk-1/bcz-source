...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i11) {
        ...
        return (!this.mWrapped.hasValue(i11) || (resourceId = this.mWrapped.getResourceId(i11, 0)) == 0 || (colorStateList = AppCompatResources.getColorStateList(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i11) : colorStateList;
    }
    ...
    public Drawable getDrawable(int i11) {
        int resourceId;
        return (!this.mWrapped.hasValue(i11) || (resourceId = this.mWrapped.getResourceId(i11, 0)) == 0) ? this.mWrapped.getDrawable(i11) : AppCompatResources.getDrawable(this.mContext, resourceId);
    }
    ...
    public int getType(int i11) {
        return Api21Impl.getType(this.mWrapped, i11);
    }
