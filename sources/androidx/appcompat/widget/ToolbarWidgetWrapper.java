...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void animateToVisibility(int i11) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(i11, 200L);
    ...
    public void setCollapsible(boolean z11) {
        this.mToolbar.setCollapsible(z11);
    }
    ...
    public void setNavigationMode(int i11) {
        ...
        if (i11 != i12) {
            ...
            } else if (i12 == 2 && (view = this.mTabView) != null) {
    ...
    public void setVisibility(int i11) {
        this.mToolbar.setVisibility(i11);
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i11, long j11) {
        return ViewCompat.animate(this.mToolbar).alpha(i11 == 0 ? 1.0f : 0.0f).setDuration(j11).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
            ...
            public void onAnimationEnd(View view) {
                ...
                ToolbarWidgetWrapper.this.mToolbar.setVisibility(i11);
            }
