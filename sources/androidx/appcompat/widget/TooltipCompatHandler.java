...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.j
        @Override // java.lang.Runnable
        public final void run() {
            TooltipCompatHandler.this.show(false);
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.k
        @Override // java.lang.Runnable
        public final void run() {
    ...
    private boolean updateAnchorPos(MotionEvent motionEvent) {
        ...
        if (!this.mForceNextChangeSignificant && Math.abs(x11 - this.mAnchorX) <= this.mHoverSlop && Math.abs(y11 - this.mAnchorY) <= this.mHoverSlop) {
            return false;
        }
        this.mAnchorX = x11;
        this.mAnchorY = y11;
    ...
    public void show(boolean z11) {
        ...
        if (ViewCompat.isAttachedToWindow(this.mAnchor)) {
            ...
            if (this.mFromTouch) {
                j12 = LONG_CLICK_HIDE_TIMEOUT_MS;
            } else {
            ...
            this.mAnchor.removeCallbacks(this.mHideRunnable);
            this.mAnchor.postDelayed(this.mHideRunnable, j12);
        }
    }
