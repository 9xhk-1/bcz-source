...
public final class HintConstants {
    ...
    @NonNull
    public static String generateSmsOtpHintForCharacterPosition(int i11) {
        Preconditions.checkArgumentInRange(i11, 1, 8, "characterPosition");
        return (AUTOFILL_HINT_SMS_OTP + i11).intern();
    }
}
