...
public final class Camera2ImplConfig extends CaptureRequestOptions {
    ...
    public int getCaptureRequestTemplate(int i11) {
        return ((Integer) getConfig().retrieveOption(TEMPLATE_TYPE_OPTION, Integer.valueOf(i11))).intValue();
    }
    ...
    public long getStreamUseCase(long j11) {
        return ((Long) getConfig().retrieveOption(STREAM_USE_CASE_OPTION, Long.valueOf(j11))).longValue();
    }
}
