...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
    ...
    @Nullable
    @GuardedBy("mLock")
    com.google.common.util.concurrent.p1<Void> mOpenCaptureSessionFuture;
    ...
    @Nullable
    @GuardedBy("mLock")
    private com.google.common.util.concurrent.p1<List<Surface>> mStartingSurface;
    ...
    public static /* synthetic */ void a(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        synchronizedCaptureSessionBaseImpl.mCaptureSessionRepository.onCaptureSessionClosed(synchronizedCaptureSessionBaseImpl);
        synchronizedCaptureSessionBaseImpl.e(synchronizedCaptureSession);
        ...
        Logger.w(TAG, "[" + synchronizedCaptureSessionBaseImpl + "] Cannot call onClosed() when the CameraCaptureSession is not correctly configured.");
    }

    public static /* synthetic */ Object b(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) {
        String str;
    ...
    public static /* synthetic */ void c(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback);
        synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback.e(synchronizedCaptureSession);
    }

    public static /* synthetic */ com.google.common.util.concurrent.p1 d(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, List list, List list2) {
        synchronizedCaptureSessionBaseImpl.getClass();
        Logger.d(TAG, "[" + synchronizedCaptureSessionBaseImpl + "] getSurface done with results: " + list2);
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.k3
            @Override // java.lang.Runnable
            public final void run() {
                SynchronizedCaptureSessionBaseImpl.this.e(r0);
            }
        });
    }
    ...
    @NonNull
    public SessionConfigurationCompat createSessionConfigurationCompat(int i11, @NonNull List<OutputConfigurationCompat> list, @NonNull SynchronizedCaptureSession.StateCallback stateCallback) {
        this.mCaptureSessionStateCallback = stateCallback;
        return new SessionConfigurationCompat(i11, list, getExecutor(), new CameraCaptureSession.StateCallback() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl.2
    ...
    public boolean isCameraCaptureSessionOpen() {
        boolean z11;
        synchronized (this.mLock) {
            z11 = this.mOpenCaptureSessionFuture != null;
        }
        return z11;
    }
    ...
    public void onClosed(@NonNull final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        synchronized (this.mLock) {
            try {
                if (this.mClosed) {
                    ...
                    p1Var = this.mOpenCaptureSessionFuture;
                }
            } catch (Throwable th2) {
                throw th2;
            }
        ...
        finishClose();
        if (p1Var != null) {
            p1Var.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.l3
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.a(SynchronizedCaptureSessionBaseImpl.this, synchronizedCaptureSession);
                }
    ...
    public void e(@NonNull final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (p1Var != null) {
            p1Var.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.j3
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.c(SynchronizedCaptureSessionBaseImpl.this, synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.Opener
    @NonNull
    public com.google.common.util.concurrent.p1<Void> openCaptureSession(@NonNull CameraDevice cameraDevice, @NonNull final SessionConfigurationCompat sessionConfigurationCompat, @NonNull final List<DeferrableSurface> list) {
        synchronized (this.mLock) {
            try {
                ...
                com.google.common.util.concurrent.p1<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.m3
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return SynchronizedCaptureSessionBaseImpl.b(SynchronizedCaptureSessionBaseImpl.this, list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                    }
                });
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.Opener
    @NonNull
    public com.google.common.util.concurrent.p1<List<Surface>> startWithDeferrableSurface(@NonNull final List<DeferrableSurface> list, long j11) {
        synchronized (this.mLock) {
            try {
                if (this.mOpenerDisabled) {
                    return Futures.immediateFailedFuture(new CancellationException("Opener is disabled"));
                }
                FutureChain transformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j11, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.n3
                    @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                    public final com.google.common.util.concurrent.p1 apply(Object obj) {
                        return SynchronizedCaptureSessionBaseImpl.d(SynchronizedCaptureSessionBaseImpl.this, list, (List) obj);
                    }
                }, getExecutor());
    ...
    public boolean stop() {
        ...
        try {
            synchronized (this.mLock) {
                try {
                    if (!this.mOpenerDisabled) {
                        com.google.common.util.concurrent.p1<List<Surface>> p1Var = this.mStartingSurface;
                        r1 = p1Var != null ? p1Var : null;
                        this.mOpenerDisabled = true;
                    }
                    z11 = !isCameraCaptureSessionOpen();
                } finally {
                }
            }
            return z11;
