...
public final class SessionConfigurationCompat {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof SessionConfigurationCompatBaseImpl) {
                ...
                if (Objects.equals(this.mInputConfig, sessionConfigurationCompatBaseImpl.mInputConfig) && this.mSessionType == sessionConfigurationCompatBaseImpl.mSessionType && this.mOutputConfigurations.size() == sessionConfigurationCompatBaseImpl.mOutputConfigurations.size()) {
                    for (int i11 = 0; i11 < this.mOutputConfigurations.size(); i11++) {
                        if (!this.mOutputConfigurations.get(i11).equals(sessionConfigurationCompatBaseImpl.mOutputConfigurations.get(i11))) {
                            return false;
                        }
                    }
                    return true;
    ...
    public SessionConfigurationCompat(int i11, @NonNull List<OutputConfigurationCompat> list, @NonNull Executor executor, @NonNull CameraCaptureSession.StateCallback stateCallback) {
        if (Build.VERSION.SDK_INT < 28) {
            this.mImpl = new SessionConfigurationCompatBaseImpl(i11, list, executor, stateCallback);
        } else {
            this.mImpl = new SessionConfigurationCompatApi28Impl(i11, list, executor, stateCallback);
        }
    }
    ...
    public static final class SessionConfigurationCompatApi28Impl implements SessionConfigurationCompatImpl {
        ...
        public SessionConfigurationCompatApi28Impl(int i11, @NonNull List<OutputConfigurationCompat> list, @NonNull Executor executor, @NonNull CameraCaptureSession.StateCallback stateCallback) {
            this(new SessionConfiguration(i11, SessionConfigurationCompat.transformFromCompat(list), executor, stateCallback));
        }
    }
