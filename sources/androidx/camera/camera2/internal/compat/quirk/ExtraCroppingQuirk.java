...
public class ExtraCroppingQuirk implements Quirk {
    ...
    private static boolean isSamsungDistortion() {
        if (!l.f31607b.equalsIgnoreCase(Build.BRAND)) {
            return false;
        }
    ...
    public Size getVerifiedResolution(@NonNull SurfaceConfig.ConfigType configType) {
        ...
        int i11 = AnonymousClass1.$SwitchMap$androidx$camera$core$impl$SurfaceConfig$ConfigType[configType.ordinal()];
        if (i11 == 1) {
            return new Size(1920, pd.a.f80340j);
        }
        if (i11 == 2) {
