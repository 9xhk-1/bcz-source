...
public class SmallDisplaySizeQuirk implements Quirk {
    ...
    static {
        ...
        hashMap.put("REDMI NOTE 8", new Size(pd.a.f80340j, 2340));
        hashMap.put("REDMI NOTE 7", new Size(pd.a.f80340j, 2340));
        hashMap.put("SM-A207M", new Size(720, 1560));
        hashMap.put("REDMI NOTE 7S", new Size(pd.a.f80340j, 2340));
        hashMap.put("SM-A127F", new Size(720, 1600));
        hashMap.put("SM-A536E", new Size(pd.a.f80340j, 2400));
        hashMap.put("220233L2I", new Size(720, 1600));
        hashMap.put("V2149", new Size(720, 1600));
        hashMap.put("VIVO 1920", new Size(pd.a.f80340j, 2340));
        hashMap.put("CPH2223", new Size(pd.a.f80340j, 2400));
        hashMap.put("V2029", new Size(720, 1600));
        hashMap.put("CPH1901", new Size(720, d.f84344v));
        hashMap.put("REDMI Y3", new Size(720, d.f84344v));
        hashMap.put("SM-A045M", new Size(720, 1600));
        hashMap.put("SM-A146U", new Size(pd.a.f80340j, 2408));
        hashMap.put("CPH1909", new Size(720, d.f84344v));
        hashMap.put("NOKIA 4.2", new Size(720, d.f84344v));
        hashMap.put("SM-G960U1", new Size(1440, f.f11576e0));
        hashMap.put("SM-A137F", new Size(pd.a.f80340j, 2408));
        hashMap.put("VIVO 1816", new Size(720, d.f84344v));
        ...
        hashMap.put("INFINIX X670", new Size(pd.a.f80340j, 2400));
    }
