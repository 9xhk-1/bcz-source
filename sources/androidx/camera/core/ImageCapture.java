...
public final class ImageCapture extends UseCase {
    ...
    public static final class Builder implements UseCaseConfig.Builder<ImageCapture, ImageCaptureConfig, Builder>, ImageOutputConfig.Builder<Builder>, IoConfig.Builder<Builder>, ImageInputConfig.Builder<Builder> {
        ...
        @NonNull
        public Builder setJpegQuality(@IntRange(from = 1, to = 100) int i11) {
            Preconditions.checkArgumentInRange(i11, 1, 100, "jpegQuality");
        ...
        @NonNull
        @ExperimentalImageCaptureOutputFormat
        public Builder setOutputFormat(int i11) {
            getMutableConfig().insertOption(ImageCaptureConfig.OPTION_OUTPUT_FORMAT, Integer.valueOf(i11));
            return this;
        }

        @NonNull
        public Builder setPostviewEnabled(boolean z11) {
            getMutableConfig().insertOption(ImageCaptureConfig.OPTION_POSTVIEW_ENABLED, Boolean.valueOf(z11));
            return this;
        }
        ...
        public ImageCapture build() {
            ...
            if (num != null) {
                ...
                getMutableConfig().insertOption(ImageInputConfig.OPTION_INPUT_FORMAT, Integer.valueOf(MessageConstant.MessageType.MESSAGE_FIND_PHONE));
    ...
    public static class ImageCaptureCapabilitiesImpl implements ImageCaptureCapabilities {
        ...
        private boolean isUltraHdrSupported() {
            ...
            if (cameraInfo instanceof CameraInfoInternal) {
                return ((CameraInfoInternal) cameraInfo).getSupportedOutputFormats().contains(Integer.valueOf(MessageConstant.MessageType.MESSAGE_FIND_PHONE));
            }
            return false;
        }
    ...
    public static final class Metadata {
        ...
        public String toString() {
            return "Metadata{mIsReversedHorizontal=" + this.mIsReversedHorizontal + ", mIsReversedVertical=" + this.mIsReversedVertical + ", mLocation=" + this.mLocation + com.alipay.sdk.m.u.i.f11099d;
        }
    }
    ...
    public static final class OutputFileOptions {
        ...
        @NonNull
        public String toString() {
            return "OutputFileOptions{mFile=" + this.mFile + ", mContentResolver=" + this.mContentResolver + ", mSaveCollection=" + this.mSaveCollection + ", mContentValues=" + this.mContentValues + ", mOutputStream=" + this.mOutputStream + ", mMetadata=" + this.mMetadata + com.alipay.sdk.m.u.i.f11099d;
        }
    ...
    public interface ScreenFlash {
        @UiThread
        void apply(long j11, @NonNull ScreenFlashListener screenFlashListener);
    ...
    public ImageCapture(@NonNull ImageCaptureConfig imageCaptureConfig) {
        ...
        this.mClosingListener = new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.w
        ...
        this.mImageCaptureControl = new ImageCaptureControl() { // from class: androidx.camera.core.ImageCapture.1
            ...
            @NonNull
            @MainThread
            public p1<Void> submitStillCaptureRequests(@NonNull List<CaptureConfig> list) {
    ...
    public static /* synthetic */ void c(ImageCapture imageCapture, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        ...
        SessionConfig.Builder createPipeline = imageCapture.createPipeline(imageCapture.getCameraId(), (ImageCaptureConfig) imageCapture.getCurrentConfig(), (StreamSpec) Preconditions.checkNotNull(imageCapture.getAttachedStreamSpec()));
        imageCapture.mSessionConfigBuilder = createPipeline;
        a11 = j.a(new Object[]{createPipeline.build()});
        imageCapture.updateSessionConfig(a11);
    ...
    @NonNull
    public static Rect computeDispatchCropRect(@Nullable Rect rect, @Nullable Rational rational, int i11, @NonNull Size size, int i12) {
        if (rect != null) {
    ...
    private SessionConfig.Builder createPipeline(@NonNull String str, @NonNull ImageCaptureConfig imageCaptureConfig, @NonNull StreamSpec streamSpec) {
        ...
        boolean z11 = !camera.getHasTransform();
        ...
        if (((Boolean) getCurrentConfig().retrieveOption(ImageCaptureConfig.OPTION_POSTVIEW_ENABLED, Boolean.FALSE)).booleanValue() && (sessionProcessor = getSessionProcessor()) != null) {
            ...
            if (list2 != null && !list2.isEmpty()) {
                if (resolutionSelector != null) {
                    ...
                    List<Size> sortSupportedOutputSizesByResolutionSelector = SupportedOutputSizesSorter.sortSupportedOutputSizesByResolutionSelector(resolutionSelector, list2, null, getTargetRotation(), new Rational(sensorRect.width(), sensorRect.height()), cameraInfoInternal.getSensorRotationDegrees(), cameraInfoInternal.getLensFacing());
                    if (sortSupportedOutputSizesByResolutionSelector.isEmpty()) {
                        throw new IllegalArgumentException("The postview ResolutionSelector cannot select a valid size for the postview.");
                    }
                    size = sortSupportedOutputSizesByResolutionSelector.get(0);
                } else {
                    size = (Size) Collections.max(list2, new CompareSizesByArea());
                }
            }
        }
        this.mImagePipeline = new ImagePipeline(imageCaptureConfig, resolution, getEffect(), z11, size, i11);
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.t
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                ImageCapture.c(ImageCapture.this, sessionConfig, sessionError);
            }
        });
    ...
    /* JADX WARN: Type inference failed for: r8v15, types: [androidx.camera.core.impl.UseCaseConfig, androidx.camera.core.impl.UseCaseConfig<?>] */
    @Override // androidx.camera.core.UseCase
    @NonNull
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    ...
    public void setFlashMode(int i11) {
        Logger.d(TAG, "setFlashMode: flashMode = " + i11);
    ...
    @MainThread
    public p1<Void> submitStillCaptureRequest(@NonNull List<CaptureConfig> list) {
        Threads.checkMainThread();
        return Futures.transform(getCameraControl().submitStillCaptureRequests(list, this.mCaptureMode, this.mFlashType), new Function() { // from class: androidx.camera.core.x
