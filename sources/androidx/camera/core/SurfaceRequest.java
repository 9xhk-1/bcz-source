...
public final class SurfaceRequest {
    ...
    private final p1<Void> mSessionStatusFuture;
    ...
    public static abstract class Result {
        ...
        @NonNull
        public static Result of(int i11, @NonNull Surface surface) {
    ...
    public static abstract class TransformationInfo {
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static TransformationInfo of(@NonNull Rect rect, int i11, int i12, boolean z11, @NonNull Matrix matrix, boolean z12) {
            return new AutoValue_SurfaceRequest_TransformationInfo(rect, i11, i12, z11, matrix, z12);
        }
    ...
    public static /* synthetic */ Object g(SurfaceRequest surfaceRequest, AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
        ...
        atomicReference.set(completer);
        return "SurfaceRequest-surface-recreation(" + surfaceRequest.hashCode() + pn.j.f81007d;
    }
    ...
    private CallbackToFutureAdapter.Completer<Void> initialSurfaceRecreationCompleter(@NonNull Executor executor, @NonNull final Runnable runnable) {
        ...
        Futures.addCallback(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.n0
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public SurfaceRequest(@NonNull Size size, @NonNull CameraInternal cameraInternal, boolean z11, @NonNull DynamicRange dynamicRange, @NonNull Range<Integer> range, @NonNull Runnable runnable) {
        ...
        final AtomicReference atomicReference = new AtomicReference(null);
        final p1 future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.o0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
        ...
        p1<Void> future2 = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.p0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
        ...
        p1<Surface> future3 = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.q0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
        ...
        final p1<Void> terminationFuture = deferrableSurface.getTerminationFuture();
        Futures.addCallback(future3, new FutureCallback<Surface>() { // from class: androidx.camera.core.SurfaceRequest.3
            ...
            public void onFailure(@NonNull Throwable th2) {
                ...
                Preconditions.checkState(completer2.setException(new RequestCancelledException(str + " cancelled.", th2)));
            }
        ...
        terminationFuture.addListener(new Runnable() { // from class: androidx.camera.core.r0
            @Override // java.lang.Runnable
            public final void run() {
