...
final class ProcessingInput2Packet implements Operation<ProcessingNode.InputPacket, Packet<ImageProxy>> {
    ...
    private static CameraCaptureResult getCameraCaptureResult(@NonNull ImageProxy imageProxy) {
        return imageProxy.getImageInfo() instanceof CameraCaptureResultImageInfo ? ((CameraCaptureResultImageInfo) imageProxy.getImageInfo()).getCameraCaptureResult() : CameraCaptureResult.EmptyCameraCaptureResult.create();
    }
