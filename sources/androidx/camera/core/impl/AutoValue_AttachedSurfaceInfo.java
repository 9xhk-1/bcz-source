...
final class AutoValue_AttachedSurfaceInfo extends AttachedSurfaceInfo {
    ...
    public AutoValue_AttachedSurfaceInfo(SurfaceConfig surfaceConfig, int i11, Size size, DynamicRange dynamicRange, List<UseCaseConfigFactory.CaptureType> list, @Nullable Config config, @Nullable Range<Integer> range) {
    ...
    public String toString() {
        return "AttachedSurfaceInfo{surfaceConfig=" + this.surfaceConfig + ", imageFormat=" + this.imageFormat + ", size=" + this.size + ", dynamicRange=" + this.dynamicRange + ", captureTypes=" + this.captureTypes + ", implementationOptions=" + this.implementationOptions + ", targetFrameRate=" + this.targetFrameRate + com.alipay.sdk.m.u.i.f11099d;
    }
}
