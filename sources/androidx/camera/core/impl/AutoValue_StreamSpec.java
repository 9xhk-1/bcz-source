...
final class AutoValue_StreamSpec extends StreamSpec {
    ...
    public static final class Builder extends StreamSpec.Builder {
        ...
        @Override // androidx.camera.core.impl.StreamSpec.Builder
        public StreamSpec.Builder setZslDisabled(boolean z11) {
            this.zslDisabled = Boolean.valueOf(z11);
            return this;
        }
    ...
    public String toString() {
        return "StreamSpec{resolution=" + this.resolution + ", dynamicRange=" + this.dynamicRange + ", expectedFrameRateRange=" + this.expectedFrameRateRange + ", implementationOptions=" + this.implementationOptions + ", zslDisabled=" + this.zslDisabled + com.alipay.sdk.m.u.i.f11099d;
    }

    private AutoValue_StreamSpec(Size size, DynamicRange dynamicRange, Range<Integer> range, @Nullable Config config, boolean z11) {
        this.resolution = size;
        this.dynamicRange = dynamicRange;
        this.expectedFrameRateRange = range;
        this.implementationOptions = config;
        this.zslDisabled = z11;
    }
}
