...
public final class CameraProviderExecutionState implements RetryPolicy.ExecutionState {
    ...
    public CameraProviderExecutionState(long j11, int i11, @Nullable Throwable th2) {
        this.mTaskExecutedTimeInMillis = SystemClock.elapsedRealtime() - j11;
        this.mAttemptCount = i11;
