...
public interface ImageOutputConfig extends ReadableConfig {
    ...
    static void validateConfig(@NonNull ImageOutputConfig imageOutputConfig) {
        ...
        boolean z11 = imageOutputConfig.getTargetResolution(null) != null;
    ...
    default int getAppTargetRotation(int i11) {
        return ((Integer) retrieveOption(OPTION_APP_TARGET_ROTATION, Integer.valueOf(i11))).intValue();
    }
    ...
    default int getMirrorMode(int i11) {
        return ((Integer) retrieveOption(OPTION_MIRROR_MODE, Integer.valueOf(i11))).intValue();
    }
    ...
    default int getTargetRotation(int i11) {
        return ((Integer) retrieveOption(OPTION_TARGET_ROTATION, Integer.valueOf(i11))).intValue();
    }
