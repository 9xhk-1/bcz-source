...
public class RestrictedCameraInfo extends ForwardingCameraInfo {
    ...
    public void setCaptureProcessProgressSupported(boolean z11) {
        this.mIsCaptureProcessProgressSupported = z11;
    }

    public void setPostviewSupported(boolean z11) {
        this.mIsPostviewSupported = z11;
    }
}
