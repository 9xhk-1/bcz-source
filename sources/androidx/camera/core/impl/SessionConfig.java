...
public final class SessionConfig {
    ...
    public static class Builder extends BaseBuilder {
        ...
        @NonNull
        public Builder setPreviewStabilization(int i11) {
            if (i11 != 0) {
                this.mCaptureConfigBuilder.setPreviewStabilization(i11);
            }
            return this;
        }
        ...
        @NonNull
        public Builder setVideoStabilization(int i11) {
            if (i11 != 0) {
                this.mCaptureConfigBuilder.setVideoStabilization(i11);
            }
            return this;
        }
        ...
        @NonNull
        public Builder addSurface(@NonNull DeferrableSurface deferrableSurface, @NonNull DynamicRange dynamicRange, @Nullable String str, int i11) {
            this.mOutputConfigs.add(OutputConfig.builder(deferrableSurface).setPhysicalCameraId(str).setDynamicRange(dynamicRange).setMirrorMode(i11).build());
    ...
    public static abstract class OutputConfig {
        ...
        public static abstract class Builder {
            ...
            @NonNull
            public abstract Builder setMirrorMode(int i11);
    ...
    public static final class ValidatingBuilder extends BaseBuilder {
        ...
        private void setPreviewStabilizationMode(int i11) {
            if (i11 != 0) {
                this.mCaptureConfigBuilder.setPreviewStabilization(i11);
            }
        }

        private void setVideoStabilizationMode(int i11) {
            if (i11 != 0) {
                this.mCaptureConfigBuilder.setVideoStabilization(i11);
            }
        }
        ...
        public <T> void addImplementationOption(@NonNull Config.Option<T> option, @NonNull T t11) {
        ...
        public SessionConfig build() {
            ...
            return new SessionConfig(arrayList, new ArrayList(this.mDeviceStateCallbacks), new ArrayList(this.mSessionStateCallbacks), new ArrayList(this.mSingleCameraCaptureCallbacks), this.mCaptureConfigBuilder.build(), !this.mErrorListeners.isEmpty() ? new ErrorListener() { // from class: androidx.camera.core.impl.v
                @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
    ...
    public static int getHigherPriorityTemplateType(int i11, int i12) {
