...
public abstract class StateObservable<T> implements Observable<T> {
    ...
    public static final class ObserverWrapper<T> implements Runnable {
        ...
        public void run() {
            synchronized (this) {
                try {
                    ...
                    int i11 = this.mLatestSignalledVersion;
                    while (true) {
                        ...
                        synchronized (this) {
                            try {
                                if (i11 == this.mLatestSignalledVersion || !this.mActive.get()) {
                                    break;
                                }
                                obj = this.mStateRef.get();
                                i11 = this.mLatestSignalledVersion;
                            } finally {
                            }
                        }
                    }
        ...
        public void update(int i11) {
            synchronized (this) {
                try {
                    if (this.mActive.get()) {
                        if (i11 <= this.mLatestSignalledVersion) {
                            return;
                        }
                        this.mLatestSignalledVersion = i11;
    ...
    public StateObservable(@Nullable Object obj, boolean z11) {
        if (!z11) {
    ...
    public void updateState(@Nullable T t11) {
        updateStateInternal(t11);
    }
