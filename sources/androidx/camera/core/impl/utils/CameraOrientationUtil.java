...
public final class CameraOrientationUtil {
    ...
    public static int getRelativeImageRotation(int i11, int i12, boolean z11) {
        ...
        if (Logger.isVerboseEnabled(TAG)) {
            Logger.d(TAG, String.format("getRelativeImageRotation: destRotationDegrees=%s, sourceRotationDegrees=%s, isOppositeFacing=%s, result=%s", Integer.valueOf(i11), Integer.valueOf(i12), Boolean.valueOf(z11), Integer.valueOf(i13)));
        }
        return i13;
    }
