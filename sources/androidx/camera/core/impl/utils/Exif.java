...
public final class Exif {
    ...
    public void attachTimestamp() {
        ...
        try {
            ...
            this.mExifInterface.setAttribute(ExifInterface.TAG_SUBSEC_TIME_ORIGINAL, l11);
            this.mExifInterface.setAttribute(ExifInterface.TAG_SUBSEC_TIME_DIGITIZED, l11);
        } catch (ParseException unused) {
        }
    ...
    public void flipHorizontally() {
        ...
        this.mExifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, String.valueOf(i11));
    }
    ...
    public void rotate(int i11) {
        if (i11 % 90 != 0) {
            Logger.w(TAG, String.format(Locale.US, "Can only rotate in right angles (eg. 0, 90, 180, 270). %d is unsupported.", Integer.valueOf(i11)));
