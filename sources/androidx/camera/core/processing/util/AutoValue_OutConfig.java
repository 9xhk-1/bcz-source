...
final class AutoValue_OutConfig extends OutConfig {
    ...
    public AutoValue_OutConfig(UUID uuid, int i11, int i12, Rect rect, Size size, int i13, boolean z11, boolean z12) {
        if (uuid == null) {
        ...
        this.getSize = size;
        this.getRotationDegrees = i13;
        this.isMirroring = z11;
        this.shouldRespectInputCropRect = z12;
    }
    ...
    public String toString() {
        return "OutConfig{getUuid=" + this.getUuid + ", getTargets=" + this.getTargets + ", getFormat=" + this.getFormat + ", getCropRect=" + this.getCropRect + ", getSize=" + this.getSize + ", getRotationDegrees=" + this.getRotationDegrees + ", isMirroring=" + this.isMirroring + ", shouldRespectInputCropRect=" + this.shouldRespectInputCropRect + i.f11099d;
    }
}
