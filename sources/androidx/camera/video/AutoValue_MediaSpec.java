...
final class AutoValue_MediaSpec extends MediaSpec {
    ...
    public static final class Builder extends MediaSpec.Builder {
        ...
        @Override // androidx.camera.video.MediaSpec.Builder
        public MediaSpec.Builder setOutputFormat(int i11) {
            this.outputFormat = Integer.valueOf(i11);
            return this;
        }
    ...
    public String toString() {
        return "MediaSpec{videoSpec=" + this.videoSpec + ", audioSpec=" + this.audioSpec + ", outputFormat=" + this.outputFormat + com.alipay.sdk.m.u.i.f11099d;
    }

    private AutoValue_MediaSpec(VideoSpec videoSpec, AudioSpec audioSpec, int i11) {
        this.videoSpec = videoSpec;
        this.audioSpec = audioSpec;
