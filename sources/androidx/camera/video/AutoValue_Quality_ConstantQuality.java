...
final class AutoValue_Quality_ConstantQuality extends Quality.ConstantQuality {
    ...
    public AutoValue_Quality_ConstantQuality(int i11, String str, List<Size> list) {
        this.value = i11;
        if (str == null) {
    ...
    public String toString() {
        return "ConstantQuality{value=" + this.value + ", name=" + this.name + ", typicalSizes=" + this.typicalSizes + com.alipay.sdk.m.u.i.f11099d;
    }
}
