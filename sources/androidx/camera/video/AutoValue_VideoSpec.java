...
final class AutoValue_VideoSpec extends VideoSpec {
    ...
    public static final class Builder extends VideoSpec.Builder {
        ...
        @Override // androidx.camera.video.VideoSpec.Builder
        public VideoSpec.Builder setAspectRatio(int i11) {
            this.aspectRatio = Integer.valueOf(i11);
            return this;
        }
    ...
    public String toString() {
        return "VideoSpec{qualitySelector=" + this.qualitySelector + ", frameRate=" + this.frameRate + ", bitrate=" + this.bitrate + ", aspectRatio=" + this.aspectRatio + com.alipay.sdk.m.u.i.f11099d;
    }

    private AutoValue_VideoSpec(QualitySelector qualitySelector, Range<Integer> range, Range<Integer> range2, int i11) {
        this.qualitySelector = qualitySelector;
        this.frameRate = range;
        this.bitrate = range2;
