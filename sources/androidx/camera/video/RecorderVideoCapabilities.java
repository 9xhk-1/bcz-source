...
public final class RecorderVideoCapabilities implements VideoCapabilities {
    ...
    public RecorderVideoCapabilities(int i11, @NonNull CameraInfoInternal cameraInfoInternal, @NonNull Function<VideoEncoderConfig, VideoEncoderInfo> function) {
        Function<VideoEncoderConfig, VideoEncoderInfo> function2;
        Preconditions.checkArgument(i11 == 0 || i11 == 1, "Not a supported video capabilities source: " + i11);
