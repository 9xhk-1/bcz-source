...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    public class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i11, @NonNull CameraCaptureResult cameraCaptureResult) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.o0
    ...
    public static final class Builder<T extends VideoOutput> implements UseCaseConfig.Builder<VideoCapture<T>, VideoCaptureConfig<T>, Builder<T>>, ImageOutputConfig.Builder<Builder<T>>, ImageInputConfig.Builder<Builder<T>>, ThreadConfig.Builder<Builder<T>> {
        ...
        public Builder(@NonNull T t11) {
            this(createInitialBundle(t11));
        }

        @NonNull
        private static <T extends VideoOutput> MutableOptionsBundle createInitialBundle(@NonNull T t11) {
            MutableOptionsBundle create = MutableOptionsBundle.create();
            create.insertOption(VideoCaptureConfig.OPTION_VIDEO_OUTPUT, t11);
            return create;
        }
        ...
        @NonNull
        public Builder<T> setVideoStabilizationEnabled(boolean z11) {
            getMutableConfig().insertOption(UseCaseConfig.OPTION_VIDEO_STABILIZATION_MODE, Integer.valueOf(z11 ? 2 : 1));
            return this;
        }
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder<T> setHighResolutionDisabled(boolean z11) {
        ...
        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        @NonNull
        public Builder<T> setMirrorMode(int i11) {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder<T> setSurfaceOccupancyPriority(int i11) {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder<T> setTargetAspectRatio(int i11) {
        ...
        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        @NonNull
        public Builder<T> setTargetRotation(int i11) {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder<T> setZslDisabled(boolean z11) {
    ...
    public static final class Defaults implements ConfigProvider<VideoCaptureConfig<?>> {
        ...
        static {
            VideoOutput videoOutput = new VideoOutput() { // from class: androidx.camera.video.p0
    ...
    public static class SourceStreamRequirementObserver implements Observable.Observer<Boolean> {
        ...
        private void updateVideoUsageInCamera(boolean z11) {
            if (this.mIsSourceStreamRequired == z11) {
                return;
            }
            this.mIsSourceStreamRequired = z11;
        ...
        this.mStreamInfoObserver = new Observable.Observer<StreamInfo>() { // from class: androidx.camera.video.VideoCapture.1
            ...
            public void onNewData(@Nullable StreamInfo streamInfo) {
                ...
                if ((streamInfo2.getId() != -1 && streamInfo.getId() == -1) || (streamInfo2.getId() == -1 && streamInfo.getId() != -1)) {
                    ...
                    a12 = androidx.camera.core.j.a(new Object[]{videoCapture3.mSessionConfigBuilder.build()});
                    videoCapture3.updateSessionConfig(a12);
                ...
                if (streamInfo2.getStreamState() != streamInfo.getStreamState()) {
                    ...
                    a11 = androidx.camera.core.j.a(new Object[]{videoCapture5.mSessionConfigBuilder.build()});
                    videoCapture5.updateSessionConfig(a11);
    ...
    private static void addBySupportedSize(@NonNull Set<Size> set, int i11, int i12, @NonNull Size size, @NonNull VideoEncoderInfo videoEncoderInfo) {
        ...
        try {
            ...
            Logger.w(TAG, "No supportedHeights for width: " + i11, e11);
        }
        try {
            set.add(new Size(videoEncoderInfo.getSupportedWidthsFor(i12).clamp(Integer.valueOf(i11)).intValue(), i12));
        } catch (IllegalArgumentException e12) {
            Logger.w(TAG, "No supportedWidths for height: " + i12, e12);
        }
    }

    @NonNull
    private static Rect adjustCropRectByQuirk(@NonNull Rect rect, int i11, boolean z11, @Nullable VideoEncoderInfo videoEncoderInfo) {
        ...
        return sizeCannotEncodeVideoQuirk.adjustCropRectForProblematicEncodeSize(rect, i11, videoEncoderInfo);
    }
    ...
    private static Rect adjustCropRectToValidSize(@NonNull final Rect rect, @NonNull Size size, @NonNull VideoEncoderInfo videoEncoderInfo) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: androidx.camera.video.m0
            ...
            public final int compare(Object obj, Object obj2) {
                return VideoCapture.b(rect, (Size) obj, (Size) obj2);
            }
        });
    ...
    @NonNull
    private Rect adjustCropRectWithInProgressTransformation(@NonNull Rect rect, int i11) {
        return shouldCompensateTransformation() ? TransformUtils.sizeToRect(TransformUtils.getRotatedSize(((SurfaceRequest.TransformationInfo) Preconditions.checkNotNull(this.mStreamInfo.getInProgressTransformationInfo())).getCropRect(), i11)) : rect;
    }
    ...
    private static int align(boolean z11, int i11, int i12, @NonNull Range<Integer> range) {
        int i13 = i11 % i12;
        if (i13 != 0) {
    ...
    private static int alignDown(int i11, int i12, @NonNull Range<Integer> range) {
        return align(true, i11, i12, range);
    }

    private static int alignUp(int i11, int i12, @NonNull Range<Integer> range) {
        return align(false, i11, i12, range);
    }

    public static /* synthetic */ int b(Rect rect, Size size, Size size2) {
        return (Math.abs(size.getWidth() - rect.width()) + Math.abs(size.getHeight() - rect.height())) - (Math.abs(size2.getWidth() - rect.width()) + Math.abs(size2.getHeight() - rect.height()));
    }

    public static /* synthetic */ void c(VideoCapture videoCapture, DeferrableSurface deferrableSurface) {
    ...
    private SessionConfig.Builder createPipeline(@NonNull final VideoCaptureConfig<T> videoCaptureConfig, @NonNull StreamSpec streamSpec) {
        ...
        Rect calculateCropRect = videoCapture.calculateCropRect(resolution, resolveVideoEncoderInfo);
        Rect adjustCropRectWithInProgressTransformation = videoCapture.adjustCropRectWithInProgressTransformation(calculateCropRect, videoCapture.mRotationDegrees);
        videoCapture.mCropRect = adjustCropRectWithInProgressTransformation;
        Size adjustResolutionWithInProgressTransformation = videoCapture.adjustResolutionWithInProgressTransformation(resolution, calculateCropRect, adjustCropRectWithInProgressTransformation);
        ...
        Rect adjustCropRectByQuirk = adjustCropRectByQuirk(rect, videoCapture.mRotationDegrees, videoCapture.isCreateNodeNeeded(cameraInternal, videoCaptureConfig, rect, resolution), resolveVideoEncoderInfo);
        videoCapture.mCropRect = adjustCropRectByQuirk;
        SurfaceProcessorNode createNodeIfNeeded = videoCapture.createNodeIfNeeded(cameraInternal, videoCaptureConfig, adjustCropRectByQuirk, resolution, dynamicRange);
        videoCapture.mNode = createNodeIfNeeded;
        final Timebase resolveTimebase = resolveTimebase(cameraInternal, createNodeIfNeeded);
        ...
        SurfaceEdge surfaceEdge = new SurfaceEdge(2, 34, build, videoCapture.getSensorToBufferTransformMatrix(), cameraInternal.getHasTransform(), videoCapture.mCropRect, videoCapture.mRotationDegrees, videoCapture.getAppTargetRotation(), videoCapture.shouldMirror(cameraInternal));
        videoCapture.mCameraEdge = surfaceEdge;
        surfaceEdge.addOnInvalidatedListener(runnable);
        if (videoCapture.mNode != null) {
            OutConfig of2 = OutConfig.of(videoCapture.mCameraEdge);
            final SurfaceEdge surfaceEdge2 = videoCapture.mNode.transform(SurfaceProcessorNode.In.of(videoCapture.mCameraEdge, Collections.singletonList(of2))).get(of2);
            Objects.requireNonNull(surfaceEdge2);
            Runnable runnable2 = new Runnable() { // from class: androidx.camera.video.i0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.onAppEdgeInvalidated(surfaceEdge2, cameraInternal, videoCaptureConfig, resolveTimebase);
                }
            };
            videoCapture = this;
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.j0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.c(VideoCapture.this, deferrableSurface);
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
            videoCaptureConfig2 = videoCaptureConfig;
            SurfaceRequest createSurfaceRequest = videoCapture.mCameraEdge.createSurfaceRequest(cameraInternal);
            videoCapture.mSurfaceRequest = createSurfaceRequest;
            videoCapture.mDeferrableSurface = createSurfaceRequest.getDeferrableSurface();
        }
        videoCaptureConfig2.getVideoOutput().onSurfaceRequested(videoCapture.mSurfaceRequest, resolveTimebase);
        ...
        createFrom.setVideoStabilization(videoCaptureConfig2.getVideoStabilizationMode());
        SessionConfig.CloseableErrorListener closeableErrorListener = videoCapture.mCloseableErrorListener;
        if (closeableErrorListener != null) {
            closeableErrorListener.close();
        }
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.k0
    ...
    public static /* synthetic */ void e(AtomicBoolean atomicBoolean, SessionConfig.Builder builder, CameraCaptureCallback cameraCaptureCallback) {
    ...
    public static /* synthetic */ Object f(VideoCapture videoCapture, final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) {
        ...
        completer.addCancellationListener(new Runnable() { // from class: androidx.camera.video.l0
            @Override // java.lang.Runnable
            public final void run() {
                VideoCapture.e(atomicBoolean, builder, anonymousClass2);
            }
    ...
    @Nullable
    private static <T> T fetchObservableValue(@NonNull Observable<T> observable, @Nullable T t11) {
        p1<T> fetchData = observable.fetchData();
        if (!fetchData.isDone()) {
            return t11;
        }
        try {
        ...
        if (!list.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (!map.containsValue(next) && (findNearestHigherSupportedEncoderProfilesFor = videoCapabilities.findNearestHigherSupportedEncoderProfilesFor(next, dynamicRange)) != null) {
                    ...
                    VideoEncoderInfo findLargestSupportedSizeVideoEncoderInfo = findLargestSupportedSizeVideoEncoderInfo(videoEncoderInfoFinder, findNearestHigherSupportedEncoderProfilesFor, dynamicRange2, mediaSpec2, next, targetFrameRate);
    ...
    public void onAppEdgeInvalidated(@NonNull SurfaceEdge surfaceEdge, @NonNull CameraInternal cameraInternal, @NonNull VideoCaptureConfig<T> videoCaptureConfig, @NonNull Timebase timebase) {
    ...
    @MainThread
    private void setupSurfaceUpdateNotifier(@NonNull final SessionConfig.Builder builder, final boolean z11) {
        p1<Void> p1Var = this.mSurfaceUpdateFuture;
        if (p1Var != null && p1Var.cancel(false)) {
            Logger.d(TAG, "A newer surface update is requested. Previous surface update cancelled.");
        }
        final p1<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.n0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return VideoCapture.f(VideoCapture.this, builder, completer);
            }
        });
        ...
        Futures.addCallback(future, new FutureCallback<Void>() { // from class: androidx.camera.video.VideoCapture.3
            ...
            public void onSuccess(@Nullable Void r32) {
                p1<Void> p1Var2 = future;
                VideoCapture videoCapture = VideoCapture.this;
                if (p1Var2 != videoCapture.mSurfaceUpdateFuture || videoCapture.mSourceState == VideoOutput.SourceState.INACTIVE) {
                    return;
                }
                videoCapture.setSourceState(z11 ? VideoOutput.SourceState.ACTIVE_STREAMING : VideoOutput.SourceState.ACTIVE_NON_STREAMING);
            }
        }, CameraXExecutors.mainThreadExecutor());
    }
    ...
    @NonNull
    public static <T extends VideoOutput> VideoCapture<T> withOutput(@NonNull T t11) {
        return new Builder((VideoOutput) Preconditions.checkNotNull(t11)).build();
    }
    ...
    public void applyStreamInfoAndStreamSpecToSessionConfigBuilder(@NonNull SessionConfig.Builder builder, @NonNull StreamInfo streamInfo, @NonNull StreamSpec streamSpec) {
        ...
        boolean z11 = streamInfo.getId() == -1;
        boolean z12 = streamInfo.getStreamState() == StreamInfo.StreamState.ACTIVE;
        if (z11 && z12) {
            throw new IllegalStateException("Unexpected stream state, stream is error but active");
        }
        builder.clearSurfaces();
        DynamicRange dynamicRange = streamSpec.getDynamicRange();
        if (!z11 && (deferrableSurface = this.mDeferrableSurface) != null) {
            if (z12) {
        ...
        setupSurfaceUpdateNotifier(builder, z12);
    }
    ...
    public boolean isStreamIdChanged(int i11, int i12) {
    ...
    public void onStateAttached() {
        ...
        a11 = androidx.camera.core.j.a(new Object[]{this.mSessionConfigBuilder.build()});
