...
public abstract class VideoRecordEvent {
    ...
    public static final class Finalize extends VideoRecordEvent {
        ...
        public Finalize(@NonNull OutputOptions outputOptions, @NonNull RecordingStats recordingStats, @NonNull OutputResults outputResults, int i11, @Nullable Throwable th2) {
        ...
        @NonNull
        public static String errorToString(int i11) {
            switch (i11) {
                case 0:
                    return "ERROR_NONE";
                case 1:
                ...
                default:
                    return "Unknown(" + i11 + pn.j.f81007d;
            }
        }
    ...
    @NonNull
    public static Finalize finalizeWithError(@NonNull OutputOptions outputOptions, @NonNull RecordingStats recordingStats, @NonNull OutputResults outputResults, int i11, @Nullable Throwable th2) {
        Preconditions.checkArgument(i11 != 0, "An error type is required.");
        return new Finalize(outputOptions, recordingStats, outputResults, i11, th2);
    }
