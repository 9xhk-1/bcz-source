...
public class MediaCodecInfoReportIncorrectInfoQuirk implements Quirk {
    ...
    public static class MediaFormatResolver {
        ...
        private String getMime() {
            return this.mMediaFormat.getString(IMediaFormat.KEY_MIME);
        }
        ...
        public boolean isSize(int i11, int i12) {
            return this.mMediaFormat.getInteger("width") == i11 && this.mMediaFormat.getInteger("height") == i12;
        }
    ...
    public static Set<Size> getExtraSupportedSizes() {
        return isFHDProblematicDevice() ? Collections.singleton(new Size(1920, pd.a.f80340j)) : Collections.EMPTY_SET;
    }
    ...
    public boolean isUnSupportMediaCodecInfo(@NonNull MediaFormat mediaFormat) {
        ...
        return (isNokia1() || isMotoC() || isX650() || isX230() || isPositivoTwist2Pro()) ? mediaFormatResolver.isMpeg4() : (isHuaweiMate9() || isRedmiNote8Pro()) ? mediaFormatResolver.isVideo() && mediaFormatResolver.isSize(3840, 2160) : isFHDProblematicDevice() && mediaFormatResolver.isAvc() && mediaFormatResolver.isSize(1920, pd.a.f80340j);
    }
}
