...
public final class AudioEncoderConfigAudioProfileResolver implements Supplier<AudioEncoderConfig> {
    ...
    public AudioEncoderConfigAudioProfileResolver(@NonNull String str, int i11, @NonNull Timebase timebase, @NonNull AudioSpec audioSpec, @NonNull AudioSettings audioSettings, @NonNull EncoderProfilesProxy.AudioProfileProxy audioProfileProxy) {
        this.mMimeType = str;
        this.mAudioProfile = i11;
