...
public final class AudioEncoderConfigDefaultResolver implements Supplier<AudioEncoderConfig> {
    ...
    public AudioEncoderConfigDefaultResolver(@NonNull String str, int i11, @NonNull Timebase timebase, @NonNull AudioSpec audioSpec, @NonNull AudioSettings audioSettings) {
        this.mMimeType = str;
