...
public class CardView extends FrameLayout {
    ...
    public void onMeasure(int i11, int i12) {
        ...
        if (mode == Integer.MIN_VALUE || mode == 1073741824) {
            i11 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(r0.getMinWidth(this.mCardViewDelegate)), View.MeasureSpec.getSize(i11)), mode);
        }
        int mode2 = View.MeasureSpec.getMode(i12);
        if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
            i12 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(r0.getMinHeight(this.mCardViewDelegate)), View.MeasureSpec.getSize(i12)), mode2);
        }
        super.onMeasure(i11, i12);
    }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        CardViewDelegate cardViewDelegate = new CardViewDelegate() { // from class: androidx.cardview.widget.CardView.1
            ...
            @Override // androidx.cardview.widget.CardViewDelegate
            public void setMinWidthHeightInternal(int i12, int i13) {
            ...
            public void setShadowPadding(int i12, int i13, int i14, int i15) {
                ...
                CardView.super.setPadding(i12 + rect2.left, i13 + rect2.top, i14 + rect2.right, i15 + rect2.bottom);
            }
        };
        ...
        IMPL.initialize(cardViewDelegate, context, colorStateList, dimension, dimension2, f11);
    }
