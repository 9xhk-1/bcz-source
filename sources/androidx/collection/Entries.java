...
final class Entries<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, y00.a {

    @k
    private final ScatterMap<K, V> parent;

    public Entries(@k ScatterMap<K, V> parent) {
        g0.p(parent, "parent");
        this.parent = parent;
    }
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return q.a(new Entries$iterator$1(this, null));
    }
    ...
    public boolean contains(@k Map.Entry<? extends K, ? extends V> element) {
