...
public abstract class FloatLongMap {
    ...
    public /* synthetic */ FloatLongMap(v vVar) {
        this();
    }

    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, int i12, Object obj) {
        if (obj != null) {
        ...
        return floatLongMap.joinToString(charSequence, charSequence2, charSequence6, i11, charSequence5);
    }

    public final boolean all(@k p<? super Float, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (!predicate.invoke(Float.valueOf(fArr[i14]), Long.valueOf(jArr[i14])).booleanValue()) {
                            return false;
                        }
                    }
                    j11 >>= 8;
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j11) < 128) {
                            ...
                            float f11 = fArr[i14];
                            long j12 = jArr[i14];
                            int findKeyIndex = floatLongMap.findKeyIndex(f11);
                            if (findKeyIndex < 0 || j12 != floatLongMap.values[findKeyIndex]) {
                                break loop0;
                            }
                        }
                        j11 >>= 8;
    ...
    public final void forEach(@k p<? super Float, ? super Long, g2> block) {
        g0.p(block, "block");
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        block.invoke(Float.valueOf(fArr[i14]), Long.valueOf(jArr[i14]));
                    }
                    j11 >>= 8;
                }
                if (i12 != 8) {
    ...
    public final long get(float f11) {
    ...
    public final long getOrDefault(float f11, long j11) {
        int findKeyIndex = findKeyIndex(f11);
        return findKeyIndex >= 0 ? this.values[findKeyIndex] : j11;
    }

    public final long getOrElse(float f11, @k x00.a<Long> defaultValue) {
    ...
    public final boolean any(@k p<? super Float, ? super Long, Boolean> predicate) {
        g0.p(predicate, "predicate");
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@k p<? super Float, ? super Long, Boolean> predicate) {
        g0.p(predicate, "predicate");
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, p transform, int i12, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i13;
        if (obj == null) {
                    ...
                    if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i21 < i19) {
                            if ((j11 & 255) < 128) {
                                ...
                                i13 = i18;
                                jArr2 = jArr4;
                                sb2.append((CharSequence) transform.invoke(Float.valueOf(f11), Long.valueOf(j12)));
                                i16++;
                            } else {
                                jArr2 = jArr4;
                                i13 = i18;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k CharSequence truncated, @k p<? super Float, ? super Long, ? extends CharSequence> transform) {
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(Float.valueOf(f11), Long.valueOf(j12)));
                            i13++;
                        }
                        j11 >>= 8;
                        i16++;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i12;
        CharSequence separator = charSequence;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, @k p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(transform, "transform");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
    ...
    @w00.k
    @k
    public final String joinToString(@k p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i11;
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
