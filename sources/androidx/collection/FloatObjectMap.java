...
public abstract class FloatObjectMap<V> {
    ...
    public /* synthetic */ FloatObjectMap(v vVar) {
        this();
    }

    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, int i12, Object obj) {
        if (obj != null) {
        ...
        return floatObjectMap.joinToString(charSequence, charSequence2, charSequence6, i11, charSequence5);
    }

    public final boolean all(@k p<? super Float, ? super V, Boolean> predicate) {
    ...
    */
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j11) < 128) {
                            ...
                            if (obj2 == null) {
                                if (floatObjectMap.get(f11) != null || !floatObjectMap.containsKey(f11)) {
                                    break loop0;
                                }
                            } else if (!g0.g(obj2, floatObjectMap.get(f11))) {
                                return false;
                            }
                        }
                        j11 >>= 8;
    ...
    public final int findKeyIndex$collection(float f11) {
    ...
    public final void forEach(@k p<? super Float, ? super V, g2> block) {
        g0.p(block, "block");
        float[] fArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        block.invoke(Float.valueOf(fArr[i14]), objArr[i14]);
                    }
                    j11 >>= 8;
                }
                if (i12 != 8) {
    ...
    */
    ...
    public final V getOrElse(float f11, @k x00.a<? extends V> defaultValue) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i14 = 0; i14 < i13; i14++) {
                    if ((255 & j11) < 128) {
                        ...
                        i12 += (obj != null ? obj.hashCode() : 0) ^ Float.hashCode(f11);
                    }
                    j11 >>= 8;
                }
                if (i13 != 8) {
    ...
    public final boolean any(@k p<? super Float, ? super V, Boolean> predicate) {
        g0.p(predicate, "predicate");
        float[] fArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(@k p<? super Float, ? super V, Boolean> predicate) {
        g0.p(predicate, "predicate");
        float[] fArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, p transform, int i12, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i13;
        if (obj == null) {
                    ...
                    if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i21 < i19) {
                            if ((j11 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb2.append((CharSequence) transform.invoke(Float.valueOf(f11), obj2));
                                i16++;
                            } else {
                                jArr2 = jArr3;
                                i13 = i18;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k CharSequence truncated, @k p<? super Float, ? super V, ? extends CharSequence> transform) {
        float[] fArr;
        float[] fArr2;
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(Float.valueOf(f11), obj));
                            i13++;
                        } else {
                            fArr2 = fArr3;
                        }
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, int i11, @k p<? super Float, ? super V, ? extends CharSequence> transform) {
        int i12;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, @k p<? super Float, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k p<? super Float, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(transform, "transform");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k p<? super Float, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
    ...
    @w00.k
    @k
    public final String joinToString(@k p<? super Float, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
