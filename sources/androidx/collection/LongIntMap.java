...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(v vVar) {
        this();
    }

    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, int i12, Object obj) {
        if (obj != null) {
        ...
        return longIntMap.joinToString(charSequence, charSequence2, charSequence6, i11, charSequence5);
    }

    public final boolean all(@k p<? super Long, ? super Integer, Boolean> predicate) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((255 & j11) < 128) {
                        ...
                        long j12 = jArr2[i14];
                        int i15 = iArr[i14];
                        int findKeyIndex = longIntMap.findKeyIndex(j12);
                        if (findKeyIndex < 0 || i15 != longIntMap.values[findKeyIndex]) {
                            break loop0;
                        }
                    } else {
                        z12 = z13;
    ...
    public final void forEach(@k p<? super Long, ? super Integer, g2> block) {
        g0.p(block, "block");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        block.invoke(Long.valueOf(jArr[i14]), Integer.valueOf(iArr[i14]));
                    }
                    j11 >>= 8;
                }
                if (i12 != 8) {
    ...
    public final int getOrDefault(long j11, int i11) {
        int findKeyIndex = findKeyIndex(j11);
        return findKeyIndex >= 0 ? this.values[findKeyIndex] : i11;
    }

    public final int getOrElse(long j11, @k x00.a<Integer> defaultValue) {
    ...
    public final boolean any(@k p<? super Long, ? super Integer, Boolean> predicate) {
        g0.p(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@k p<? super Long, ? super Integer, Boolean> predicate) {
        g0.p(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i14 = 0; i14 < i13; i14++) {
                    if ((255 & j11) < 128) {
                        int i15 = (i11 << 3) + i14;
                        if (predicate.invoke(Long.valueOf(jArr[i15]), Integer.valueOf(iArr[i15])).booleanValue()) {
                            i12++;
                        }
                    }
                    j11 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, p transform, int i12, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i13;
        if (obj == null) {
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k CharSequence truncated, @k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(Long.valueOf(j12), Integer.valueOf(i18)));
                            i13++;
                        }
                        j11 >>= 8;
                        i16++;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i12;
        CharSequence separator = charSequence;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(Long.valueOf(j12), Integer.valueOf(i19)));
                            i14++;
                        } else {
                            i12 = i15;
                        }
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, @k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(transform, "transform");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
    ...
    @w00.k
    @k
    public final String joinToString(@k p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i11;
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
