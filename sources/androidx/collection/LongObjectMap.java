...
public abstract class LongObjectMap<V> {
    ...
    public /* synthetic */ LongObjectMap(v vVar) {
        this();
    }

    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, int i12, Object obj) {
        if (obj != null) {
        ...
        return longObjectMap.joinToString(charSequence, charSequence2, charSequence6, i11, charSequence5);
    }

    public final boolean all(@k p<? super Long, ? super V, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (!predicate.invoke(Long.valueOf(jArr[i14]), objArr[i14]).booleanValue()) {
                            return false;
                        }
                    }
                    j11 >>= 8;
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean equals(@m80.l java.lang.Object r19) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
        ...
        L65:
            ...
            boolean r2 = kotlin.jvm.internal.g0.g(r14, r2)
            if (r2 != 0) goto L73
            return r4
        L70:
            r15 = r2
    ...
    public final int findKeyIndex$collection(long j11) {
    ...
    public final void forEach(@k p<? super Long, ? super V, g2> block) {
        g0.p(block, "block");
        long[] jArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr2 = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        block.invoke(Long.valueOf(jArr[i14]), objArr[i14]);
                    }
                    j11 >>= 8;
                }
                if (i12 != 8) {
    ...
    public final void forEachKey(@k l<? super Long, g2> block) {
        g0.p(block, "block");
        long[] jArr = this.keys;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    */
    ...
    public final V getOrElse(long j11, @k x00.a<? extends V> defaultValue) {
    ...
    public final boolean any(@k p<? super Long, ? super V, Boolean> predicate) {
        g0.p(predicate, "predicate");
        long[] jArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@k p<? super Long, ? super V, Boolean> predicate) {
        g0.p(predicate, "predicate");
        long[] jArr = this.keys;
        Object[] objArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, p transform, int i12, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i13;
        if (obj == null) {
                    ...
                    if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i21 < i19) {
                            if ((j11 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb2.append((CharSequence) transform.invoke(Long.valueOf(j12), obj2));
                                i16++;
                            } else {
                                jArr2 = jArr4;
                                i13 = i18;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k CharSequence truncated, @k p<? super Long, ? super V, ? extends CharSequence> transform) {
        long[] jArr;
        long[] jArr2;
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(Long.valueOf(j12), obj));
                            i13++;
                        } else {
                            jArr2 = jArr3;
                        }
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, int i11, @k p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i12;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, @k p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(transform, "transform");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
    ...
    @w00.k
    @k
    public final String joinToString(@k p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i11;
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
