...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long getOrPut(float f11, @k x00.a<Long> defaultValue) {
    ...
    public final void plusAssign(@k FloatLongMap from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(float f11, long j11) {
        set(f11, j11);
    }

    public final void putAll(@k FloatLongMap from) {
        g0.p(from, "from");
    ...
    public final void removeIf(@k p<? super Float, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(Float.valueOf(this.keys[i14]), Long.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        while (i14 < i12) {
            if (((jArr2[i14 >> 3] >> ((i14 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatLongMap.findFirstAvailableSlot(i15 >>> 7);
                long j11 = i15 & 127;
    ...
    public final void set(float f11, long j11) {
    ...
    public final long put(float f11, long j11, long j12) {
        int findInsertIndex = findInsertIndex(f11);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(float f11, long j11) {
        int findKeyIndex = findKeyIndex(f11);
    ...
    public /* synthetic */ MutableFloatLongMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
