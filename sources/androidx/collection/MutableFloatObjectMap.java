...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    public final V getOrPut(float f11, @k x00.a<? extends V> defaultValue) {
    ...
    public final void plusAssign(@k FloatObjectMap<V> from) {
        g0.p(from, "from");
        putAll(from);
    }

    @l
    public final V put(float f11, V v11) {
        int findAbsoluteInsertIndex = findAbsoluteInsertIndex(f11);
        Object[] objArr = this.values;
        V v12 = (V) objArr[findAbsoluteInsertIndex];
        this.keys[findAbsoluteInsertIndex] = f11;
        objArr[findAbsoluteInsertIndex] = v11;
        return v12;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(@k FloatObjectMap<V> from) {
        g0.p(from, "from");
    ...
    */
    ...
    public final void removeIf(@k p<? super Float, ? super V, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(Float.valueOf(this.keys[i14]), this.values[i14]).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        while (i14 < i12) {
            if (((jArr2[i14 >> 3] >> ((i14 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatObjectMap.findFirstAvailableSlot(i15 >>> 7);
                long j11 = i15 & 127;
                ...
                objArr2[findFirstAvailableSlot] = objArr[i14];
            } else {
                jArr = jArr2;
            }
            i14++;
    ...
    public final void set(float f11, V v11) {
        int findAbsoluteInsertIndex = findAbsoluteInsertIndex(f11);
        this.keys[findAbsoluteInsertIndex] = f11;
        this.values[findAbsoluteInsertIndex] = v11;
    }
    ...
    public /* synthetic */ MutableFloatObjectMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
    ...
    public MutableFloatObjectMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    */
    public final boolean remove(float r17, V r18) {
        ...
        L69:
            ...
            r1 = r1[r10]
            r6 = r18
            boolean r1 = kotlin.jvm.internal.g0.g(r1, r6)
            if (r1 == 0) goto L7b
