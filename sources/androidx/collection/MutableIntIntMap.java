...
public final class MutableIntIntMap extends IntIntMap {
            ...
            if (j14 != 128 && j14 == 254) {
                ...
                if (((findFirstAvailableSlot - i21) & i11) / 8 == ((i16 - i21) & i11) / 8) {
                    ...
                    if (((j15 >> i24) & 255) == 128) {
                        ...
                        iArr[i16] = i22;
                        iArr2[findFirstAvailableSlot] = iArr2[i16];
                        iArr2[i16] = i22;
                    } else {
                        j11 = j13;
                        jArr[i23] = ((r8 & 127) << i24) | (j15 & (~(255 << i24)));
                        ...
                        iArr[findFirstAvailableSlot] = iArr[i16];
                        iArr[i16] = i25;
                        int i26 = iArr2[findFirstAvailableSlot];
                        iArr2[findFirstAvailableSlot] = iArr2[i16];
                        iArr2[i16] = i26;
                        i16--;
                    }
    ...
    public final int getOrPut(int i11, @k x00.a<Integer> defaultValue) {
    ...
    public final void plusAssign(@k IntIntMap from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(int i11, int i12) {
        set(i11, i12);
    }

    public final void putAll(@k IntIntMap from) {
        g0.p(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@k p<? super Integer, ? super Integer, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(Integer.valueOf(this.keys[i14]), Integer.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        int i13 = mutableIntIntMap._capacity;
        int i14 = 0;
        while (i14 < i12) {
            if (((jArr2[i14 >> 3] >> ((i14 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableIntIntMap.findFirstAvailableSlot(i16 >>> 7);
                long j11 = i16 & 127;
                ...
                iArr3[findFirstAvailableSlot] = i15;
                iArr4[findFirstAvailableSlot] = iArr2[i14];
            } else {
                jArr = jArr2;
            }
            i14++;
    ...
    public final void set(int i11, int i12) {
        ...
        this.values[findInsertIndex] = i12;
    }
    ...
    public MutableIntIntMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    public final int put(int i11, int i12, int i13) {
        int findInsertIndex = findInsertIndex(i11);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
            i13 = this.values[findInsertIndex];
        }
        this.keys[findInsertIndex] = i11;
        this.values[findInsertIndex] = i12;
        return i13;
    ...
    public final boolean remove(int i11, int i12) {
        int findKeyIndex = findKeyIndex(i11);
        if (findKeyIndex < 0 || this.values[findKeyIndex] != i12) {
            return false;
        }
        removeValueAt(findKeyIndex);
        return true;
    ...
    public /* synthetic */ MutableIntIntMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
