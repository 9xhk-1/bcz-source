...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long getOrPut(int i11, @k x00.a<Long> defaultValue) {
    ...
    public final void plusAssign(@k IntLongMap from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(int i11, long j11) {
        set(i11, j11);
    }

    public final void putAll(@k IntLongMap from) {
        g0.p(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@k p<? super Integer, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(Integer.valueOf(this.keys[i14]), Long.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        int i12 = mutableIntLongMap._capacity;
        ...
        int i13 = mutableIntLongMap._capacity;
        int i14 = 0;
        while (i14 < i12) {
            if (((jArr2[i14 >> 3] >> ((i14 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i16 >>> 7);
                long j11 = i16 & 127;
                int i17 = findFirstAvailableSlot >> 3;
                int i18 = (findFirstAvailableSlot & 7) << 3;
                jArr = jArr2;
                long j12 = (jArr4[i17] & (~(255 << i18))) | (j11 << i18);
                jArr4[i17] = j12;
    ...
    public MutableIntLongMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    public final long put(int i11, long j11, long j12) {
        int findInsertIndex = findInsertIndex(i11);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
            j12 = this.values[findInsertIndex];
        }
        this.keys[findInsertIndex] = i11;
        this.values[findInsertIndex] = j11;
        return j12;
    ...
    public final boolean remove(int i11, long j11) {
        int findKeyIndex = findKeyIndex(i11);
        if (findKeyIndex < 0 || this.values[findKeyIndex] != j11) {
            return false;
        }
        removeValueAt(findKeyIndex);
        return true;
    ...
    public /* synthetic */ MutableIntLongMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
