...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final float getOrPut(long j11, @k x00.a<Float> defaultValue) {
    ...
    public final void plusAssign(@k LongFloatMap from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(long j11, float f11) {
        set(j11, f11);
    }

    public final void putAll(@k LongFloatMap from) {
        g0.p(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@k p<? super Long, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(Long.valueOf(this.keys[i14]), Float.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        int i12 = mutableLongFloatMap._capacity;
        ...
        int i13 = mutableLongFloatMap._capacity;
        int i14 = 0;
        while (i14 < i12) {
            if (((jArr2[i14 >> 3] >> ((i14 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableLongFloatMap.findFirstAvailableSlot(i15 >>> 7);
                long j12 = i15 & 127;
    ...
    public final void set(long j11, float f11) {
    ...
    public MutableLongFloatMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    public final float put(long j11, float f11, float f12) {
        int findInsertIndex = findInsertIndex(j11);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(long j11, float f11) {
        int findKeyIndex = findKeyIndex(j11);
    ...
    public /* synthetic */ MutableLongFloatMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
