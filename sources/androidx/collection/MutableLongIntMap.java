...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final void dropDeletes$collection() {
        ...
        while (i16 != i11) {
            ...
            if (j14 != 128 && j14 == 254) {
                int hashCode = Long.hashCode(jArr2[i16]) * (-862048943);
    ...
    public final int getOrPut(long j11, @k x00.a<Integer> defaultValue) {
    ...
    public final void plusAssign(@k LongIntMap from) {
        g0.p(from, "from");
        putAll(from);
    }
    ...
    public final void putAll(@k LongIntMap from) {
        g0.p(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@k p<? super Long, ? super Integer, Boolean> predicate) {
    ...
    public final int put(long j11, int i11, int i12) {
        int findInsertIndex = findInsertIndex(j11);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(long j11, int i11) {
        int findKeyIndex = findKeyIndex(j11);
    ...
    public /* synthetic */ MutableLongIntMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
