...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k11, @k x00.a<Float> defaultValue) {
    ...
    public final void plusAssign(@k ObjectFloatMap<K> from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(K k11, float f11) {
        set(k11, f11);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(@k ObjectFloatMap<K> from) {
        g0.p(from, "from");
    ...
    public final void removeIf(@k p<? super K, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(this.keys[i14], Float.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void set(K k11, float f11) {
        int findIndex = findIndex(k11);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        }
        this.keys[findIndex] = k11;
        this.values[findIndex] = f11;
    }
    ...
    public /* synthetic */ MutableObjectFloatMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
    ...
    public final float put(K k11, float f11, float f12) {
        int findIndex = findIndex(k11);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        } else {
            f12 = this.values[findIndex];
        }
        this.keys[findIndex] = k11;
        this.values[findIndex] = f11;
        return f12;
    ...
    public MutableObjectFloatMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    public final boolean remove(K k11, float f11) {
        int findKeyIndex = findKeyIndex(k11);
