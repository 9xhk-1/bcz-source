...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final long getOrPut(K k11, @k x00.a<Long> defaultValue) {
    ...
    public final void plusAssign(@k ObjectLongMap<K> from) {
        g0.p(from, "from");
        putAll(from);
    }

    public final void put(K k11, long j11) {
        set(k11, j11);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(@k ObjectLongMap<K> from) {
        g0.p(from, "from");
    ...
    public final void removeIf(@k p<? super K, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        if (predicate.invoke(this.keys[i14], Long.valueOf(this.values[i14])).booleanValue()) {
                            removeValueAt(i14);
                        }
                    }
                    j11 >>= 8;
    ...
    public final void resizeStorage$collection(int i11) {
        ...
        while (i15 < i13) {
            if (((jArr[i15 >> 3] >> ((i15 & 7) << 3)) & 255) < 128) {
                ...
                long j12 = (j11 << i18) | (jArr3[i17] & (~(255 << i18)));
                jArr3[i17] = j12;
                jArr3[(((findFirstAvailableSlot - 7) & i14) + (i14 & 7)) >> 3] = j12;
                objArr2[findFirstAvailableSlot] = obj;
                jArr4[findFirstAvailableSlot] = jArr2[i12];
            } else {
                i12 = i15;
            }
            i15 = i12 + 1;
    ...
    public final void set(K k11, long j11) {
        int findIndex = findIndex(k11);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        }
        this.keys[findIndex] = k11;
        this.values[findIndex] = j11;
    }
    ...
    public /* synthetic */ MutableObjectLongMap(int i11, int i12, v vVar) {
        this((i12 & 1) != 0 ? 6 : i11);
    }
    ...
    public final long put(K k11, long j11, long j12) {
        int findIndex = findIndex(k11);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        } else {
            j12 = this.values[findIndex];
        }
        this.keys[findIndex] = k11;
        this.values[findIndex] = j11;
        return j12;
    ...
    public MutableObjectLongMap(int i11) {
        super(null);
        if (!(i11 >= 0)) {
    ...
    public final boolean remove(K k11, long j11) {
        int findKeyIndex = findKeyIndex(k11);
