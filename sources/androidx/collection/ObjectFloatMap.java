...
public abstract class ObjectFloatMap<K> {
    ...
    public /* synthetic */ ObjectFloatMap(v vVar) {
        this();
    }

    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, int i12, Object obj) {
        if (obj != null) {
        ...
        return objectFloatMap.joinToString(charSequence, charSequence2, charSequence6, i11, charSequence5);
    }

    public final boolean all(@k p<? super K, ? super Float, Boolean> predicate) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((255 & j11) < 128) {
                        ...
                        z12 = z13;
                        if (f11 != objectFloatMap.values[findKeyIndex]) {
                            break loop0;
                        }
                    } else {
                        z12 = z13;
    ...
    public final void forEach(@k p<? super K, ? super Float, g2> block) {
        g0.p(block, "block");
        Object[] objArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
        ...
        while (true) {
            ...
            if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j11) < 128) {
                        int i14 = (i11 << 3) + i13;
                        block.invoke(objArr[i14], Float.valueOf(fArr[i14]));
                    }
                    j11 >>= 8;
                }
                if (i12 != 8) {
    ...
    public final float getOrDefault(K k11, float f11) {
        int findKeyIndex = findKeyIndex(k11);
        return findKeyIndex >= 0 ? this.values[findKeyIndex] : f11;
    }

    public final float getOrElse(K k11, @k x00.a<Float> defaultValue) {
        g0.p(defaultValue, "defaultValue");
        int findKeyIndex = findKeyIndex(k11);
        return findKeyIndex >= 0 ? this.values[findKeyIndex] : defaultValue.invoke().floatValue();
    }
    ...
    public final boolean any(@k p<? super K, ? super Float, Boolean> predicate) {
        g0.p(predicate, "predicate");
        Object[] objArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(@k p<? super K, ? super Float, Boolean> predicate) {
        g0.p(predicate, "predicate");
        Object[] objArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i11, CharSequence charSequence4, p transform, int i12, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i13;
        if (obj == null) {
                    ...
                    if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i21 < i19) {
                            if ((j11 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb2.append((CharSequence) transform.invoke(obj2, Float.valueOf(f11)));
                                i16++;
                            } else {
                                jArr2 = jArr3;
                                i13 = i18;
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence charSequence, @k CharSequence prefix, @k CharSequence postfix, int i11, @k CharSequence truncated, @k p<? super K, ? super Float, ? extends CharSequence> transform) {
        Object[] objArr;
        Object[] objArr2;
                ...
                if ((((~j11) << 7) & j11 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j11 & 255) < 128) {
                            ...
                            sb2.append(transform.invoke(obj, Float.valueOf(f11)));
                            i13++;
                        } else {
                            objArr2 = objArr3;
                        }
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, int i11, @k p<? super K, ? super Float, ? extends CharSequence> transform) {
        int i12;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k CharSequence postfix, @k p<? super K, ? super Float, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(postfix, "postfix");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k CharSequence prefix, @k p<? super K, ? super Float, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(prefix, "prefix");
        g0.p(transform, "transform");
    ...
    @w00.k
    @k
    public final String joinToString(@k CharSequence separator, @k p<? super K, ? super Float, ? extends CharSequence> transform) {
        int i11;
        g0.p(separator, "separator");
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
    ...
    @w00.k
    @k
    public final String joinToString(@k p<? super K, ? super Float, ? extends CharSequence> transform) {
        int i11;
        g0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
