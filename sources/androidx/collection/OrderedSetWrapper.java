...
class OrderedSetWrapper<E> implements Set<E>, y00.a {

    @k
    private final OrderedScatterSet<E> parent;

    public OrderedSetWrapper(@k OrderedScatterSet<E> parent) {
        g0.p(parent, "parent");
        this.parent = parent;
    }
    ...
    public boolean equals(@l Object obj) {
        ...
        return g0.g(this.parent, ((OrderedSetWrapper) obj).parent);
    }
    ...
    public Iterator<E> iterator() {
        return q.a(new OrderedSetWrapper$iterator$1(this, null));
    }
