...
public final class MutatorMutex {
    ...
    @m80.l
    public final <R> Object mutate(@k MutatePriority mutatePriority, @k l<? super j00.c<? super R>, ? extends Object> lVar, @k j00.c<? super R> cVar) {
        return s0.g(new MutatorMutex$mutate$2(mutatePriority, this, lVar, null), cVar);
    }

    @m80.l
    public final <T, R> Object mutateWith(T t11, @k MutatePriority mutatePriority, @k p<? super T, ? super j00.c<? super R>, ? extends Object> pVar, @k j00.c<? super R> cVar) {
