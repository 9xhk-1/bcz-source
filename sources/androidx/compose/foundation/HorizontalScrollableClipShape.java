...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public Outline mo291createOutlinePq9zytI(long j11, @m80.k LayoutDirection layoutDirection, @m80.k Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -mo371roundToPx0680j_4, Float.intBitsToFloat((int) (j11 >> 32)), Float.intBitsToFloat((int) (j11 & 4294967295L)) + mo371roundToPx0680j_4));
    }
}
