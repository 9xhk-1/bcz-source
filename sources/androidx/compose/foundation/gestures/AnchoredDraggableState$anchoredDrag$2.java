...
@d(c = "androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$2", f = "AnchoredDraggable.kt", i = {}, l = {1125}, m = "invokeSuspend", n = {}, s = {})
...
public final class AnchoredDraggableState$anchoredDrag$2 extends SuspendLambda implements l<c<? super g2>, Object> {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    @d(c = "androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$2$2", f = "AnchoredDraggable.kt", i = {}, l = {1126}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass2<T> extends SuspendLambda implements p<DraggableAnchors<T>, c<? super g2>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.label = 1;
                if (qVar.invoke(anchoredDraggableState$anchoredDragScope$1, draggableAnchors, this) == l11) {
                    return l11;
                }
            } else {
                if (i11 != 1) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            a<DraggableAnchors<T>> aVar = new a<DraggableAnchors<T>>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
