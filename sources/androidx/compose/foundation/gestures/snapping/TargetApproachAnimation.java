...
final class TargetApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public TargetApproachAnimation(@k AnimationSpec<Float> animationSpec) {
    ...
    public Object approachAnimation(@k ScrollScope scrollScope, float f11, float f12, @k l<? super Float, g2> lVar, @k c<? super AnimationResult<Float, AnimationVector1D>> cVar) {
        ...
        animateWithTarget = SnapFlingBehaviorKt.animateWithTarget(scrollScope, Math.abs(f11) * Math.signum(f12), f11, AnimationStateKt.AnimationState$default(0.0f, f12, 0L, 0L, false, 28, null), this.animationSpec, lVar, cVar);
