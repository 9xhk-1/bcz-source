...
public final class DragInteractionKt {
    @Composable
    @k
    public static final State<Boolean> collectIsDraggedAsState(@k InteractionSource interactionSource, @l Composer composer, int i11) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(101276833, i11, -1, "androidx.compose.foundation.interaction.collectIsDraggedAsState (DragInteraction.kt:77)");
        }
