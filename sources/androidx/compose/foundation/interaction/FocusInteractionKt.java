...
public final class FocusInteractionKt {
    @Composable
    @k
    public static final State<Boolean> collectIsFocusedAsState(@k InteractionSource interactionSource, @l Composer composer, int i11) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1805515472, i11, -1, "androidx.compose.foundation.interaction.collectIsFocusedAsState (FocusInteraction.kt:63)");
        }
