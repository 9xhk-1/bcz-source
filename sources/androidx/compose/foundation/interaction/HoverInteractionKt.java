...
public final class HoverInteractionKt {
    @Composable
    @k
    public static final State<Boolean> collectIsHoveredAsState(@k InteractionSource interactionSource, @l Composer composer, int i11) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1206586544, i11, -1, "androidx.compose.foundation.interaction.collectIsHoveredAsState (HoverInteraction.kt:63)");
        }
