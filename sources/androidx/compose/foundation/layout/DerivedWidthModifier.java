...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedWidthModifier(@m80.k WindowInsets windowInsets, @m80.k l<? super InspectorInfo, g2> lVar, @m80.k q<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> qVar) {
        super(lVar);
    ...
    public boolean equals(@m80.l Object obj) {
        ...
        return g0.g(this.insets, derivedWidthModifier.insets) && this.widthCalc == derivedWidthModifier.widthCalc;
    }
    ...
    public MeasureResult mo646measure3p2s80s(@m80.k MeasureScope measureScope, @m80.k Measurable measurable, long j11) {
        ...
        if (intValue == 0) {
            return MeasureScope.layout$default(measureScope, 0, 0, null, new l<Placeable.PlacementScope, g2>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$1
        ...
        final Placeable mo3857measureBRTryo0 = measurable.mo3857measureBRTryo0(Constraints.m5058copyZbe2FdA$default(j11, intValue, intValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measureScope, intValue, mo3857measureBRTryo0.getHeight(), null, new l<Placeable.PlacementScope, g2>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
