...
public final class FlowRowOverflowScopeImpl implements FlowRowScope, FlowRowOverflowScope {
    ...
    @m80.k
    private final c0 totalItemCount$delegate = FlowLayoutOverflowKt.lazyInt$default(null, new x00.a<Integer>() { // from class: androidx.compose.foundation.layout.FlowRowOverflowScopeImpl$totalItemCount$2
        {
            super(0);
        }
    ...
    public FlowRowOverflowScopeImpl(@m80.k FlowLayoutOverflowState flowLayoutOverflowState) {
        this.state = flowLayoutOverflowState;
        this.shownItemCount$delegate = FlowLayoutOverflowKt.lazyInt(flowLayoutOverflowState.getShownItemLazyErrorMessage$foundation_layout_release(), new x00.a<Integer>() { // from class: androidx.compose.foundation.layout.FlowRowOverflowScopeImpl$shownItemCount$2
            {
                super(0);
            }
