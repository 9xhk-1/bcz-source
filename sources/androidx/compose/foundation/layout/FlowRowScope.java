...
public interface FlowRowScope extends RowScope {
    static /* synthetic */ Modifier fillMaxRowHeight$default(FlowRowScope flowRowScope, Modifier modifier, float f11, int i11, Object obj) {
        if (obj != null) {
        ...
        return flowRowScope.fillMaxRowHeight(modifier, f11);
    }
