...
final class GapBuffer {
    ...
    public GapBuffer(@m80.k char[] cArr, int i11, int i12) {
    ...
    private final void delete(int i11, int i12) {
        ...
        if (i11 < i13 && i12 <= i13) {
            ...
            a00.q.w0(cArr, cArr, this.gapEnd - i14, i12, i13);
            this.gapStart = i11;
            this.gapEnd -= i14;
            return;
        }
        ...
        a00.q.w0(cArr2, cArr2, this.gapStart, i15, gapLength);
    ...
    private final void makeSureAvailableSpace(int i11) {
        ...
        a00.q.w0(this.buffer, cArr, 0, 0, this.gapStart);
        int i13 = this.capacity;
        int i14 = this.gapEnd;
        int i15 = i13 - i14;
        int i16 = i12 - i15;
        a00.q.w0(this.buffer, cArr, i16, i14, i15 + i14);
        this.buffer = cArr;
        this.capacity = i12;
        this.gapEnd = i16;
    }

    public static /* synthetic */ void replace$default(GapBuffer gapBuffer, int i11, int i12, CharSequence charSequence, int i13, int i14, int i15, Object obj) {
        if ((i15 & 8) != 0) {
            i13 = 0;
        }
        int i16 = i13;
        ...
        gapBuffer.replace(i11, i12, charSequence, i16, i14);
    }

    public final void append(@m80.k StringBuilder sb2) {
    ...
    public final void replace(int i11, int i12, @m80.k CharSequence charSequence, int i13, int i14) {
        int i15 = i14 - i13;
        makeSureAvailableSpace(i15 - (i12 - i11));
        delete(i11, i12);
        ToCharArray_androidKt.toCharArray(charSequence, this.buffer, this.gapStart, i13, i14);
        this.gapStart += i15;
    }
