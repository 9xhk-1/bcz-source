...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    ...
    */
    ...
    @m80.k
    public static final CursorAnchorInfo build(@m80.k CursorAnchorInfo.Builder builder, @m80.k TextFieldValue textFieldValue, @m80.k OffsetMapping offsetMapping, @m80.k TextLayoutResult textLayoutResult, @m80.k Matrix matrix, @m80.k Rect rect, @m80.k Rect rect2, boolean z11, boolean z12, boolean z13, boolean z14) {
        builder.reset();
    ...
    public static final boolean containsInclusive(@m80.k Rect rect, float f11, float f12) {
