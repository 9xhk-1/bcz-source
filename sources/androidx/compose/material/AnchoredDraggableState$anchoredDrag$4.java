...
@d(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4", f = "AnchoredDraggable.kt", i = {}, l = {574}, m = "invokeSuspend", n = {}, s = {})
...
public final class AnchoredDraggableState$anchoredDrag$4 extends SuspendLambda implements l<c<? super g2>, Object> {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    @d(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4$2", f = "AnchoredDraggable.kt", i = {}, l = {576}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass2<T> extends SuspendLambda implements p<Pair<? extends DraggableAnchors<T>, ? extends T>, c<? super g2>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.label = 1;
                if (rVar.invoke(anchoredDragScope, draggableAnchors, component2, this) == l11) {
                    return l11;
                }
            } else {
                if (i11 != 1) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            a<Pair<? extends DraggableAnchors<T>, ? extends T>> aVar = new a<Pair<? extends DraggableAnchors<T>, ? extends T>>() { // from class: androidx.compose.material.AnchoredDraggableState$anchoredDrag$4.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
