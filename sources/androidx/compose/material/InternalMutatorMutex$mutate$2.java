...
@d(c = "androidx.compose.material.InternalMutatorMutex$mutate$2", f = "InternalMutatorMutex.kt", i = {0, 0, 1, 1}, l = {180, 103}, m = "invokeSuspend", n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, s = {"L$0", "L$1", "L$0", "L$1"})
@u0({"SMAP\nInternalMutatorMutex.kt\nKotlin\n*S Kotlin\n*F\n+ 1 InternalMutatorMutex.kt\nandroidx/compose/material/InternalMutatorMutex$mutate$2\n+ 2 Mutex.kt\nkotlinx/coroutines/sync/MutexKt\n*L\n1#1,174:1\n120#2,10:175\n*S KotlinDebug\n*F\n+ 1 InternalMutatorMutex.kt\nandroidx/compose/material/InternalMutatorMutex$mutate$2\n*L\n101#1:175,10\n*E\n"})
/* loaded from: classes.dex */
public final class InternalMutatorMutex$mutate$2<R> extends SuspendLambda implements p<r0, c<? super R>, Object> {
    ...
    public InternalMutatorMutex$mutate$2(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, l<? super c<? super R>, ? extends Object> lVar, c<? super InternalMutatorMutex$mutate$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(r0 r0Var, c<? super R> cVar) {
        return ((InternalMutatorMutex$mutate$2) create(r0Var, cVar)).invokeSuspend(g2.f100423a);
    }
        ...
        try {
            try {
                if (r12 == 0) {
                    ...
                    l<c<? super R>, Object> lVar2 = this.$block;
