...
public final class KeyboardArrowRightKt {
    ...
    @k
    public static final ImageVector getKeyboardArrowRight(@k Icons.AutoMirrored.Filled filled) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.KeyboardArrowRight", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
