...
public final class ArrowBackKt {
    ...
    @k
    public static final ImageVector getArrowBack(@k Icons.AutoMirrored.Rounded rounded) {
        ImageVector imageVector = _arrowBack;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.ArrowBack", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
