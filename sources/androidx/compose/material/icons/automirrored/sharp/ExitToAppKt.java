...
public final class ExitToAppKt {
    ...
    @k
    public static final ImageVector getExitToApp(@k Icons.AutoMirrored.Sharp sharp) {
        ImageVector imageVector = _exitToApp;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.ExitToApp", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
