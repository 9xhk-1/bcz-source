...
public final class ArrowForwardKt {
    ...
    @k
    public static final ImageVector getArrowForward(@k Icons.AutoMirrored.TwoTone twoTone) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.ArrowForward", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
