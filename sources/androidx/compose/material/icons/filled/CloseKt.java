...
public final class CloseKt {
    ...
    @k
    public static final ImageVector getClose(@k Icons.Filled filled) {
        ImageVector imageVector = _close;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Close", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
