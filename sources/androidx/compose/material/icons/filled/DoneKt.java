...
public final class DoneKt {
    ...
    @k
    public static final ImageVector getDone(@k Icons.Filled filled) {
        ImageVector imageVector = _done;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Done", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
