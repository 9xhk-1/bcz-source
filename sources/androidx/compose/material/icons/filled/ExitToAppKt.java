...
public final class ExitToAppKt {
    ...
    @k
    public static final ImageVector getExitToApp(@k Icons.Filled filled) {
        ImageVector imageVector = _exitToApp;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ExitToApp", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Filled.ExitToApp", replaceWith = @w0(expression = "Icons.AutoMirrored.Filled.ExitToApp", imports = {"androidx.compose.material.icons.automirrored.filled.ExitToApp"}))
    public static /* synthetic */ void getExitToApp$annotations(Icons.Filled filled) {
    }
}
