...
public final class KeyboardArrowLeftKt {
    ...
    @k
    public static final ImageVector getKeyboardArrowLeft(@k Icons.Filled filled) {
        ImageVector imageVector = _keyboardArrowLeft;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.KeyboardArrowLeft", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Filled.KeyboardArrowLeft", replaceWith = @w0(expression = "Icons.AutoMirrored.Filled.KeyboardArrowLeft", imports = {"androidx.compose.material.icons.automirrored.filled.KeyboardArrowLeft"}))
