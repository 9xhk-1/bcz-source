...
public final class KeyboardArrowUpKt {
    ...
    @k
    public static final ImageVector getKeyboardArrowUp(@k Icons.Filled filled) {
        ImageVector imageVector = _keyboardArrowUp;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.KeyboardArrowUp", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
