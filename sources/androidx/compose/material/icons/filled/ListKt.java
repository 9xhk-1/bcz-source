...
public final class ListKt {
    ...
    @k
    public static final ImageVector getList(@k Icons.Filled filled) {
        ImageVector imageVector = _list;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.List", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Filled.List", replaceWith = @w0(expression = "Icons.AutoMirrored.Filled.List", imports = {"androidx.compose.material.icons.automirrored.filled.List"}))
