...
public final class ExitToAppKt {
    ...
    @k
    public static final ImageVector getExitToApp(@k Icons.Outlined outlined) {
        ImageVector imageVector = _exitToApp;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ExitToApp", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.ExitToApp", replaceWith = @w0(expression = "Icons.AutoMirrored.Outlined.ExitToApp", imports = {"androidx.compose.material.icons.automirrored.outlined.ExitToApp"}))
