...
public final class FavoriteKt {
    ...
    @k
    public static final ImageVector getFavorite(@k Icons.Outlined outlined) {
        ImageVector imageVector = _favorite;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Favorite", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
