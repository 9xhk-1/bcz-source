...
public final class MenuKt {
    ...
    @k
    public static final ImageVector getMenu(@k Icons.Outlined outlined) {
        ImageVector imageVector = _menu;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Menu", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
