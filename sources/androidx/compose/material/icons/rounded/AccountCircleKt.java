...
public final class AccountCircleKt {
    ...
    @k
    public static final ImageVector getAccountCircle(@k Icons.Rounded rounded) {
        ImageVector imageVector = _accountCircle;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AccountCircle", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
