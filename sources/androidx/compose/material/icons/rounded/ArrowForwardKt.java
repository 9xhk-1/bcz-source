...
public final class ArrowForwardKt {
    ...
    @k
    public static final ImageVector getArrowForward(@k Icons.Rounded rounded) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowForward", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.ArrowForward", replaceWith = @w0(expression = "Icons.AutoMirrored.Rounded.ArrowForward", imports = {"androidx.compose.material.icons.automirrored.rounded.ArrowForward"}))
