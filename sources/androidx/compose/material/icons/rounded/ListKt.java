...
public final class ListKt {
    ...
    @k
    public static final ImageVector getList(@k Icons.Rounded rounded) {
        ImageVector imageVector = _list;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.List", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.List", replaceWith = @w0(expression = "Icons.AutoMirrored.Rounded.List", imports = {"androidx.compose.material.icons.automirrored.rounded.List"}))
    public static /* synthetic */ void getList$annotations(Icons.Rounded rounded) {
    }
}
