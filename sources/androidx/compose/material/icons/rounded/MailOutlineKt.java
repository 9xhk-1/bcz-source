...
public final class MailOutlineKt {
    ...
    @k
    public static final ImageVector getMailOutline(@k Icons.Rounded rounded) {
        ImageVector imageVector = _mailOutline;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MailOutline", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
