...
public final class ArrowBackKt {
    ...
    @k
    public static final ImageVector getArrowBack(@k Icons.Sharp sharp) {
        ImageVector imageVector = _arrowBack;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ArrowBack", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.ArrowBack", replaceWith = @w0(expression = "Icons.AutoMirrored.Sharp.ArrowBack", imports = {"androidx.compose.material.icons.automirrored.sharp.ArrowBack"}))
