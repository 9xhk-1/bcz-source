...
public final class ArrowForwardKt {
    ...
    @k
    public static final ImageVector getArrowForward(@k Icons.Sharp sharp) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ArrowForward", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.ArrowForward", replaceWith = @w0(expression = "Icons.AutoMirrored.Sharp.ArrowForward", imports = {"androidx.compose.material.icons.automirrored.sharp.ArrowForward"}))
