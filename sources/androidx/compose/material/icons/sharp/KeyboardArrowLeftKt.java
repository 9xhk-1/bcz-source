...
public final class KeyboardArrowLeftKt {
    ...
    @k
    public static final ImageVector getKeyboardArrowLeft(@k Icons.Sharp sharp) {
        ImageVector imageVector = _keyboardArrowLeft;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.KeyboardArrowLeft", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.KeyboardArrowLeft", replaceWith = @w0(expression = "Icons.AutoMirrored.Sharp.KeyboardArrowLeft", imports = {"androidx.compose.material.icons.automirrored.sharp.KeyboardArrowLeft"}))
