...
public final class ListKt {
    ...
    @k
    public static final ImageVector getList(@k Icons.Sharp sharp) {
        ImageVector imageVector = _list;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.List", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.List", replaceWith = @w0(expression = "Icons.AutoMirrored.Sharp.List", imports = {"androidx.compose.material.icons.automirrored.sharp.List"}))
    public static /* synthetic */ void getList$annotations(Icons.Sharp sharp) {
    }
}
