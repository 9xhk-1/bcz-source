...
public final class AddCircleKt {
    ...
    @k
    public static final ImageVector getAddCircle(@k Icons.TwoTone twoTone) {
        ImageVector imageVector = _addCircle;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AddCircle", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
