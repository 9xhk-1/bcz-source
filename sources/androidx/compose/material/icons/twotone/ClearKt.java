...
public final class ClearKt {
    ...
    @k
    public static final ImageVector getClear(@k Icons.TwoTone twoTone) {
        ImageVector imageVector = _clear;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Clear", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
