...
public final class KeyboardArrowRightKt {
    ...
    @k
    public static final ImageVector getKeyboardArrowRight(@k Icons.TwoTone twoTone) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.KeyboardArrowRight", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @n(message = "Use the AutoMirrored version at Icons.AutoMirrored.TwoTone.KeyboardArrowRight", replaceWith = @w0(expression = "Icons.AutoMirrored.TwoTone.KeyboardArrowRight", imports = {"androidx.compose.material.icons.automirrored.twotone.KeyboardArrowRight"}))
    public static /* synthetic */ void getKeyboardArrowRight$annotations(Icons.TwoTone twoTone) {
    }
}
