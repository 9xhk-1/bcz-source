...
public final class MenuKt {
    ...
    @k
    public static final ImageVector getMenu(@k Icons.TwoTone twoTone) {
        ImageVector imageVector = _menu;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Menu", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
