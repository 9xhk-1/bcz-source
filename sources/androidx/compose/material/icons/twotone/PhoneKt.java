...
public final class PhoneKt {
    ...
    @k
    public static final ImageVector getPhone(@k Icons.TwoTone twoTone) {
        ImageVector imageVector = _phone;
        if (imageVector != null) {
            g0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Phone", Dp.m5115constructorimpl(24.0f), Dp.m5115constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
