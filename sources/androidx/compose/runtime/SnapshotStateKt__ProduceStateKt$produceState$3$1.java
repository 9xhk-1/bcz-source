...
@d(c = "androidx.compose.runtime.SnapshotStateKt__ProduceStateKt$produceState$3$1", f = "ProduceState.kt", i = {}, l = {138}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
public final class SnapshotStateKt__ProduceStateKt$produceState$3$1 extends SuspendLambda implements p<r0, c<? super g2>, Object> {
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$3$1(p<? super ProduceStateScope<T>, ? super c<? super g2>, ? extends Object> pVar, MutableState<T> mutableState, c<? super SnapshotStateKt__ProduceStateKt$produceState$3$1> cVar) {
        super(2, cVar);
        this.$producer = pVar;
    ...
    public final Object invoke(r0 r0Var, c<? super g2> cVar) {
        return ((SnapshotStateKt__ProduceStateKt$produceState$3$1) create(r0Var, cVar)).invokeSuspend(g2.f100423a);
    }
