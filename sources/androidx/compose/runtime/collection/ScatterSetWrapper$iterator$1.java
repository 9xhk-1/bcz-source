...
@d(c = "androidx.compose.runtime.collection.ScatterSetWrapper$iterator$1", f = "ScatterSetWrapper.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {31}, m = "invokeSuspend", n = {"$this$iterator", "elements$iv", "m$iv$iv", "lastIndex$iv$iv", "i$iv$iv", "slot$iv$iv", "bitCount$iv$iv", "j$iv$iv"}, s = {"L$0", "L$1", "L$2", "I$0", "I$1", "J$0", "I$2", "I$3"})
...
public final class ScatterSetWrapper$iterator$1<T> extends RestrictedSuspendLambda implements p<o<? super T>, c<? super g2>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterSetWrapper$iterator$1(ScatterSetWrapper<T> scatterSetWrapper, c<? super ScatterSetWrapper$iterator$1> cVar) {
        super(2, cVar);
    ...
    public final c<g2> create(Object obj, c<?> cVar) {
        ScatterSetWrapper$iterator$1 scatterSetWrapper$iterator$1 = new ScatterSetWrapper$iterator$1(this.this$0, cVar);
    ...
    */
    ...
    @Override // x00.p
    public final Object invoke(o<? super T> oVar, c<? super g2> cVar) {
        return ((ScatterSetWrapper$iterator$1) create(oVar, cVar)).invokeSuspend(g2.f100423a);
    }
}
