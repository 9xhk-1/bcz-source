...
public final class PersistentOrderedMapBuilderKeys<K, V> extends j<K> implements Set<K>, h {
    public static final int $stable = 8;

    @k
    private final PersistentOrderedMapBuilder<K, V> builder;

    public PersistentOrderedMapBuilderKeys(@k PersistentOrderedMapBuilder<K, V> persistentOrderedMapBuilder) {
