...
public final class ColorSpaces {
    ...
    static {
        ...
        LinearSrgb = rgb2;
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr, illuminant.getD65(), null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.a
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d11) {
                double ExtendedSrgb$lambda$0;
                ExtendedSrgb$lambda$0 = ColorSpaces.ExtendedSrgb$lambda$0(d11);
                return ExtendedSrgb$lambda$0;
            }
        }, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.b
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d11) {
                double ExtendedSrgb$lambda$1;
                ExtendedSrgb$lambda$1 = ColorSpaces.ExtendedSrgb$lambda$1(d11);
                return ExtendedSrgb$lambda$1;
            }
        ...
        Unspecified = rgb15;
        Rgb rgb16 = new Rgb("Hybrid Log Gamma encoding", fArr3, illuminant.getD65(), null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.c
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d11) {
                double Bt2020Hlg$lambda$2;
                Bt2020Hlg$lambda$2 = ColorSpaces.Bt2020Hlg$lambda$2(d11);
            ...
            public final double invoke(double d11) {
                ...
                Bt2020Hlg$lambda$3 = ColorSpaces.Bt2020Hlg$lambda$3(d11);
                return Bt2020Hlg$lambda$3;
            }
        }, 0.0f, 1.0f, transferParameters3, 17);
        Bt2020Hlg = rgb16;
        Rgb rgb17 = new Rgb("Perceptual Quantizer encoding", fArr3, illuminant.getD65(), null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.e
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d11) {
                double Bt2020Pq$lambda$4;
                Bt2020Pq$lambda$4 = ColorSpaces.Bt2020Pq$lambda$4(d11);
            ...
            public final double invoke(double d11) {
                ...
                Bt2020Pq$lambda$5 = ColorSpaces.Bt2020Pq$lambda$5(d11);
    ...
    public static final double Bt2020Hlg$lambda$2(double d11) {
        return INSTANCE.transferHlgOetf$ui_graphics_release(Bt2020HlgTransferParameters, d11);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double Bt2020Hlg$lambda$3(double d11) {
        return INSTANCE.transferHlgEotf$ui_graphics_release(Bt2020HlgTransferParameters, d11);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double Bt2020Pq$lambda$4(double d11) {
        return INSTANCE.transferSt2048Oetf$ui_graphics_release(Bt2020PqTransferParameters, d11);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double Bt2020Pq$lambda$5(double d11) {
        return INSTANCE.transferSt2048Eotf$ui_graphics_release(Bt2020PqTransferParameters, d11);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double ExtendedSrgb$lambda$0(double d11) {
        return ColorSpaceKt.absRcpResponse(d11, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 2.4d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double ExtendedSrgb$lambda$1(double d11) {
        return ColorSpaceKt.absResponse(d11, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 2.4d);
    }
    ...
    @m80.k
    public final ColorSpace getColorSpace$ui_graphics_release(int i11) {
        return getColorSpacesArray$ui_graphics_release()[i11];
    }
    ...
    @m80.l
    public final ColorSpace match(@Size(9) @m80.k float[] fArr, @m80.k TransferParameters transferParameters) {
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m2916equalsimpl0(colorSpace.m2925getModelxdoWZVw(), ColorModel.Companion.m2923getRgbxdoWZVw())) {
                ...
                g0.n(adapt$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
    ...
    public final double transferHlgEotf$ui_graphics_release(@m80.k TransferParameters transferParameters, double d11) {
        double d12 = d11 < 0.0d ? -1.0d : 1.0d;
        double d13 = d11 * d12;
        double a11 = transferParameters.getA();
        double b11 = transferParameters.getB();
        double c11 = transferParameters.getC();
        double d14 = transferParameters.getD();
        double e11 = transferParameters.getE();
        double d15 = a11 * d13;
        return (transferParameters.getF() + 1.0d) * d12 * (d15 <= 1.0d ? Math.pow(d15, b11) : Math.exp((d13 - e11) * c11) + d14);
    }

    public final double transferHlgOetf$ui_graphics_release(@m80.k TransferParameters transferParameters, double d11) {
        double d12 = d11 < 0.0d ? -1.0d : 1.0d;
        double a11 = 1.0d / transferParameters.getA();
        double b11 = 1.0d / transferParameters.getB();
        double c11 = 1.0d / transferParameters.getC();
        double d13 = transferParameters.getD();
        double e11 = transferParameters.getE();
        double f11 = (d11 * d12) / (transferParameters.getF() + 1.0d);
        return d12 * (f11 <= 1.0d ? a11 * Math.pow(f11, b11) : (c11 * Math.log(f11 - d13)) + e11);
    }

    public final double transferSt2048Eotf$ui_graphics_release(@m80.k TransferParameters transferParameters, double d11) {
        double d12 = d11 < 0.0d ? -1.0d : 1.0d;
        double d13 = d11 * d12;
        return d12 * Math.pow(g10.u.s(transferParameters.getA() + (transferParameters.getB() * Math.pow(d13, transferParameters.getC())), 0.0d) / (transferParameters.getD() + (transferParameters.getE() * Math.pow(d13, transferParameters.getC()))), transferParameters.getF());
    }

    public final double transferSt2048Oetf$ui_graphics_release(@m80.k TransferParameters transferParameters, double d11) {
        double d12 = d11 < 0.0d ? -1.0d : 1.0d;
        double d13 = d11 * d12;
        double d14 = -transferParameters.getA();
        double d15 = transferParameters.getD();
        double f11 = 1.0d / transferParameters.getF();
        return d12 * Math.pow(Math.max(d14 + (d15 * Math.pow(d13, f11)), 0.0d) / (transferParameters.getB() + ((-transferParameters.getE()) * Math.pow(d13, f11))), 1.0d / transferParameters.getC());
    }
}
