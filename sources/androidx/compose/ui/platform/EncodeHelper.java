...
public final class EncodeHelper {
    ...
    public final void encode(@m80.k SpanStyle spanStyle) {
        ...
        if (!Color.m2510equalsimpl0(m4500getColor0d7_KjU, companion.m2545getUnspecified0d7_KjU())) {
            encode((byte) 1);
            m4262encode8_81llA(spanStyle.m4500getColor0d7_KjU());
        }
        ...
        if (!TextUnit.m5306equalsimpl0(m4501getFontSizeXSAIIZE, companion2.m5320getUnspecifiedXSAIIZE())) {
            encode((byte) 2);
            m4259encodeR2X_6o(spanStyle.m4501getFontSizeXSAIIZE());
        }
        ...
        if (m4502getFontStyle4Lr2A7w != null) {
            ...
            encode((byte) 4);
            m4264encodenzbMABs(m4673unboximpl);
        }
        ...
        if (m4503getFontSynthesisZQGJjVo != null) {
            ...
            encode((byte) 5);
            m4261encode6p3vJLY(m4686unboximpl);
        }
        ...
        if (!TextUnit.m5306equalsimpl0(spanStyle.m4504getLetterSpacingXSAIIZE(), companion2.m5320getUnspecifiedXSAIIZE())) {
            encode((byte) 7);
            m4259encodeR2X_6o(spanStyle.m4504getLetterSpacingXSAIIZE());
        }
        ...
        if (m4499getBaselineShift5SSeXJ0 != null) {
            ...
            encode((byte) 8);
            m4260encode4Dl_Bck(m4855unboximpl);
        }
        ...
        if (!Color.m2510equalsimpl0(spanStyle.m4498getBackground0d7_KjU(), companion.m2545getUnspecified0d7_KjU())) {
            encode((byte) 10);
            m4262encode8_81llA(spanStyle.m4498getBackground0d7_KjU());
        }
    ...
    public final void m4259encodeR2X_6o(long j11) {
    ...
    public final void m4260encode4Dl_Bck(float f11) {
        encode(f11);
    }

    /* renamed from: encode-6p3vJLY, reason: not valid java name */
    public final void m4261encode6p3vJLY(int i11) {
    ...
    public final void m4262encode8_81llA(long j11) {
        m4263encodeVKZWuLQ(j11);
    }

    /* renamed from: encode-VKZWuLQ, reason: not valid java name */
    public final void m4263encodeVKZWuLQ(long j11) {
        this.parcel.writeLong(j11);
    }

    /* renamed from: encode-nzbMABs, reason: not valid java name */
    public final void m4264encodenzbMABs(int i11) {
    ...
    public final void encode(@m80.k FontWeight fontWeight) {
        encode(fontWeight.getWeight());
    }

    public final void encode(@m80.k TextGeometricTransform textGeometricTransform) {
        encode(textGeometricTransform.getScaleX());
        encode(textGeometricTransform.getSkewX());
    }

    public final void encode(@m80.k TextDecoration textDecoration) {
        encode(textDecoration.getMask());
    }

    public final void encode(@m80.k Shadow shadow) {
        m4262encode8_81llA(shadow.m2834getColor0d7_KjU());
    ...
    public final void encode(@m80.k String str) {
