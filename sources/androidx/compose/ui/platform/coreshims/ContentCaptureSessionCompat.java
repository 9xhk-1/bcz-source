...
public class ContentCaptureSessionCompat {
    ...
    public void flush() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            Api29Impl.notifyViewsDisappeared(a11, autofillId.toAutofillId(), new long[]{Long.MIN_VALUE});
        }
    }
    ...
    public void notifyViewAppeared(ViewStructure viewStructure) {
        if (Build.VERSION.SDK_INT >= 29) {
            Api29Impl.notifyViewAppeared(b.a(this.mWrappedObj), viewStructure);
        }
    }

    public void notifyViewDisappeared(AutofillId autofillId) {
        if (Build.VERSION.SDK_INT >= 29) {
            Api29Impl.notifyViewDisappeared(b.a(this.mWrappedObj), autofillId);
        }
    }
