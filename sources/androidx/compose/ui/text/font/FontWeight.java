...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    static {
        ...
        Black = fontWeight9;
        values = h0.Q(fontWeight, fontWeight2, fontWeight3, fontWeight4, fontWeight5, fontWeight6, fontWeight7, fontWeight8, fontWeight9);
    }
    ...
    public FontWeight(int i11) {
        ...
        InlineClassHelperKt.throwIllegalArgumentException("Font weight can be in range [1, 1000]. Current value: " + i11);
    }
    ...
    public int compareTo(@k FontWeight fontWeight) {
        return g0.t(this.weight, fontWeight.weight);
    }
}
