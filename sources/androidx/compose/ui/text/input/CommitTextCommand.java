...
public final class CommitTextCommand implements EditCommand {
    ...
    public CommitTextCommand(@k AnnotatedString annotatedString, int i11) {
    ...
    public boolean equals(@l Object obj) {
        ...
        return g0.g(getText(), commitTextCommand.getText()) && this.newCursorPosition == commitTextCommand.newCursorPosition;
    }
    ...
    public CommitTextCommand(@k String str, int i11) {
