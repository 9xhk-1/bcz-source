...
public abstract class AbstractResolvableFuture<V> implements p1<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        final p1<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, p1<? extends V> p1Var) {
    ...
    static {
        ...
        try {
            synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, l1.b.f62938h), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Object.class, "value"));
            th = null;
        } catch (Throwable th2) {
            th = th2;
    ...
    public static Object getFutureValue(p1<?> p1Var) {
        if (p1Var instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) p1Var).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        try {
            ...
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + p1Var, e11));
        } catch (ExecutionException e12) {
    ...
    */
    public final boolean cancel(boolean r8) {
        ...
        L35:
            ...
            com.google.common.util.concurrent.p1<? extends V> r0 = r0.future
    ...
    public boolean set(@Nullable V v11) {
        ...
        if (!ATOMIC_HELPER.casValue(this, null, v11)) {
            return false;
        }
        complete(this);
        return true;
    ...
    public boolean setFuture(p1<? extends V> p1Var) {
        ...
        if (obj == null) {
            if (p1Var.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(p1Var))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, p1Var);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    p1Var.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th2) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            p1Var.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
