...
public final class ConstraintLayoutKt$ConstraintLayout$7$1 extends Lambda implements l<SemanticsPropertyReceiver, g2> {
    final /* synthetic */ Measurer2 $measurer;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConstraintLayoutKt$ConstraintLayout$7$1(Measurer2 measurer2) {
        super(1);
