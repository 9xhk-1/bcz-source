...
public class MotionKeyTrigger extends MotionKey {
    ...
    public boolean setValue(int i11, int i12) {
        ...
        if (i11 == 308) {
            this.mTriggerID = toInt(Integer.valueOf(i12));
            return true;
        }
        if (i11 == 311) {
        ...
        switch (i11) {
            case 301:
                this.mViewTransitionOnCross = i12;
                return true;
            case 302:
                this.mViewTransitionOnPositiveCross = i12;
                return true;
            case 303:
                this.mViewTransitionOnNegativeCross = i12;
                return true;
            default:
