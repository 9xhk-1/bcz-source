...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference bias(float f11) {
        ...
        if (constraint != null) {
            int i11 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
            if (i11 != 19) {
                if (i11 != 20) {
                    switch (i11) {
                    }
    ...
    public void setHorizontalChainWeight(float f11) {
        this.mHorizontalChainWeight = f11;
    }
    ...
    public ConstraintReference margin(int i11) {
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
            ...
            case 16:
            case 17:
                this.mMarginBaseline = i11;
                break;
            case 18:
                this.mCircularDistance = i11;
                break;
        }
        return this;
    }
