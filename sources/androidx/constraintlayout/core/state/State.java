...
public class State {
    ...
    private String createHelperKey() {
        ...
        int i11 = this.mNumHelpers;
        this.mNumHelpers = i11 + 1;
        sb2.append(i11);
        sb2.append("__");
        return sb2.toString();
    }
    ...
    public FlowReference getFlow(Object obj, boolean z11) {
        ConstraintReference constraints = constraints(obj);
        if (constraints.getFacade() == null || !(constraints.getFacade() instanceof FlowReference)) {
            constraints.setFacade(z11 ? new FlowReference(this, Helper.VERTICAL_FLOW) : new FlowReference(this, Helper.HORIZONTAL_FLOW));
        }
    ...
    @Deprecated
    public void setLtr(boolean z11) {
        this.mIsLtr = z11;
    }
