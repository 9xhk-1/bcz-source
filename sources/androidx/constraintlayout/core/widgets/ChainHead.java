...
public class ChainHead {
    ...
    private void defineChainProperties() {
        ...
        while (!z11) {
            ...
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = this.mTotalSize + constraintWidget.mListAnchors[i11].getMargin();
                this.mTotalSize = margin;
                int i13 = i11 + 1;
                this.mTotalSize = margin + constraintWidget.mListAnchors[i13].getMargin();
                int margin2 = this.mTotalMargins + constraintWidget.mListAnchors[i11].getMargin();
                this.mTotalMargins = margin2;
                this.mTotalMargins = margin2 + constraintWidget.mListAnchors[i13].getMargin();
        ...
        if (constraintWidget6 != null) {
            this.mTotalSize -= constraintWidget6.mListAnchors[i11].getMargin();
        }
        ConstraintWidget constraintWidget7 = this.mLastVisibleWidget;
        if (constraintWidget7 != null) {
            this.mTotalSize -= constraintWidget7.mListAnchors[i11 + 1].getMargin();
        }
    ...
    private static boolean isMatchConstraintEqualityCandidate(ConstraintWidget constraintWidget, int i11) {
        if (constraintWidget.getVisibility() == 8 || constraintWidget.mListDimensionBehaviors[i11] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            return false;
        }
