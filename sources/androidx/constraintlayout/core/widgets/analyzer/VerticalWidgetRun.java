...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void apply() {
        ...
        if (z11 || this.mDimensionBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.mDimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            } else if (i13 == 3 && constraintWidget2.mHorizontalRun.mDimension.resolved) {
                int dimensionRatioSide = constraintWidget2.getDimensionRatioSide();
                if (dimensionRatioSide == -1) {
                    ConstraintWidget constraintWidget3 = this.mWidget;
                    f11 = constraintWidget3.mHorizontalRun.mDimension.value;
                    dimensionRatio = constraintWidget3.getDimensionRatio();
                } else if (dimensionRatioSide == 0) {
                    f12 = r7.mHorizontalRun.mDimension.value * this.mWidget.getDimensionRatio();
                    i11 = (int) (f12 + 0.5f);
                    this.mDimension.resolve(i11);
                } else if (dimensionRatioSide != 1) {
                    i11 = 0;
                    this.mDimension.resolve(i11);
                } else {
                    ConstraintWidget constraintWidget4 = this.mWidget;
                    f11 = constraintWidget4.mHorizontalRun.mDimension.value;
        ...
        if (dependencyNode.readyToSolve) {
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (!this.mDimension.resolved && this.mDimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.mTargets.size() > 0 && this.end.mTargets.size() > 0) {
                    ...
                    int i17 = (this.end.mTargets.get(0).value + this.end.mMargin) - (dependencyNode6.value + this.start.mMargin);
                    DimensionDependency dimensionDependency2 = this.mDimension;
                    int i18 = dimensionDependency2.wrapValue;
                    if (i17 < i18) {
                ...
                if (this.mDimension.resolved && this.start.mTargets.size() > 0 && this.end.mTargets.size() > 0) {
                    ...
                    int i19 = dependencyNode7.value + this.start.mMargin;
                    int i21 = dependencyNode8.value + this.end.mMargin;
                    float verticalBiasPercent = this.mWidget.getVerticalBiasPercent();
                    if (dependencyNode7 == dependencyNode8) {
                        i19 = dependencyNode7.value;
                        i21 = dependencyNode8.value;
                        verticalBiasPercent = 0.5f;
                    }
                    this.start.resolve((int) (i19 + 0.5f + (((i21 - i19) - this.mDimension.value) * verticalBiasPercent)));
