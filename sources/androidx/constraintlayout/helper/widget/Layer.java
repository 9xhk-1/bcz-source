...
public class Layer extends ConstraintHelper {
    ...
    private void transform() {
        ...
        for (int i11 = 0; i11 < this.mCount; i11++) {
            ...
            float f17 = left - this.mComputedCenterX;
            float f18 = top - this.mComputedCenterY;
            float f19 = (((f12 * f17) + (f14 * f18)) - f17) + this.mShiftX;
            float f21 = (((f17 * f15) + (f16 * f18)) - f18) + this.mShiftY;
