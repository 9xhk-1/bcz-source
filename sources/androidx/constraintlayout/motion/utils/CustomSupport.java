...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        String str = d.f46854h + constraintAttribute.getName();
        try {
            int i11 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.getType().ordinal()];
            ...
            Log.e(TAG, "Cannot access method " + str + " on View \"" + Debug.getName(view) + "\"", e11);
        } catch (NoSuchMethodException e12) {
            Log.e(TAG, "No method " + str + " on View \"" + Debug.getName(view) + "\"", e12);
        } catch (InvocationTargetException e13) {
            Log.e(TAG, "Cannot invoke method " + str + " on View \"" + Debug.getName(view) + "\"", e13);
        }
    }
}
