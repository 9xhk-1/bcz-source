...
public class DesignTool {
    ...
    private static void connect(int i11, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i12, int i13) {
        String str = sAllAttributes.get(Pair.create(Integer.valueOf(i12), Integer.valueOf(i13)));
        String str2 = hashMap.get(str);
        if (str2 != null) {
            String str3 = sAllMargins.get(str);
            constraintSet.connect(view.getId(), i12, Integer.parseInt(str2), i13, str3 != null ? getPxFromDp(i11, hashMap.get(str3)) : 0);
        }
    }

    private static int getPxFromDp(int i11, String str) {
        int indexOf;
    ...
    private static void setAbsolutePositions(int i11, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap) {
        String str = hashMap.get("layout_editor_absoluteX");
        if (str != null) {
            constraintSet.setEditorAbsoluteX(view.getId(), getPxFromDp(i11, str));
        }
        String str2 = hashMap.get("layout_editor_absoluteY");
        if (str2 != null) {
            constraintSet.setEditorAbsoluteY(view.getId(), getPxFromDp(i11, str2));
        }
    }

    private static void setBias(ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i11) {
        String str = hashMap.get(i11 == 1 ? "layout_constraintVertical_bias" : "layout_constraintHorizontal_bias");
        if (str != null) {
            if (i11 == 0) {
    ...
    private static void setDimensions(int i11, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i12) {
        String str = hashMap.get(i12 == 1 ? "layout_height" : "layout_width");
        if (str != null) {
            int pxFromDp = !str.equalsIgnoreCase("wrap_content") ? getPxFromDp(i11, str) : -2;
            if (i12 == 0) {
    ...
    public int designAccess(int i11, String str, Object obj, float[] fArr, int i12, float[] fArr2, int i13) {
        ...
        return motionController.getAttributeValues(str, fArr2, i13);
    }

    public void disableAutoTransition(boolean z11) {
        this.mMotionLayout.disableAutoTransition(z11);
    }
    ...
    public void dumpConstraintSet(String str) {
        ...
        System.out.println(" dumping  " + str + " (" + lookUpConstraintId + j.f81007d);
        try {
            this.mMotionLayout.mScene.getConstraintSet(lookUpConstraintId).dump(this.mMotionLayout.mScene, new int[0]);
        } catch (Exception e11) {
            Log.e(TAG, "Error while dumping: " + str + " (" + lookUpConstraintId + j.f81007d, e11);
        }
    }
    ...
    public int getAnimationPath(Object obj, float[] fArr, int i11) {
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
            return -1;
        }
        ...
        motionController.buildPath(fArr, i11);
        return i11;
    }
    ...
    public int getKeyFrameInfo(Object obj, int i11, int[] iArr) {
        MotionController motionController = this.mMotionLayout.mFrameArrayList.get((View) obj);
        if (motionController == null) {
            return 0;
        }
        return motionController.getKeyFrameInfo(i11, iArr);
    }

    public float getKeyFramePosition(Object obj, int i11, float f11, float f12) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) obj)) != null) {
            return motionController.getKeyFrameParameter(i11, f11, f12);
        }
        return 0.0f;
    }
    ...
    public Object getKeyframe(int i11, int i12, int i13) {
        MotionLayout motionLayout = this.mMotionLayout;
        MotionScene motionScene = motionLayout.mScene;
        if (motionScene == null) {
            return null;
        }
        return motionScene.getKeyFrame(motionLayout.getContext(), i11, i12, i13);
    }

    public Object getKeyframeAtLocation(Object obj, float f11, float f12) {
        MotionController motionController;
        View view = (View) obj;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), f11, f12);
    }

    public Boolean getPositionKeyframe(Object obj, Object obj2, float f11, float f12, String[] strArr, float[] fArr) {
        if (!(obj instanceof KeyPositionBase)) {
            return Boolean.FALSE;
        }
        View view = (View) obj2;
        this.mMotionLayout.mFrameArrayList.get(view).positionKeyframe(view, (KeyPositionBase) obj, f11, f12, strArr, fArr);
    ...
    public void setAttributes(int i11, String str, Object obj, Object obj2) {
        View view = (View) obj;
        ...
        setDimensions(i11, constraintSet, view, hashMap, 0);
        setDimensions(i11, constraintSet, view, hashMap, 1);
        connect(i11, constraintSet, view, hashMap, 6, 6);
        connect(i11, constraintSet, view, hashMap, 6, 7);
        connect(i11, constraintSet, view, hashMap, 7, 7);
        connect(i11, constraintSet, view, hashMap, 7, 6);
        connect(i11, constraintSet, view, hashMap, 1, 1);
        connect(i11, constraintSet, view, hashMap, 1, 2);
        connect(i11, constraintSet, view, hashMap, 2, 2);
        connect(i11, constraintSet, view, hashMap, 2, 1);
        connect(i11, constraintSet, view, hashMap, 3, 3);
        connect(i11, constraintSet, view, hashMap, 3, 4);
        connect(i11, constraintSet, view, hashMap, 4, 3);
        connect(i11, constraintSet, view, hashMap, 4, 4);
        connect(i11, constraintSet, view, hashMap, 5, 5);
        setBias(constraintSet, view, hashMap, 0);
        setBias(constraintSet, view, hashMap, 1);
        setAbsolutePositions(i11, constraintSet, view, hashMap);
        this.mMotionLayout.updateState(lookUpConstraintId, constraintSet);
        this.mMotionLayout.requestLayout();
    }

    public void setKeyFrame(Object obj, int i11, String str, Object obj2) {
        MotionScene motionScene = this.mMotionLayout.mScene;
        if (motionScene != null) {
            motionScene.setKeyframe((View) obj, i11, str, obj2);
            MotionLayout motionLayout = this.mMotionLayout;
            motionLayout.mTransitionGoalPosition = i11 / 100.0f;
    ...
    public boolean setKeyFramePosition(Object obj, int i11, int i12, float f11, float f12) {
        ...
        if (motionLayout.mScene != null) {
            ...
            int i13 = (int) (motionLayout2.mTransitionPosition * 100.0f);
            if (motionController != null) {
                View view = (View) obj;
                if (motionLayout2.mScene.hasKeyFramePosition(view, i13)) {
                    float keyFrameParameter = motionController.getKeyFrameParameter(2, f11, f12);
                    float keyFrameParameter2 = motionController.getKeyFrameParameter(5, f11, f12);
                    this.mMotionLayout.mScene.setKeyframe(view, i13, "motion:percentX", Float.valueOf(keyFrameParameter));
                    this.mMotionLayout.mScene.setKeyframe(view, i13, "motion:percentY", Float.valueOf(keyFrameParameter2));
                    this.mMotionLayout.rebuildScene();
                    this.mMotionLayout.evaluate(true);
    ...
    public void setToolPosition(float f11) {
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
            motionLayout.mScene = this.mSceneCache;
        }
    ...
    public void setViewDebug(Object obj, int i11) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get(obj)) != null) {
            motionController.setDrawPath(i11);
            this.mMotionLayout.invalidate();
        }
    }

    public Object getKeyframe(Object obj, int i11, int i12) {
        if (this.mMotionLayout.mScene == null) {
            return null;
        }
        int id2 = ((View) obj).getId();
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), i11, id2, i12);
    }
}
