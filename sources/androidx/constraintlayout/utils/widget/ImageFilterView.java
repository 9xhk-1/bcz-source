...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f12 != 1.0f) {
                this.mTmpColorMatrix.setScale(f12, f12, f12, 1.0f);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z11 = true;
            }
            float f13 = this.mWarmth;
            if (f13 != 1.0f) {
                warmth(f13);
    ...
    private void setMatrix() {
        ...
        float f11 = Float.isNaN(this.mPanX) ? 0.0f : this.mPanX;
        float f12 = Float.isNaN(this.mPanY) ? 0.0f : this.mPanY;
        float f13 = Float.isNaN(this.mZoom) ? 1.0f : this.mZoom;
        float f14 = Float.isNaN(this.mRotate) ? 0.0f : this.mRotate;
    ...
    public void setBrightness(float f11) {
        ...
        imageMatrix.mBrightness = f11;
        imageMatrix.updateMatrix(this);
    }

    public void setContrast(float f11) {
        ImageMatrix imageMatrix = this.mImageMatrix;
        imageMatrix.mContrast = f11;
        imageMatrix.updateMatrix(this);
    }
    ...
    public void setRoundPercent(float f11) {
        boolean z11 = this.mRoundPercent != f11;
    ...
    public void setSaturation(float f11) {
        ImageMatrix imageMatrix = this.mImageMatrix;
        imageMatrix.mSaturation = f11;
        imageMatrix.updateMatrix(this);
    }

    public void setWarmth(float f11) {
        ImageMatrix imageMatrix = this.mImageMatrix;
        imageMatrix.mWarmth = f11;
        imageMatrix.updateMatrix(this);
    }
