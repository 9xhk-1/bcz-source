...
public class MockView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f12 = height;
            canvas2 = canvas;
            canvas2.drawLine(0.0f, 0.0f, f11, f12, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f12, f11, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, f11, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(f11, 0.0f, f11, f12, this.mPaintDiagonals);
            canvas2.drawLine(f11, f12, 0.0f, f12, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f12, 0.0f, 0.0f, this.mPaintDiagonals);
        } else {
            canvas2 = canvas;
        }
