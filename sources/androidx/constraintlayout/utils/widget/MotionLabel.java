...
public class MotionLabel extends View implements FloatLayout {
    ...
    private float getHorizontalOffset() {
        float f11 = Float.isNaN(this.mBaseTextSize) ? 1.0f : this.mTextSize / this.mBaseTextSize;
        TextPaint textPaint = this.mPaint;
        String str = this.mText;
        return (((((Float.isNaN(this.mFloatWidth) ? getMeasuredWidth() : this.mFloatWidth) - getPaddingLeft()) - getPaddingRight()) - (f11 * textPaint.measureText(str, 0, str.length()))) * (this.mTextPanX + 1.0f)) / 2.0f;
    }
    ...
    private float getVerticalOffset() {
        ...
        return (((measuredHeight - ((f12 - f13) * f11)) * (1.0f - this.mTextPanY)) / 2.0f) - (f11 * f13);
    }
    ...
    private void setTypefaceFromAttrs(String str, int i11, int i12) {
        ...
        if (i12 <= 0) {
            ...
            this.mPaint.setFakeBoldText((i13 & 1) != 0);
            this.mPaint.setTextSkewX((i13 & 2) != 0 ? -0.25f : 0.0f);
        }
    }
    ...
    private void updateShaderMatrix() {
        float f11 = Float.isNaN(this.mBackgroundPanX) ? 0.0f : this.mBackgroundPanX;
        float f12 = Float.isNaN(this.mBackgroundPanY) ? 0.0f : this.mBackgroundPanY;
        ...
        float f15 = Float.isNaN(this.mTextureWidth) ? this.mFloatWidth : this.mTextureWidth;
        float f16 = Float.isNaN(this.mTextureHeight) ? this.mFloatHeight : this.mTextureHeight;
        ...
        if (!Float.isNaN(this.mTextureHeight)) {
            f22 = this.mTextureHeight / 2.0f;
        }
        if (!Float.isNaN(this.mTextureWidth)) {
            f19 = this.mTextureWidth / 2.0f;
        }
        this.mTextShaderMatrix.postTranslate((((f11 * f19) + f15) - f18) * 0.5f, (((f12 * f22) + f16) - f21) * 0.5f);
        this.mTextShaderMatrix.postRotate(f14, f15 / 2.0f, f16 / 2.0f);
    ...
    public void buildShape(float f11) {
        if (this.mUseOutline || f11 != 1.0f) {
            ...
            if (f11 != 1.0f) {
                Log.v(TAG, Debug.getLoc() + " scale " + f11);
    ...
    public void layout(int i11, int i12, int i13, int i14) {
        ...
        float f11 = isNaN ? 1.0f : this.mTextSize / this.mBaseTextSize;
        this.mFloatWidth = i13 - i11;
        this.mFloatHeight = i14 - i12;
        if (this.mAutoSize) {
            ...
            float f12 = (this.mFloatWidth - this.mPaddingRight) - this.mPaddingLeft;
            float f13 = (this.mFloatHeight - this.mPaddingBottom) - this.mPaddingTop;
            if (isNaN) {
                float f14 = width;
                float f15 = height;
                if (f14 * f13 > f15 * f12) {
                    ...
                    this.mPaint.setTextSize((this.mPaintTextSize * f13) / f15);
                }
            } else {
                float f16 = width;
                float f17 = height;
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        this.mOutlinePositionMatrix.preScale(f11, f11);
        this.mPath.transform(this.mOutlinePositionMatrix);
    ...
    public void setTextBackgroundPanX(float f11) {
        this.mBackgroundPanX = f11;
        updateShaderMatrix();
        invalidate();
    }

    public void setTextBackgroundPanY(float f11) {
        this.mBackgroundPanY = f11;
        updateShaderMatrix();
        invalidate();
    }
    ...
    public void layout(float f11, float f12, float f13, float f14) {
        ...
        if (this.mAutoSize) {
            ...
            float f17 = (f15 - this.mPaddingRight) - this.mPaddingLeft;
            float f18 = (f16 - this.mPaddingBottom) - this.mPaddingTop;
            float width = this.mTempRect.width();
            if (width * f18 > height * f17) {
                this.mPaint.setTextSize((this.mPaintTextSize * f17) / width);
            } else {
                this.mPaint.setTextSize((this.mPaintTextSize * f18) / height);
            }
