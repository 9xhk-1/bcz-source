...
public class ConstraintAttribute {
    ...
    public static HashMap<String, ConstraintAttribute> extractAttributes(HashMap<String, ConstraintAttribute> hashMap, View view) {
        ...
        for (String str : hashMap.keySet()) {
            ...
            try {
                ...
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e11);
            } catch (NoSuchMethodException e12) {
                Log.e(TAG, cls.getName() + " must have a method " + str, e12);
            } catch (InvocationTargetException e13) {
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e13);
            }
        }
        return hashMap2;
    }
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            ConstraintAttribute constraintAttribute = hashMap.get(str);
            String str2 = constraintAttribute.mMethod ? str : d.f46854h + str;
            try {
                ...
                Log.e(TAG, cls.getName() + " must have a method " + str2, e12);
            } catch (InvocationTargetException e13) {
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e13);
            }
        }
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            Log.e(TAG, " Custom Attribute \"" + str2 + "\" not found on " + cls.getName(), e11);
        } catch (NoSuchMethodException e12) {
            Log.e(TAG, cls.getName() + " must have a method " + str, e12);
        } catch (InvocationTargetException e13) {
            Log.e(TAG, " Custom Attribute \"" + str2 + "\" not found on " + cls.getName(), e13);
        }
    }
