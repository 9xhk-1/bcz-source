...
public class ConstraintLayoutStates {
    ...
    public void updateConstraints(int i11, float f11, float f12) {
        ...
        if (i12 == i11) {
            State valueAt = i11 == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(i12);
            int i13 = this.mCurrentConstraintNumber;
            if ((i13 == -1 || !valueAt.mVariants.get(i13).match(f11, f12)) && this.mCurrentConstraintNumber != (findMatch = valueAt.findMatch(f11, f12))) {
                ConstraintSet constraintSet = findMatch == -1 ? this.mDefaultConstraintSet : valueAt.mVariants.get(findMatch).mConstraintSet;
                int i14 = findMatch == -1 ? valueAt.mConstraintID : valueAt.mVariants.get(findMatch).mConstraintID;
        ...
        int i15 = findMatch2 == -1 ? state.mConstraintID : state.mVariants.get(findMatch2).mConstraintID;
        if (constraintSet2 == null) {
            Log.v("ConstraintLayoutStates", "NO Constraint set found ! id=" + i11 + ", dim =" + f11 + j2.O + f12);
            return;
        }
