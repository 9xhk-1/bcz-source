...
public class ConstraintLayoutStatistics {
    ...
    private String compare(DecimalFormat decimalFormat, ConstraintLayoutStatistics constraintLayoutStatistics, int i11) {
        String str = fmt(decimalFormat, getValue(i11) * 1.0E-6f, 7) + " -> " + fmt(decimalFormat, constraintLayoutStatistics.getValue(i11) * 1.0E-6f, 7) + "ms";
        String str2 = WORD_PAD + geName(i11);
        return "CL Perf: " + (str2.substring(str2.length() - MAX_WORD) + " = ") + str;
    }

    private String fmt(DecimalFormat decimalFormat, float f11, int i11) {
    ...
    public ConstraintLayoutStatistics m5599clone() {
    ...
    private String compare(ConstraintLayoutStatistics constraintLayoutStatistics, int i11) {
        String str = getValue(i11) + " -> " + constraintLayoutStatistics.getValue(i11);
        String str2 = WORD_PAD + geName(i11);
        return "CL Perf: " + (str2.substring(str2.length() - MAX_WORD) + " = ") + str;
    }

    private String log(DecimalFormat decimalFormat, int i11) {
        String fmt = fmt(decimalFormat, getValue(i11) * 1.0E-6f, 7);
        String str = WORD_PAD + geName(i11);
        return "CL Perf: " + (str.substring(str.length() - MAX_WORD) + " = ") + fmt;
    }

    private String log(int i11) {
        String l11 = Long.toString(getValue(i11));
        String str = WORD_PAD + geName(i11);
        return "CL Perf: " + (str.substring(str.length() - MAX_WORD) + " = ") + l11;
    }
}
