...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        public FrameMetricsApi24Impl(int i11) {
            this.mTrackingFlags = i11;
        }
        ...
        public void add(Activity activity) {
            ...
            for (int i11 = 0; i11 <= 8; i11++) {
                ...
                if (sparseIntArrayArr[i11] == null && (this.mTrackingFlags & (1 << i11)) != 0) {
        ...
        public void addDurationItem(SparseIntArray sparseIntArray, long j11) {
    ...
    public FrameMetricsAggregator(int i11) {
        this.mInstance = new FrameMetricsApi24Impl(i11);
    }
