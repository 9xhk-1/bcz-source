...
public final class GrammaticalInflectionManagerCompat {
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static void setRequestedApplicationGrammaticalGender(Context context, int i11) {
            getGrammaticalInflectionManager(context).setRequestedApplicationGrammaticalGender(i11);
        }
    }
    ...
    @AnyThread
    @OptIn(markerClass = {BuildCompat.PrereleaseSdkCheck.class})
    public static void setRequestedApplicationGrammaticalGender(@NonNull Context context, int i11) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setRequestedApplicationGrammaticalGender(context, i11);
        }
    }
}
