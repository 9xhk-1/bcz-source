...
public abstract class JobIntentService extends Service {
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        public JobWorkEnqueuer(Context context, ComponentName componentName, int i11) {
            super(componentName);
            ensureJobId(i11);
            this.mJobInfo = new JobInfo.Builder(i11, this.mComponentName).setOverrideDeadline(0L).build();
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z11, int i11) {
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int i11, @NonNull Intent intent) {
        ...
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, i11);
            workEnqueuer.ensureJobId(i11);
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i11) {
            if (!this.mHasJobId) {
                this.mHasJobId = true;
                this.mJobId = i11;
            } else {
                ...
                throw new IllegalArgumentException("Given job ID " + i11 + " is different than previous " + this.mJobId);
            }
        }
