...
public class NotificationChannelCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static NotificationChannel createNotificationChannel(String str, CharSequence charSequence, int i11) {
            return new NotificationChannel(str, charSequence, i11);
        }

        @DoNotInline
        public static void enableLights(NotificationChannel notificationChannel, boolean z11) {
            notificationChannel.enableLights(z11);
        }

        @DoNotInline
        public static void enableVibration(NotificationChannel notificationChannel, boolean z11) {
        ...
        @DoNotInline
        public static void setLightColor(NotificationChannel notificationChannel, int i11) {
            notificationChannel.setLightColor(i11);
        }

        @DoNotInline
        public static void setShowBadge(NotificationChannel notificationChannel, boolean z11) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str, int i11) {
            this.mChannel = new NotificationChannelCompat(str, i11);
        }
        ...
        public Builder setImportance(int i11) {
            this.mChannel.mImportance = i11;
            return this;
        }

        @NonNull
        public Builder setLightColor(int i11) {
            this.mChannel.mLightColor = i11;
            return this;
        }

        @NonNull
        public Builder setLightsEnabled(boolean z11) {
            this.mChannel.mLights = z11;
            return this;
        }
        ...
        public Builder setVibrationEnabled(boolean z11) {
            this.mChannel.mVibrationEnabled = z11;
            return this;
        }
    ...
    public NotificationChannel getNotificationChannel() {
        ...
        if (i11 >= 30 && (str = this.mParentId) != null && (str2 = this.mConversationId) != null) {
