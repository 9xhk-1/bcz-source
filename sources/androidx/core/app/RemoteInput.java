...
public final class RemoteInput {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static RemoteInput.Builder setAllowDataType(RemoteInput.Builder builder, String str, boolean z11) {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static RemoteInput.Builder setEditChoicesBeforeSending(RemoteInput.Builder builder, int i11) {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAllowDataType(@NonNull String str, boolean z11) {
            if (z11) {
        ...
        @NonNull
        public Builder setAllowFreeFormInput(boolean z11) {
            this.mAllowFreeFormTextInput = z11;
            return this;
        }
        ...
        @NonNull
        public Builder setEditChoicesBeforeSending(int i11) {
            this.mEditChoicesBeforeSending = i11;
            return this;
        }
    ...
    public static android.app.RemoteInput[] fromCompat(RemoteInput[] remoteInputArr) {
        ...
        for (int i11 = 0; i11 < remoteInputArr.length; i11++) {
            remoteInputArr2[i11] = fromCompat(remoteInputArr[i11]);
        }
    ...
    public static void setResultsSource(@NonNull Intent intent, int i11) {
        if (Build.VERSION.SDK_INT >= 28) {
            Api28Impl.setResultsSource(intent, i11);
            return;
        }
        Intent clipDataIntentFromIntent = getClipDataIntentFromIntent(intent);
        if (clipDataIntentFromIntent == null) {
        ...
        clipDataIntentFromIntent.putExtra(EXTRA_RESULTS_SOURCE, i11);
        intent.setClipData(ClipData.newIntent(RESULTS_CLIP_LABEL, clipDataIntentFromIntent));
    }
