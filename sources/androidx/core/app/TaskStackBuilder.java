...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    @Nullable
    public Intent editIntentAt(int i11) {
        return this.mIntents.get(i11);
    }

    @Deprecated
    public Intent getIntent(int i11) {
        return editIntentAt(i11);
    }
    ...
    public Intent[] getIntents() {
        ...
        if (size != 0) {
            ...
            for (int i11 = 1; i11 < size; i11++) {
                intentArr[i11] = new Intent(this.mIntents.get(i11));
            }
        }
        return intentArr;
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i11, int i12) {
        return getPendingIntent(i11, i12, null);
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i11, int i12, @Nullable Bundle bundle) {
        if (this.mIntents.isEmpty()) {
            throw new IllegalStateException("No intents added to TaskStackBuilder; cannot getPendingIntent");
        }
        Intent[] intentArr = (Intent[]) this.mIntents.toArray(new Intent[0]);
        intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
        return PendingIntent.getActivities(this.mSourceContext, i11, intentArr, i12, bundle);
    }
