...
public class ContextCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static Intent registerReceiver(Context context, @Nullable BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i11) {
            return ((i11 & 4) == 0 || str != null) ? context.registerReceiver(broadcastReceiver, intentFilter, str, handler, i11 & 1) : context.registerReceiver(broadcastReceiver, intentFilter, ContextCompat.obtainAndCheckReceiverPermission(context), handler);
        }
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(CameraManager.class, PermissionStatusUtilKt.PERMISSION_CAMERA);
            ...
            hashMap.put(DisplayManager.class, CommonConstant.ReqAccessTokenParam.DISPLAY_LABEL);
            hashMap.put(UserManager.class, "user");
            hashMap.put(InputManager.class, "input");
            hashMap.put(MediaRouter.class, "media_router");
            hashMap.put(NsdManager.class, "servicediscovery");
            hashMap.put(AccessibilityManager.class, "accessibility");
            hashMap.put(AccountManager.class, AccountVerificationActivity.f19910x);
            ...
            hashMap.put(LocationManager.class, kc.u.S);
            hashMap.put(NfcManager.class, "nfc");
            hashMap.put(NotificationManager.class, "notification");
            hashMap.put(PowerManager.class, c6.d.f8118j);
    ...
    public static int getColor(@NonNull Context context, @ColorRes int i11) {
        return Api23Impl.getColor(context, i11);
    }
    ...
    public static Drawable getDrawable(@NonNull Context context, @DrawableRes int i11) {
        return Api21Impl.getDrawable(context, i11);
    }
    ...
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i11) {
        ...
        return i15 >= 33 ? Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i13) : i15 >= 26 ? Api26Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i13) : ((i13 & 4) == 0 || str != null) ? context.registerReceiver(broadcastReceiver, intentFilter, str, handler) : context.registerReceiver(broadcastReceiver, intentFilter, obtainAndCheckReceiverPermission(context), handler);
    }
