...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i11, int i12, @Nullable String str2) {
        ...
        return ((Process.myUid() != i12 || !ObjectsCompat.equals(context.getPackageName(), str2)) ? AppOpsManagerCompat.noteProxyOpNoThrow(context, permissionToOp, str2) : AppOpsManagerCompat.checkOrNoteProxyOp(context, i12, permissionToOp, str2)) == 0 ? 0 : -2;
    }
