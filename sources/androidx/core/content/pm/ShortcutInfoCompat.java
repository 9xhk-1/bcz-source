...
public class ShortcutInfoCompat {
    ...
    public static class Api33Impl {
        ...
        public static void setExcludedFromSurfaces(@NonNull ShortcutInfo.Builder builder, int i11) {
    ...
    public static class Builder {
        ...
        public Builder setExcludedFromSurfaces(int i11) {
            this.mInfo.mExcludedSurfaces = i11;
            return this;
        }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i11 < this.mPersons.length) {
                ...
                int i12 = i11 + 1;
                sb2.append(i12);
                persistableBundle.putPersistableBundle(sb2.toString(), this.mPersons[i11].toPersistableBundle());
                i11 = i12;
            }
        }
