...
public class ShortcutManagerCompat {
    ...
    public static boolean convertUriIconToBitmapIcon(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        shortcutInfoCompat.mIcon = i11 == 6 ? IconCompat.createWithAdaptiveBitmap(decodeStream) : IconCompat.createWithBitmap(decodeStream);
        return true;
    }
    ...
    public static Intent createShortcutResultIntent(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        Intent createShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? x0.a(context.getSystemService(m0.a())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    private static int getIconDimensionInternal(@NonNull Context context, boolean z11) {
        ...
        return (int) (max * ((z11 ? displayMetrics.xdpi : displayMetrics.ydpi) / 160.0f));
    }
    ...
    private static String getShortcutInfoCompatWithLowestRank(@NonNull List<ShortcutInfoCompat> list) {
        ...
        for (ShortcutInfoCompat shortcutInfoCompat : list) {
            if (shortcutInfoCompat.getRank() > i11) {
                str = shortcutInfoCompat.getId();
                i11 = shortcutInfoCompat.getRank();
            }
        }
        return str;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i11) {
        ...
        if (i12 >= 30) {
            shortcuts = x0.a(context.getSystemService(m0.a())).getShortcuts(i11);
        ...
        ShortcutManager a11 = x0.a(context.getSystemService(m0.a()));
        ArrayList arrayList = new ArrayList();
        if ((i11 & 1) != 0) {
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        int i11 = Build.VERSION.SDK_INT;
        if (i11 <= 32 && shortcutInfoCompat.isExcludedFromSurfaces(1)) {
            Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
            while (it.hasNext()) {
        ...
        if (i11 >= 30) {
            ...
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                a11.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            a11.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
    ...
    private static List<ShortcutInfoCompat> removeShortcutsExcludedFromSurface(@NonNull List<ShortcutInfoCompat> list, int i11) {
        ...
        for (ShortcutInfoCompat shortcutInfoCompat : list) {
            if (shortcutInfoCompat.isExcludedFromSurfaces(i11)) {
