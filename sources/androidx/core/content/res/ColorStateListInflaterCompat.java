...
public final class ColorStateListInflaterCompat {
    ...
    @Nullable
    public static ColorStateList inflate(@NonNull Resources resources, @XmlRes int i11, @Nullable Resources.Theme theme) {
        try {
            return createFromXml(resources, resources.getXml(i11), theme);
        } catch (Exception e11) {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i11, @FloatRange(from = 0.0d, to = 1.0d) float f11, @FloatRange(from = 0.0d, to = 100.0d) float f12) {
        boolean z11 = f12 >= 0.0f && f12 <= 100.0f;
        if (f11 == 1.0f && !z11) {
            return i11;
        }
        int clamp = MathUtils.clamp((int) ((Color.alpha(i11) * f11) + 0.5f), 0, 255);
        if (z11) {
            CamColor fromColor = CamColor.fromColor(i11);
            i11 = CamColor.toColor(fromColor.getHue(), fromColor.getChroma(), f12);
        }
        return (i11 & 16777215) | (clamp << 24);
    }
