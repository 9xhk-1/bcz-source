...
final class GrowingArrayUtils {
    ...
    public static <T> T[] append(T[] tArr, int i11, T t11) {
        if (i11 + 1 > tArr.length) {
            ?? r02 = (Object[]) Array.newInstance(tArr.getClass().getComponentType(), growSize(i11));
    ...
    public static <T> T[] insert(T[] tArr, int i11, int i12, T t11) {
        ...
        T[] tArr2 = (T[]) ((Object[]) Array.newInstance(tArr.getClass().getComponentType(), growSize(i11)));
