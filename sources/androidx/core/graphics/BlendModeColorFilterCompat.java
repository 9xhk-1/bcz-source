...
public class BlendModeColorFilterCompat {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static ColorFilter createBlendModeColorFilter(int i11, Object obj) {
    ...
    public static ColorFilter createBlendModeColorFilterCompat(int i11, @NonNull BlendModeCompat blendModeCompat) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (obtainBlendModeFromCompat != null) {
                return Api29Impl.createBlendModeColorFilter(i11, obtainBlendModeFromCompat);
            }
            return null;
        }
        PorterDuff.Mode obtainPorterDuffFromCompat = BlendModeUtils.obtainPorterDuffFromCompat(blendModeCompat);
        if (obtainPorterDuffFromCompat != null) {
            return new PorterDuffColorFilter(i11, obtainPorterDuffFromCompat);
        }
        return null;
    }
}
