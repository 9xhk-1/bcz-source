...
public final class Insets {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static android.graphics.Insets of(int i11, int i12, int i13, int i14) {
    ...
    public static Insets of(int i11, int i12, int i13, int i14) {
        return (i11 == 0 && i12 == 0 && i13 == 0 && i14 == 0) ? NONE : new Insets(i11, i12, i13, i14);
    }
    ...
    public String toString() {
        return "Insets{left=" + this.left + ", top=" + this.top + ", right=" + this.right + ", bottom=" + this.bottom + l50.b.f69928j;
    }
