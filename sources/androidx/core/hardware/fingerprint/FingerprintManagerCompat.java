...
public class FingerprintManagerCompat {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static void authenticate(Object obj, Object obj2, CancellationSignal cancellationSignal, int i11, Object obj3, Handler handler) {
    ...
    public void authenticate(@Nullable CryptoObject cryptoObject, int i11, @Nullable androidx.core.os.CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        authenticate(cryptoObject, i11, cancellationSignal != null ? (CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, authenticationCallback, handler);
    }
    ...
    @RequiresPermission("android.permission.USE_FINGERPRINT")
    public void authenticate(@Nullable CryptoObject cryptoObject, int i11, @Nullable CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        FingerprintManager fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext);
        if (fingerprintManagerOrNull != null) {
            Api23Impl.authenticate(fingerprintManagerOrNull, wrapCryptoObject(cryptoObject), cancellationSignal, i11, wrapCallback(authenticationCallback), handler);
        }
    }
    ...
    public static abstract class AuthenticationCallback {
        ...
        public void onAuthenticationHelp(int i11, @NonNull CharSequence charSequence) {
        }
    }
}
