...
public final class LocationCompat {
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static void setMslAltitudeAccuracyMeters(Location location, float f11) {
            location.setMslAltitudeAccuracyMeters(f11);
        }

        @DoNotInline
        public static void setMslAltitudeMeters(Location location, double d11) {
            location.setMslAltitudeMeters(d11);
        }
    }
    ...
    public static void setMslAltitudeAccuracyMeters(@NonNull Location location, @FloatRange(from = 0.0d) float f11) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setMslAltitudeAccuracyMeters(location, f11);
        } else {
    ...
    public static void setMslAltitudeMeters(@NonNull Location location, double d11) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setMslAltitudeMeters(location, d11);
        } else {
    ...
    public static void setVerticalAccuracyMeters(@NonNull Location location, float f11) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            getOrCreateExtras(location).putFloat(EXTRA_VERTICAL_ACCURACY, f11);
        }
    }
}
