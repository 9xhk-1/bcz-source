...
public final class ParcelCompat {
    ...
    public static <T extends Parcelable> T readParcelable(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        throw new BadParcelableException("Parcelable " + t11.getClass() + " is not a subclass of required class " + cls.getName() + " provided in the parameter");
    }
    ...
    public static <T> T[] readParcelableArray(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        for (int i11 = 0; i11 < tArr.length; i11++) {
            try {
                tArr2[i11] = cls.cast(tArr[i11]);
            } catch (ClassCastException unused) {
                throw new BadParcelableException("Parcelable at index " + i11 + " is not a subclass of required class " + cls.getName() + " provided in the parameter");
            }
        }
        return tArr2;
    }
