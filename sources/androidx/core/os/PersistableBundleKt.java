...
public final class PersistableBundleKt {
    @RequiresApi(21)
    @k
    public static final PersistableBundle persistableBundleOf(@k Pair<String, ? extends Object>... pairArr) {
    ...
    @RequiresApi(21)
    @k
    public static final PersistableBundle toPersistableBundle(@k Map<String, ? extends Object> map) {
