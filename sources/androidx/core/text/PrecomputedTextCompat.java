...
public class PrecomputedTextCompat implements Spannable {
    ...
    public int getParagraphEnd(@IntRange(from = 0) int i11) {
        ...
        paragraphEnd = this.mWrapped.getParagraphEnd(i11);
        return paragraphEnd;
    }
    ...
    public int getParagraphStart(@IntRange(from = 0) int i11) {
        ...
        Preconditions.checkArgumentInRange(i11, 0, getParagraphCount(), "paraIndex");
        if (Build.VERSION.SDK_INT >= 29) {
            paragraphStart = this.mWrapped.getParagraphStart(i11);
    ...
    public <T> T[] getSpans(int i11, int i12, Class<T> cls) {
        Object[] spans;
        if (Build.VERSION.SDK_INT < 29) {
            return (T[]) this.mText.getSpans(i11, i12, cls);
        }
        spans = this.mWrapped.getSpans(i11, i12, cls);
        return (T[]) spans;
    }
