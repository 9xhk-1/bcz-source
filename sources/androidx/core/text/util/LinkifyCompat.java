...
public final class LinkifyCompat {
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i12 < size - 1) {
            ...
            if (i14 <= i15 && (i11 = linkSpec2.end) > i15) {
                int i16 = linkSpec3.end;
                int i17 = (i16 > i11 && i11 - i14 <= i16 - i15) ? i11 - i14 < i16 - i15 ? i12 : -1 : i13;
                if (i17 != -1) {
                    Object obj = arrayList.get(i17).frameworkAddedSpan;
                    if (obj != null) {
    ...
    public static boolean addLinks(@NonNull TextView textView, int i11) {
        ...
        if (text instanceof Spannable) {
            if (addLinks((Spannable) text, i11)) {
                addLinkMovementMethod(textView);
                return true;
            }
        } else {
            SpannableString valueOf = SpannableString.valueOf(text);
            if (addLinks(valueOf, i11)) {
                addLinkMovementMethod(textView);
