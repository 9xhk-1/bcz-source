...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public boolean performAccessibilityAction(View view, int i11, Bundle bundle) {
            return this.mCompat.performAccessibilityAction(view, i11, bundle);
        }

        @Override // android.view.View.AccessibilityDelegate
        public void sendAccessibilityEvent(View view, int i11) {
            this.mCompat.sendAccessibilityEvent(view, i11);
        }
    ...
    private boolean isSpanStillValid(ClickableSpan clickableSpan, View view) {
        if (clickableSpan != null) {
            ...
            for (int i11 = 0; clickableSpans != null && i11 < clickableSpans.length; i11++) {
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i11, @Nullable Bundle bundle) {
        ...
        return (z11 || i11 != R.id.accessibility_action_clickable_span || bundle == null) ? z11 : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
