...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        public void setInsets(int i11, @NonNull Insets insets) {
            if (this.mInsetsTypeMask == null) {
                this.mInsetsTypeMask = new Insets[9];
            }
            for (int i12 = 1; i12 <= 256; i12 <<= 1) {
                if ((i11 & i12) != 0) {
                    this.mInsetsTypeMask[Type.indexOf(i12)] = insets;
                }
            }
        }

        public void setInsetsIgnoringVisibility(int i11, @NonNull Insets insets) {
            if (i11 == 8) {
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        public void setInsets(int i11, @NonNull Insets insets) {
            this.mPlatBuilder.setInsets(TypeImpl30.toPlatformType(i11), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsetsIgnoringVisibility(int i11, @NonNull Insets insets) {
            this.mPlatBuilder.setInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i11), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setVisible(int i11, boolean z11) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i11), z11);
        }
    ...
    public static class Impl20 extends Impl {
        ...
        @NonNull
        public Insets getInsetsForType(int i11, boolean z11) {
            Insets stableInsets;
            int i12;
            if (i11 == 1) {
                return z11 ? Insets.of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0) : Insets.of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i11 == 2) {
                if (z11) {
                ...
                int i13 = systemWindowInsets.bottom;
                if (stableInsets != null) {
                    i13 = Math.min(i13, stableInsets.bottom);
                }
                return Insets.of(systemWindowInsets.left, 0, systemWindowInsets.right, i13);
            }
            if (i11 != 8) {
                if (i11 == 16) {
            ...
            int i14 = systemWindowInsets2.bottom;
            if (i14 > rootStableInsets2.bottom) {
                return Insets.of(0, 0, 0, i14);
            }
            Insets insets = this.mRootViewVisibleInsets;
            return (insets == null || insets.equals(Insets.NONE) || (i12 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.of(0, 0, 0, i12);
        }
        ...
        public WindowInsetsCompat inset(int i11, int i12, int i13, int i14) {
            ...
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i11, i12, i13, i14));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i11, i12, i13, i14));
        ...
        public boolean isTypeVisible(int i11) {
            ...
            return !getInsetsForType(i11, false).equals(Insets.NONE);
        }
        ...
        private Insets getInsets(int i11, boolean z11) {
            ...
            for (int i12 = 1; i12 <= 256; i12 <<= 1) {
                if ((i11 & i12) != 0) {
                    insets = Insets.max(insets, getInsetsForType(i12, z11));
                }
            }
            return insets;
        }
    ...
    public static class Impl30 extends Impl29 {
        ...
        public Insets getInsets(int i11) {
            ...
            insets = this.mPlatformInsets.getInsets(TypeImpl30.toPlatformType(i11));
        ...
        public Insets getInsetsIgnoringVisibility(int i11) {
            ...
            insetsIgnoringVisibility = this.mPlatformInsets.getInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i11));
        ...
        public boolean isVisible(int i11) {
            boolean isVisible;
            isVisible = this.mPlatformInsets.isVisible(TypeImpl30.toPlatformType(i11));
            return isVisible;
        }
    ...
    public static final class TypeImpl30 {
        ...
        public static int toPlatformType(int i11) {
            int statusBars;
            int i12 = 0;
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i11, int i12, int i13, int i14) {
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = androidx.core.splashscreen.h.a();
        }
        ...
        public BuilderImpl29(@NonNull WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                a11 = i1.a(windowInsets);
            } else {
                a11 = androidx.core.splashscreen.h.a();
            }
            this.mPlatBuilder = a11;
        }
    }
    ...
    public WindowInsetsCompat inset(@IntRange(from = 0) int i11, @IntRange(from = 0) int i12, @IntRange(from = 0) int i13, @IntRange(from = 0) int i14) {
        return this.mImpl.inset(i11, i12, i13, i14);
    }
    ...
    public static final class Builder {
        ...
        public Builder setInsets(int i11, @NonNull Insets insets) {
            this.mImpl.setInsets(i11, insets);
            return this;
        }

        @NonNull
        public Builder setInsetsIgnoringVisibility(int i11, @NonNull Insets insets) {
            this.mImpl.setInsetsIgnoringVisibility(i11, insets);
            return this;
        }
