...
public class AccessibilityWindowInfoCompat {
    ...
    public static class Api33Impl {
        ...
        @DoNotInline
        public static AccessibilityNodeInfoCompat getRoot(Object obj, int i11) {
    ...
    public AccessibilityWindowInfoCompat getChild(int i11) {
        return wrapNonNullInstance(Api21Impl.getChild((AccessibilityWindowInfo) this.mInfo, i11));
    }
    ...
    public AccessibilityNodeInfoCompat getRoot(int i11) {
        if (Build.VERSION.SDK_INT >= 33) {
            return Api33Impl.getRoot(this.mInfo, i11);
        }
        return getRoot();
    }
