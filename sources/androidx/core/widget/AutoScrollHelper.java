...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long j11) {
            if (j11 < this.mStartTime) {
                return 0.0f;
            }
            long j12 = this.mStopTime;
            if (j12 < 0 || j11 < j12) {
                return AutoScrollHelper.constrain((j11 - r0) / this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
            }
            float f11 = this.mStopValue;
            return (1.0f - f11) + (f11 * AutoScrollHelper.constrain((j11 - j12) / this.mEffectiveRampDown, 0.0f, 1.0f));
        }
        ...
        public void computeScrollDelta() {
            ...
            long j11 = currentAnimationTimeMillis - this.mDeltaTime;
            this.mDeltaTime = currentAnimationTimeMillis;
            float f11 = j11 * interpolateValue;
    ...
    private float computeTargetVelocity(int i11, float f11, float f12, float f13) {
        ...
        float f17 = f14 * f13;
        return edgeValue > 0.0f ? constrain(edgeValue * f17, f15, f16) : -constrain((-edgeValue) * f17, f15, f16);
    }
    ...
    private void startAnimating() {
        ...
        if (this.mAlreadyDelayed || (i11 = this.mActivationDelay) <= 0) {
            ...
            ViewCompat.postOnAnimationDelayed(this.mTarget, this.mRunnable, i11);
        }
