...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public long getItemId(int i11) {
        Cursor cursor;
        if (this.mDataValid && (cursor = this.mCursor) != null && cursor.moveToPosition(i11)) {
    ...
    @Deprecated
    public void init(Context context, Cursor cursor, boolean z11) {
        init(context, cursor, z11 ? 1 : 2);
    }
    ...
    public void init(Context context, Cursor cursor, int i11) {
        if ((i11 & 1) == 1) {
            i11 |= 2;
        ...
        this.mRowIDColumn = z11 ? cursor.getColumnIndexOrThrow("_id") : -1;
        if ((i11 & 2) == 2) {
