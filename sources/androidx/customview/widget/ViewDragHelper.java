...
public class ViewDragHelper {
    ...
    private boolean checkNewEdgeDrag(float f11, float f12, int i11, int i12) {
        ...
        if ((this.mInitialEdgesTouched[i11] & i12) == i12 && (this.mTrackingEdges & i12) != 0 && (this.mEdgeDragsLocked[i11] & i12) != i12 && (this.mEdgeDragsInProgress[i11] & i12) != i12) {
            ...
            if (abs > i13 || abs2 > i13) {
                ...
                if ((this.mEdgeDragsInProgress[i11] & i12) == 0 && abs > this.mTouchSlop) {
                    return true;
                }
            }
        }
    ...
    private boolean checkTouchSlop(View view, float f11, float f12) {
        ...
        if (!z11 || !z12) {
            return z11 ? Math.abs(f11) > ((float) this.mTouchSlop) : z12 && Math.abs(f12) > ((float) this.mTouchSlop);
        }
    ...
    private void reportNewEdgeDrags(float f11, float f12, int i11) {
        ...
        boolean z11 = checkNewEdgeDrag;
        if (checkNewEdgeDrag(f12, f11, i11, 4)) {
            z11 = (checkNewEdgeDrag ? 1 : 0) | 4;
        }
        boolean z12 = z11;
    ...
    public boolean canScroll(@NonNull View view, boolean z11, int i11, int i12, int i13, int i14) {
        int i15;
        ...
        if (z11) {
            return view.canScrollHorizontally(-i11) || view.canScrollVertically(-i12);
        }
        return false;
    }
    ...
    public void captureChildView(@NonNull View view, int i11) {
        ...
        throw new IllegalArgumentException("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (" + this.mParentView + j.f81007d);
    }
    ...
    public void processTouchEvent(@NonNull MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            if (this.mDragState == 1) {
                if (isValidPointerForActionMove(this.mActivePointerId)) {
                    ...
                    int i17 = (int) (y12 - this.mLastMotionY[i15]);
            ...
            while (i12 < pointerCount) {
                ...
                if (isValidPointerForActionMove(pointerId2)) {
                    ...
                    float f11 = x13 - this.mInitialMotionX[pointerId2];
                    float f12 = y13 - this.mInitialMotionY[pointerId2];
        ...
        if (actionMasked == 5) {
            ...
            saveInitialMotion(x14, y14, pointerId3);
            if (this.mDragState != 0) {
                ...
                tryCaptureViewForDrag(findTopChildUnder((int) x14, (int) y14), pointerId3);
    ...
    public void setDragState(int i11) {
    ...
    */
    ...
    public boolean tryCaptureViewForDrag(View view, int i11) {
