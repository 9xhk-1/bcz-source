...
public class TextViewBindingAdapter {
    ...
    public static void setAutoText(TextView textView, boolean z11) {
        ...
        textView.setKeyListener(TextKeyListener.getInstance(z11, capitalize));
    }
    ...
    public static void setInputMethod(TextView textView, CharSequence charSequence) {
        try {
            ...
            Log.e(TAG, "Could not create input method: " + ((Object) charSequence), e13);
        }
    }
    ...
    public static void setLineSpacingExtra(TextView textView, float f11) {
        textView.setLineSpacing(f11, textView.getLineSpacingMultiplier());
    }

    @BindingAdapter({"android:lineSpacingMultiplier"})
    public static void setLineSpacingMultiplier(TextView textView, float f11) {
        textView.setLineSpacing(textView.getLineSpacingExtra(), f11);
    }

    @BindingAdapter({"android:maxLength"})
    public static void setMaxLength(TextView textView, int i11) {
        ...
        if (filters != null) {
            ...
            while (true) {
                if (i12 >= filters.length) {
                    ...
                    inputFilterArr[length] = new InputFilter.LengthFilter(i11);
                ...
                if (!(inputFilter instanceof InputFilter.LengthFilter)) {
                    i12++;
                } else if (((InputFilter.LengthFilter) inputFilter).getMax() != i11) {
    ...
    public static void setNumeric(TextView textView, int i11) {
        textView.setKeyListener(DigitsKeyListener.getInstance((i11 & 3) != 0, (i11 & 5) != 0));
    }

    @BindingAdapter({"android:password"})
    public static void setPassword(TextView textView, boolean z11) {
        if (z11) {
    ...
    public static void setPhoneNumber(TextView textView, boolean z11) {
        if (z11) {
    ...
    public static void setShadowColor(TextView textView, int i11) {
        textView.setShadowLayer(textView.getShadowRadius(), textView.getShadowDx(), textView.getShadowDy(), i11);
    }

    @BindingAdapter({"android:shadowDx"})
    public static void setShadowDx(TextView textView, float f11) {
        int shadowColor = textView.getShadowColor();
        textView.setShadowLayer(textView.getShadowRadius(), f11, textView.getShadowDy(), shadowColor);
    }

    @BindingAdapter({"android:shadowDy"})
    public static void setShadowDy(TextView textView, float f11) {
        int shadowColor = textView.getShadowColor();
        textView.setShadowLayer(textView.getShadowRadius(), textView.getShadowDx(), f11, shadowColor);
    }

    @BindingAdapter({"android:shadowRadius"})
    public static void setShadowRadius(TextView textView, float f11) {
        textView.setShadowLayer(f11, textView.getShadowDx(), textView.getShadowDy(), textView.getShadowColor());
    }
    ...
    public static void setTextSize(TextView textView, float f11) {
        ...
        TextWatcher textWatcher = (beforeTextChanged == null && afterTextChanged == null && onTextChanged == null && inverseBindingListener == null) ? null : new TextWatcher() { // from class: androidx.databinding.adapters.TextViewBindingAdapter.1
            ...
            public void beforeTextChanged(CharSequence charSequence, int i11, int i12, int i13) {
                ...
                if (beforeTextChanged2 != null) {
                    beforeTextChanged2.beforeTextChanged(charSequence, i11, i12, i13);
                }
            }
            ...
            public void onTextChanged(CharSequence charSequence, int i11, int i12, int i13) {
                ...
                if (onTextChanged2 != null) {
                    onTextChanged2.onTextChanged(charSequence, i11, i12, i13);
                }
    ...
    public static void setImeActionLabel(TextView textView, int i11) {
        textView.setImeActionLabel(textView.getImeActionLabel(), i11);
    }
}
