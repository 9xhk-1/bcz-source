...
public final class DataMigrationInitializer$Companion$getInitializer$1<T> extends SuspendLambda implements p<InitializerApi<T>, c<? super g2>, Object> {
    ...
    @Override // x00.p
    @l
    public final Object invoke(@k InitializerApi<T> initializerApi, @l c<? super g2> cVar) {
        return ((DataMigrationInitializer$Companion$getInitializer$1) create(initializerApi, cVar)).invokeSuspend(g2.f100423a);
    }
