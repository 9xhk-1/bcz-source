...
public final class DataStoreInMemoryCache<T> {
    ...
    @k
    private final y<State<T>> cachedValue;

    public DataStoreInMemoryCache() {
        UnInitialized unInitialized = UnInitialized.INSTANCE;
        g0.n(unInitialized, "null cannot be cast to non-null type androidx.datastore.core.State<T of androidx.datastore.core.DataStoreInMemoryCache>");
        this.cachedValue = o0.a(unInitialized);
    }
    ...
    @k
    public final i<State<T>> getFlow() {
    ...
    */
    public final androidx.datastore.core.State<T> tryUpdate(@m80.k androidx.datastore.core.State<T> r6) {
        /*
            r5 = this;
            java.lang.String r0 = "newState"
            kotlin.jvm.internal.g0.p(r6, r0)
            kotlinx.coroutines.flow.y<androidx.datastore.core.State<T>> r0 = r5.cachedValue
        L7:
