...
@d(c = "androidx.datastore.core.MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1", f = "MultiProcessCoordinator.android.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1 extends SuspendLambda implements p<r0, c<? super Integer>, Object> {
    int label;
    ...
    public final Object invoke(@k r0 r0Var, @l c<? super Integer> cVar) {
        return ((MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1) create(r0Var, cVar)).invokeSuspend(g2.f100423a);
    }
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        return l00.a.f(sharedCounter.getValue());
    }
}
