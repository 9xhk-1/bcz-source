...
public final class PreferencesFileSerializer implements Serializer<Preferences> {
    ...
    @l
    public Object readFrom(@k InputStream inputStream, @k c<? super Preferences> cVar) throws IOException, CorruptionException {
        ...
        for (Map.Entry<String, PreferencesProto.Value> entry : preferencesMap.entrySet()) {
            ...
            g0.o(name, "name");
            g0.o(value, "value");
            preferencesFileSerializer.addProtoEntryToPreferences(name, value, createMutable);
        }
        return createMutable.toPreferences();
    }

    @Override // androidx.datastore.core.Serializer
    public /* bridge */ /* synthetic */ Object writeTo(Preferences preferences, OutputStream outputStream, c cVar) {
        return writeTo2(preferences, outputStream, (c<? super g2>) cVar);
    }
    ...
    public Object writeTo2(@k Preferences preferences, @k OutputStream outputStream, @k c<? super g2> cVar) throws IOException, CorruptionException {
