...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f4365id] = fieldType52;
        }
    }

    private FieldType(String $enum$name, int $enum$ordinal, int id2, Collection collection, JavaType javaType) {
        int i11;
        this.f4365id = id2;
        this.collection = collection;
        this.javaType = javaType;
        int i12 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i12 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i11 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i11 == 2 || i11 == 3) ? false : true;
    }
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        for (int i13 = 0; i13 < typeParameters.length; i13++) {
                            if (type == typeParameters[i13]) {
                                actualTypeArguments[i12] = realTypes[i13];
                            }
                        }
