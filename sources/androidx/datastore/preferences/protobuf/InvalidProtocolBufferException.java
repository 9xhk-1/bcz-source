...
public class InvalidProtocolBufferException extends IOException {
    ...
    public InvalidProtocolBufferException(Exception e11) {
        super(e11.getMessage(), e11);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(String description, Exception e11) {
        super(description, e11);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(IOException e11) {
        super(e11.getMessage(), e11);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(String description, IOException e11) {
        super(description, e11);
        this.unfinishedMessage = null;
    }
}
