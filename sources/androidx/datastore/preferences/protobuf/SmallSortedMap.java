...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private int binarySearchInArray(K key) {
        ...
        int i12 = size - 1;
        if (i12 >= 0) {
            int compareTo = key.compareTo(this.entryList.get(i12).getKey());
            if (compareTo > 0) {
                i11 = size + 1;
                return -i11;
            }
        ...
        while (i13 <= i12) {
            int i14 = (i13 + i12) / 2;
            int compareTo2 = key.compareTo(this.entryList.get(i14).getKey());
            if (compareTo2 < 0) {
                i12 = i14 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    @Override // java.util.AbstractMap, java.util.Map
    public boolean containsKey(Object o11) {
        Comparable comparable = (Comparable) o11;
    ...
    public boolean equals(Object o11) {
        ...
        if (!(o11 instanceof SmallSortedMap)) {
            return super.equals(o11);
        }
        SmallSortedMap smallSortedMap = (SmallSortedMap) o11;
        int size = size();
