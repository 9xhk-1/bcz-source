...
class AnimationHandler {
    ...
    public void doAnimationFrame(long j11) {
        long uptimeMillis = SystemClock.uptimeMillis();
        for (int i11 = 0; i11 < this.mAnimationCallbacks.size(); i11++) {
            AnimationFrameCallback animationFrameCallback = this.mAnimationCallbacks.get(i11);
