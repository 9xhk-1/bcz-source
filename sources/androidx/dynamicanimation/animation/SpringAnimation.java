...
public final class SpringAnimation extends DynamicAnimation<SpringAnimation> {
    ...
    public float getAcceleration(float f11, float f12) {
        return this.mSpring.getAcceleration(f11, f12);
    }
    ...
    public boolean updateValueAndVelocity(long j11) {
        ...
        if (this.mPendingPosition != Float.MAX_VALUE) {
            ...
            long j12 = j11 / 2;
            DynamicAnimation.MassState updateValues = this.mSpring.updateValues(this.mValue, this.mVelocity, j12);
            this.mSpring.setFinalPosition(this.mPendingPosition);
            this.mPendingPosition = Float.MAX_VALUE;
            DynamicAnimation.MassState updateValues2 = this.mSpring.updateValues(updateValues.mValue, updateValues.mVelocity, j12);
            this.mValue = updateValues2.mValue;
            this.mVelocity = updateValues2.mVelocity;
        } else {
            DynamicAnimation.MassState updateValues3 = this.mSpring.updateValues(this.mValue, this.mVelocity, j11);
