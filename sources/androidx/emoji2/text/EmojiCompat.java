...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i11, @IntRange(from = 0) int i12, @IntRange(from = 0) int i13, boolean z11) {
            return charSequence;
        }
    }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        public int getEmojiEnd(@NonNull CharSequence charSequence, int i11) {
            return this.mProcessor.getEmojiEnd(charSequence, i11);
        }

        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiMatch(CharSequence charSequence, int i11) {
            return this.mProcessor.getEmojiMatch(charSequence, i11);
        }

        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiStart(@NonNull CharSequence charSequence, int i11) {
            return this.mProcessor.getEmojiStart(charSequence, i11);
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int i11, int i12, int i13, boolean z11) {
            return this.mProcessor.process(charSequence, i11, i12, i13, z11);
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int i11) {
            return this.mProcessor.getEmojiMatch(charSequence, i11) == 1;
        }
    }
    ...
    public static abstract class Config {
        ...
        public Config setEmojiSpanIndicatorColor(@ColorInt int i11) {
            this.mEmojiSpanIndicatorColor = i11;
            return this;
        }

        @NonNull
        public Config setEmojiSpanIndicatorEnabled(boolean z11) {
            this.mEmojiSpanIndicatorEnabled = z11;
            return this;
        }
        ...
        public Config setMetadataLoadStrategy(int i11) {
            this.mMetadataLoadStrategy = i11;
            return this;
        }

        @NonNull
        public Config setReplaceAll(boolean z11) {
            this.mReplaceAll = z11;
            return this;
        }
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z11, @Nullable List<Integer> list) {
            ...
            int i11 = 0;
            while (it.hasNext()) {
                this.mEmojiAsDefaultStyleExceptions[i11] = it.next().intValue();
                i11++;
            }
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i11, @IntRange(from = 0) int i12, boolean z11) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i11, i12, z11);
    }

    public static boolean handleOnKeyDown(@NonNull Editable editable, int i11, @NonNull KeyEvent keyEvent) {
        return EmojiProcessor.handleOnKeyDown(editable, i11, keyEvent);
    }
    ...
    public int getEmojiEnd(@NonNull CharSequence charSequence, @IntRange(from = 0) int i11) {
        ...
        return this.mHelper.getEmojiEnd(charSequence, i11);
    }
    ...
    public int getEmojiStart(@NonNull CharSequence charSequence, @IntRange(from = 0) int i11) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "charSequence cannot be null");
        return this.mHelper.getEmojiStart(charSequence, i11);
    }
    ...
    public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, @IntRange(from = 0) int i11) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
        return this.mHelper.hasEmojiGlyph(charSequence, i11);
    }
    ...
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i11, @IntRange(from = 0) int i12, @IntRange(from = 0) int i13, int i14) {
        ...
        if (i14 != 1) {
            z11 = i14 != 2 ? this.mReplaceAll : false;
        } else {
            z11 = true;
        }
        return this.mHelper.process(charSequence, i11, i12, i13, z11);
    }
