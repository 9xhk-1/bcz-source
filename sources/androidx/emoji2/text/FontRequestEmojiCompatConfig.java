...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    public static class ExponentialBackoffRetryPolicy extends RetryPolicy {
        ...
        public ExponentialBackoffRetryPolicy(long j11) {
            this.mTotalMs = j11;
        }
    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        private FontsContractCompat.FontInfo retrieveFontInfo() {
            try {
                ...
                throw new RuntimeException("fetchFonts failed (" + fetchFonts.getStatusCode() + j.f81007d);
        ...
        @RequiresApi(19)
        @WorkerThread
        private void scheduleRetry(Uri uri, long j11) {
            synchronized (this.mLock) {
                try {
                    Handler handler = this.mMainHandler;
                    if (handler == null) {
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    try {
                        ...
                        if (resultCode != 0) {
                            throw new RuntimeException("fetchFonts result is not OK. (" + resultCode + j.f81007d);
                        }
                        try {
