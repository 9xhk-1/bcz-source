...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, 13, 10, c.D, 10};
    ...
    public static class ExifAttribute {
        ...
        */
        ...
        public String toString() {
            return j.f81006c + ExifInterface.IFD_FORMAT_NAMES[this.format] + ", data length:" + this.bytes.length + j.f81007d;
        }
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, a.f48454z, 2), new ExifTag(TAG_STRIP_OFFSETS, a.A, 3, 4), new ExifTag(TAG_ORIENTATION, DefaultImageHeaderParser.f28794q, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, f.f11590g2, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, g.Q5, 4), new ExifTag(TAG_RW2_SENSOR_TOP_BORDER, 4, 4), new ExifTag(TAG_RW2_SENSOR_LEFT_BORDER, 5, 4), new ExifTag(TAG_RW2_SENSOR_BOTTOM_BORDER, 6, 4), new ExifTag(TAG_RW2_SENSOR_RIGHT_BORDER, 7, 4), new ExifTag(TAG_RW2_ISO, 23, 3), new ExifTag(TAG_RW2_JPG_FROM_RAW, 46, 7), new ExifTag(TAG_XMP, 700, 1)};
        IFD_TIFF_TAGS = exifTagArr;
        ExifTag[] exifTagArr2 = {new ExifTag(TAG_EXPOSURE_TIME, 33434, 5), new ExifTag(TAG_F_NUMBER, 33437, 5), new ExifTag(TAG_EXPOSURE_PROGRAM, 34850, 3), new ExifTag(TAG_SPECTRAL_SENSITIVITY, g.P5, 2), new ExifTag(TAG_PHOTOGRAPHIC_SENSITIVITY, g.S5, 3), new ExifTag(TAG_OECF, g.T5, 7), new ExifTag(TAG_SENSITIVITY_TYPE, g.f11714b6, 3), new ExifTag(TAG_STANDARD_OUTPUT_SENSITIVITY, g.f11720c6, 4), new ExifTag(TAG_RECOMMENDED_EXPOSURE_INDEX, g.f11726d6, 4), new ExifTag(TAG_ISO_SPEED, g.f11732e6, 4), new ExifTag(TAG_ISO_SPEED_LATITUDE_YYY, g.f11738f6, 4), new ExifTag(TAG_ISO_SPEED_LATITUDE_ZZZ, 34869, 4), new ExifTag(TAG_EXIF_VERSION, 36864, 2), new ExifTag(TAG_DATETIME_ORIGINAL, 36867, 2), new ExifTag(TAG_DATETIME_DIGITIZED, 36868, 2), new ExifTag(TAG_OFFSET_TIME, 36880, 2), new ExifTag(TAG_OFFSET_TIME_ORIGINAL, 36881, 2), new ExifTag(TAG_OFFSET_TIME_DIGITIZED, 36882, 2), new ExifTag(TAG_COMPONENTS_CONFIGURATION, 37121, 7), new ExifTag(TAG_COMPRESSED_BITS_PER_PIXEL, i.Jg, 5), new ExifTag(TAG_SHUTTER_SPEED_VALUE, 37377, 10), new ExifTag(TAG_APERTURE_VALUE, 37378, 5), new ExifTag(TAG_BRIGHTNESS_VALUE, 37379, 10), new ExifTag(TAG_EXPOSURE_BIAS_VALUE, 37380, 10), new ExifTag(TAG_MAX_APERTURE_VALUE, 37381, 5), new ExifTag(TAG_SUBJECT_DISTANCE, 37382, 5), new ExifTag(TAG_METERING_MODE, 37383, 3), new ExifTag(TAG_LIGHT_SOURCE, 37384, 3), new ExifTag(TAG_FLASH, 37385, 3), new ExifTag(TAG_FOCAL_LENGTH, 37386, 5), new ExifTag(TAG_SUBJECT_AREA, 37396, 3), new ExifTag(TAG_MAKER_NOTE, 37500, 7), new ExifTag(TAG_USER_COMMENT, 37510, 7), new ExifTag(TAG_SUBSEC_TIME, 37520, 2), new ExifTag(TAG_SUBSEC_TIME_ORIGINAL, 37521, 2), new ExifTag(TAG_SUBSEC_TIME_DIGITIZED, 37522, 2), new ExifTag(TAG_FLASHPIX_VERSION, 40960, 7), new ExifTag(TAG_COLOR_SPACE, 40961, 3), new ExifTag(TAG_PIXEL_X_DIMENSION, 40962, 3, 4), new ExifTag(TAG_PIXEL_Y_DIMENSION, 40963, 3, 4), new ExifTag(TAG_RELATED_SOUND_FILE, 40964, 2), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_FLASH_ENERGY, 41483, 5), new ExifTag(TAG_SPATIAL_FREQUENCY_RESPONSE, 41484, 7), new ExifTag(TAG_FOCAL_PLANE_X_RESOLUTION, 41486, 5), new ExifTag(TAG_FOCAL_PLANE_Y_RESOLUTION, 41487, 5), new ExifTag(TAG_FOCAL_PLANE_RESOLUTION_UNIT, 41488, 3), new ExifTag(TAG_SUBJECT_LOCATION, 41492, 3), new ExifTag(TAG_EXPOSURE_INDEX, 41493, 5), new ExifTag(TAG_SENSING_METHOD, 41495, 3), new ExifTag(TAG_FILE_SOURCE, 41728, 7), new ExifTag(TAG_SCENE_TYPE, 41729, 7), new ExifTag(TAG_CFA_PATTERN, 41730, 7), new ExifTag(TAG_CUSTOM_RENDERED, 41985, 3), new ExifTag(TAG_EXPOSURE_MODE, 41986, 3), new ExifTag(TAG_WHITE_BALANCE, 41987, 3), new ExifTag(TAG_DIGITAL_ZOOM_RATIO, 41988, 5), new ExifTag(TAG_FOCAL_LENGTH_IN_35MM_FILM, 41989, 3), new ExifTag(TAG_SCENE_CAPTURE_TYPE, 41990, 3), new ExifTag(TAG_GAIN_CONTROL, 41991, 3), new ExifTag(TAG_CONTRAST, 41992, 3), new ExifTag(TAG_SATURATION, 41993, 3), new ExifTag(TAG_SHARPNESS, 41994, 3), new ExifTag(TAG_DEVICE_SETTING_DESCRIPTION, 41995, 7), new ExifTag(TAG_SUBJECT_DISTANCE_RANGE, 41996, 3), new ExifTag(TAG_IMAGE_UNIQUE_ID, 42016, 2), new ExifTag("CameraOwnerName", 42032, 2), new ExifTag(TAG_BODY_SERIAL_NUMBER, 42033, 2), new ExifTag(TAG_LENS_SPECIFICATION, 42034, 5), new ExifTag(TAG_LENS_MAKE, 42035, 2), new ExifTag(TAG_LENS_MODEL, 42036, 2), new ExifTag(TAG_GAMMA, 42240, 5), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, a.f48454z, 2), new ExifTag(TAG_STRIP_OFFSETS, a.A, 3, 4), new ExifTag("ThumbnailOrientation", DefaultImageHeaderParser.f28794q, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, f.f11590g2, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, g.Q5, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag(TAG_STRIP_OFFSETS, a.A, 3);
        ...
        ASCII = forName;
        IDENTIFIER_EXIF_APP1 = DefaultImageHeaderParser.f28785h.getBytes(forName);
        ...
        while (true) {
            ...
            for (ExifTag exifTag : exifTagArr11[i11]) {
                ...
                sExifTagMapsForWriting[i11].put(exifTag.name, exifTag);
            }
            i11++;
        }
    }
    ...
    private void getHeifAttributes(final SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream) throws IOException {
        ...
        try {
            try {
                ExifInterfaceUtils.Api23Impl.setDataSource(mediaMetadataRetriever, new MediaDataSource() { // from class: androidx.exifinterface.media.ExifInterface.1
                    ...
                    public int readAt(long j11, byte[] bArr, int i11, int i12) throws IOException {
                        ...
                        try {
                            ...
                            if (j12 != j11) {
                                if (j12 >= 0 && j11 >= j12 + seekableByteOrderedDataInputStream.available()) {
                                    return -1;
                                }
                ...
                if (b.H0.equals(extractMetadata3)) {
                    str = mediaMetadataRetriever.extractMetadata(29);
                    str2 = mediaMetadataRetriever.extractMetadata(30);
                    str3 = mediaMetadataRetriever.extractMetadata(31);
                } else if (b.H0.equals(extractMetadata4)) {
    ...
    */
        ...
        if (!str.contains("/")) {
            try {
                try {
                    ...
                    return (parseLong < 0 || parseLong > j60.g.f63638t) ? parseLong < 0 ? new Pair<>(9, -1) : new Pair<>(4, -1) : new Pair<>(3, 4);
    ...
    private void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap hashMap) throws IOException {
        ...
        long j11 = 0;
        for (long j12 : convertToLongArray2) {
            j11 += j12;
        }
        int i12 = (int) j11;
        ...
        int i15 = 0;
        int i16 = 0;
        while (i14 < convertToLongArray.length) {
            int i17 = (int) convertToLongArray[i14];
            int i18 = (int) convertToLongArray2[i14];
            if (i14 < convertToLongArray.length - i13) {
                i11 = i14;
                if (i17 + i18 != convertToLongArray[i11 + 1]) {
            ...
            try {
                byteOrderedDataInputStream.skipFully(i19);
                int i21 = i15 + i19;
                ...
                try {
                    ...
                    Log.d(TAG, "Failed to read " + i18 + " bytes.");
                    return;
                }
            } catch (EOFException unused2) {
                Log.d(TAG, "Failed to skip " + i19 + " bytes.");
                return;
            }
        }
        this.mThumbnailBytes = bArr;
    ...
    private boolean isOrfFormat(byte[] bArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                boolean z11 = readShort == 20306 || readShort == 21330;
                byteOrderedDataInputStream2.close();
                return z11;
    ...
    private boolean isRw2Format(byte[] bArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                this.mExifByteOrder = readByteOrder;
                byteOrderedDataInputStream2.setByteOrder(readByteOrder);
                boolean z11 = byteOrderedDataInputStream2.readShort() == 85;
                byteOrderedDataInputStream2.close();
                return z11;
            } catch (Exception unused) {
                byteOrderedDataInputStream = byteOrderedDataInputStream2;
    ...
    */
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || Constants.ACCEPT_TIME_SEPARATOR_SERVER.equals(substring)) && ":".equals(str3.substring(3, 4)) && parseInt <= 14) {
                        int i12 = ((parseInt * 60) + parseInt2) * OrderStatusCode.ORDER_STATE_CANCEL;
    ...
    private void printAttributes() {
        for (int i11 = 0; i11 < this.mAttributes.length; i11++) {
            Log.d(TAG, "The size of tag group[" + i11 + "]: " + this.mAttributes[i11].size());
            for (Map.Entry<String, ExifAttribute> entry : this.mAttributes[i11].entrySet()) {
    ...
    */
    ...
    private void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        if (DEBUG) {
            Log.d(TAG, "saveJpegAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + j.f81007d);
        }
        ...
        while (byteOrderedDataInputStream.readByte() == -1) {
            ...
            if (readByte != -31) {
                ...
                while (i12 > 0) {
                    int read2 = byteOrderedDataInputStream.read(bArr, 0, Math.min(i12, 4096));
                    if (read2 >= 0) {
    ...
    private void savePngAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (DEBUG) {
            Log.d(TAG, "savePngAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + j.f81007d);
        }
        ByteOrderedDataInputStream byteOrderedDataInputStream = new ByteOrderedDataInputStream(inputStream);
    ...
    private void saveWebpAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        boolean z11;
        if (DEBUG) {
            Log.d(TAG, "saveWebpAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + j.f81007d);
        }
        ...
        try {
            ByteOrderedDataOutputStream byteOrderedDataOutputStream2 = new ByteOrderedDataOutputStream(byteArrayOutputStream, byteOrder);
            int i14 = this.mOffsetToExifData;
            if (i14 != 0) {
                ExifInterfaceUtils.copy(byteOrderedDataInputStream, byteOrderedDataOutputStream2, (i14 - ((bArr.length + 4) + bArr2.length)) - 8);
                ...
                if (Arrays.equals(bArr3, bArr4)) {
                    ...
                    if (z13) {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                z11 = !Arrays.equals(bArr6, WEBP_CHUNK_TYPE_ANMF);
                            } catch (EOFException unused) {
                                z11 = true;
                            }
                            if (z11) {
                    ...
                    if (Arrays.equals(bArr3, bArr7) || Arrays.equals(bArr3, WEBP_CHUNK_TYPE_VP8L)) {
                        ...
                        if (Arrays.equals(bArr3, bArr7)) {
                            ...
                            i12 = byteOrderedDataInputStream.readInt();
                            c11 = '\b';
                            i11 = (i12 & n.f12683h) + 1;
                        ...
                        ExifInterfaceUtils.copy(byteOrderedDataInputStream, byteOrderedDataOutputStream2, i15);
                        writeExifSegment(byteOrderedDataOutputStream2);
                    }
                }
            }
    ...
    private void updateImageSizeValues(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i11) throws IOException {
        ...
        ExifAttribute exifAttribute = this.mAttributes[i11].get(TAG_DEFAULT_CROP_SIZE);
        ExifAttribute exifAttribute2 = this.mAttributes[i11].get(TAG_RW2_SENSOR_TOP_BORDER);
        ExifAttribute exifAttribute3 = this.mAttributes[i11].get(TAG_RW2_SENSOR_LEFT_BORDER);
        ExifAttribute exifAttribute4 = this.mAttributes[i11].get(TAG_RW2_SENSOR_BOTTOM_BORDER);
        ExifAttribute exifAttribute5 = this.mAttributes[i11].get(TAG_RW2_SENSOR_RIGHT_BORDER);
        if (exifAttribute == null) {
            ...
            this.mAttributes[i11].put(TAG_IMAGE_LENGTH, createUShort3);
            this.mAttributes[i11].put(TAG_IMAGE_WIDTH, createUShort4);
            return;
        }
        ...
        this.mAttributes[i11].put(TAG_IMAGE_WIDTH, createUShort);
        this.mAttributes[i11].put(TAG_IMAGE_LENGTH, createUShort2);
    }
    ...
    public Bitmap getThumbnailBitmap() {
        ...
        if (i11 == 1) {
            ...
            for (int i12 = 0; i12 < length; i12++) {
                ...
                int i13 = i12 * 3;
                iArr[i12] = (bArr[i13] << 16) + (bArr[i13 + 1] << 8) + bArr[i13 + 2];
            }
    ...
    */
    ...
    public void setAttribute(@NonNull String str, @Nullable String str2) {
        ...
        boolean equals = TAG_DATETIME.equals(str4);
        String str6 = TAG;
        if ((equals || TAG_DATETIME_ORIGINAL.equals(str4) || TAG_DATETIME_DIGITIZED.equals(str4)) && str5 != null) {
            ...
            if (find2) {
                str5 = str5.replaceAll(Constants.ACCEPT_TIME_SEPARATOR_SERVER, ":");
            }
        }
        ...
        int i17 = 0;
        int i18 = 0;
        while (i18 < EXIF_TAGS.length) {
            if ((i18 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i18].get(str4)) != null) {
                if (str5 == null) {
                    this.mAttributes[i18].remove(str4);
                } else {
                    Pair<Integer, Integer> guessDataFormat = guessDataFormat(str5);
                    if (exifTag.primaryFormat == ((Integer) guessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) guessDataFormat.second).intValue()) {
                        i11 = exifTag.primaryFormat;
                    } else {
                        int i19 = exifTag.secondaryFormat;
                        if (i19 == -1 || !(i19 == ((Integer) guessDataFormat.first).intValue() || exifTag.secondaryFormat == ((Integer) guessDataFormat.second).intValue())) {
                            int i21 = exifTag.primaryFormat;
                            if (i21 == i16 || i21 == 7 || i21 == i15) {
                                i11 = i21;
                            } else if (DEBUG) {
                                StringBuilder sb2 = new StringBuilder();
                                ...
                                sb2.append(exifTag.secondaryFormat == -1 ? "" : j2.O + strArr[exifTag.secondaryFormat]);
                                sb2.append(" (guess: ");
                                sb2.append(strArr[((Integer) guessDataFormat.first).intValue()]);
                                sb2.append(((Integer) guessDataFormat.second).intValue() != -1 ? j2.O + strArr[((Integer) guessDataFormat.second).intValue()] : "");
                                sb2.append(j.f81007d);
                                Log.d(str6, sb2.toString());
                            }
                        } else {
                            i11 = exifTag.secondaryFormat;
                        }
                    }
                    switch (i11) {
                        case 1:
                            ...
                            str3 = str6;
                            i14 = i16;
                            this.mAttributes[i13].put(str4, ExifAttribute.createByte(str5));
                            break;
                        case 2:
                        case 7:
                            i12 = i17;
                            ...
                            str3 = str6;
                            i14 = i16;
                            this.mAttributes[i13].put(str4, ExifAttribute.createString(str5));
                            break;
                        case 3:
                            i12 = i17;
                            i13 = i18;
                            ...
                            for (int i22 = i12; i22 < split.length; i22++) {
                                iArr[i22] = Integer.parseInt(split[i22]);
                            }
                            this.mAttributes[i13].put(str4, ExifAttribute.createUShort(iArr, this.mExifByteOrder));
                            break;
                        case 4:
                            i12 = i17;
                            i13 = i18;
                            ...
                            for (int i23 = i12; i23 < split2.length; i23++) {
                                jArr[i23] = Long.parseLong(split2[i23]);
                            }
                            this.mAttributes[i13].put(str4, ExifAttribute.createULong(jArr, this.mExifByteOrder));
                            break;
                        case 5:
                            i12 = i17;
                            i14 = i16;
                            ...
                            while (i24 < split3.length) {
                                ...
                                rationalArr[i24] = new Rational((long) Double.parseDouble(split4[i12]), (long) Double.parseDouble(split4[i14]));
                                i24++;
                                str6 = str6;
                                i18 = i18;
                            }
                            i13 = i18;
                            str3 = str6;
                            this.mAttributes[i13].put(str4, ExifAttribute.createURational(rationalArr, this.mExifByteOrder));
                            break;
                        case 6:
                        case 8:
                        case 11:
                        ...
                        case 9:
                            ...
                            for (int i25 = i12; i25 < split5.length; i25++) {
                                iArr2[i25] = Integer.parseInt(split5[i25]);
                            }
                            this.mAttributes[i18].put(str4, ExifAttribute.createSLong(iArr2, this.mExifByteOrder));
                            i13 = i18;
                            str3 = str6;
                            break;
                        case 10:
                            ...
                            while (i26 < split6.length) {
                                String[] split7 = split6[i26].split("/", -1);
                                rationalArr2[i26] = new Rational((long) Double.parseDouble(split7[i17]), (long) Double.parseDouble(split7[i16]));
                                i26++;
                                i17 = i17;
                                i16 = i16;
                                split6 = split6;
                            ...
                            i12 = i17;
                            i14 = i16;
                            this.mAttributes[i18].put(str4, ExifAttribute.createSRational(rationalArr2, this.mExifByteOrder));
                            i13 = i18;
                            str3 = str6;
                            break;
                        case 12:
                            ...
                            for (int i27 = i17; i27 < split8.length; i27++) {
                                dArr[i27] = Double.parseDouble(split8[i27]);
                            }
                            this.mAttributes[i18].put(str4, ExifAttribute.createDouble(dArr, this.mExifByteOrder));
                            break;
                    }
                    i18 = i13 + 1;
                    i17 = i12;
    ...
    public void setLatLong(double d11, double d12) {
        ...
        setAttribute(TAG_GPS_LATITUDE_REF, d11 >= 0.0d ? "N" : LATITUDE_SOUTH);
        setAttribute(TAG_GPS_LATITUDE, convertDecimalDegree(Math.abs(d11)));
        setAttribute(TAG_GPS_LONGITUDE_REF, d12 >= 0.0d ? LONGITUDE_EAST : LONGITUDE_WEST);
    ...
    public static class ByteOrderedDataInputStream extends InputStream implements DataInput {
        ...
        public void readFully(byte[] bArr, int i11, int i12) throws IOException {
            this.mPosition += i12;
            this.mDataInputStream.readFully(bArr, i11, i12);
        }
        ...
        public void skipFully(int i11) throws IOException {
            ...
            while (i12 < i11) {
                int i13 = i11 - i12;
                int skip = (int) this.mDataInputStream.skip(i13);
                if (skip <= 0) {
                    if (this.mSkipBuffer == null) {
                        this.mSkipBuffer = new byte[8192];
                    }
                    skip = this.mDataInputStream.read(this.mSkipBuffer, 0, Math.min(8192, i13));
                    if (skip == -1) {
