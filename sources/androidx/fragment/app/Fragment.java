...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(str + GlideException.a.f28776d, fileDescriptor, printWriter, strArr);
    }
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater) | z11;
    }

    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        this.mChildFragmentManager.noteStateNotSaved();
        this.mPerformedCreateView = true;
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new Runnable() { // from class: androidx.fragment.app.k
            @Override // java.lang.Runnable
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu) | z11;
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i11) {
        if (this.mHost != null) {
            getParentFragmentManager().launchRequestPermissions(this, strArr, i11);
            return;
        }
    ...
    public void setAllowEnterTransitionOverlap(boolean z11) {
        ensureAnimationInfo().mAllowEnterTransitionOverlap = Boolean.valueOf(z11);
    }

    public void setAllowReturnTransitionOverlap(boolean z11) {
        ensureAnimationInfo().mAllowReturnTransitionOverlap = Boolean.valueOf(z11);
    }

    public void setAnimations(@AnimRes int i11, @AnimRes int i12, @AnimRes int i13, @AnimRes int i14) {
        if (this.mAnimationInfo == null && i11 == 0 && i12 == 0 && i13 == 0 && i14 == 0) {
            return;
        }
        ensureAnimationInfo().mEnterAnim = i11;
        ensureAnimationInfo().mExitAnim = i12;
        ensureAnimationInfo().mPopEnterAnim = i13;
        ensureAnimationInfo().mPopExitAnim = i14;
    }
    ...
    public void setNextTransition(int i11) {
        ...
        ensureAnimationInfo();
        this.mAnimationInfo.mNextTransition = i11;
    }
    ...
    public void setPopDirection(boolean z11) {
        ...
        ensureAnimationInfo().mIsPop = z11;
    }

    public void setPostOnViewCreatedAlpha(float f11) {
        ensureAnimationInfo().mPostOnViewCreatedAlpha = f11;
    }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i11) {
        if (fragment != null) {
            FragmentStrictMode.onSetTargetFragmentUsage(this, fragment, i11);
        }
        FragmentManager fragmentManager = this.mFragmentManager;
    ...
    public void setUserVisibleHint(boolean z11) {
        FragmentStrictMode.onSetUserVisibleHint(this, z11);
    ...
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i11, @Nullable Intent intent, int i12, int i13, int i14, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i11, intent, i12, i13, i14, bundle2);
    }
    ...
    @NonNull
    public final String getString(@StringRes int i11, @Nullable Object... objArr) {
    ...
    public void startActivityForResult(@NonNull Intent intent, int i11, @Nullable Bundle bundle) {
        if (this.mHost != null) {
            getParentFragmentManager().launchStartActivityForResult(this, intent, i11, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
