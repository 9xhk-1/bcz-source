...
class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + i11 + " for " + this.mFragment);
        }
        return i11;
    }
    ...
    public void destroy() {
        ...
        if (!z12 && !this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
        ...
        if ((z12 && !this.mFragment.mBeingSaved) || z11) {
    ...
    public void restoreState(@NonNull ClassLoader classLoader) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to restore view hierarchy state for fragment " + getFragment(), e11);
        }
    }
