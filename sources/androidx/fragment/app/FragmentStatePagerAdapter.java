...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public void destroyItem(@NonNull ViewGroup viewGroup, int i11, @NonNull Object obj) {
        ...
        this.mSavedState.set(i11, fragment.isAdded() ? this.mFragmentManager.saveFragmentInstanceState(fragment) : null);
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i11) {
        ...
        Fragment fragment;
        if (this.mFragments.size() > i11 && (fragment = this.mFragments.get(i11)) != null) {
            return fragment;
        }
        if (this.mCurTransaction == null) {
            this.mCurTransaction = this.mFragmentManager.beginTransaction();
        ...
        if (this.mSavedState.size() > i11 && (savedState = this.mSavedState.get(i11)) != null) {
    ...
    public Parcelable saveState() {
        ...
        for (int i11 = 0; i11 < this.mFragments.size(); i11++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, "f" + i11, fragment);
            }
        }
        return bundle;
    }
    ...
    public FragmentStatePagerAdapter(@NonNull FragmentManager fragmentManager, int i11) {
        this.mCurTransaction = null;
