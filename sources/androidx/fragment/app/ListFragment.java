...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i11, long j11) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, i11, j11);
        }
    };
    ...
    public void setListAdapter(@Nullable ListAdapter listAdapter) {
        boolean z11 = this.mAdapter != null;
        this.mAdapter = listAdapter;
        ListView listView = this.mList;
        if (listView != null) {
            listView.setAdapter(listAdapter);
            if (this.mListShown || z11) {
                return;
            }
    ...
    public void setListShown(boolean z11) {
        setListShown(z11, true);
    }

    public void setListShownNoAnimation(boolean z11) {
        setListShown(z11, false);
    }

    public void setSelection(int i11) {
        ensureList();
        this.mList.setSelection(i11);
    }
    ...
    public void onListItemClick(@NonNull ListView listView, @NonNull View view, int i11, long j11) {
    }
}
