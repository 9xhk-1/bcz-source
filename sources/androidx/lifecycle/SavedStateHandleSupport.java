...
@w00.j(name = "SavedStateHandleSupport")
...
public final class SavedStateHandleSupport {
    ...
    @MainThread
    public static final <T extends SavedStateRegistryOwner & ViewModelStoreOwner> void enableSavedStateHandles(@k T t11) {
        g0.p(t11, "<this>");
    ...
    public static final SavedStateHandlesProvider getSavedStateHandlesProvider(@k SavedStateRegistryOwner savedStateRegistryOwner) {
        g0.p(savedStateRegistryOwner, "<this>");
