...
public final class LifecycleEffectKt$LifecycleResumeEffectImpl$1$1 extends Lambda implements l<DisposableEffectScope, DisposableEffectResult> {
    ...
    public static final void invoke$lambda$1(LifecycleResumePauseEffectScope lifecycleResumePauseEffectScope, Ref.ObjectRef objectRef, l lVar, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        int i11 = WhenMappings.$EnumSwitchMapping$0[event.ordinal()];
        if (i11 == 1) {
            objectRef.element = lVar.invoke(lifecycleResumePauseEffectScope);
        } else {
            if (i11 != 2) {
                return;
            }
    ...
    public final DisposableEffectResult invoke(@k DisposableEffectScope disposableEffectScope) {
        ...
        final LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: androidx.lifecycle.compose.b
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                LifecycleEffectKt$LifecycleResumeEffectImpl$1$1.invoke$lambda$1(LifecycleResumePauseEffectScope.this, objectRef, lVar, lifecycleOwner, event);
            }
        };
