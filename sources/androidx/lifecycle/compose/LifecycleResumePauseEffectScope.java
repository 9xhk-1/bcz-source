...
public final class LifecycleResumePauseEffectScope implements LifecycleOwner {
    ...
    public LifecycleResumePauseEffectScope(@k Lifecycle lifecycle) {
    ...
    @k
    public final LifecyclePauseOrDisposeEffectResult onPauseOrDispose(@k final l<? super LifecycleOwner, g2> lVar) {
