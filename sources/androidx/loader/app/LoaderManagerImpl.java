...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        @MainThread
        public Loader<D> destroy(boolean z11) {
            ...
            if ((loaderObserver == null || loaderObserver.hasDeliveredData()) && !z11) {
                return this.mLoader;
            }
            this.mLoader.reset();
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(str + GlideException.a.f28776d, fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(str + GlideException.a.f28776d, printWriter);
            }
            printWriter.print(str);
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d11) {
            if (LoaderManagerImpl.DEBUG) {
                Log.v(LoaderManagerImpl.TAG, "  onLoadFinished in " + this.mLoader + ": " + this.mLoader.dataToString(d11));
            }
    ...
    public static class LoaderViewModel extends ViewModel {
        ...
        public <D> LoaderInfo<D> getLoader(int i11) {
        ...
        public boolean hasRunningLoaders() {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                if (this.mLoaders.valueAt(i11).isCallbackWaitingForData()) {
                    return true;
                }
            }
            return false;
        ...
        public void markForRedelivery() {
            int size = this.mLoaders.size();
            for (int i11 = 0; i11 < size; i11++) {
                this.mLoaders.valueAt(i11).markForRedelivery();
            }
        }
        ...
        public void onCleared() {
            ...
            int size = this.mLoaders.size();
            for (int i11 = 0; i11 < size; i11++) {
                this.mLoaders.valueAt(i11).destroy(true);
            }
            this.mLoaders.clear();
        }

        public void putLoader(int i11, @NonNull LoaderInfo loaderInfo) {
            this.mLoaders.put(i11, loaderInfo);
        }

        public void removeLoader(int i11) {
    ...
    private <D> Loader<D> createAndInstallLoader(int i11, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            this.mLoaderViewModel.putLoader(i11, loaderInfo);
    ...
    public void destroyLoader(int i11) {
        ...
        if (DEBUG) {
            Log.v(TAG, "destroyLoader in " + this + " of " + i11);
        }
        LoaderInfo loader = this.mLoaderViewModel.getLoader(i11);
        if (loader != null) {
            loader.destroy(true);
            this.mLoaderViewModel.removeLoader(i11);
        }
    }
    ...
    public <D> Loader<D> getLoader(int i11) {
        ...
        LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i11);
        if (loader != null) {
    ...
    public <D> Loader<D> initLoader(int i11, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        if (loader == null) {
            return createAndInstallLoader(i11, bundle, loaderCallbacks, null);
        }
        if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i11, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i11);
        return createAndInstallLoader(i11, bundle, loaderCallbacks, loader != null ? loader.destroy(false) : null);
    }
