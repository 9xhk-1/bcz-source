...
public class Loader<D> {
    ...
    @NonNull
    public String dataToString(@Nullable D d11) {
        StringBuilder sb2 = new StringBuilder(64);
        DebugUtils.buildShortClassTag(d11, sb2);
    ...
    @MainThread
    public void deliverResult(@Nullable D d11) {
    ...
    @MainThread
    public void registerListener(int i11, @NonNull OnLoadCompleteListener<D> onLoadCompleteListener) {
