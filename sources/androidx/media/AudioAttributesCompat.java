...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static void setForceLegacyBehavior(boolean z11) {
        sForceLegacyBehavior = z11;
    }

    public static int toVolumeStreamType(boolean z11, AudioAttributesCompat audioAttributesCompat) {
        return toVolumeStreamType(z11, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }

    public static int usageForStreamType(int i11) {
        switch (i11) {
        }
        return 2;
    }

    public static String usageToString(int i11) {
        switch (i11) {
            case 0:
    ...
    public static int toVolumeStreamType(boolean z11, int i11, int i12) {
        if ((i11 & 1) == 1) {
            return z11 ? 1 : 7;
        }
        if ((i11 & 4) == 4) {
    ...
    public static class Builder {
        ...
        public Builder setInternalLegacyStreamType(int i11) {
            switch (i11) {
                case 0:
                    this.mContentType = 1;
                    break;
            ...
            this.mUsage = AudioAttributesCompat.usageForStreamType(i11);
            return this;
        }
        ...
        public Builder setLegacyStreamType(int i11) {
            ...
            return setInternalLegacyStreamType(i11);
        }
