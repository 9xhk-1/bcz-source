...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getBigContentViewLayoutResource(int i11) {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            boolean z11 = action.getActionIntent() == null;
        ...
        public RemoteViews generateBigContentView() {
            ...
            applyStandardTemplate.setOnClickPendingIntent(i12, this.mCancelButtonIntent);
            return applyStandardTemplate;
        }
        ...
        public RemoteViews generateContentView() {
            ...
            if (min > 0) {
                for (int i11 = 0; i11 < min; i11++) {
                    ...
                    applyStandardTemplate.addView(R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i11])));
                }
            }
            if (!this.mShowCancelButton) {
