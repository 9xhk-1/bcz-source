...
public final class C {
    ...
    @UnstableApi
    public static final int STREAM_TYPE_ACCESSIBILITY = 10;
    ...
    @UnstableApi
    public static final int VIDEO_CODEC_FLAG_H265 = 2;
    ...
    @uo.l(imports = {"androidx.media3.common.util.Util"}, replacement = "Util.generateAudioSessionIdV21(context)")
    @UnstableApi
    @Deprecated
    ...
    @uo.l(imports = {"androidx.media3.common.util.Util"}, replacement = "Util.getErrorCodeForMediaDrmErrorCode(mediaDrmErrorCode)")
    @UnstableApi
    @Deprecated
    public static int getErrorCodeForMediaDrmErrorCode(int i11) {
        return Util.getErrorCodeForMediaDrmErrorCode(i11);
    }

    @uo.l(imports = {"androidx.media3.common.util.Util"}, replacement = "Util.getFormatSupportString(formatSupport)")
    @UnstableApi
    @Deprecated
    public static String getFormatSupportString(int i11) {
        return Util.getFormatSupportString(i11);
    }

    @uo.l(imports = {"androidx.media3.common.util.Util"}, replacement = "Util.msToUs(timeMs)")
    @UnstableApi
    @Deprecated
    public static long msToUs(long j11) {
        return Util.msToUs(j11);
    }

    @uo.l(imports = {"androidx.media3.common.util.Util"}, replacement = "Util.usToMs(timeUs)")
    @UnstableApi
    @Deprecated
