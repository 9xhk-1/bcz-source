...
public final class MediaItem {
    ...
    public static final class Builder {
        ...
        @UnstableApi
        @uo.a
        public Builder setImageDurationMs(long j11) {
    ...
    public static class ClippingConfiguration {
        ...
        public static final class Builder {
            ...
            @UnstableApi
            @uo.a
            public Builder setStartPositionUs(@IntRange(from = 0) long j11) {
        ...
        public static ClippingProperties fromBundle(Bundle bundle) {
            ...
            long j11 = bundle.getLong(FIELD_START_POSITION_US, clippingConfiguration.startPositionUs);
            if (j11 != clippingConfiguration.startPositionUs) {
                startsAtKeyFrame.setStartPositionUs(j11);
            }
            long j12 = bundle.getLong(FIELD_END_POSITION_US, clippingConfiguration.endPositionUs);
            if (j12 != clippingConfiguration.endPositionUs) {
        ...
        public Bundle toBundle() {
            ...
            if (j13 != clippingConfiguration.startPositionUs) {
                bundle.putLong(FIELD_START_POSITION_US, j13);
            }
            long j14 = this.endPositionUs;
            if (j14 != clippingConfiguration.endPositionUs) {
                bundle.putLong(FIELD_END_POSITION_US, j14);
            }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            @Deprecated
            @uo.l(replacement = "this.setForceSessionsForAudioAndVideoTracks(forceSessionsForAudioAndVideoTracks)")
            @UnstableApi
            @uo.a
        ...
        public static DrmConfiguration fromBundle(Bundle bundle) {
            ...
            return new Builder(fromString).setLicenseUri(uri).setLicenseRequestHeaders(bundleToStringImmutableMap).setMultiSession(z11).setForceDefaultLicenseUri(z13).setPlayClearContentWithoutKey(z12).setForcedSessionTrackTypes(copyOf).setKeySetId(bundle.getByteArray(FIELD_KEY_SET_ID)).build();
        }
    ...
    public static final class LocalConfiguration {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList of2 = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new r() { // from class: androidx.media3.common.p
                @Override // ho.r
            ...
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), fromBundle, fromBundle2, of2, bundle.getString(FIELD_CUSTOM_CACHE_KEY), parcelableArrayList2 == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new r() { // from class: androidx.media3.common.q
                @Override // ho.r
                public final Object apply(Object obj) {
        ...
        public Bundle toBundle() {
            ...
            if (!this.streamKeys.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_STREAM_KEYS, BundleCollectionUtil.toBundleArrayList(this.streamKeys, new r() { // from class: androidx.media3.common.n
                    @Override // ho.r
                    public final Object apply(Object obj) {
            ...
            if (!this.subtitleConfigurations.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION, BundleCollectionUtil.toBundleArrayList(this.subtitleConfigurations, new r() { // from class: androidx.media3.common.o
                    @Override // ho.r
                    public final Object apply(Object obj) {
            ...
            if (j11 != C.TIME_UNSET) {
                bundle.putLong(FIELD_IMAGE_DURATION_MS, j11);
            }
            return bundle;
        }

        private LocalConfiguration(Uri uri, @Nullable String str, @Nullable DrmConfiguration drmConfiguration, @Nullable AdsConfiguration adsConfiguration, List<StreamKey> list, @Nullable String str2, ImmutableList<SubtitleConfiguration> immutableList, @Nullable Object obj, long j11) {
            this.uri = uri;
            ...
            for (int i11 = 0; i11 < immutableList.size(); i11++) {
                builder.g(immutableList.get(i11).buildUpon().buildSubtitle());
            }
    ...
    @UnstableApi
    private Bundle toBundle(boolean z11) {
        LocalConfiguration localConfiguration;
        Bundle bundle = new Bundle();
        ...
        if (z11 && (localConfiguration = this.localConfiguration) != null) {
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f4449id = subtitleConfiguration.f4448id;
            }
        }
        ...
        public static SubtitleConfiguration fromBundle(Bundle bundle) {
            ...
            return new Builder(uri).setMimeType(string).setLanguage(string2).setSelectionFlags(i11).setRoleFlags(i12).setLabel(string3).setId(bundle.getString(FIELD_ID)).build();
        }
        ...
        private SubtitleConfiguration(Uri uri, String str, @Nullable String str2, int i11, int i12, @Nullable String str3, @Nullable String str4) {
            this.uri = uri;
            this.mimeType = MimeTypes.normalizeMimeType(str);
            this.language = str2;
            this.selectionFlags = i11;
