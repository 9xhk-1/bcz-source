...
public final class MediaMetadata {
    ...
    public static final class Builder {
        ...
        public Builder maybeSetArtworkData(byte[] bArr, int i11) {
            if (this.artworkData != null && i11 != 3 && Objects.equals(this.artworkDataType, 3)) {
                return this;
            }
        ...
        public Builder populate(@Nullable MediaMetadata mediaMetadata) {
            if (mediaMetadata != null) {
                ...
                Long l11 = mediaMetadata.durationMs;
                if (l11 != null) {
                    setDurationMs(l11);
                }
        ...
        @uo.a
        public Builder setDurationMs(@Nullable Long l11) {
            Assertions.checkArgument(l11 == null || l11.longValue() >= 0);
            this.durationMs = l11;
            return this;
        }
    ...
    public Bundle toBundle() {
        ...
        if (l11 != null) {
            bundle.putLong(FIELD_DURATION_MS, l11.longValue());
        }
