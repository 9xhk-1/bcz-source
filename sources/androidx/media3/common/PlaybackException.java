...
public class PlaybackException extends Exception {
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i11) {
        this(str, th2, i11, Bundle.EMPTY, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    public static String getErrorCodeName(int i11) {
        if (i11 == -100) {
    ...
    */
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i11, Bundle bundle) {
        this(str, th2, i11, bundle, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i11, Bundle bundle, long j11) {
        super(str, th2);
        this.errorCode = i11;
        this.extras = bundle;
