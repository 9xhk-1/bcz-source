...
public interface Player {
    ...
    public interface Listener {
        ...
        default void onMediaItemTransition(@Nullable MediaItem mediaItem, int i11) {
        }
    ...
    public static final class PositionInfo {
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            ...
            return new PositionInfo(null, i11, bundle2 == null ? null : MediaItem.fromBundle(bundle2), null, bundle.getInt(FIELD_PERIOD_INDEX, 0), bundle.getLong(FIELD_POSITION_MS, 0L), bundle.getLong(FIELD_CONTENT_POSITION_MS, 0L), bundle.getInt(FIELD_AD_GROUP_INDEX, -1), bundle.getInt(FIELD_AD_INDEX_IN_AD_GROUP, -1));
        }
        ...
        @UnstableApi
        public PositionInfo filterByAvailableCommands(boolean z11, boolean z12) {
            if (z11 && z12) {
                return this;
            }
            return new PositionInfo(this.windowUid, z12 ? this.mediaItemIndex : 0, z11 ? this.mediaItem : null, this.periodUid, z12 ? this.periodIndex : 0, z11 ? this.positionMs : 0L, z11 ? this.contentPositionMs : 0L, z11 ? this.adGroupIndex : -1, z11 ? this.adIndexInAdGroup : -1);
        }
        ...
        @UnstableApi
        public Bundle toBundle(int i11) {
            Bundle bundle = new Bundle();
            if (i11 < 3 || this.mediaItemIndex != 0) {
