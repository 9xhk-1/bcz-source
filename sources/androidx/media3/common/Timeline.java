...
public abstract class Timeline {
    ...
    public static final class Period {
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            AdPlaybackState fromBundle = bundle2 != null ? AdPlaybackState.fromBundle(bundle2) : AdPlaybackState.NONE;
            Period period = new Period();
            period.set(null, null, i11, j11, j12, fromBundle, z11);
            return period;
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj != null && Period.class.equals(obj.getClass())) {
                ...
                if (Objects.equals(this.f4450id, period.f4450id) && Objects.equals(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Objects.equals(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            ...
            return ((((i11 + ((int) (j12 ^ (j12 >>> 32)))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31) + this.adPlaybackState.hashCode();
        }

        @UnstableApi
        public boolean isLivePostrollPlaceholder(int i11) {
            return i11 == getAdGroupCount() - 1 && this.adPlaybackState.isLivePostrollPlaceholder(i11);
        }
        ...
        @UnstableApi
        @uo.a
        public Period set(@Nullable Object obj, @Nullable Object obj2, int i11, long j11, long j12, AdPlaybackState adPlaybackState, boolean z11) {
            this.f4450id = obj;
            this.uid = obj2;
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public int getLastWindowIndex(boolean z11) {
            ...
            return z11 ? this.shuffledWindowIndices[getWindowCount() - 1] : getWindowCount() - 1;
        }
        ...
        public Period getPeriod(int i11, Period period, boolean z11) {
            ...
            period.set(period2.f4450id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
        ...
        @Override // androidx.media3.common.Timeline
        public Window getWindow(int i11, Window window, long j11) {
            Window window2 = this.windows.get(i11);
    ...
    public static final class Window {
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            window.set(FAKE_WINDOW_UID, fromBundle, null, j11, j12, j13, z11, z12, fromBundle2, j14, j15, i11, i12, j16);
        ...
        @UnstableApi
        @uo.a
        public Window set(Object obj, @Nullable MediaItem mediaItem, @Nullable Object obj2, long j11, long j12, long j13, boolean z11, boolean z12, @Nullable MediaItem.LiveConfiguration liveConfiguration, long j14, long j15, int i11, int i12, long j16) {
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList fromBundleListRetriever = fromBundleListRetriever(new r() { // from class: androidx.media3.common.h2
            @Override // ho.r
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj);
            }
        }, bundle.getBinder(FIELD_WINDOWS));
        ImmutableList fromBundleListRetriever2 = fromBundleListRetriever(new r() { // from class: androidx.media3.common.i2
            @Override // ho.r
            public final Object apply(Object obj) {
    ...
    private static <T> ImmutableList<T> fromBundleListRetriever(r<Bundle, T> rVar, @Nullable IBinder iBinder) {
        return iBinder == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(rVar, BundleListRetriever.getList(iBinder));
    }
    ...
    @UnstableApi
    public final Timeline copyWithSingleWindow(int i11) {
        if (getWindowCount() == 1) {
            return this;
        }
        Window window = getWindow(i11, new Window(), 0L);
        ...
        while (true) {
            ...
            if (i12 > i13) {
                ...
                return new RemotableTimeline(ImmutableList.of(window), builder.e(), new int[]{0});
            }
            Period period = getPeriod(i12, new Period(), true);
    ...
    @uo.l(replacement = "this.getPeriodPositionUs(window, period, windowIndex, windowPositionUs)")
    @UnstableApi
    @Deprecated
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int i11, long j11) {
        return (Pair) Assertions.checkNotNull(getPeriodPositionUs(window, period, i11, j11, 0L));
    }
    ...
    public final Window getWindow(int i11, Window window) {
        return getWindow(i11, window, 0L);
    }
    ...
    public final Bundle toBundle() {
        ...
        for (int i11 = 0; i11 < windowCount; i11++) {
            arrayList.add(getWindow(i11, window, 0L).toBundle());
        }
    ...
    @Deprecated
    @Nullable
    @uo.l(replacement = "this.getPeriodPositionUs(window, period, windowIndex, windowPositionUs, defaultPositionProjectionUs)")
    @UnstableApi
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int i11, long j11, long j12) {
        ...
        return Pair.create(Assertions.checkNotNull(period.uid), Long.valueOf(Math.max(0L, j13)));
    }
}
