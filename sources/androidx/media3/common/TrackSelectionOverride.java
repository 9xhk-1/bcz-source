...
public final class TrackSelectionOverride {
    ...
    public TrackSelectionOverride(TrackGroup trackGroup, int i11) {
        this(trackGroup, ImmutableList.of(Integer.valueOf(i11)));
    }

    @UnstableApi
    public static TrackSelectionOverride fromBundle(Bundle bundle) {
        return new TrackSelectionOverride(TrackGroup.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP))), ro.i.c((int[]) Assertions.checkNotNull(bundle.getIntArray(FIELD_TRACKS))));
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putIntArray(FIELD_TRACKS, ro.i.E(this.trackIndices));
        return bundle;
    }
