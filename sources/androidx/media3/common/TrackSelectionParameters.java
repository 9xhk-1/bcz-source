...
public class TrackSelectionParameters {
    ...
    public static final class AudioOffloadPreferences {
        ...
        public static final class Builder {
            ...
            @uo.a
            public Builder setAudioOffloadMode(int i11) {
                this.audioOffloadMode = i11;
                return this;
            }

            @uo.a
            public Builder setIsGaplessSupportRequired(boolean z11) {
                this.isGaplessSupportRequired = z11;
                return this;
            }

            @uo.a
            public Builder setIsSpeedChangeSupportRequired(boolean z11) {
                this.isSpeedChangeSupportRequired = z11;
                return this;
            }
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleArrayList(this.overrides.values(), new r() { // from class: androidx.media3.common.k2
            @Override // ho.r
            public final Object apply(Object obj) {
                return ((TrackSelectionOverride) obj).toBundle();
            }
        }));
        bundle.putIntArray(FIELD_DISABLED_TRACK_TYPE, ro.i.E(this.disabledTrackTypes));
        return bundle;
    }
    ...
    public static class Builder {
        ...
        private static ImmutableList<String> normalizeLanguageCodes(String[] strArr) {
            ...
            for (String str : (String[]) Assertions.checkNotNull(strArr)) {
                builder.g(Util.normalizeLanguageCode((String) Assertions.checkNotNull(str)));
            }
            return builder.e();
        }
        ...
        public Builder setPrioritizeImageOverVideoEnabled(boolean z11) {
            this.isPrioritizeImageOverVideoEnabled = z11;
            return this;
        }
        ...
        public Builder setViewportSizeToPhysicalDisplaySize(Context context, boolean z11) {
            return setViewportSizeToPhysicalDisplaySize(z11);
        }
        ...
        public Builder(Bundle bundle) {
            ...
            int i11 = bundle.getInt(TrackSelectionParameters.FIELD_VIEWPORT_HEIGHT, trackSelectionParameters.viewportHeight);
            this.viewportHeight = i11;
            this.isViewportSizeLimitedByPhysicalDisplaySize = this.viewportWidth == Integer.MAX_VALUE && i11 == Integer.MAX_VALUE && bundle.getBoolean(TrackSelectionParameters.FIELD_IS_VIEWPORT_SIZE_LIMITED_BY_PHYSICAL_DISPLAY_SIZE, trackSelectionParameters.isViewportSizeLimitedByPhysicalDisplaySize);
            ...
            this.preferredVideoMimeTypes = ImmutableList.copyOf((String[]) ho.b0.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_MIMETYPES), new String[0]));
            this.preferredVideoLanguages = ImmutableList.copyOf((String[]) ho.b0.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioLanguages = normalizeLanguageCodes((String[]) ho.b0.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioMimeTypes = ImmutableList.copyOf((String[]) ho.b0.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_MIME_TYPES), new String[0]));
            this.audioOffloadPreferences = getAudioOffloadPreferencesFromBundle(bundle);
            this.preferredTextLanguages = normalizeLanguageCodes((String[]) ho.b0.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_TEXT_LANGUAGES), new String[0]));
            ...
            if (parcelableArrayList == null) {
                ...
                fromBundleList = BundleCollectionUtil.fromBundleList(new r() { // from class: androidx.media3.common.l2
                    @Override // ho.r
                    public final Object apply(Object obj) {
            ...
            this.overrides = new HashMap<>();
            for (int i12 = 0; i12 < fromBundleList.size(); i12++) {
                TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) fromBundleList.get(i12);
                this.overrides.put(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
            }
            int[] iArr = (int[]) ho.b0.a(bundle.getIntArray(TrackSelectionParameters.FIELD_DISABLED_TRACK_TYPE), new int[0]);
            this.disabledTrackTypes = new HashSet<>();
            for (int i13 : iArr) {
