...
public interface VideoFrameProcessor {
    ...
    public interface Factory {
        VideoFrameProcessor create(Context context, DebugViewProvider debugViewProvider, ColorInfo colorInfo, boolean z11, Executor executor, Listener listener) throws VideoFrameProcessingException;
    }
    ...
    void registerInputStream(int i11, Format format, List<Effect> list, long j11);
    ...
    public interface Listener {
        ...
        default void onInputStreamRegistered(int i11, Format format, List<Effect> list) {
        }
    }
}
