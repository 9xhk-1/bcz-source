...
final class CustomSpanBundler {
    ...
    private static Bundle spanToBundle(Spanned spanned, Object obj, int i11, @Nullable Bundle bundle) {
    ...
    public static void unbundleAndApplyCustomSpan(Bundle bundle, Spannable spannable) {
        int i11 = bundle.getInt(FIELD_START_INDEX);
        int i12 = bundle.getInt(FIELD_END_INDEX);
        int i13 = bundle.getInt(FIELD_FLAGS);
        int i14 = bundle.getInt(FIELD_TYPE, -1);
        Bundle bundle2 = bundle.getBundle(FIELD_PARAMS);
        if (i14 == 1) {
            spannable.setSpan(RubySpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i11, i12, i13);
            return;
        }
        if (i14 == 2) {
            spannable.setSpan(TextEmphasisSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i11, i12, i13);
        } else if (i14 == 3) {
            spannable.setSpan(new HorizontalTextInVerticalContextSpan(), i11, i12, i13);
        } else {
            if (i14 != 4) {
                return;
            }
            spannable.setSpan(VoiceSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i11, i12, i13);
        }
    }
}
