...
public final class ListenerSet<T> {
    ...
    public static /* synthetic */ void a(CopyOnWriteArraySet copyOnWriteArraySet, int i11, Event event) {
    ...
    public void queueEvent(final int i11, final Event<T> event) {
        ...
        this.queuedEvents.add(new Runnable() { // from class: androidx.media3.common.util.e
            @Override // java.lang.Runnable
            public final void run() {
                ListenerSet.a(copyOnWriteArraySet, i11, event);
            }
        });
    }
    ...
    private ListenerSet(CopyOnWriteArraySet<ListenerHolder<T>> copyOnWriteArraySet, Looper looper, Clock clock, IterationFinishedEvent<T> iterationFinishedEvent, boolean z11) {
        ...
        this.handler = clock.createHandler(looper, new Handler.Callback() { // from class: androidx.media3.common.util.d
