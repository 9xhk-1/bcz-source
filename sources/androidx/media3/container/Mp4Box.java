...
public abstract class Mp4Box {
    ...
    public static final int TYPE_apv1 = 1634760241;
    public static final int TYPE_apvC = 1634760259;
    ...
    public static final int TYPE_axte = 1635284069;
    public static final int TYPE_btrt = 1651798644;
    ...
    public static final class ContainerBox extends Mp4Box {
        ...
        public ContainerBox(int i11, long j11) {
            super(i11);
        ...
        @Nullable
        public ContainerBox getContainerBoxOfType(int i11) {
            int size = this.containerChildren.size();
            for (int i12 = 0; i12 < size; i12++) {
                ContainerBox containerBox = this.containerChildren.get(i12);
                if (containerBox.type == i11) {
                    return containerBox;
                }
            }
            return null;
        ...
        @Nullable
        public LeafBox getLeafBoxOfType(int i11) {
            int size = this.leafChildren.size();
            for (int i12 = 0; i12 < size; i12++) {
                LeafBox leafBox = this.leafChildren.get(i12);
                if (leafBox.type == i11) {
                    return leafBox;
                }
            }
    ...
    public static final class LeafBox extends Mp4Box {
        ...
        public LeafBox(int i11, ParsableByteArray parsableByteArray) {
            super(i11);
            this.data = parsableByteArray;
        }
    }

    public static String getBoxTypeString(int i11) {
