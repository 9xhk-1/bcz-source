...
public final class VersionTable {
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i11, String str) throws DatabaseIOException {
        try {
            ...
            Cursor query = sQLiteDatabase.query(TABLE_NAME, new String[]{"version"}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i11, str), null, null, null);
            try {
                if (query.getCount() == 0) {
                    query.close();
                    return -1;
