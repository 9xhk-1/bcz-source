...
public final class CacheDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        private CacheDataSource createDataSourceInternal(@Nullable DataSource dataSource, int i11, int i12) {
            ...
            return new CacheDataSource(cache, dataSource, this.cacheReadDataSourceFactory.createDataSource(), dataSink, this.cacheKeyFactory, i11, this.upstreamPriorityTaskManager, i12, this.eventListener);
        }
    ...
    private void openNextSource(DataSpec dataSpec, boolean z11) throws IOException {
        ...
        if (startReadWrite == null) {
            ...
            build = dataSpec.buildUpon().setPosition(this.readPosition).setLength(j11).build();
    ...
    */
    ...
    public CacheDataSource(Cache cache, @Nullable DataSource dataSource, DataSource dataSource2, @Nullable DataSink dataSink, int i11, @Nullable EventListener eventListener, @Nullable CacheKeyFactory cacheKeyFactory) {
        this(cache, dataSource, dataSource2, dataSink, cacheKeyFactory, i11, null, -1000, eventListener);
    }

    private CacheDataSource(Cache cache, @Nullable DataSource dataSource, DataSource dataSource2, @Nullable DataSink dataSink, @Nullable CacheKeyFactory cacheKeyFactory, int i11, @Nullable PriorityTaskManager priorityTaskManager, int i12, @Nullable EventListener eventListener) {
        this.cache = cache;
