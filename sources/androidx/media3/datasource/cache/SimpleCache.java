...
public final class SimpleCache implements Cache {
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        SimpleCacheSpan lastTouchTimestamp = ((CachedContent) Assertions.checkNotNull(this.contentIndex.get(str))).setLastTouchTimestamp(simpleCacheSpan, currentTimeMillis, z11);
    ...
    */
    ...
    public synchronized File startFile(String str, long j11, long j12) throws Cache.CacheException {
        ...
        try {
            try {
                ...
                return SimpleCacheSpan.getCacheFile(file, cachedContent.f4598id, j11, System.currentTimeMillis());
            } catch (Throwable th4) {
                th = th4;
                th2 = th;
                throw th2;
    ...
    public synchronized CacheSpan startReadWrite(String str, long j11, long j12) throws InterruptedException, Cache.CacheException {
        try {
            ...
            checkInitialization();
            while (true) {
                CacheSpan startReadWriteNonBlocking = startReadWriteNonBlocking(str, j11, j12);
                long j13 = j12;
                long j14 = j11;
                String str2 = str;
    ...
    public synchronized CacheSpan startReadWriteNonBlocking(String str, long j11, long j12) throws Cache.CacheException {
        try {
            try {
                ...
                if (this.contentIndex.getOrAdd(str).lockRange(j11, span.length)) {
                    return span;
                }
                return null;
            } catch (Throwable th2) {
