...
public class ForwardingRenderer implements Renderer {
    ...
    @Override // androidx.media3.exoplayer.Renderer
    public void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j11, boolean z11, boolean z12, long j12, long j13, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException {
        this.renderer.enable(rendererConfiguration, formatArr, sampleStream, j11, z11, z12, j12, j13, mediaPeriodId);
    }
    ...
    @Override // androidx.media3.exoplayer.Renderer
    public void init(int i11, PlayerId playerId, Clock clock) {
    ...
    @Override // androidx.media3.exoplayer.Renderer
    public void replaceStream(Format[] formatArr, SampleStream sampleStream, long j11, long j12, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException {
        this.renderer.replaceStream(formatArr, sampleStream, j11, j12, mediaPeriodId);
    }
    ...
    @Override // androidx.media3.exoplayer.Renderer
    public void resetPosition(long j11) throws ExoPlaybackException {
