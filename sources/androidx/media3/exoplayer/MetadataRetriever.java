...
public final class MetadataRetriever {
    ...
    public static final class MetadataRetrieverInternal {
        ...
        private final com.google.common.util.concurrent.h2<TrackGroupArray> trackGroupsFuture = com.google.common.util.concurrent.h2.F();
            ...
            public final class MediaSourceCaller implements MediaSource.MediaSourceCaller {
                ...
                public final class MediaPeriodCallback implements MediaPeriod.Callback {
                    ...
                    public void onPrepared(MediaPeriod mediaPeriod) {
                        MetadataRetrieverInternal.this.trackGroupsFuture.B(mediaPeriod.getTrackGroups());
            ...
            public boolean handleMessage(Message message) {
                ...
                if (i11 == 2) {
                    try {
                        ...
                        MetadataRetrieverInternal.this.trackGroupsFuture.C(e11);
                        MetadataRetrieverInternal.this.mediaSourceHandler.obtainMessage(4).sendToTarget();
                    }
                    return true;
                }
        ...
        public com.google.common.util.concurrent.p1<TrackGroupArray> retrieveMetadata() {
    ...
    public static com.google.common.util.concurrent.p1<TrackGroupArray> retrieveMetadata(Context context, MediaItem mediaItem) {
        return retrieveMetadata(context, mediaItem, Clock.DEFAULT);
    }

    public static void setMaximumParallelRetrievals(int i11) {
        Assertions.checkArgument(i11 >= 1);
        SharedWorkerThread.MAX_PARALLEL_RETRIEVALS.set(i11);
    }

    public static com.google.common.util.concurrent.p1<TrackGroupArray> retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem) {
        return retrieveMetadata(factory, mediaItem, Clock.DEFAULT);
    }

    @VisibleForTesting
    public static com.google.common.util.concurrent.p1<TrackGroupArray> retrieveMetadata(Context context, MediaItem mediaItem, Clock clock) {
    ...
    private static com.google.common.util.concurrent.p1<TrackGroupArray> retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem, Clock clock) {
