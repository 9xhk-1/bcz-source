...
public interface Renderer extends PlayerMessage.Target {
    ...
    void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j11, boolean z11, boolean z12, long j12, long j13, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException;
    ...
    void init(int i11, PlayerId playerId, Clock clock);
    ...
    void replaceStream(Format[] formatArr, SampleStream sampleStream, long j11, long j12, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException;
    ...
    default void setPlaybackSpeed(float f11, float f12) throws ExoPlaybackException {
    }
}
