...
public interface RendererCapabilities {
    ...
    static int create(int i11, int i12, int i13, int i14, int i15, int i16) {
        return i11 | i12 | i13 | i14 | i15 | i16;
    }

    @SuppressLint({"WrongConstant"})
    static int getAdaptiveSupport(int i11) {
        return i11 & 24;
    }

    @SuppressLint({"WrongConstant"})
    static int getAudioOffloadSupport(int i11) {
        return i11 & AUDIO_OFFLOAD_SUPPORT_MASK;
    }
    ...
    @SuppressLint({"WrongConstant"})
    static int getFormatSupport(int i11) {
        return i11 & 7;
    }
    ...
    @SuppressLint({"WrongConstant"})
    static int getTunnelingSupport(int i11) {
        return i11 & 32;
    }

    static boolean isFormatSupported(int i11, boolean z11) {
        int formatSupport = getFormatSupport(i11);
        if (formatSupport != 4) {
            return z11 && formatSupport == 3;
        }
        return true;
    }
    ...
    static int create(int i11) {
        return create(i11, 0, 0, 0);
    }

    static int create(int i11, int i12, int i13) {
        return create(i11, i12, i13, 0, 128, 0);
    }

    static int create(int i11, int i12, int i13, int i14) {
        return create(i11, i12, i13, 0, 128, i14);
    }

    static int create(int i11, int i12, int i13, int i14, int i15) {
        return create(i11, i12, i13, i14, i15, 0);
    }
