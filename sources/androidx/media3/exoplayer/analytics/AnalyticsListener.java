...
public interface AnalyticsListener {
    ...
    @UnstableApi
    @Deprecated
    default void onAudioDecoderInitialized(EventTime eventTime, String str, long j11) {
    }
    ...
    @UnstableApi
    @Deprecated
    default void onPositionDiscontinuity(EventTime eventTime, int i11) {
    }

    @UnstableApi
    @Deprecated
    default void onVideoDecoderInitialized(EventTime eventTime, String str, long j11) {
    }

    @UnstableApi
    @Deprecated
    default void onVideoSizeChanged(EventTime eventTime, int i11, int i12, int i13, float f11) {
    }

    @UnstableApi
    default void onAudioDecoderInitialized(EventTime eventTime, String str, long j11, long j12) {
    }
    ...
    @UnstableApi
    default void onDrmSessionAcquired(EventTime eventTime, int i11) {
    }

    @UnstableApi
    default void onLoadStarted(EventTime eventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, int i11) {
    }

    @UnstableApi
    default void onPositionDiscontinuity(EventTime eventTime, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, int i11) {
    }

    @UnstableApi
    default void onVideoDecoderInitialized(EventTime eventTime, String str, long j11, long j12) {
    }
    ...
    @UnstableApi
    default void onAudioPositionAdvancing(EventTime eventTime, long j11) {
    }

    @UnstableApi
    default void onAudioSessionIdChanged(EventTime eventTime, int i11) {
    }
    ...
    @UnstableApi
    default void onIsLoadingChanged(EventTime eventTime, boolean z11) {
    }

    @UnstableApi
    default void onIsPlayingChanged(EventTime eventTime, boolean z11) {
    }

    @UnstableApi
    @Deprecated
    default void onLoadingChanged(EventTime eventTime, boolean z11) {
    }

    @UnstableApi
    default void onMaxSeekToPreviousPositionChanged(EventTime eventTime, long j11) {
    }
    ...
    @UnstableApi
    default void onPlaybackStateChanged(EventTime eventTime, int i11) {
    }

    @UnstableApi
    default void onPlaybackSuppressionReasonChanged(EventTime eventTime, int i11) {
    }
    ...
    @UnstableApi
    default void onRepeatModeChanged(EventTime eventTime, int i11) {
    }

    @UnstableApi
    default void onSeekBackIncrementChanged(EventTime eventTime, long j11) {
    }

    @UnstableApi
    default void onSeekForwardIncrementChanged(EventTime eventTime, long j11) {
    }

    @UnstableApi
    default void onShuffleModeChanged(EventTime eventTime, boolean z11) {
    }

    @UnstableApi
    default void onSkipSilenceEnabledChanged(EventTime eventTime, boolean z11) {
    }

    @UnstableApi
    default void onTimelineChanged(EventTime eventTime, int i11) {
    }
    ...
    @UnstableApi
    default void onVolumeChanged(EventTime eventTime, float f11) {
    }
    ...
    @UnstableApi
    default void onDeviceVolumeChanged(EventTime eventTime, int i11, boolean z11) {
    }

    @UnstableApi
    default void onDroppedVideoFrames(EventTime eventTime, int i11, long j11) {
    }
    ...
    @UnstableApi
    default void onMediaItemTransition(EventTime eventTime, @Nullable MediaItem mediaItem, int i11) {
    }

    @UnstableApi
    default void onPlayWhenReadyChanged(EventTime eventTime, boolean z11, int i11) {
    }

    @UnstableApi
    @Deprecated
    default void onPlayerStateChanged(EventTime eventTime, boolean z11, int i11) {
    }

    @UnstableApi
    default void onRenderedFirstFrame(EventTime eventTime, Object obj, long j11) {
    }

    @UnstableApi
    default void onSurfaceSizeChanged(EventTime eventTime, int i11, int i12) {
    }

    @UnstableApi
    default void onVideoFrameProcessingOffset(EventTime eventTime, long j11, int i11) {
    }
    ...
    @UnstableApi
    default void onAudioUnderrun(EventTime eventTime, int i11, long j11, long j12) {
    }

    @UnstableApi
    default void onBandwidthEstimate(EventTime eventTime, int i11, long j11, long j12) {
    }

    @UnstableApi
    default void onRendererReadyChanged(EventTime eventTime, int i11, int i12, boolean z11) {
    }

    @UnstableApi
    default void onLoadError(EventTime eventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z11) {
    }
}
