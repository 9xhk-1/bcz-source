...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
    public static final ho.p0<String> DEFAULT_SESSION_ID_GENERATOR = new ho.p0() { // from class: androidx.media3.exoplayer.analytics.u1
        @Override // ho.p0
    ...
    private final ho.p0<String> sessionIdGenerator;
    ...
    public final class SessionDescriptor {
        ...
        public SessionDescriptor(String str, int i11, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            this.sessionId = str;
        ...
        public boolean belongsToSession(int i11, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public boolean isFinishedAtEventTime(AnalyticsListener.EventTime eventTime) {
            ...
            if (mediaPeriodId.windowSequenceNumber > j11) {
                return true;
            }
            ...
            if (!mediaPeriodId2.isAd()) {
                ...
                return i11 == -1 || i11 > this.adMediaPeriodId.adGroupIndex;
            }
            ...
            return i12 > i14 || (i12 == i14 && i13 > mediaPeriodId4.adIndexInAdGroup);
        }

        public void maybeSetWindowSequenceNumber(int i11, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            if (this.windowSequenceNumber != -1 || i11 != this.windowIndex || mediaPeriodId == null || mediaPeriodId.windowSequenceNumber < DefaultPlaybackSessionManager.this.getMinWindowSequenceNumber()) {
                return;
            }
    ...
    private SessionDescriptor getOrAddSession(int i11, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
        SessionDescriptor sessionDescriptor = null;
        long j11 = Long.MAX_VALUE;
        for (SessionDescriptor sessionDescriptor2 : this.sessions.values()) {
            sessionDescriptor2.maybeSetWindowSequenceNumber(i11, mediaPeriodId);
            if (sessionDescriptor2.belongsToSession(i11, mediaPeriodId)) {
                long j12 = sessionDescriptor2.windowSequenceNumber;
                if (j12 == -1 || j12 < j11) {
                    sessionDescriptor = sessionDescriptor2;
                    j11 = j12;
                } else if (j12 == j11 && ((SessionDescriptor) Util.castNonNull(sessionDescriptor)).adMediaPeriodId != null && sessionDescriptor2.adMediaPeriodId != null) {
                    sessionDescriptor = sessionDescriptor2;
                }
            }
        }
        ...
        SessionDescriptor sessionDescriptor3 = new SessionDescriptor(str, i11, mediaPeriodId);
    ...
    public DefaultPlaybackSessionManager(ho.p0<String> p0Var) {
        this.sessionIdGenerator = p0Var;
