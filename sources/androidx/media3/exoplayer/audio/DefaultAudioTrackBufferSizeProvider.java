...
public class DefaultAudioTrackBufferSizeProvider implements DefaultAudioSink.AudioTrackBufferSizeProvider {
    ...
    public static class Builder {
        ...
        @uo.a
        public Builder setDtshdBufferMultiplicationFactor(int i11) {
            this.dtshdBufferMultiplicationFactor = i11;
            return this;
        }
    ...
    public static int durationUsToBytes(int i11, int i12, int i13) {
        return ro.i.e(((i11 * i12) * i13) / 1000000);
    }
    ...
    public int getBufferSizeInBytes(int i11, int i12, int i13, int i14, int i15, int i16, double d11) {
        return (((Math.max(i11, (int) (get1xBufferSizeInBytes(i11, i12, i13, i14, i15, i16) * d11)) + i14) - 1) / i14) * i14;
    }

    public int getOffloadBufferSizeInBytes(int i11) {
        return ro.i.e((this.offloadBufferDurationUs * getMaximumEncodedRateBytesPerSecond(i11)) / 1000000);
    }
