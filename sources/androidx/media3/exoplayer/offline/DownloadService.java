...
public abstract class DownloadService extends Service {
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: androidx.media3.exoplayer.offline.k
        ...
        private DownloadManagerHelper(Context context, DownloadManager downloadManager, boolean z11, @Nullable Scheduler scheduler, Class<? extends DownloadService> cls) {
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.offline.l
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public static Intent buildSetStopReasonIntent(Context context, Class<? extends DownloadService> cls, @Nullable String str, int i11, boolean z11) {
        return getIntent(context, cls, ACTION_SET_STOP_REASON, z11).putExtra("content_id", str).putExtra(KEY_STOP_REASON, i11);
    }
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            Scheduler scheduler = (z11 && (Util.SDK_INT < 31)) ? getScheduler() : null;
            DownloadManager downloadManager = getDownloadManager();
            downloadManager.resumeDownloads();
            DownloadManagerHelper downloadManagerHelper2 = new DownloadManagerHelper(getApplicationContext(), downloadManager, z11, scheduler, cls);
