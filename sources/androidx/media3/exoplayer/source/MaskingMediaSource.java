...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    public static final class MaskingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i11, Timeline.Period period, boolean z11) {
            ...
            if (Objects.equals(period.uid, this.replacedInternalPeriodUid) && z11) {
    ...
    public static final class PlaceholderTimeline extends Timeline {
        ...
        @Override // androidx.media3.common.Timeline
        public Timeline.Period getPeriod(int i11, Timeline.Period period, boolean z11) {
            period.set(z11 ? 0 : null, z11 ? MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID : null, 0, C.TIME_UNSET, 0L, AdPlaybackState.NONE, true);
            return period;
        }
    ...
    public MaskingMediaSource(MediaSource mediaSource, boolean z11) {
        super(mediaSource);
        this.useLazyPreparation = z11 && mediaSource.isSingleWindow();
    ...
    private boolean setPreparePositionOverrideToUnpreparedMaskingPeriod(long j11) {
        MaskingMediaPeriod maskingMediaPeriod = this.unpreparedMaskingMediaPeriod;
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f5027id.periodUid);
        if (indexOfPeriod == -1) {
            return false;
        }
    ...
    */
    public void onChildSourceInfoRefreshed(androidx.media3.common.Timeline r15) {
        ...
        L36:
            ...
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r7 = r7.f5027id
        ...
        L98:
            ...
            if (r0 == 0) goto Lb1
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r15 = r15.f5027id
