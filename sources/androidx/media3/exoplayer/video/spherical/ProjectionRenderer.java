...
final class ProjectionRenderer {
    ...
    public void draw(int i11, float[] fArr, boolean z11) {
        ...
        GLES20.glVertexAttribPointer(this.positionHandle, 3, f.f11703z1, false, 12, (Buffer) meshData.vertexBuffer);
        try {
            GlUtil.checkGlError();
        } catch (GlUtil.GlException e12) {
            Log.e(TAG, "Failed to load position data", e12);
        }
        GLES20.glVertexAttribPointer(this.texCoordsHandle, 2, f.f11703z1, false, 8, (Buffer) meshData.textureBuffer);
        try {
            GlUtil.checkGlError();
