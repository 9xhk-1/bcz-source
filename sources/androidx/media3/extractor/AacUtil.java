...
public final class AacUtil {
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i11, int i12) {
        ...
        throw new IllegalArgumentException("Invalid sample rate or number of channels: " + i11 + j2.O + i12);
    }

    public static byte[] buildAudioSpecificConfig(int i11, int i12, int i13) {
        return new byte[]{(byte) (((i11 << 3) & com.jiongji.andriod.card.R.styleable.Theme_drawable_walk_sound4) | ((i12 >> 1) & 7)), (byte) (((i12 << 7) & 128) | ((i13 << 3) & 120))};
    }
