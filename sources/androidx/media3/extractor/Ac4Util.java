...
public final class Ac4Util {
    ...
    private static int getAdjustedChannelCount(int i11, boolean z11, int i12) {
        int channelCountFromChannelMode = getChannelCountFromChannelMode(i11);
        ...
        return i12 != 0 ? i12 != 1 ? channelCountFromChannelMode : channelCountFromChannelMode - 2 : channelCountFromChannelMode - 4;
    }

    private static int getChannelCountFromChannelMode(int i11) {
        switch (i11) {
            case 0:
                return 1;
            case 1:
    ...
    */
    public static androidx.media3.common.Format parseAc4AnnexEFormat(androidx.media3.common.util.ParsableByteArray r19, java.lang.String r20, @androidx.annotation.Nullable java.lang.String r21, @androidx.annotation.Nullable androidx.media3.common.DrmInitData r22) throws androidx.media3.common.ParserException {
        /*
