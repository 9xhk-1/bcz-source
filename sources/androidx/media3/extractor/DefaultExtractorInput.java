...
public final class DefaultExtractorInput implements ExtractorInput {
    ...
    public boolean advancePeekPosition(int i11, boolean z11) throws IOException {
        ...
        while (i12 < i11) {
            int i13 = i11;
            boolean z12 = z11;
            i12 = readFromUpstream(this.peekBuffer, this.peekBufferPosition, i13, i12, z12);
            if (i12 == -1) {
                return false;
            }
    ...
    public int peek(byte[] bArr, int i11, int i12) throws IOException {
        ...
        int i13 = this.peekBufferLength;
        int i14 = this.peekBufferPosition;
        int i15 = i13 - i14;
        if (i15 == 0) {
            defaultExtractorInput = this;
            min = defaultExtractorInput.readFromUpstream(this.peekBuffer, i14, i12, 0, true);
            if (min == -1) {
                return -1;
            }
        ...
        System.arraycopy(defaultExtractorInput.peekBuffer, defaultExtractorInput.peekBufferPosition, bArr, i11, min);
