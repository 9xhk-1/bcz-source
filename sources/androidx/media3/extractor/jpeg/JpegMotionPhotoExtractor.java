...
final class JpegMotionPhotoExtractor implements Extractor {
    ...
    @Nullable
    private static MotionPhotoMetadata getMotionPhotoMetadata(String str, long j11) throws IOException {
    ...
    public void seek(long j11, long j12) {
        if (j11 == 0) {
            ...
            ((Mp4Extractor) Assertions.checkNotNull(this.mp4Extractor)).seek(j11, j12);
        }
    }
