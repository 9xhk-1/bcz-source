...
final class DefaultOggSeeker implements OggSeeker {
    ...
    public final class OggSeekMap implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j11) {
            return new SeekMap.SeekPoints(new SeekPoint(j11, Util.constrainValue((DefaultOggSeeker.this.payloadStartPosition + BigInteger.valueOf(DefaultOggSeeker.this.streamReader.convertTimeToGranule(j11)).multiply(BigInteger.valueOf(DefaultOggSeeker.this.payloadEndPosition - DefaultOggSeeker.this.payloadStartPosition)).divide(BigInteger.valueOf(DefaultOggSeeker.this.totalGranules)).longValue()) - 30000, DefaultOggSeeker.this.payloadStartPosition, DefaultOggSeeker.this.payloadEndPosition - 1)));
        }
    ...
    private long getNextSeekPosition(ExtractorInput extractorInput) throws IOException {
        ...
        if (j14 < 0) {
            ...
            this.start = extractorInput.getPosition() + i11;
            this.startGranule = this.pageHeader.granulePosition;
        }
        long j15 = this.end;
        long j16 = this.start;
        if (j15 - j16 < SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US) {
            this.end = j16;
            return j16;
        }
    ...
    public void startSeek(long j11) {
        this.targetGranule = Util.constrainValue(j11, 0L, this.totalGranules - 1);
        this.state = 2;
