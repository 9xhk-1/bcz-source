...
final class OggPageHeader {
    ...
    public boolean populate(ExtractorInput extractorInput, boolean z11) throws IOException {
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, 27, z11) || this.scratch.readUnsignedInt() != 1332176723) {
            return false;
        }
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, this.pageSegmentCount, z11)) {
            return false;
        }
    ...
    public boolean skipToNextPage(ExtractorInput extractorInput, long j11) throws IOException {
        ...
        while (true) {
            if ((j11 == -1 || extractorInput.getPosition() + 4 < j11) && ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, 4, true)) {
