...
public final class CuesWithTimingSubtitle implements Subtitle {
    private static final s7<CuesWithTiming> CUES_BY_START_TIME_ASCENDING = s7.z().D(new r() { // from class: androidx.media3.extractor.text.b
        @Override // ho.r
    ...
    */
    public CuesWithTimingSubtitle(java.util.List<androidx.media3.extractor.text.CuesWithTiming> r15) {
        /*
            ...
            r5 = 1
            if (r0 != r5) goto L4a
            java.lang.Object r15 = com.google.common.collect.k6.z(r15)
        ...
        L32:
            ...
            com.google.common.collect.ImmutableList r0 = com.google.common.collect.ImmutableList.of(r0, r3)
            r14.eventCues = r0
            long r3 = r15.durationUs
            long r3 = r3 + r6
        ...
        L4a:
            ...
            r0.<init>()
            com.google.common.collect.s7<androidx.media3.extractor.text.CuesWithTiming> r1 = androidx.media3.extractor.text.CuesWithTimingSubtitle.CUES_BY_START_TIME_ASCENDING
            com.google.common.collect.ImmutableList r15 = com.google.common.collect.ImmutableList.sortedCopyOf(r1, r15)
            r1 = r2
        L67:
            int r5 = r15.size()
            if (r2 >= r5) goto Ld3
        ...
        Lb0:
            ...
            int r11 = r1 + 1
            r10[r1] = r6
            com.google.common.collect.ImmutableList<androidx.media3.common.text.Cue> r1 = r5.cues
            r0.add(r1)
            r1 = r11
        Lbc:
    ...
    private static long normalizeUnsetStartTimeToZero(long j11) {
        if (j11 == C.TIME_UNSET) {
            return 0L;
        }
        return j11;
    ...
    public long getEventTime(int i11) {
        Assertions.checkArgument(i11 < this.eventCues.size());
    ...
    @Override // androidx.media3.extractor.text.Subtitle
    public ImmutableList<Cue> getCues(long j11) {
        int binarySearchFloor = Util.binarySearchFloor(this.eventTimesUs, j11, true, false);
