...
final class TtmlNode {
    ...
    private TtmlNode(@Nullable String str, @Nullable String str2, long j11, long j12, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str3, @Nullable String str4, @Nullable TtmlNode ttmlNode) {
        this.tag = str;
        this.text = str2;
        this.imageId = str4;
    ...
    public static TtmlNode buildNode(@Nullable String str, long j11, long j12, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str2, @Nullable String str3, @Nullable TtmlNode ttmlNode) {
        return new TtmlNode(str, null, j11, j12, ttmlStyle, strArr, str2, str3, ttmlNode);
    }
    ...
    private void traverseForText(long j11, boolean z11, String str, Map<String, Cue.Builder> map) {
        ...
        if (isActive(j11)) {
            ...
            while (i11 < getChildCount()) {
                ...
                child.traverseForText(j12, z12, str2, map2);
                i11++;
                j11 = j12;
                map = map2;
            }
    ...
    public List<Cue> getCues(long j11, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, Map<String, String> map3) {
        ...
        traverseForStyle(j11, map, map2, this.regionId, treeMap);
    ...
    public boolean isActive(long j11) {
        ...
        if (j12 == C.TIME_UNSET && this.endTimeUs == C.TIME_UNSET) {
            return true;
        }
        if (j12 <= j11 && this.endTimeUs == C.TIME_UNSET) {
            return true;
        }
        if (j12 != C.TIME_UNSET || j11 >= this.endTimeUs) {
            return j12 <= j11 && j11 < this.endTimeUs;
        }
        return true;
    }
}
