...
public final class WebvttParser implements SubtitleParser {
    ...
    private static int getNextEvent(ParsableByteArray parsableByteArray) {
        ...
        while (i11 == -1) {
            ...
            i11 = readLine == null ? 0 : STYLE_START.equals(readLine) ? 2 : readLine.startsWith(COMMENT_START) ? 1 : 3;
        }
    ...
    public void parse(byte[] bArr, int i11, int i12, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        ...
        this.parsableWebvttData.reset(bArr, i12 + i11);
        this.parsableWebvttData.setPosition(i11);
