...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        if (format == null || parseAc3SyncframeInfo.channelCount != format.channelCount || parseAc3SyncframeInfo.sampleRate != format.sampleRate || !Objects.equals(parseAc3SyncframeInfo.mimeType, format.sampleMimeType)) {
    ...
    public Ac3Reader(@Nullable String str, int i11, String str2) {
