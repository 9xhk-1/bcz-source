...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private void copyData(ParsableByteArray parsableByteArray, ParsableByteArray parsableByteArray2, boolean z11) {
    ...
    private void finalizeFrame() {
        ...
        double d11 = ((this.standardFrameLength - this.truncationSamples) * 1000000.0d) / this.samplingRate;
        ...
        this.output.sampleMetadata(round, i11, this.frameBytes, 0, null);
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        long j11 = this.mainStreamLabel;
        long j12 = this.header.packetLabel;
        if (j11 != j12) {
            this.mainStreamLabel = j12;
            String str = "mhm1";
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setContainerMimeType(this.containerMimeType).setSampleMimeType(MimeTypes.AUDIO_MPEGH_MHM1).setSampleRate(this.samplingRate).setCodecs(str).setInitializationData((bArr == null || bArr.length <= 0) ? null : ImmutableList.of(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }
    ...
    private boolean shouldParsePacket(int i11) {
        return i11 == 1 || i11 == 17;
    }
