...
final class PsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public static final class PsScrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        private BinarySearchSeeker.TimestampSearchResult searchForScrValueInBuffer(ParsableByteArray parsableByteArray, long j11, long j12) {
                ...
                if (PsBinarySearchSeeker.peekIntAtPosition(parsableByteArray.getData(), parsableByteArray.getPosition()) != 442) {
                    ...
                    if (readScrValueFromPack != C.TIME_UNSET) {
                        ...
                        if (adjustTsTimestamp > j11) {
                            return j13 == C.TIME_UNSET ? BinarySearchSeeker.TimestampSearchResult.overestimatedResult(adjustTsTimestamp, j12) : BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j12 + i12);
                        }
                        if (100000 + adjustTsTimestamp > j11) {
                            return BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j12 + parsableByteArray.getPosition());
                        }
            ...
            return j13 != C.TIME_UNSET ? BinarySearchSeeker.TimestampSearchResult.underestimatedResult(j13, j12 + i11) : BinarySearchSeeker.TimestampSearchResult.NO_TIMESTAMP_IN_RANGE_RESULT;
        }
    ...
    public PsBinarySearchSeeker(TimestampAdjuster timestampAdjuster, long j11, long j12) {
        super(new BinarySearchSeeker.DefaultSeekTimestampConverter(), new PsScrSeeker(timestampAdjuster), j11, 0L, j11 + 1, 0L, j12, 188L, 1000);
    }
