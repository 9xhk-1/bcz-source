...
public final class PsExtractor implements Extractor {
    ...
    private void maybeOutputSeekMap(long j11) {
        ...
        PsBinarySearchSeeker psBinarySearchSeeker = new PsBinarySearchSeeker(this.durationReader.getScrTimestampAdjuster(), this.durationReader.getDurationUs(), j11);
    ...
    public void seek(long j11, long j12) {
        boolean z11 = this.timestampAdjuster.getTimestampOffsetUs() == C.TIME_UNSET;
        if (!z11) {
