...
public final class WearUnsuitableOutputPlaybackSuppressionResolverListener implements Player.Listener {
    ...
    public WearUnsuitableOutputPlaybackSuppressionResolverListener(Context context, @IntRange(from = 0) long j11) {
        this(context, j11, Clock.DEFAULT);
    }

    @VisibleForTesting
    public WearUnsuitableOutputPlaybackSuppressionResolverListener(Context context, @IntRange(from = 0) long j11, Clock clock) {
        PowerManager.WakeLock wakeLock;
        Assertions.checkArgument(j11 >= 0);
        Context applicationContext = context.getApplicationContext();
        this.applicationContext = applicationContext;
        this.autoResumeTimeoutAfterUnsuitableOutputSuppressionMs = j11;
        this.clock = clock;
        this.unsuitableOutputPlaybackSuppressionStartRealtimeMs = C.TIME_UNSET;
        PowerManager powerManager = (PowerManager) applicationContext.getSystemService(c6.d.f8118j);
