...
public final class MultiDex {
    ...
    public static final class V14 {
        ...
        public static void install(ClassLoader classLoader, List<? extends File> list) throws IOException, SecurityException, IllegalArgumentException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
            ...
            try {
                ...
                Log.w(MultiDex.TAG, "Failed find field 'dexElements' attempting 'pathElements'", e11);
            ...
            try {
                ...
                try {
                    try {
                        ...
                        Log.w(TAG, "Failed to install extracted secondary dex files, retrying with forced extraction", e11);
    ...
    private static ApplicationInfo getApplicationInfo(Context context) {
        try {
            ...
            Log.w(TAG, "Failure while trying to obtain ApplicationInfo from Context. Must be running in test mode. Skip patching.", e11);
            return null;
        }
    }
    ...
    private static ClassLoader getDexClassloader(Context context) {
        try {
            ...
            Log.w(TAG, "Failure while trying to obtain Context class loader. Must be running in test mode. Skip patching.", e11);
            return null;
        }
    }
