...
public class ProfileInstallReceiver extends BroadcastReceiver {
    ...
    public class ResultDiagnostics implements ProfileInstaller.DiagnosticsCallback {
        ...
        public void onDiagnosticReceived(int i11, @Nullable Object obj) {
            ProfileInstaller.LOG_DIAGNOSTICS.onDiagnosticReceived(i11, obj);
        }

        @Override // androidx.profileinstaller.ProfileInstaller.DiagnosticsCallback
        public void onResultReceived(int i11, @Nullable Object obj) {
            ProfileInstaller.LOG_DIAGNOSTICS.onResultReceived(i11, obj);
    ...
    public void onReceive(@NonNull Context context, @Nullable Intent intent) {
        ...
        if (ACTION_INSTALL_PROFILE.equals(action)) {
            ProfileInstaller.writeProfile(context, new androidx.media3.exoplayer.offline.a(), new ResultDiagnostics(), true);
            return;
        }
        if (ACTION_SKIP_FILE.equals(action)) {
            ...
            if (extras2 != null) {
                ...
                if (EXTRA_SKIP_FILE_OPERATION_WRITE.equals(string)) {
                    ProfileInstaller.writeSkipFile(context, new androidx.media3.exoplayer.offline.a(), new ResultDiagnostics());
                    return;
                } else {
                    if (EXTRA_SKIP_FILE_OPERATION_DELETE.equals(string)) {
                        ProfileInstaller.deleteSkipFile(context, new androidx.media3.exoplayer.offline.a(), new ResultDiagnostics());
                        return;
                    }
                    return;
                }
