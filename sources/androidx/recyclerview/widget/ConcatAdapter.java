...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final class Config {
        ...
        public static final class Builder {
            ...
            @NonNull
            public Builder setIsolateViewTypes(boolean z11) {
                this.mIsolateViewTypes = z11;
                return this;
            }
    ...
    public int findRelativeAdapterPositionIn(@NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, @NonNull RecyclerView.ViewHolder viewHolder, int i11) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, i11);
    }
    ...
    public long getItemId(int i11) {
        return this.mController.getItemId(i11);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i11) {
        return this.mController.getItemViewType(i11);
    }

    @NonNull
    public Pair<RecyclerView.Adapter<? extends RecyclerView.ViewHolder>, Integer> getWrappedAdapterAndPosition(int i11) {
        return this.mController.getWrappedAdapterAndPosition(i11);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i11) {
        this.mController.onBindViewHolder(viewHolder, i11);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    @NonNull
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i11) {
        return this.mController.onCreateViewHolder(viewGroup, i11);
    }
    ...
    public boolean addAdapter(int i11, @NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter) {
        return this.mController.addAdapter(i11, adapter);
    }
