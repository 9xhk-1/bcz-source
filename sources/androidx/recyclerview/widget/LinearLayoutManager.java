...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            return "AnchorInfo{mPosition=" + this.mPosition + ", mCoordinate=" + this.mCoordinate + ", mLayoutFromEnd=" + this.mLayoutFromEnd + ", mValid=" + this.mValid + b.f69928j;
        }
    }
    ...
    public View findOnePartiallyOrCompletelyInvisibleChild(int i11, int i12) {
        ...
        return this.mOrientation == 0 ? this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i11, i12, i13, i14) : this.mVerticalBoundCheck.findOneViewWithinBoundFlags(i11, i12, i13, i14);
    }

    public View findOneVisibleChild(int i11, int i12, boolean z11, boolean z12) {
        ensureLayoutState();
        int i13 = MediaSessionCompat.K;
        int i14 = z11 ? 24579 : 320;
        if (!z12) {
            i13 = 0;
        }
        return this.mOrientation == 0 ? this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i11, i12, i14, i13) : this.mVerticalBoundCheck.findOneViewWithinBoundFlags(i11, i12, i14, i13);
    }
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i15 = i16 - layoutChunkResult.mConsumed;
            } else {
                i15 = layoutState.mOffset;
                i16 = layoutChunkResult.mConsumed + i15;
            }
            int i17 = paddingLeft;
            i14 = i15;
            i13 = i17;
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i13 = i18 - layoutChunkResult.mConsumed;
                i11 = i18;
                i12 = decoratedMeasurementInOther2;
            } else {
                int i19 = layoutState.mOffset;
                i11 = layoutChunkResult.mConsumed + i19;
                i12 = decoratedMeasurementInOther2;
                i13 = i19;
            }
            i14 = paddingTop;
        }
        layoutDecoratedWithMargins(next, i13, i14, i11, i12);
