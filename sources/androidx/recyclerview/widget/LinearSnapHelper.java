...
public class LinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i11, int i12) {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i11, int i12) {
        ...
        if (layoutManager.canScrollVertically()) {
            i15 = estimateNextPositionDiffForFling(layoutManager, getVerticalHelper(layoutManager), 0, i12);
