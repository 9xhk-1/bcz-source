...
@l00.d(c = "androidx.room.TriggerBasedInvalidationTracker$syncTriggers$2$1", f = "InvalidationTracker.kt", i = {0}, l = {301, 309}, m = "invokeSuspend", n = {c60.c.f8163j}, s = {"L$0"})
/* loaded from: classes3.dex */
public final class TriggerBasedInvalidationTracker$syncTriggers$2$1 extends SuspendLambda implements x00.p<Transactor, j00.c<? super g2>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ TriggerBasedInvalidationTracker this$0;

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    @l00.d(c = "androidx.room.TriggerBasedInvalidationTracker$syncTriggers$2$1$1", f = "InvalidationTracker.kt", i = {0, 0, 1, 1}, l = {313, 314}, m = "invokeSuspend", n = {"$this$forEachIndexed$iv", "index$iv", "$this$forEachIndexed$iv", "index$iv"}, s = {"L$0", "I$0", "L$0", "I$0"})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements x00.p<TransactionScope<g2>, j00.c<? super g2>, Object> {
        ...
        public AnonymousClass1(ObservedTableStates.ObserveOp[] observeOpArr, TriggerBasedInvalidationTracker triggerBasedInvalidationTracker, Transactor transactor, j00.c<? super AnonymousClass1> cVar) {
            super(2, cVar);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TriggerBasedInvalidationTracker$syncTriggers$2$1(TriggerBasedInvalidationTracker triggerBasedInvalidationTracker, j00.c<? super TriggerBasedInvalidationTracker$syncTriggers$2$1> cVar) {
        super(2, cVar);
        this.this$0 = triggerBasedInvalidationTracker;
    }
    ...
    public final Object invoke(Transactor transactor, j00.c<? super g2> cVar) {
        return ((TriggerBasedInvalidationTracker$syncTriggers$2$1) create(transactor, cVar)).invokeSuspend(g2.f100423a);
    }
