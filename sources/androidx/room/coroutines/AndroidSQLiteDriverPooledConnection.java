...
final class AndroidSQLiteDriverPooledConnection implements Transactor, RawConnectionAccessor {
    ...
    public final class AndroidSQLiteDriverTransactor<T> implements TransactionScope<T>, RawConnectionAccessor {
        ...
        @l
        public Object rollback(T t11, @k j00.c<?> cVar) {
    ...
    public AndroidSQLiteDriverPooledConnection(@k AndroidSQLiteConnection delegate) {
    ...
    */
    public final <R> java.lang.Object transaction(androidx.room.Transactor.SQLiteTransactionType r6, x00.p<? super androidx.room.TransactionScope<R>, ? super j00.c<? super R>, ? extends java.lang.Object> r7, j00.c<? super R> r8) {
        ...
        Lbd:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.room.coroutines.AndroidSQLiteDriverPooledConnection.transaction(androidx.room.Transactor$SQLiteTransactionType, x00.p, j00.c):java.lang.Object");
    }
    ...
    public Object inTransaction(@k j00.c<? super Boolean> cVar) {
        return l00.a.a(this.delegate.getDb().inTransaction());
    }
