...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    public LimitOffsetDataSource(RoomDatabase roomDatabase, SupportSQLiteQuery supportSQLiteQuery, boolean z11, String... strArr) {
    ...
    private RoomSQLiteQuery getSQLiteQuery(int i11, int i12) {
        ...
        acquire.bindLong(acquire.getArgCount() - 1, i12);
        acquire.bindLong(acquire.getArgCount(), i11);
        return acquire;
    }
    ...
    public void loadInitial(PositionalDataSource.LoadInitialParams loadInitialParams, PositionalDataSource.LoadInitialCallback<T> loadInitialCallback) {
        ...
        try {
            ...
            loadInitialCallback.onResult(list, i11, countItems);
        } catch (Throwable th3) {
            th = th3;
    ...
    public LimitOffsetDataSource(RoomDatabase roomDatabase, SupportSQLiteQuery supportSQLiteQuery, boolean z11, boolean z12, String... strArr) {
    ...
    public LimitOffsetDataSource(RoomDatabase roomDatabase, RoomSQLiteQuery roomSQLiteQuery, boolean z11, String... strArr) {
        this(roomDatabase, roomSQLiteQuery, z11, true, strArr);
    }

    public LimitOffsetDataSource(RoomDatabase roomDatabase, RoomSQLiteQuery roomSQLiteQuery, boolean z11, boolean z12, String... strArr) {
