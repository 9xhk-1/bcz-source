...
@l00.d(c = "androidx.room.support.QueryInterceptorDatabase$query$3", f = "QueryInterceptorDatabase.android.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class QueryInterceptorDatabase$query$3 extends SuspendLambda implements x00.p<r0, j00.c<? super g2>, Object> {
    ...
    public QueryInterceptorDatabase$query$3(QueryInterceptorDatabase queryInterceptorDatabase, SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram, j00.c<? super QueryInterceptorDatabase$query$3> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(r0 r0Var, j00.c<? super g2> cVar) {
        return ((QueryInterceptorDatabase$query$3) create(r0Var, cVar)).invokeSuspend(g2.f100423a);
    }
