...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionHorizontal(View view, int i11, int i12) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                return Math.max(Math.min(i11, width), width - SlidingPaneLayout.this.mSlideRange);
            }
            int paddingLeft = SlidingPaneLayout.this.getPaddingLeft() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
            return Math.min(Math.max(i11, paddingLeft), SlidingPaneLayout.this.mSlideRange + paddingLeft);
        }
        ...
        public void onEdgeDragStarted(int i11, int i12) {
            ...
            slidingPaneLayout.mDragHelper.captureChildView(slidingPaneLayout.mSlideableView, i12);
        }
        ...
        public void onViewPositionChanged(View view, int i11, int i12, int i13, int i14) {
            SlidingPaneLayout.this.onPanelDragged(i11);
        ...
        public void onViewReleased(View view, float f11, float f12) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                if (f11 < 0.0f || (f11 == 0.0f && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
    ...
    private void dimChildView(View view, float f11, int i11) {
        ...
        if (f11 > 0.0f && i11 != 0) {
            ...
            layoutParams.dimPaint.setColorFilter(new PorterDuffColorFilter(i12, PorterDuff.Mode.SRC_OVER));
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mDragHelper.isViewUnder(this.mSlideableView, (int) x11, (int) y11) && isDimmed(this.mSlideableView)) {
                z11 = true;
                return !this.mDragHelper.shouldInterceptTouchEvent(motionEvent) || z11;
            }
    ...
    */
    ...
    public void onPanelDragged(int i11) {
        ...
        float paddingRight = (i11 - ((isLayoutRtlSupport ? getPaddingRight() : getPaddingLeft()) + (isLayoutRtlSupport ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin))) / this.mSlideRange;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 1 && isDimmed(this.mSlideableView)) {
            ...
            if ((f11 * f11) + (f12 * f12) < touchSlop * touchSlop && this.mDragHelper.isViewUnder(this.mSlideableView, (int) x12, (int) y12)) {
    ...
    public boolean smoothSlideTo(float f11, int i11) {
        int paddingLeft;
        if (!this.mCanSlide) {
            return false;
        }
        ...
        LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (isLayoutRtlSupport) {
            paddingLeft = (int) (getWidth() - (((getPaddingRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) + (f11 * this.mSlideRange)) + this.mSlideableView.getWidth()));
        } else {
            paddingLeft = (int) (getPaddingLeft() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + (f11 * this.mSlideRange));
        }
    ...
    public void updateObscuredViewsVisibility(View view) {
        ...
        while (i15 < childCount && (childAt = getChildAt(i15)) != view2) {
            if (childAt.getVisibility() == 8) {
                z11 = isLayoutRtlSupport;
            } else {
                z11 = isLayoutRtlSupport;
                childAt.setVisibility((Math.max(isLayoutRtlSupport ? paddingLeft : width, childAt.getLeft()) < i11 || Math.max(paddingTop, childAt.getTop()) < i13 || Math.min(isLayoutRtlSupport ? width : paddingLeft, childAt.getRight()) > i12 || Math.min(height, childAt.getBottom()) > i14) ? 0 : 4);
            }
            i15++;
            view2 = view;
            isLayoutRtlSupport = z11;
        }
    }
    ...
    public SlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        this.mOverhangSize = (int) ((32.0f * f11) + 0.5f);
