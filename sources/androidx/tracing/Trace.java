...
public final class Trace {
    ...
    public static void beginAsyncSection(@NonNull String str, int i11) {
        if (Build.VERSION.SDK_INT >= 29) {
            TraceApi29Impl.beginAsyncSection(truncatedTraceSectionLabel(str), i11);
        } else {
            beginAsyncSectionFallback(truncatedTraceSectionLabel(str), i11);
        }
    }
    ...
    private static void beginAsyncSectionFallback(@NonNull String str, int i11) {
        try {
            ...
            sAsyncTraceBeginMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i11));
        } catch (Exception e11) {
    ...
    public static void endAsyncSection(@NonNull String str, int i11) {
        if (Build.VERSION.SDK_INT >= 29) {
            TraceApi29Impl.endAsyncSection(truncatedTraceSectionLabel(str), i11);
        } else {
            endAsyncSectionFallback(truncatedTraceSectionLabel(str), i11);
        }
    }
    ...
    private static void endAsyncSectionFallback(@NonNull String str, int i11) {
        try {
            ...
            sAsyncTraceEndMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i11));
        } catch (Exception e11) {
    ...
    public static void setCounter(@NonNull String str, int i11) {
        if (Build.VERSION.SDK_INT >= 29) {
            TraceApi29Impl.setCounter(truncatedTraceSectionLabel(str), i11);
        } else {
            setCounterFallback(truncatedTraceSectionLabel(str), i11);
        }
    }
    ...
    private static void setCounterFallback(@NonNull String str, int i11) {
        try {
            ...
            sTraceCounterMethod.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i11));
        } catch (Exception e11) {
