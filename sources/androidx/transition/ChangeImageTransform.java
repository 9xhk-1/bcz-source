...
public class ChangeImageTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues, boolean z11) {
        ...
        if ((view instanceof ImageView) && view.getVisibility() == 0) {
            ...
            Matrix matrix = z11 ? (Matrix) imageView.getTag(R.id.transition_image_transform) : null;
            if (matrix == null) {
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        int i11 = AnonymousClass3.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        return i11 != 1 ? i11 != 2 ? new Matrix(imageView.getImageMatrix()) : centerCropMatrix(imageView) : fitXYMatrix(imageView);
    }
