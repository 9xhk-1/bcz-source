...
public class ChangeTransform extends Transition {
    ...
    public static class Listener extends AnimatorListenerAdapter {
        ...
        public Listener(View view, Transforms transforms, PathAnimatorMatrix pathAnimatorMatrix, Matrix matrix, boolean z11, boolean z12) {
            this.mHandleParentChange = z11;
            this.mUseOverlay = z12;
            this.mView = view;
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z11) {
        ...
        Listener listener = new Listener(view, transforms, pathAnimatorMatrix, matrix3, z11, this.mUseOverlay);
    ...
    public static void setTransforms(View view, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18) {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        boolean z11 = this.mReparent && !parentsMatch(viewGroup2, (ViewGroup) transitionValues2.values.get(PROPNAME_PARENT));
        ...
        if (z11 && createTransformAnimator != null && this.mUseOverlay) {
