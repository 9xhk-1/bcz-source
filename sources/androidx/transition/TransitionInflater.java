...
public class TransitionInflater {
    ...
    */
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException("Could not create " + namedString3, e11);
                                    }
                                } else {
    ...
    @Nullable
    public Transition inflateTransition(int i11) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i11);
        try {
            try {
    ...
    @Nullable
    public TransitionManager inflateTransitionManager(int i11, @NonNull ViewGroup viewGroup) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i11);
        try {
            try {
                return createTransitionManagerFromXml(xml, Xml.asAttributeSet(xml), viewGroup);
            } catch (IOException e11) {
                InflateException inflateException = new InflateException(xml.getPositionDescription() + ": " + e11.getMessage());
