...
public abstract class Visibility extends Transition {
    ...
    public static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        private void suppressLayout(boolean z11) {
            ...
            ViewGroupUtils.suppressLayout(viewGroup, z11);
        }
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            int i11 = visibilityInfo.mStartVisibility;
            int i12 = visibilityInfo.mEndVisibility;
            if (i11 != i12 || visibilityInfo.mStartParent != visibilityInfo.mEndParent) {
                if (i11 != i12) {
                    if (i11 == 0) {
                        visibilityInfo.mFadeIn = false;
    ...
    @Nullable
    public Animator onAppear(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, int i11, @Nullable TransitionValues transitionValues2, int i12) {
