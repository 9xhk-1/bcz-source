...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i11 = 0; i11 < size; i11++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(i11);
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i11) {
    ...
    public boolean onLevelChange(int i11) {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? drawable.setLevel(i11) : this.mAnimatedVectorState.mVectorDrawable.setLevel(i11);
    }
    ...
    public void setAlpha(int i11) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i11);
        }
    }
    ...
    public void setAutoMirrored(boolean z11) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAutoMirrored(z11);
        }
    }
    ...
    public void setTint(int i11) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i11);
        }
    }
    ...
    public boolean setVisible(boolean z11, boolean z12) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z11, z12);
