...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public void createCachedBitmapIfNeeded(int i11, int i12) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i11, i12)) {
        ...
        public void updateCachedBitmap(int i11, int i12) {
            ...
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i11, i12, null);
        }
    ...
    public static int applyAlpha(int i11, float f11) {
        return (i11 & 16777215) | (((int) (Color.alpha(i11) * f11)) << 24);
    }

    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources resources, @DrawableRes int i11, @Nullable Resources.Theme theme) {
        VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
        vectorDrawableCompat.mDelegateDrawable = ResourcesCompat.getDrawable(resources, i11, theme);
    ...
    private void printGroupTree(VGroup vGroup, int i11) {
        ...
        for (int i13 = 0; i13 < vGroup.mChildren.size(); i13++) {
            VObject vObject = vGroup.mChildren.get(i13);
    ...
    public float getPixelSize() {
        ...
        float f11 = vPathRenderer.mBaseWidth;
        if (f11 == 0.0f) {
            return 1.0f;
        }
        float f12 = vPathRenderer.mBaseHeight;
        if (f12 == 0.0f) {
            return 1.0f;
        }
        float f13 = vPathRenderer.mViewportHeight;
        if (f13 == 0.0f) {
            return 1.0f;
        }
        float f14 = vPathRenderer.mViewportWidth;
        if (f14 == 0.0f) {
            return 1.0f;
        }
    ...
    public void setAlpha(int i11) {
        ...
        } else if (this.mVectorState.mVPathRenderer.getRootAlpha() != i11) {
            this.mVectorState.mVPathRenderer.setRootAlpha(i11);
            invalidateSelf();
        }
    }
    ...
    public void setAutoMirrored(boolean z11) {
        ...
        if (drawable != null) {
            ...
            this.mVectorState.mAutoMirrored = z11;
        }
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i11 = 0; i11 < pathDataNodeArr.length; i11++) {
                str = str + pathDataNodeArr[i11].mType + ":";
                for (float f11 : pathDataNodeArr[i11].mParams) {
                    str = str + f11 + ",";
                }
            }
            return str;
    ...
    public static class VFullPath extends VPath {
        ...
        public void setStrokeColor(int i11) {
            this.mStrokeColor.setColor(i11);
        }
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i11, int i12, ColorFilter colorFilter) {
            ...
            canvas.save();
            int i13 = 0;
            while (i13 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i13);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i11, i12, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i11, i12, colorFilter);
                }
                i13++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i11, int i12, ColorFilter colorFilter) {
            float f11 = i11 / this.mViewportWidth;
            float f12 = i12 / this.mViewportHeight;
            ...
            float f13 = vFullPath.mTrimPathStart;
            if (f13 != 0.0f || vFullPath.mTrimPathEnd != 1.0f) {
                float f14 = vFullPath.mTrimPathOffset;
                float f15 = (f13 + f14) % 1.0f;
                float f16 = (vFullPath.mTrimPathEnd + f14) % 1.0f;
        ...
        public void draw(Canvas canvas, int i11, int i12, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i11, i12, colorFilter);
        }
    ...
    public static class VGroup extends VObject {
        ...
        public boolean isStateful() {
            for (int i11 = 0; i11 < this.mChildren.size(); i11++) {
                if (this.mChildren.get(i11).isStateful()) {
                    return true;
                }
            }
            return false;
        ...
        public boolean onStateChanged(int[] iArr) {
            boolean z11 = false;
            for (int i11 = 0; i11 < this.mChildren.size(); i11++) {
                z11 |= this.mChildren.get(i11).onStateChanged(iArr);
            }
            return z11;
        }
