...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        public void updateFragmentMaxLifecycle(boolean z11) {
            ...
            if ((itemId != this.mPrimaryItemId || z11) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                this.mPrimaryItemId = itemId;
                FragmentTransaction beginTransaction = FragmentStateAdapter.this.mFragmentManager.beginTransaction();
                ArrayList arrayList = new ArrayList();
                Fragment fragment2 = null;
                for (int i11 = 0; i11 < FragmentStateAdapter.this.mFragments.size(); i11++) {
                    long keyAt = FragmentStateAdapter.this.mFragments.keyAt(i11);
                    Fragment valueAt = FragmentStateAdapter.this.mFragments.valueAt(i11);
                    if (valueAt.isAdded()) {
    ...
    private boolean isFragmentViewBound(long j11) {
        ...
        Fragment fragment = this.mFragments.get(j11);
    ...
    private void removeFragment(long j11) {
        ...
        if (fragment.isAdded() && containsItem(j11)) {
            ...
            this.mSavedStates.put(j11, saveFragmentInstanceState);
        }
    ...
    public void gcFragments() {
        ...
        for (int i11 = 0; i11 < this.mFragments.size(); i11++) {
            long keyAt = this.mFragments.keyAt(i11);
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i12 = 0; i12 < this.mFragments.size(); i12++) {
                long keyAt2 = this.mFragments.keyAt(i12);
