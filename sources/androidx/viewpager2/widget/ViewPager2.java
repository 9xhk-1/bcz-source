...
public final class ViewPager2 extends ViewGroup {
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public boolean performAccessibilityAction(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State state, int i11, @Nullable Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i11) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i11) : super.performAccessibilityAction(recycler, state, i11, bundle);
        }
