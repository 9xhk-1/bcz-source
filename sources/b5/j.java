...
public final class j implements c1 {
    ...
    public static final /* synthetic */ class a implements j50.p0<j> {
        ...
        static {
            a aVar = new a();
            f5905a = aVar;
            j50.u0 u0Var = new j50.u0("com.baicizhan.app.biz.game.impl.unity.command.CheckResourceRsp", aVar);
            u0Var.q("value", false);
            descriptor = u0Var;
        }
        ...
        public final boolean g(@m80.k i50.f decoder) {
            ...
            return j.b(decoder.decodeInline(descriptor).decodeBoolean());
        }
    ...
    public static boolean c(boolean z11, Object obj) {
        return (obj instanceof j) && z11 == ((j) obj).h();
    }
    ...
    public static String g(boolean z11) {
        return "CheckResourceRsp(value=" + z11 + ')';
    }
