...
public abstract class i extends Fragment implements gv.d {

    /* renamed from: a, reason: collision with root package name */
    public ContextWrapper f6689a;

    /* renamed from: b, reason: collision with root package name */
    public boolean f6690b;

    /* renamed from: c, reason: collision with root package name */
    public volatile xu.g f6691c;
    ...
    public i() {
        this.f6692d = new Object();
        this.f6693e = false;
    }

    private void initializeComponentContext() {
        if (this.f6689a == null) {
            this.f6689a = xu.g.b(super.getContext(), this);
            this.f6690b = su.a.a(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f6690b) {
            return null;
        }
    ...
    public void inject() {
        ...
        this.f6693e = true;
        ((f) generatedComponent()).f((d) gv.i.a(this));
    }
    ...
    public final xu.g componentManager() {
        if (this.f6691c == null) {
            synchronized (this.f6692d) {
                try {
                    if (this.f6691c == null) {
                        this.f6691c = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f6689a;
