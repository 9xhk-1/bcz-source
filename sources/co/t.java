...
public final class t implements x {
    ...
    public static final int f9509c = -1;
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ float f9513b;
        ...
        public void onAnimationEnd(Animator animator) {
            this.f9512a.setTranslationX(this.f9513b);
        }
    }
    ...
    public class b extends AnimatorListenerAdapter {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ float f9515b;
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            this.f9514a.setTranslationY(this.f9515b);
        }
    }
    ...
    public Animator a(@NonNull ViewGroup viewGroup, @NonNull View view) {
        return d(viewGroup, view, this.f9510a, h(view.getContext()));
    }

    @Override // co.x
    @Nullable
    public Animator b(@NonNull ViewGroup viewGroup, @NonNull View view) {
        return c(viewGroup, view, this.f9510a, h(view.getContext()));
    }
