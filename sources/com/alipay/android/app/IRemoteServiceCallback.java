...
public interface IRemoteServiceCallback extends IInterface {
    ...
    void payEnd(boolean z11, String str) throws RemoteException;

    void r03(String str, String str2, Map map) throws RemoteException;

    void startActivity(String str, String str2, int i11, Bundle bundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IRemoteServiceCallback {
        ...
        public static class a implements IRemoteServiceCallback {
            ...
            public IBinder f10251a;

            public a(IBinder iBinder) {
                this.f10251a = iBinder;
            }
            ...
            public int getVersion() throws RemoteException {
                ...
                try {
                    ...
                    this.f10251a.transact(4, obtain, obtain2, 0);
            ...
            public boolean isHideLoadingScreen() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f10251a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void payEnd(boolean z11, String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f10251a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void r03(String str, String str2, Map map) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeMap(map);
                    this.f10251a.transact(5, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void startActivity(String str, String str2, int i11, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f10251a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                    obtain2.recycle();
                    obtain.recycle();
                } catch (Throwable th2) {
