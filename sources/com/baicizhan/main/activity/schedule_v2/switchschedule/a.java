...
public abstract class a extends Fragment implements gv.d {
    ...
    public ContextWrapper f19461a;

    /* renamed from: b, reason: collision with root package name */
    public boolean f19462b;

    /* renamed from: c, reason: collision with root package name */
    public volatile xu.g f19463c;
    ...
    public a() {
        this.f19464d = new Object();
        this.f19465e = false;
    }

    private void initializeComponentContext() {
        if (this.f19461a == null) {
            this.f19461a = xu.g.b(super.getContext(), this);
            this.f19462b = su.a.a(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f19462b) {
            return null;
        }
    ...
    public void inject() {
        ...
        this.f19465e = true;
        ((p) generatedComponent()).h((SwitchScheduleFragment) gv.i.a(this));
    }
    ...
    public final xu.g componentManager() {
        if (this.f19463c == null) {
            synchronized (this.f19464d) {
                try {
                    if (this.f19463c == null) {
                        this.f19463c = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f19461a;
