...
public class BBRedirectInfo implements TBase<BBRedirectInfo, _Fields>, Serializable, Cloneable, Comparable<BBRedirectInfo> {
    ...
    public BBRedirectType redirect_type;
    public String redirect_url;
    public int sys_notify_id;
    public String taobao_item_id;
    private static final TStruct STRUCT_DESC = new TStruct("BBRedirectInfo");
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.bs_users.BBRedirectInfo$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields = iArr;
            try {
                iArr[_Fields.REDIRECT_TYPE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields[_Fields.REDIRECT_URL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields[_Fields.TAOBAO_ITEM_ID.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields[_Fields.SYS_NOTIFY_ID.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields[_Fields.MALL_URL.ordinal()] = 5;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BBRedirectInfoStandardScheme extends StandardScheme<BBRedirectInfo> {
        private BBRedirectInfoStandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, BBRedirectInfo struct) throws TException {
            ...
            while (true) {
                ...
                if (s11 != 1) {
                    ...
                    struct.redirect_type = BBRedirectType.findByValue(iprot.readI32());
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, BBRedirectInfo struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(BBRedirectInfo.STRUCT_DESC);
            if (struct.redirect_type != null) {
                oprot.writeFieldBegin(BBRedirectInfo.REDIRECT_TYPE_FIELD_DESC);
                oprot.writeI32(struct.redirect_type.getValue());
                oprot.writeFieldEnd();
            }
            if (struct.redirect_url != null) {
                oprot.writeFieldBegin(BBRedirectInfo.REDIRECT_URL_FIELD_DESC);
                oprot.writeString(struct.redirect_url);
                oprot.writeFieldEnd();
            }
            if (struct.taobao_item_id != null && struct.isSetTaobao_item_id()) {
                oprot.writeFieldBegin(BBRedirectInfo.TAOBAO_ITEM_ID_FIELD_DESC);
                oprot.writeString(struct.taobao_item_id);
                oprot.writeFieldEnd();
            }
            if (struct.isSetSys_notify_id()) {
                oprot.writeFieldBegin(BBRedirectInfo.SYS_NOTIFY_ID_FIELD_DESC);
                oprot.writeI32(struct.sys_notify_id);
                oprot.writeFieldEnd();
            }
            if (struct.mall_url != null && struct.isSetMall_url()) {
                oprot.writeFieldBegin(BBRedirectInfo.MALL_URL_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BBRedirectInfoStandardSchemeFactory implements SchemeFactory {
        private BBRedirectInfoStandardSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public BBRedirectInfoStandardScheme getScheme() {
            return new BBRedirectInfoStandardScheme();
        }
    }

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BBRedirectInfoTupleScheme extends TupleScheme<BBRedirectInfo> {
        private BBRedirectInfoTupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, BBRedirectInfo struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
            struct.redirect_type = BBRedirectType.findByValue(tTupleProtocol.readI32());
            struct.setRedirect_typeIsSet(true);
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, BBRedirectInfo struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BBRedirectInfoTupleSchemeFactory implements SchemeFactory {
        private BBRedirectInfoTupleSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public BBRedirectInfoTupleScheme getScheme() {
            return new BBRedirectInfoTupleScheme();
        }
    }
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new BBRedirectInfoStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new BBRedirectInfoTupleSchemeFactory());
        EnumMap enumMap = new EnumMap(_Fields.class);
        enumMap.put((EnumMap) _Fields.REDIRECT_TYPE, (_Fields) new FieldMetaData("redirect_type", (byte) 1, new EnumMetaData((byte) 16, BBRedirectType.class)));
        ...
        FieldMetaData.addStructMetaDataMap(BBRedirectInfo.class, unmodifiableMap);
    }

    public BBRedirectInfo() {
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof BBRedirectInfo)) {
            return equals((BBRedirectInfo) that);
        }
        return false;
    }
    ...
    public BBRedirectType getRedirect_type() {
    ...
    public BBRedirectInfo setMall_url(String mall_url) {
    ...
    public BBRedirectInfo setRedirect_type(BBRedirectType redirect_type) {
    ...
    public BBRedirectInfo setRedirect_url(String redirect_url) {
    ...
    public BBRedirectInfo setSys_notify_id(int sys_notify_id) {
    ...
    public BBRedirectInfo setTaobao_item_id(String taobao_item_id) {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("BBRedirectInfo(");
        sb2.append("redirect_type:");
        BBRedirectType bBRedirectType = this.redirect_type;
        if (bBRedirectType == null) {
            sb2.append("null");
        } else {
            sb2.append(bBRedirectType);
        }
        sb2.append(j2.O);
    ...
    public int compareTo(BBRedirectInfo other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
    ...
    public TBase<BBRedirectInfo, _Fields> deepCopy2() {
        return new BBRedirectInfo(this);
    }
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$bs_users$BBRedirectInfo$_Fields[field.ordinal()];
        if (i11 == 1) {
    ...
    public void setFieldValue(_Fields field, Object value) {
        ...
        if (i11 == 1) {
            if (value == null) {
                ...
                setRedirect_type((BBRedirectType) value);
                return;
            }
        }
        if (i11 == 2) {
    ...
    public boolean equals(BBRedirectInfo that) {
        if (that == null) {
            return false;
        }
    ...
    public BBRedirectInfo(BBRedirectType redirect_type, String redirect_url) {
        this();
        this.redirect_type = redirect_type;
        this.redirect_url = redirect_url;
    }

    public BBRedirectInfo(BBRedirectInfo other) {
        this.__isset_bitfield = (byte) 0;
        this.optionals = new _Fields[]{_Fields.TAOBAO_ITEM_ID, _Fields.SYS_NOTIFY_ID, _Fields.MALL_URL};
