...
public class BBTopicAsset implements TBase<BBTopicAsset, _Fields>, Serializable, Cloneable, Comparable<BBTopicAsset> {
    ...
    public static class BBTopicAssetStandardScheme extends StandardScheme<BBTopicAsset> {
        ...
        public void read(TProtocol iprot, BBTopicAsset struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, BBTopicAsset struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(BBTopicAsset.STRUCT_DESC);
            oprot.writeFieldBegin(BBTopicAsset.TOPIC_ID_FIELD_DESC);
            oprot.writeI32(struct.topic_id);
            oprot.writeFieldEnd();
            if (struct.word != null) {
                oprot.writeFieldBegin(BBTopicAsset.WORD_FIELD_DESC);
                oprot.writeString(struct.word);
                oprot.writeFieldEnd();
            }
            if (struct.word_variants != null) {
                oprot.writeFieldBegin(BBTopicAsset.WORD_VARIANTS_FIELD_DESC);
                oprot.writeString(struct.word_variants);
                oprot.writeFieldEnd();
            }
            if (struct.word_audio != null) {
                oprot.writeFieldBegin(BBTopicAsset.WORD_AUDIO_FIELD_DESC);
                oprot.writeString(struct.word_audio);
                oprot.writeFieldEnd();
            }
            if (struct.word_etyma != null) {
                oprot.writeFieldBegin(BBTopicAsset.WORD_ETYMA_FIELD_DESC);
                oprot.writeString(struct.word_etyma);
                oprot.writeFieldEnd();
            }
            if (struct.image_file != null) {
                oprot.writeFieldBegin(BBTopicAsset.IMAGE_FILE_FIELD_DESC);
                oprot.writeString(struct.image_file);
                oprot.writeFieldEnd();
            }
            if (struct.accent != null) {
                oprot.writeFieldBegin(BBTopicAsset.ACCENT_FIELD_DESC);
                oprot.writeString(struct.accent);
                oprot.writeFieldEnd();
            }
            if (struct.mean_cn != null) {
                oprot.writeFieldBegin(BBTopicAsset.MEAN_CN_FIELD_DESC);
                oprot.writeString(struct.mean_cn);
                oprot.writeFieldEnd();
            }
            if (struct.mean_en != null) {
                oprot.writeFieldBegin(BBTopicAsset.MEAN_EN_FIELD_DESC);
                oprot.writeString(struct.mean_en);
                oprot.writeFieldEnd();
            }
            if (struct.short_phrase != null) {
                oprot.writeFieldBegin(BBTopicAsset.SHORT_PHRASE_FIELD_DESC);
                oprot.writeString(struct.short_phrase);
                oprot.writeFieldEnd();
            }
            if (struct.deformation_img != null) {
                oprot.writeFieldBegin(BBTopicAsset.DEFORMATION_IMG_FIELD_DESC);
                oprot.writeString(struct.deformation_img);
                oprot.writeFieldEnd();
            }
            if (struct.deformation_desc != null) {
                oprot.writeFieldBegin(BBTopicAsset.DEFORMATION_DESC_FIELD_DESC);
                oprot.writeString(struct.deformation_desc);
                oprot.writeFieldEnd();
            }
            if (struct.sentence != null) {
                oprot.writeFieldBegin(BBTopicAsset.SENTENCE_FIELD_DESC);
                oprot.writeString(struct.sentence);
                oprot.writeFieldEnd();
            }
            if (struct.sentence_trans != null) {
                oprot.writeFieldBegin(BBTopicAsset.SENTENCE_TRANS_FIELD_DESC);
                oprot.writeString(struct.sentence_trans);
                oprot.writeFieldEnd();
            }
            if (struct.sentence_audio != null) {
                oprot.writeFieldBegin(BBTopicAsset.SENTENCE_AUDIO_FIELD_DESC);
                oprot.writeString(struct.sentence_audio);
                oprot.writeFieldEnd();
            }
            if (struct.update_flag != null) {
                oprot.writeFieldBegin(BBTopicAsset.UPDATE_FLAG_FIELD_DESC);
                oprot.writeString(struct.update_flag);
                oprot.writeFieldEnd();
            }
            if (struct.asset_pack_path != null) {
                oprot.writeFieldBegin(BBTopicAsset.ASSET_PACK_PATH_FIELD_DESC);
    ...
    public static class BBTopicAssetStandardSchemeFactory implements SchemeFactory {
        ...
        public BBTopicAssetStandardScheme getScheme() {
            return new BBTopicAssetStandardScheme();
        }
    }
    ...
    public static class BBTopicAssetTupleScheme extends TupleScheme<BBTopicAsset> {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, BBTopicAsset struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, BBTopicAsset struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    public static class BBTopicAssetTupleSchemeFactory implements SchemeFactory {
        ...
        public BBTopicAssetTupleScheme getScheme() {
            return new BBTopicAssetTupleScheme();
        }
    }
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new BBTopicAssetStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new BBTopicAssetTupleSchemeFactory());
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof BBTopicAsset)) {
            return equals((BBTopicAsset) that);
        }
        return false;
    }
    ...
    public BBTopicAsset setAccent(String accent) {
        this.accent = accent;
        return this;
    }
    ...
    public BBTopicAsset setAsset_pack_path(String asset_pack_path) {
    ...
    public BBTopicAsset setDeformation_desc(String deformation_desc) {
    ...
    public BBTopicAsset setDeformation_img(String deformation_img) {
    ...
    public BBTopicAsset setImage_file(String image_file) {
    ...
    public BBTopicAsset setMean_cn(String mean_cn) {
    ...
    public BBTopicAsset setMean_en(String mean_en) {
    ...
    public BBTopicAsset setSentence(String sentence) {
    ...
    public BBTopicAsset setSentence_audio(String sentence_audio) {
    ...
    public BBTopicAsset setSentence_trans(String sentence_trans) {
    ...
    public BBTopicAsset setShort_phrase(String short_phrase) {
    ...
    public BBTopicAsset setTopic_id(int topic_id) {
    ...
    public BBTopicAsset setUpdate_flag(String update_flag) {
    ...
    public BBTopicAsset setWord(String word) {
        this.word = word;
        return this;
    }
    ...
    public BBTopicAsset setWord_audio(String word_audio) {
    ...
    public BBTopicAsset setWord_etyma(String word_etyma) {
    ...
    public BBTopicAsset setWord_variants(String word_variants) {
    ...
    public int compareTo(BBTopicAsset other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
        ...
        int compareTo18 = Boolean.valueOf(isSetTopic_id()).compareTo(Boolean.valueOf(other.isSetTopic_id()));
        if (compareTo18 != 0) {
            return compareTo18;
        }
        if (isSetTopic_id() && (compareTo17 = TBaseHelper.compareTo(this.topic_id, other.topic_id)) != 0) {
            return compareTo17;
        }
        ...
        if (isSetWord() && (compareTo16 = TBaseHelper.compareTo(this.word, other.word)) != 0) {
            return compareTo16;
        }
        int compareTo20 = Boolean.valueOf(isSetWord_variants()).compareTo(Boolean.valueOf(other.isSetWord_variants()));
        if (compareTo20 != 0) {
            return compareTo20;
        }
        if (isSetWord_variants() && (compareTo15 = TBaseHelper.compareTo(this.word_variants, other.word_variants)) != 0) {
            return compareTo15;
        }
        int compareTo21 = Boolean.valueOf(isSetWord_audio()).compareTo(Boolean.valueOf(other.isSetWord_audio()));
        if (compareTo21 != 0) {
            return compareTo21;
        }
        if (isSetWord_audio() && (compareTo14 = TBaseHelper.compareTo(this.word_audio, other.word_audio)) != 0) {
            return compareTo14;
        }
        int compareTo22 = Boolean.valueOf(isSetWord_etyma()).compareTo(Boolean.valueOf(other.isSetWord_etyma()));
        if (compareTo22 != 0) {
            return compareTo22;
        }
        if (isSetWord_etyma() && (compareTo13 = TBaseHelper.compareTo(this.word_etyma, other.word_etyma)) != 0) {
            return compareTo13;
        }
        int compareTo23 = Boolean.valueOf(isSetImage_file()).compareTo(Boolean.valueOf(other.isSetImage_file()));
        if (compareTo23 != 0) {
            return compareTo23;
        }
        if (isSetImage_file() && (compareTo12 = TBaseHelper.compareTo(this.image_file, other.image_file)) != 0) {
            return compareTo12;
        }
        int compareTo24 = Boolean.valueOf(isSetAccent()).compareTo(Boolean.valueOf(other.isSetAccent()));
        if (compareTo24 != 0) {
            return compareTo24;
        }
        if (isSetAccent() && (compareTo11 = TBaseHelper.compareTo(this.accent, other.accent)) != 0) {
            return compareTo11;
        }
        int compareTo25 = Boolean.valueOf(isSetMean_cn()).compareTo(Boolean.valueOf(other.isSetMean_cn()));
        if (compareTo25 != 0) {
            return compareTo25;
        }
        if (isSetMean_cn() && (compareTo10 = TBaseHelper.compareTo(this.mean_cn, other.mean_cn)) != 0) {
            return compareTo10;
        }
        int compareTo26 = Boolean.valueOf(isSetMean_en()).compareTo(Boolean.valueOf(other.isSetMean_en()));
        if (compareTo26 != 0) {
            return compareTo26;
        }
        if (isSetMean_en() && (compareTo9 = TBaseHelper.compareTo(this.mean_en, other.mean_en)) != 0) {
            return compareTo9;
        }
        int compareTo27 = Boolean.valueOf(isSetShort_phrase()).compareTo(Boolean.valueOf(other.isSetShort_phrase()));
        if (compareTo27 != 0) {
            return compareTo27;
        }
        if (isSetShort_phrase() && (compareTo8 = TBaseHelper.compareTo(this.short_phrase, other.short_phrase)) != 0) {
            return compareTo8;
        }
        int compareTo28 = Boolean.valueOf(isSetDeformation_img()).compareTo(Boolean.valueOf(other.isSetDeformation_img()));
        if (compareTo28 != 0) {
            return compareTo28;
        }
        if (isSetDeformation_img() && (compareTo7 = TBaseHelper.compareTo(this.deformation_img, other.deformation_img)) != 0) {
            return compareTo7;
        }
        int compareTo29 = Boolean.valueOf(isSetDeformation_desc()).compareTo(Boolean.valueOf(other.isSetDeformation_desc()));
        if (compareTo29 != 0) {
            return compareTo29;
        }
        if (isSetDeformation_desc() && (compareTo6 = TBaseHelper.compareTo(this.deformation_desc, other.deformation_desc)) != 0) {
            return compareTo6;
        }
        int compareTo30 = Boolean.valueOf(isSetSentence()).compareTo(Boolean.valueOf(other.isSetSentence()));
        if (compareTo30 != 0) {
            return compareTo30;
        }
        ...
        int compareTo31 = Boolean.valueOf(isSetSentence_trans()).compareTo(Boolean.valueOf(other.isSetSentence_trans()));
        if (compareTo31 != 0) {
            return compareTo31;
        }
        ...
        int compareTo32 = Boolean.valueOf(isSetSentence_audio()).compareTo(Boolean.valueOf(other.isSetSentence_audio()));
        if (compareTo32 != 0) {
            return compareTo32;
        }
        if (isSetSentence_audio() && (compareTo3 = TBaseHelper.compareTo(this.sentence_audio, other.sentence_audio)) != 0) {
            return compareTo3;
        }
        int compareTo33 = Boolean.valueOf(isSetUpdate_flag()).compareTo(Boolean.valueOf(other.isSetUpdate_flag()));
        if (compareTo33 != 0) {
            return compareTo33;
        }
        if (isSetUpdate_flag() && (compareTo2 = TBaseHelper.compareTo(this.update_flag, other.update_flag)) != 0) {
            return compareTo2;
        }
        int compareTo34 = Boolean.valueOf(isSetAsset_pack_path()).compareTo(Boolean.valueOf(other.isSetAsset_pack_path()));
        if (compareTo34 != 0) {
            return compareTo34;
        }
        if (!isSetAsset_pack_path() || (compareTo = TBaseHelper.compareTo(this.asset_pack_path, other.asset_pack_path)) == 0) {
            return 0;
        }
        return compareTo;
    }
    ...
    public Object getFieldValue(_Fields field) {
        switch (AnonymousClass1.$SwitchMap$com$baicizhan$online$bs_words$BBTopicAsset$_Fields[field.ordinal()]) {
            case 1:
    ...
    public BBTopicAsset(int topic_id, String word, String word_variants, String word_audio, String word_etyma, String image_file, String accent, String mean_cn, String mean_en, String short_phrase, String deformation_img, String deformation_desc, String sentence, String sentence_trans, String sentence_audio, String update_flag, String asset_pack_path) {
        this();
        this.topic_id = topic_id;
        setTopic_idIsSet(true);
        this.word = word;
    ...
    public boolean equals(BBTopicAsset that) {
        ...
        if (isSetAsset_pack_path || isSetAsset_pack_path2) {
            return isSetAsset_pack_path && isSetAsset_pack_path2 && this.asset_pack_path.equals(that.asset_pack_path);
        }
        return true;
    }

    public BBTopicAsset(BBTopicAsset other) {
        this.__isset_bitfield = (byte) 0;
