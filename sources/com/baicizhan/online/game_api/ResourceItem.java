...
public class ResourceItem implements TBase<ResourceItem, _Fields>, Serializable, Cloneable, Comparable<ResourceItem> {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.game_api.ResourceItem$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$game_api$ResourceItem$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$game_api$ResourceItem$_Fields = iArr;
            try {
                iArr[_Fields.ICON.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$game_api$ResourceItem$_Fields[_Fields.NAME.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$baicizhan$online$game_api$ResourceItem$_Fields[_Fields.LINK.ordinal()] = 3;
    ...
    public static class ResourceItemStandardScheme extends StandardScheme<ResourceItem> {
        ...
        public void write(TProtocol oprot, ResourceItem struct) throws TException {
            ...
            if (struct.icon != null) {
                oprot.writeFieldBegin(ResourceItem.ICON_FIELD_DESC);
                oprot.writeString(struct.icon);
                oprot.writeFieldEnd();
            }
            if (struct.name != null) {
                oprot.writeFieldBegin(ResourceItem.NAME_FIELD_DESC);
    ...
    public ResourceItem setIcon(String icon) {
        this.icon = icon;
        return this;
    }
    ...
    public ResourceItem setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ResourceItem(String icon, String name, String link) {
        this();
        this.icon = icon;
        this.name = name;
        this.link = link;
    ...
    public int compareTo(ResourceItem other) {
        ...
        int compareTo4 = Boolean.valueOf(isSetIcon()).compareTo(Boolean.valueOf(other.isSetIcon()));
        if (compareTo4 != 0) {
            return compareTo4;
        }
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$game_api$ResourceItem$_Fields[field.ordinal()];
        if (i11 == 1) {
            return getIcon();
        }
        if (i11 == 2) {
