...
public class GameWordReq implements TBase<GameWordReq, _Fields>, Serializable, Cloneable, Comparable<GameWordReq> {
    ...
    private static final TStruct STRUCT_DESC = new TStruct("GameWordReq");
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.resource_api.GameWordReq$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$resource_api$GameWordReq$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$resource_api$GameWordReq$_Fields = iArr;
            try {
                iArr[_Fields.BOOK_ID.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$resource_api$GameWordReq$_Fields[_Fields.TOPIC_IDS.ordinal()] = 2;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class GameWordReqStandardScheme extends StandardScheme<GameWordReq> {
        private GameWordReqStandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, GameWordReq struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, GameWordReq struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(GameWordReq.STRUCT_DESC);
            oprot.writeFieldBegin(GameWordReq.BOOK_ID_FIELD_DESC);
            oprot.writeI32(struct.book_id);
            oprot.writeFieldEnd();
            if (struct.topic_ids != null) {
                oprot.writeFieldBegin(GameWordReq.TOPIC_IDS_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class GameWordReqStandardSchemeFactory implements SchemeFactory {
        private GameWordReqStandardSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public GameWordReqStandardScheme getScheme() {
            return new GameWordReqStandardScheme();
        }
    }

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class GameWordReqTupleScheme extends TupleScheme<GameWordReq> {
        private GameWordReqTupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, GameWordReq struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, GameWordReq struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class GameWordReqTupleSchemeFactory implements SchemeFactory {
        private GameWordReqTupleSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public GameWordReqTupleScheme getScheme() {
            return new GameWordReqTupleScheme();
        }
    }
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new GameWordReqStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new GameWordReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(GameWordReq.class, unmodifiableMap);
    }
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof GameWordReq)) {
            return equals((GameWordReq) that);
        }
        return false;
    }
    ...
    public GameWordReq setBook_id(int book_id) {
    ...
    public GameWordReq setTopic_ids(List<Integer> topic_ids) {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("GameWordReq(");
        sb2.append("book_id:");
    ...
    public int compareTo(GameWordReq other) {
        int compareTo;
        int compareTo2;
    ...
    public TBase<GameWordReq, _Fields> deepCopy2() {
        return new GameWordReq(this);
    }
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$resource_api$GameWordReq$_Fields[field.ordinal()];
        if (i11 == 1) {
    ...
    public GameWordReq(int book_id, List<Integer> topic_ids) {
        this();
        this.book_id = book_id;
        setBook_idIsSet(true);
        this.topic_ids = topic_ids;
    ...
    public boolean equals(GameWordReq that) {
    ...
    public GameWordReq(GameWordReq other) {
        this.__isset_bitfield = (byte) 0;
