...
public class BELogicException extends TException implements TBase<BELogicException, _Fields>, Serializable, Cloneable, Comparable<BELogicException> {
    ...
    private static final TStruct STRUCT_DESC = new TStruct("BELogicException");
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.structs.BELogicException$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields = iArr;
            try {
                iArr[_Fields.FROM_SERVICE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields[_Fields.FROM_METHOD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields[_Fields.CODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields[_Fields.MESSAGE.ordinal()] = 4;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BELogicExceptionStandardScheme extends StandardScheme<BELogicException> {
        private BELogicExceptionStandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, BELogicException struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, BELogicException struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(BELogicException.STRUCT_DESC);
            if (struct.from_service != null) {
                oprot.writeFieldBegin(BELogicException.FROM_SERVICE_FIELD_DESC);
                oprot.writeString(struct.from_service);
                oprot.writeFieldEnd();
            }
            if (struct.from_method != null) {
                oprot.writeFieldBegin(BELogicException.FROM_METHOD_FIELD_DESC);
                oprot.writeString(struct.from_method);
                oprot.writeFieldEnd();
            }
            oprot.writeFieldBegin(BELogicException.CODE_FIELD_DESC);
            oprot.writeI32(struct.code);
            oprot.writeFieldEnd();
            if (struct.message != null && struct.isSetMessage()) {
                oprot.writeFieldBegin(BELogicException.MESSAGE_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BELogicExceptionStandardSchemeFactory implements SchemeFactory {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BELogicExceptionTupleScheme extends TupleScheme<BELogicException> {
        private BELogicExceptionTupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, BELogicException struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, BELogicException struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BELogicExceptionTupleSchemeFactory implements SchemeFactory {
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new BELogicExceptionStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new BELogicExceptionTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(BELogicException.class, unmodifiableMap);
    }
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof BELogicException)) {
            return equals((BELogicException) that);
        }
        return false;
    }
    ...
    public BELogicException setCode(int code) {
        this.code = code;
        setCodeIsSet(true);
        return this;
    }
    ...
    public BELogicException setFrom_method(String from_method) {
    ...
    public BELogicException setFrom_service(String from_service) {
    ...
    public BELogicException setMessage(String message) {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("BELogicException(");
    ...
    public int compareTo(BELogicException other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
    ...
    public TBase<BELogicException, _Fields> deepCopy2() {
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$structs$BELogicException$_Fields[field.ordinal()];
        if (i11 == 1) {
    ...
    public boolean equals(BELogicException that) {
        if (that == null) {
            return false;
        }
    ...
    public BELogicException(String from_service, String from_method, int code) {
        this();
        this.from_service = from_service;
        this.from_method = from_method;
        this.code = code;
    ...
    public BELogicException(BELogicException other) {
        this.__isset_bitfield = (byte) 0;
        this.optionals = new _Fields[]{_Fields.MESSAGE};
