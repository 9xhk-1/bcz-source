...
public class BESystemException extends TException implements TBase<BESystemException, _Fields>, Serializable, Cloneable, Comparable<BESystemException> {
    ...
    private static final TStruct STRUCT_DESC = new TStruct("BESystemException");
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.structs.BESystemException$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields = iArr;
            try {
                iArr[_Fields.FROM_SERVICE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields[_Fields.FROM_METHOD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields[_Fields.CODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields[_Fields.MESSAGE.ordinal()] = 4;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BESystemExceptionStandardScheme extends StandardScheme<BESystemException> {
        private BESystemExceptionStandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, BESystemException struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, BESystemException struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(BESystemException.STRUCT_DESC);
            if (struct.from_service != null) {
                oprot.writeFieldBegin(BESystemException.FROM_SERVICE_FIELD_DESC);
                oprot.writeString(struct.from_service);
                oprot.writeFieldEnd();
            }
            if (struct.from_method != null) {
                oprot.writeFieldBegin(BESystemException.FROM_METHOD_FIELD_DESC);
                oprot.writeString(struct.from_method);
                oprot.writeFieldEnd();
            }
            oprot.writeFieldBegin(BESystemException.CODE_FIELD_DESC);
            oprot.writeI32(struct.code);
            oprot.writeFieldEnd();
            if (struct.message != null && struct.isSetMessage()) {
                oprot.writeFieldBegin(BESystemException.MESSAGE_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BESystemExceptionStandardSchemeFactory implements SchemeFactory {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BESystemExceptionTupleScheme extends TupleScheme<BESystemException> {
        private BESystemExceptionTupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, BESystemException struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, BESystemException struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class BESystemExceptionTupleSchemeFactory implements SchemeFactory {
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new BESystemExceptionStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new BESystemExceptionTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(BESystemException.class, unmodifiableMap);
    }
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof BESystemException)) {
            return equals((BESystemException) that);
        }
        return false;
    }
    ...
    public BESystemException setCode(int code) {
        this.code = code;
        setCodeIsSet(true);
        return this;
    }
    ...
    public BESystemException setFrom_method(String from_method) {
    ...
    public BESystemException setFrom_service(String from_service) {
    ...
    public BESystemException setMessage(String message) {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("BESystemException(");
    ...
    public int compareTo(BESystemException other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
    ...
    public TBase<BESystemException, _Fields> deepCopy2() {
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$structs$BESystemException$_Fields[field.ordinal()];
        if (i11 == 1) {
    ...
    public boolean equals(BESystemException that) {
        if (that == null) {
            return false;
        }
    ...
    public BESystemException(String from_service, String from_method, int code) {
        this();
        this.from_service = from_service;
        this.from_method = from_method;
        this.code = code;
    ...
    public BESystemException(BESystemException other) {
        this.__isset_bitfield = (byte) 0;
        this.optionals = new _Fields[]{_Fields.MESSAGE};
