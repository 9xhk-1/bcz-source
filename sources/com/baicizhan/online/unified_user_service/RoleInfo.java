...
public class RoleInfo implements TBase<RoleInfo, _Fields>, Serializable, Cloneable, Comparable<RoleInfo> {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.unified_user_service.RoleInfo$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$unified_user_service$RoleInfo$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$unified_user_service$RoleInfo$_Fields = iArr;
            try {
                iArr[_Fields.ROLE_UP.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$unified_user_service$RoleInfo$_Fields[_Fields.GRADE.ordinal()] = 2;
    ...
    public String toString() {
        return "RoleInfo(role_up:" + this.role_up + j2.O + "grade:" + this.grade + pn.j.f81007d;
    }
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$unified_user_service$RoleInfo$_Fields[field.ordinal()];
        if (i11 == 1) {
