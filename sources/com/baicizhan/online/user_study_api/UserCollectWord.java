...
public class UserCollectWord implements TBase<UserCollectWord, _Fields>, Serializable, Cloneable, Comparable<UserCollectWord> {
    ...
    public int tag_id;
    public int topic_id;
    private static final TStruct STRUCT_DESC = new TStruct("UserCollectWord");
    ...
    private static final TField TAG_ID_FIELD_DESC = new TField("tag_id", (byte) 8, 4);

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.user_study_api.UserCollectWord$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWord$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWord$_Fields = iArr;
            try {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordStandardScheme extends StandardScheme<UserCollectWord> {
        private UserCollectWordStandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, UserCollectWord struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, UserCollectWord struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(UserCollectWord.STRUCT_DESC);
            oprot.writeFieldBegin(UserCollectWord.TOPIC_ID_FIELD_DESC);
            oprot.writeI32(struct.topic_id);
            oprot.writeFieldEnd();
            oprot.writeFieldBegin(UserCollectWord.BOOK_ID_FIELD_DESC);
            oprot.writeI32(struct.book_id);
            oprot.writeFieldEnd();
            oprot.writeFieldBegin(UserCollectWord.CREATED_AT_FIELD_DESC);
            oprot.writeI64(struct.created_at);
            oprot.writeFieldEnd();
            if (struct.isSetTag_id()) {
                oprot.writeFieldBegin(UserCollectWord.TAG_ID_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordStandardSchemeFactory implements SchemeFactory {
        private UserCollectWordStandardSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public UserCollectWordStandardScheme getScheme() {
            return new UserCollectWordStandardScheme();
        }
    }

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordTupleScheme extends TupleScheme<UserCollectWord> {
        private UserCollectWordTupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, UserCollectWord struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, UserCollectWord struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordTupleSchemeFactory implements SchemeFactory {
        private UserCollectWordTupleSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public UserCollectWordTupleScheme getScheme() {
            return new UserCollectWordTupleScheme();
        }
    }
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new UserCollectWordStandardSchemeFactory());
        hashMap.put(TupleScheme.class, new UserCollectWordTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(UserCollectWord.class, unmodifiableMap);
    }
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof UserCollectWord)) {
            return equals((UserCollectWord) that);
        }
        return false;
    }
    ...
    public UserCollectWord setBook_id(int book_id) {
    ...
    public UserCollectWord setCreated_at(long created_at) {
    ...
    public UserCollectWord setTag_id(int tag_id) {
        this.tag_id = tag_id;
        setTag_idIsSet(true);
        return this;
    }
    ...
    public UserCollectWord setTopic_id(int topic_id) {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("UserCollectWord(");
        sb2.append("topic_id:");
    ...
    public int compareTo(UserCollectWord other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
        ...
        int compareTo7 = Boolean.valueOf(isSetCreated_at()).compareTo(Boolean.valueOf(other.isSetCreated_at()));
        if (compareTo7 != 0) {
            return compareTo7;
        }
        ...
        int compareTo8 = Boolean.valueOf(isSetTag_id()).compareTo(Boolean.valueOf(other.isSetTag_id()));
        if (compareTo8 != 0) {
            return compareTo8;
        }
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$user_study_api$UserCollectWord$_Fields[field.ordinal()];
        if (i11 == 1) {
    ...
    public boolean equals(UserCollectWord that) {
    ...
    public UserCollectWord(int topic_id, int book_id, long created_at) {
        this();
        this.topic_id = topic_id;
        setTopic_idIsSet(true);
        this.book_id = book_id;
    ...
    public UserCollectWord(UserCollectWord other) {
        this.__isset_bitfield = (byte) 0;
        this.optionals = new _Fields[]{_Fields.TAG_ID};
