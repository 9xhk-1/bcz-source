...
public class UserCollectWordV2 implements TBase<UserCollectWordV2, _Fields>, Serializable, Cloneable, Comparable<UserCollectWordV2> {
    ...
    public int topic_id;
    public String word;
    private static final TStruct STRUCT_DESC = new TStruct("UserCollectWordV2");
    ...
    private static final TField BOOK_ID_FIELD_DESC = new TField("book_id", (byte) 8, 3);
    private static final TField CREATED_AT_FIELD_DESC = new TField("created_at", (byte) 10, 4);
    private static final TField TAG_ID_FIELD_DESC = new TField("tag_id", (byte) 8, 5);

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    /* renamed from: com.baicizhan.online.user_study_api.UserCollectWordV2$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields;

        static {
            int[] iArr = new int[_Fields.values().length];
            $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields = iArr;
            try {
                iArr[_Fields.WORD.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields[_Fields.TOPIC_ID.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields[_Fields.BOOK_ID.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields[_Fields.CREATED_AT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields[_Fields.TAG_ID.ordinal()] = 5;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordV2StandardScheme extends StandardScheme<UserCollectWordV2> {
        private UserCollectWordV2StandardScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol iprot, UserCollectWordV2 struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol oprot, UserCollectWordV2 struct) throws TException {
            struct.validate();
            oprot.writeStructBegin(UserCollectWordV2.STRUCT_DESC);
            if (struct.word != null) {
                oprot.writeFieldBegin(UserCollectWordV2.WORD_FIELD_DESC);
                oprot.writeString(struct.word);
                oprot.writeFieldEnd();
            }
            oprot.writeFieldBegin(UserCollectWordV2.TOPIC_ID_FIELD_DESC);
            oprot.writeI32(struct.topic_id);
            oprot.writeFieldEnd();
            oprot.writeFieldBegin(UserCollectWordV2.BOOK_ID_FIELD_DESC);
            oprot.writeI32(struct.book_id);
            oprot.writeFieldEnd();
            oprot.writeFieldBegin(UserCollectWordV2.CREATED_AT_FIELD_DESC);
            oprot.writeI64(struct.created_at);
            oprot.writeFieldEnd();
            if (struct.isSetTag_id()) {
                oprot.writeFieldBegin(UserCollectWordV2.TAG_ID_FIELD_DESC);
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordV2StandardSchemeFactory implements SchemeFactory {
        private UserCollectWordV2StandardSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public UserCollectWordV2StandardScheme getScheme() {
            return new UserCollectWordV2StandardScheme();
        }
    }

    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordV2TupleScheme extends TupleScheme<UserCollectWordV2> {
        private UserCollectWordV2TupleScheme() {
        }

        @Override // org.apache.thrift.scheme.IScheme
        public void read(TProtocol prot, UserCollectWordV2 struct) throws TException {
        ...
        @Override // org.apache.thrift.scheme.IScheme
        public void write(TProtocol prot, UserCollectWordV2 struct) throws TException {
            TTupleProtocol tTupleProtocol = (TTupleProtocol) prot;
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    public static class UserCollectWordV2TupleSchemeFactory implements SchemeFactory {
        private UserCollectWordV2TupleSchemeFactory() {
        }

        @Override // org.apache.thrift.scheme.SchemeFactory
        public UserCollectWordV2TupleScheme getScheme() {
            return new UserCollectWordV2TupleScheme();
        }
    }
    ...
    static {
        ...
        schemes = hashMap;
        hashMap.put(StandardScheme.class, new UserCollectWordV2StandardSchemeFactory());
        hashMap.put(TupleScheme.class, new UserCollectWordV2TupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(UserCollectWordV2.class, unmodifiableMap);
    }
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof UserCollectWordV2)) {
            return equals((UserCollectWordV2) that);
        }
        return false;
    }
    ...
    public UserCollectWordV2 setBook_id(int book_id) {
    ...
    public UserCollectWordV2 setCreated_at(long created_at) {
    ...
    public UserCollectWordV2 setTag_id(int tag_id) {
        this.tag_id = tag_id;
        setTag_idIsSet(true);
        return this;
    }
    ...
    public UserCollectWordV2 setTopic_id(int topic_id) {
    ...
    public UserCollectWordV2 setWord(String word) {
        this.word = word;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("UserCollectWordV2(");
        sb2.append("word:");
    ...
    public int compareTo(UserCollectWordV2 other) {
        int compareTo;
        int compareTo2;
        int compareTo3;
        int compareTo4;
        ...
        if (isSetCreated_at() && (compareTo2 = TBaseHelper.compareTo(this.created_at, other.created_at)) != 0) {
            return compareTo2;
        }
        int compareTo10 = Boolean.valueOf(isSetTag_id()).compareTo(Boolean.valueOf(other.isSetTag_id()));
        if (compareTo10 != 0) {
            return compareTo10;
        }
    ...
    public TBase<UserCollectWordV2, _Fields> deepCopy2() {
    ...
    public Object getFieldValue(_Fields field) {
        int i11 = AnonymousClass1.$SwitchMap$com$baicizhan$online$user_study_api$UserCollectWordV2$_Fields[field.ordinal()];
        if (i11 == 1) {
            return getWord();
        }
        if (i11 == 2) {
    ...
    public boolean equals(UserCollectWordV2 that) {
        if (that == null) {
            return false;
        }
        boolean isSetWord = isSetWord();
        boolean isSetWord2 = that.isSetWord();
        if (((isSetWord || isSetWord2) && (!isSetWord || !isSetWord2 || !this.word.equals(that.word))) || this.topic_id != that.topic_id || this.book_id != that.book_id || this.created_at != that.created_at) {
            return false;
        }
    ...
    public UserCollectWordV2(String word, int topic_id, int book_id, long created_at) {
        this();
        this.word = word;
        this.topic_id = topic_id;
        setTopic_idIsSet(true);
    ...
    public UserCollectWordV2(UserCollectWordV2 other) {
        this.__isset_bitfield = (byte) 0;
        this.optionals = new _Fields[]{_Fields.TAG_ID};
