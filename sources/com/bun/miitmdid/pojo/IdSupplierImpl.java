...
public class IdSupplierImpl implements IdSupplier {
    ...
    public IdSupplierImpl(String str, String str2, String str3, boolean z11, boolean z12, boolean z13) {
        this.OAID = str;
        this.VAID = str2;
        this.AAID = str3;
        this.isSupported = z11;
        this.isLimited = z12;
        this.isSupportRequestOAIDPermission = z13;
    }

    @Override // com.bun.miitmdid.interfaces.IdSupplier
    public void requestOAIDPermission(Activity activity, int i11) {
    }
}
