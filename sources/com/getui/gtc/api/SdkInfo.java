...
public class SdkInfo implements Parcelable {
    public static final Parcelable.Creator<SdkInfo> CREATOR = new Parcelable.Creator<SdkInfo>() { // from class: com.getui.gtc.api.SdkInfo.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SdkInfo[] newArray(int i11) {
            return new SdkInfo[i11];
        }
    };
    ...
    public static class Builder {
        ...
        private String moduleName;
        private String psUrl;
        private List<a.C0358a> stubs = new ArrayList();
        private String version;

        public Builder addStub(String str, boolean z11) {
            a.C0358a c0358a = new a.C0358a();
            c0358a.f30051d = str;
            c0358a.f30057j = z11;
            this.stubs.add(c0358a);
            return this;
        }
    ...
    public SdkInfo(Parcel parcel) {
        ...
        parcel.readTypedList(arrayList, a.C0358a.CREATOR);
    }
    ...
    public void setStubs(List<a.C0358a> list) {
        this.stubs = list;
    }
