...
public class CryptTools {
    ...
    public static SecretKey generateKey(String str, int i11) throws NoSuchAlgorithmException {
        KeyGenerator keyGenerator = KeyGenerator.getInstance(str);
        keyGenerator.init(i11);
        return keyGenerator.generateKey();
    }

    public static KeyPair generateKeyPair(String str, int i11) throws NoSuchAlgorithmException {
    ...
    public static PrivateKey parsePrivateKey(String str, File file) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException {
        ...
        try {
            ...
            while (true) {
                ...
                if (readLine == null) {
                    PrivateKey parsePrivateKey = parsePrivateKey(str, sb2.toString());
    ...
    public static PublicKey parsePublicKey(String str, File file) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException {
        ...
        try {
            ...
            while (true) {
                String readLine = bufferedReader.readLine();
                if (readLine == null) {
                    PublicKey parsePublicKey = parsePublicKey(str, sb2.toString());
                    bufferedReader.close();
