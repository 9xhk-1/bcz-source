...
public class ScheduleQueue {
            ...
            public Thread newThread(Runnable runnable) {
                ...
                thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.getui.gtc.base.util.ScheduleQueue.1.1
                    ...
                    public void uncaughtException(Thread thread2, Throwable th2) {
                        Log.e("gtc", "caught an exception from " + thread2.getName(), th2);
                    }
                });
                return thread;
            }
    ...
    public ScheduledFuture<?> addScheduler(Runnable runnable, long j11, long j12) {
        try {
            return this.exec.scheduleAtFixedRate(runnable, j11, j12, TimeUnit.MILLISECONDS);
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public boolean addSchedule(Runnable runnable, long j11) {
        try {
            this.exec.schedule(runnable, j11, TimeUnit.MILLISECONDS);
            return true;
        } catch (Throwable unused) {
            return false;
        }
    ...
    public boolean addSchedule(Runnable runnable, long j11, long j12) {
        try {
            this.exec.scheduleAtFixedRate(runnable, j11, j12, TimeUnit.MILLISECONDS);
            return true;
        } catch (Throwable unused) {
            return false;
        }
