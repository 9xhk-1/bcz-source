...
public class DimRequest implements Parcelable {
    public static final Parcelable.Creator<DimRequest> CREATOR = new Parcelable.Creator<DimRequest>() { // from class: com.getui.gtc.dim.DimRequest.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final DimRequest[] newArray(int i11) {
            return new DimRequest[i11];
        }
    };
    ...
    public static class Builder {
        ...
        @Deprecated
        public Builder ramCacheValidTime(long j11) {
            this.ramCacheValidTime = j11;
            return this;
        }

        public Builder skipCache(boolean z11) {
            this.skipCache = z11;
            return this;
        }

        @Deprecated
        public Builder storageCacheValidTime(long j11) {
            this.storageCacheValidTime = j11;
            return this;
        }

        @Deprecated
        public Builder useExpiredCacheForReserve(boolean z11) {
            this.useExpiredCacheForReserve = z11;
            return this;
        }
        ...
        @Deprecated
        public Builder allowSysCall(boolean z11) {
            this.allowSysCall = z11 ? AllowSysCall.ALL_ALLOW : AllowSysCall.NOT_ALLOW;
            return this;
        }
    }
    ...
    @Deprecated
    public void setRamCacheValidTime(long j11) {
        this.ramCacheValidTime = j11;
    }

    @Deprecated
    public void setStorageCacheValidTime(long j11) {
        this.storageCacheValidTime = j11;
    }

    @Deprecated
    public void setUseExpiredCacheForReserve(boolean z11) {
        this.useExpiredCacheForReserve = z11;
    }

    public String toString() {
        return "DimRequest{key='" + this.key + "', ramCacheValidTime=" + this.ramCacheValidTime + ", storageCacheValidTime=" + this.storageCacheValidTime + ", allowSysCall=" + this.allowSysCall + ", useExpiredCacheForReserve=" + this.useExpiredCacheForReserve + ", caller=" + this.caller + ", skipCache=" + this.skipCache + b.f69928j;
    }
    ...
    public DimRequest(Parcel parcel) {
        ...
        if (readInt >= 0) {
            this.caller = Caller.values()[readInt];
        }
