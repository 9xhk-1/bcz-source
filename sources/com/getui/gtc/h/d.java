...
public final class d {
    ...
    public static GtHttpClient f30097a = new GtHttpClient.Builder().addInterceptor(new LoggerInterceptor(a.C0359a.f30105a.f30104a)).addInterceptor(new Interceptor() { // from class: com.getui.gtc.h.d.1
