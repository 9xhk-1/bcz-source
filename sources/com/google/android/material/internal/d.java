...
public class d {
    ...
    public static final ThreadLocal<Matrix> f31569a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    public static final ThreadLocal<RectF> f31570b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f31569a;
        ...
        ThreadLocal<RectF> threadLocal2 = f31570b;
