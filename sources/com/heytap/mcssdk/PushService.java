...
public class PushService implements IPushService {
    ...
    private AppLimitBean addCommandToMap(int i11) {
        if (!this.mAppLimitMap.containsKey(Integer.valueOf(i11))) {
            ...
            this.mAppLimitMap.put(Integer.valueOf(i11), appLimitBean);
            LogUtil.d("addCommandToMap :appBean is null");
            return appLimitBean;
        }
        AppLimitBean appLimitBean2 = this.mAppLimitMap.get(Integer.valueOf(i11));
    ...
    private Intent getIntent(int i11, String str, JSONObject jSONObject) {
        ...
        intent.putExtra(IntentConstant.SDK_VERSION, getSDKVersionName());
        return intent;
    }
        ...
        if (!checkCommandLimit(i11)) {
            ...
            this.mContext.bindService(intent, new ServiceConnection() { // from class: com.heytap.mcssdk.PushService.1
                ...
                public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    ...
                    try {
                        a.b.x0(iBinder).L(bundle);
                    } catch (Exception e11) {
                        LogUtil.d("bindMcsService exception:" + e11);
                    }
    ...
    public boolean checkCommandLimit(int i11) {
        return (i11 == 12291 || i11 == 12312 || addCommandToMap(i11).getCount() <= 2) ? false : true;
    }
    ...
    public void register(Context context, String str, String str2, JSONObject jSONObject, ICallBackResultService iCallBackResultService) {
        ...
        try {
            ...
            LogUtil.e("register-Exception:" + e11.getMessage());
        }
        startMcsService(MessageConstant.CommandId.COMMAND_REGISTER, jSONObject);
    }
    ...
    public void setNotificationType(int i11, JSONObject jSONObject) {
        ...
        startMcsService(MessageConstant.CommandId.COMMAND_SET_NOTIFICATION_TYPE, i11 + "", jSONObject);
    }
    ...
    @Override // com.heytap.mcssdk.IPushService
    public void setPushTime(List<Integer> list, int i11, int i12, int i13, int i14, JSONObject jSONObject) throws IllegalArgumentException {
        if (!checkAll()) {
        ...
        try {
            ...
            LogUtil.e(LogUtil.TAG, e11.getLocalizedMessage());
        }
    }
    ...
    private void startMcsService(int i11, String str, JSONObject jSONObject) {
        ...
        try {
            ...
            LogUtil.e("startMcsService--Exception" + e11.getMessage());
        }
    }
