...
public class LogUtil {
    ...
    public static void setD(boolean z11) {
        sD = z11;
    }

    public static void setDebugs(boolean z11) {
        sIsDebug = z11;
        if (z11) {
            sV = true;
            sD = true;
    ...
    public static void setE(boolean z11) {
        sE = z11;
    }

    public static void setI(boolean z11) {
        sI = z11;
    }
    ...
    public static void setV(boolean z11) {
        sV = z11;
    }

    public static void setW(boolean z11) {
        sW = z11;
    }
