...
public class MessageStat {
    ...
    public static MessageStat parse(String str) {
        ...
        try {
            ...
            LogUtil.e(e11.getLocalizedMessage());
            return null;
        }
    }
    ...
    public MessageStat(int i11, String str, String str2, String str3) {
        this(i11, str, null, null, str2, str3);
    }

    public MessageStat(int i11, String str, String str2, String str3, String str4, String str5) {
        this(i11, str, str2, str3, str4, str5, "", "");
    }

    public MessageStat(int i11, String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        this.mType = 4096;
        this.mEventTime = System.currentTimeMillis();
        setType(i11);
        setAppPackage(str);
