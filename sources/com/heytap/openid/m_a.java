...
public interface m_a extends IInterface {
    ...
    public static abstract class AbstractBinderC0438m_a extends Binder implements m_a {
        ...
        public static class C0439m_a implements m_a {
            public IBinder m_a;

            public C0439m_a(IBinder iBinder) {
                this.m_a = iBinder;
            }
