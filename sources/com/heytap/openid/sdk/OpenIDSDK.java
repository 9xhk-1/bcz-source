...
public class OpenIDSDK {
    ...
    public static OpenIDInfo getIds(Context context, int i11) {
        m_h.m_a("2021");
        HashMap<String, String> m_a = m_d.m_a(i11);
        return new OpenIDInfo(m_a.get("OUID") == null ? "" : m_a.get("OUID"), "TRUE".equalsIgnoreCase(m_a.get("OUID_STATUS") == null ? "FALSE" : m_a.get("OUID_STATUS")), m_a.get("DUID") != null ? m_a.get("DUID") : "", m_a.get("AUID") == null ? "" : m_a.get("AUID"));
    }
    ...
    public static native void requestOAIDPermission(Activity activity, int i11);
