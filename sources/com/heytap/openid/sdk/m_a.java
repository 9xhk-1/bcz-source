...
public class m_a {
    ...
    public static int m_a(int i11) {
        return (i11 > m_e.m_a || i11 <= 0) ? 10001 : 10000;
    }
    ...
    public static long m_b(String str) {
        ...
        switch (str) {
            ...
            case "OUID":
            case "OUID_STATUS":
                return Constants.MILLS_OF_WATCH_DOG;
            default:
                return 0L;
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x00b3 A[Catch: all -> 0x006c, TRY_LEAVE, TryCatch #2 {all -> 0x006c, blocks: (B:21:0x0044, B:22:0x0055, B:24:0x0058, B:26:0x0068, B:28:0x006e, B:31:0x0078, B:34:0x007e, B:37:0x00ad, B:39:0x00b3, B:43:0x0093, B:47:0x0086), top: B:20:0x0044 }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00b6 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x0093 A[Catch: all -> 0x006c, TryCatch #2 {all -> 0x006c, blocks: (B:21:0x0044, B:22:0x0055, B:24:0x0058, B:26:0x0068, B:28:0x006e, B:31:0x0078, B:34:0x007e, B:37:0x00ad, B:39:0x00b3, B:43:0x0093, B:47:0x0086), top: B:20:0x0044 }] */
    /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.lang.String m_a(android.content.Context r6, java.lang.String r7, java.lang.String r8) {
        /*
            r0 = 0
    ...
    */
    public static void m_a(android.content.SharedPreferences.Editor r4, com.heytap.openid.sdk.m_f r5, java.lang.String r6, java.lang.String r7, java.lang.String r8) {
        /*
            ...
            javax.crypto.Cipher r2 = javax.crypto.Cipher.getInstance(r2)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            javax.crypto.SecretKey r0 = com.heytap.openid.sdk.m_g.m_b(r0)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            if (r0 != 0) goto L19
            goto L43
        L19:
            r3 = 1
            r2.init(r3, r0)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            byte[] r0 = r2.doFinal(r1)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            android.util.Pair r1 = new android.util.Pair     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            r3 = 2
            java.lang.String r0 = android.util.Base64.encodeToString(r0, r3)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            byte[] r2 = r2.getIV()     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            java.lang.String r2 = android.util.Base64.encodeToString(r2, r3)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            r1.<init>(r0, r2)     // Catch: java.lang.Exception -> L34 java.lang.InstantiationError -> L36
            goto L44
        L34:
            r0 = move-exception
            goto L3e
    ...
    public static void m_a(SharedPreferences sharedPreferences, Map<String, m_f> map, String str, String str2) {
        ...
        map.put(str, new m_f(string, j11));
    }
    ...
    public static void m_a(SharedPreferences sharedPreferences, Map<String, m_f> map, String str, String str2, String str3) {
        ...
        if (string == null || j11 == 0 || string2 == null) {
            return;
        }
        try {
            byte[] m_a2 = m_g.m_a(m_a("U3RkSWRBcHBLZXk="), string, string2);
            if (m_a2 != null) {
                map.put(str, new m_f(new String(m_a2, "ISO-8859-1"), j11));
            }
