...
public class m_b extends com.heytap.openid.base.m_b {
    ...
    */
    ...
    public final void m_a(Context context, List<String> list, HashMap<String, String> hashMap) {
    ...
    @Override // com.heytap.openid.base.m_b
    public void m_a(Context context, List<String> list, boolean z11) {
        (this.m_b.equals("OP_APP") ? m_c.m_b.m_a : m_i.m_b.m_a).m_a(context, list, z11);
    }
}
