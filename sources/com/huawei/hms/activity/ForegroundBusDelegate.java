...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    private RequestHeader f35244a;

    /* renamed from: b, reason: collision with root package name */
    private String f35245b;

    /* renamed from: c, reason: collision with root package name */
    private ForegroundInnerHeader f35246c = new ForegroundInnerHeader();

    /* renamed from: d, reason: collision with root package name */
    private ResponseHeader f35247d;

    /* renamed from: e, reason: collision with root package name */
    private WeakReference<Activity> f35248e;
    ...
    private void e() {
        ...
        if (!Util.isAvailableLibExist(g().getApplicationContext())) {
            if (HuaweiApiAvailability.getInstance().isHuaweiMobileServicesAvailable(g().getApplicationContext(), this.f35246c.getApkVersion()) == 0) {
                h();
                return;
            } else {
        ...
        b bVar = new b();
        AvailableAdapter availableAdapter = new AvailableAdapter(this.f35246c.getApkVersion());
    ...
    private Activity g() {
        WeakReference<Activity> weakReference = this.f35248e;
    ...
    public void h() {
        ...
        String packageName = this.f35249f ? g11.getPackageName() : HMSPackageManager.getInstance(g11.getApplicationContext()).getHMSPackageNameForMultiService();
        ...
        Intent intent = new Intent(this.f35246c.getAction());
        intent.putExtra(HMS_FOREGROUND_REQ_BODY, this.f35245b);
        try {
            intent.setPackage(packageName);
        } catch (IllegalArgumentException unused) {
            HMSLog.e("ForegroundBusDelegate", "IllegalArgumentException when startApkHubActivity intent.setPackage");
        }
        intent.putExtra("intent.extra.isfullscreen", UIUtil.isActivityFullscreen(g11));
        intent.setClassName(packageName, "com.huawei.hms.core.activity.UiJumpActivity");
        intent.putExtra(HMS_FOREGROUND_REQ_HEADER, this.f35244a.toJson());
        intent.putExtra("intent.extra.hms.core.DELEGATE_NAME", "com.huawei.hms.core.activity.ForegroundBus");
        try {
            b();
            g11.startActivityForResult(intent, 431057);
        } catch (ActivityNotFoundException e11) {
            HMSLog.e("ForegroundBusDelegate", "Launch sign in Intent failed. hms is probably being updated：", e11);
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        this.f35248e = new WeakReference<>(activity);
        try {
            ...
            this.f35244a = requestHeader;
            if (!requestHeader.fromJson(stringExtra)) {
                a(0, "header is invalid");
                return;
            }
            this.f35245b = intent.getStringExtra(HMS_FOREGROUND_REQ_BODY);
            ForegroundInnerHeader foregroundInnerHeader = this.f35246c;
            ...
            if (TextUtils.isEmpty(this.f35244a.getApiName())) {
    ...
    public boolean onBridgeActivityResult(int i11, int i12, Intent intent) {
        ...
        if (intent != null && intent.hasExtra(HMS_FOREGROUND_RESP_HEADER)) {
            ...
            this.f35247d = responseHeader;
            JsonUtil.jsonToEntity(str, responseHeader);
        }
        d();
        BusResponseCallback b11 = b(this.f35246c.getResponseCallbackKey());
        if (b11 == null) {
            a(i12, intent);
            return true;
        }
        BusResponseResult succeedReturn = b11.succeedReturn(this.f35248e.get(), i12, intent);
    ...
    private void b() {
        Map<String, String> mapFromForegroundRequestHeader = HiAnalyticsUtil.getInstance().getMapFromForegroundRequestHeader(this.f35244a);
        mapFromForegroundRequestHeader.put(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION, HiAnalyticsConstant.Direction.REQUEST);
        mapFromForegroundRequestHeader.put("version", HiAnalyticsUtil.versionCodeToName(String.valueOf(this.f35244a.getKitSdkVersion())));
        if (g() != null) {
    ...
    public void a(int i11, String str) {
        ...
        BusResponseCallback b11 = b(this.f35246c.getResponseCallbackKey());
        if (b11 != null) {
            BusResponseResult innerError = b11.innerError(this.f35248e.get(), i11, str);
            if (innerError == null) {
                g11.setResult(0);
            } else {
    ...
    private void a(String str) {
        ...
        mapFromForegroundRequestHeader.put("version", HiAnalyticsUtil.versionCodeToName(String.valueOf(this.f35244a.getKitSdkVersion())));
        ResponseHeader responseHeader = this.f35247d;
        if (responseHeader != null) {
            ...
            mapFromForegroundRequestHeader.put("result", String.valueOf(this.f35247d.getErrorCode()));
        }
        if (g() != null) {
