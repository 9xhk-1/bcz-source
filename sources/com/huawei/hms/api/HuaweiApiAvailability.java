...
public abstract class HuaweiApiAvailability {
    ...
    public static final int HMS_SDK_VERSION_CODE = 61200300;
    public static final String HMS_SDK_VERSION_NAME = "6.12.0.300";
    ...
    public static void setServicesVersionCode(int i11) {
        servicesVersionCode = i11;
    }

    public abstract k<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract k<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);

    public abstract PendingIntent getErrPendingIntent(Context context, int i11, int i12);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i11, int i12);

    public abstract Dialog getErrorDialog(Activity activity, int i11, int i12, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i11);

    public abstract k<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i11);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i11);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i11);

    public abstract boolean isUserResolvableError(int i11);

    public abstract boolean isUserResolvableError(int i11, PendingIntent pendingIntent);

    public abstract void popupErrNotification(Context context, ConnectionResult connectionResult);

    public abstract void resolveError(Activity activity, int i11, int i12);

    public abstract void resolveError(Activity activity, int i11, int i12, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i11, int i12);

    public abstract boolean showErrorDialogFragment(Activity activity, int i11, int i12, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i11, Fragment fragment, int i12, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i11);
}
