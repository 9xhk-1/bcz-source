...
final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    private static final HuaweiApiAvailabilityImpl f35392a = new HuaweiApiAvailabilityImpl();
    ...
    public class a implements BusResponseCallback {
        ...
        public BusResponseResult innerError(Activity activity, int i11, String str) {
            ...
            this.f35393a[0].c(new AvailabilityException());
            return null;
        }
    ...
    public Dialog getErrorDialog(Activity activity, int i11, int i12) {
        ...
        return getErrorDialog(activity, i11, i12, null);
    }
    ...
    public k<Void> getHuaweiServicesReady(Activity activity) {
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new a(lVarArr));
    ...
    public void resolveError(Activity activity, int i11, int i12) {
        resolveError(activity, i11, i12, null);
    }
    ...
    public boolean isUserResolvableError(int i11) {
        return isUserResolvableError(i11, null);
    }
