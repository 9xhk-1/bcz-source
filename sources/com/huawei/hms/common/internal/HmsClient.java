...
public abstract class HmsClient extends BaseHmsClient implements AnyClient {
    ...
    public static class a implements BaseAdapter.BaseCallBack {
        ...
        private final AnyClient.CallBack f35572a;

        /* renamed from: b, reason: collision with root package name */
        private final WeakReference<HmsClient> f35573b;

        public a(HmsClient hmsClient, AnyClient.CallBack callBack) {
            this.f35572a = callBack;
            this.f35573b = new WeakReference<>(hmsClient);
        }

        private void a(String str) {
            HmsClient hmsClient = this.f35573b.get();
            if (hmsClient != null) {
        ...
        public void onError(String str) {
            ...
            if (!responseWrap.fromJson(str)) {
                this.f35572a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            ...
            this.f35572a.onCallback(responseHeader, responseWrap.getBody());
        }
        ...
        private void a(String str, String str2) {
            ...
            if (responseHeader.fromJson(str)) {
                ...
                a(responseHeader.getSessionId());
                this.f35572a.onCallback(responseHeader, str2);
                return;
            }
            this.f35572a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
        }
