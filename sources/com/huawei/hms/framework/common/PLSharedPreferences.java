...
public class PLSharedPreferences {
    ...
    private final SharedPreferences f35607sp;

    public PLSharedPreferences(Context context, String str) {
        this.f35607sp = getSharedPreferences(context, str);
    }
    ...
    public void clear() {
        SharedPreferences sharedPreferences = this.f35607sp;
    ...
    public void putHashMap(String str, Map<String, String> map) {
        if (this.f35607sp == null || map == null) {
            return;
        }
        ...
        this.f35607sp.edit().putString(str, jSONArray.toString()).apply();
    }
