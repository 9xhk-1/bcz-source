...
public class ReflectionUtils {
    ...
    public static Field getField(Object obj, String str) {
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                Logger.e(TAG, "Exception in getField :: IllegalArgumentException:", e11);
            } catch (NoSuchFieldException e12) {
                Logger.e(TAG, "Exception in getField :: NoSuchFieldException:", e12);
            } catch (SecurityException e13) {
                Logger.e(TAG, "not security int method getField,SecurityException:", e13);
            }
        }
        return null;
    }
    ...
    public static Object getFieldObj(Object obj, String str) {
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                Logger.e(TAG, "Exception in getFieldObj :: IllegalAccessException:", e11);
            } catch (IllegalArgumentException e12) {
                Logger.e(TAG, "Exception in getFieldObj :: IllegalArgumentException:", e12);
            } catch (NoSuchFieldException e13) {
                Logger.e(TAG, "Exception in getFieldObj :: NoSuchFieldException:", e13);
            } catch (SecurityException e14) {
                Logger.e(TAG, "not security int method getFieldObj,SecurityException:", e14);
            }
        }
        return null;
    }
    ...
    public static Method getMethod(Class<?> cls, String str, Class<?>... clsArr) {
        ...
        try {
            ...
            Logger.e(TAG, "NoSuchMethodException:", e11);
            return null;
        } catch (SecurityException e12) {
            Logger.e(TAG, "SecurityException:", e12);
            return null;
        }
    }
    ...
    public static Object getStaticFieldObj(String str, String str2) {
        ...
        if (str != null && (cls = getClass(str)) != null && !TextUtils.isEmpty(str2)) {
            try {
                ...
                Logger.e(TAG, "not security int method getStaticFieldObj,SecurityException:", e14);
            }
        }
        return null;
    }
    ...
    private static Object invoke(Object obj, Method method, Object... objArr) throws UnsupportedOperationException {
        ...
        try {
            ...
            Logger.e(TAG, "RuntimeException in invoke:", e11);
            return null;
        } catch (Exception e12) {
            Logger.e(TAG, "Exception in invoke:", e12);
            return null;
        }
    }
