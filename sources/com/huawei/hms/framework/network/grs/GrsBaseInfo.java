...
public class GrsBaseInfo implements Cloneable {
    ...
    public String getGrsParasKey(boolean z11, boolean z12, Context context) {
        ...
        com.huawei.hms.framework.network.grs.f.b a11 = com.huawei.hms.framework.network.grs.f.b.a(context.getPackageName());
    ...
    public String getGrsReqParamJoint(boolean z11, boolean z12, String str, Context context) {
        ...
        if (!TextUtils.isEmpty(uid)) {
            ...
            stringBuffer.append(ContainerUtils.KEY_VALUE_DELIMITER);
            if (z11) {
                a11 = com.huawei.hms.framework.network.grs.h.b.b(uid);
            } else if (z12) {
                a11 = com.huawei.hms.framework.network.grs.h.b.a(uid);
            } else {
                stringBuffer.append(uid);
            }
