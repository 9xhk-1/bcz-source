...
public class CountryCodeBean {
    ...
    private void getLocaleCountryCode() {
        String str;
        String str2;
        if (SystemPropUtils.getProperty(ct.d.f46852f, "ro.build.version.emui", ANDRIOD_SYSTEMPROP, "").isEmpty()) {
    ...
    private void getProductCountryCode() {
        int lastIndexOf;
        this.countryCode = SystemPropUtils.getProperty(ct.d.f46852f, LOCALE_REGION_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
        ...
        if (TextUtils.isEmpty(this.countryCode) || "UNKNOWN".equals(this.countryCode)) {
            String property = SystemPropUtils.getProperty(ct.d.f46852f, LOCALE_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
    ...
    private void getVendorCountryCode() {
        ...
        this.countryCode = SystemPropUtils.getProperty(ct.d.f46852f, VENDORCOUNTRY_SYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
