...
public class p1 {
    ...
    public static boolean b(String str) {
        if (p.f35881a.booleanValue()) {
            return true;
        }
        for (String str2 : f35889a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
    ...
    public static boolean a(String str, String str2, int i11) {
        ...
        if (TextUtils.isEmpty(a11) || TextUtils.isEmpty(str2)) {
            ...
            if (!TextUtils.isEmpty(a12)) {
                if (str2.equals(qr.d.b(a11))) {
                    return true;
                }
                if (!str2.equals(qr.d.b(a12))) {
                    return false;
                }
                try {
