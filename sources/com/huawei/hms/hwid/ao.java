...
public class ao {
            ...
            activity.getWindow().getDecorView().setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.huawei.hms.hwid.ao.1
                ...
                public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                    try {
                        ...
                        as.d("AccountSdkUtil", "onApplyWindowInsets--" + th2.getClass().getSimpleName(), true);
                    }
    ...
    public static void c(Activity activity) {
        ...
        try {
            ...
            as.d("AccountSdkUtil", "setDisplaySideMode--" + th2.getClass().getSimpleName(), true);
        }
    }
    ...
    public static void a(ResponseErrorCode responseErrorCode, Status status) {
        ...
        try {
            ...
            as.d("AccountSdkUtil", "doExecuteIntent--" + th2.getClass().getSimpleName(), true);
        }
    }
}
