...
public class i extends TaskApiCall<c, AccountIcon> {
    ...
    public void doExecute(c cVar, ResponseErrorCode responseErrorCode, String str, fr.l<AccountIcon> lVar) {
        ...
        try {
            ...
            lVar.d(accountIcon);
            long a11 = ao.a();
            SharedPreferences.Editor edit = this.f35960a.getSharedPreferences("ACCOUNT_CHANNEL_CACHE", 0).edit();
            edit.putLong("cache_time", a11);
    ...
    private Bitmap a(String str) {
        try {
            ...
            as.d("[AccountSDK]AccountGetChannelTaskApiCall", "stringToBitmap Exception is " + e11.getClass().getSimpleName(), true);
            return null;
