...
public class j extends TaskApiCall<c, Void> {
    ...
    public void doExecute(c cVar, ResponseErrorCode responseErrorCode, String str, fr.l<Void> lVar) {
        ...
        if (CommonCode.Resolution.HAS_RESOLUTION.equals(responseErrorCode.getResolution())) {
            ...
            lVar.c(new ResolvableApiException(new Status(responseErrorCode.getErrorCode(), responseErrorCode.getErrorReason(), (PendingIntent) responseErrorCode.getParcelable())));
        } else {
    ...
    private void a(ResponseErrorCode responseErrorCode) {
        ...
        as.b("AccountLogoutTaskApiCall", sb2.toString(), true);
    }
}
