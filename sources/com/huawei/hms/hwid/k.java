...
public class k extends TaskApiCall<c, Intent> {
    ...
    public void doExecute(c cVar, ResponseErrorCode responseErrorCode, String str, fr.l<Intent> lVar) {
        ...
        if (responseErrorCode.getStatusCode() == 0 && responseErrorCode.getErrorCode() == 0) {
            ...
            a(responseErrorCode.getParcelable(), cVar, responseErrorCode, lVar);
        } else {
    ...
    private void a(Parcelable parcelable, c cVar, ResponseErrorCode responseErrorCode, fr.l<Intent> lVar) {
        ...
        if (parcelable instanceof Intent) {
            ...
            try {
                if (UIUtil.isBackground(cVar.getContext())) {
                    ...
                    lVar.c(new ApiException(new Status(responseErrorCode.getErrorCode(), responseErrorCode.getErrorReason(), pendingIntent)));
                } else {
