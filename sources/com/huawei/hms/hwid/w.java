...
public class w extends HuaweiApi<a> {
    ...
    private static final Api<a> f35967a = new Api<>(HuaweiApiAvailability.HMS_API_NAME_GAME);

    /* renamed from: c, reason: collision with root package name */
    private static final a f35968c = new a();
    ...
    public w(Context context) {
        super(context, f35967a, f35968c, new v());
    ...
    public void a() {
        ...
        try {
            ...
            jSONObject.put("cpId", Util.getCpId(this.f35969b));
