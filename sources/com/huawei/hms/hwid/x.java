    ...
    public static Intent a(Context context, HuaweiIdAuthParams huaweiIdAuthParams, String str) {
        ...
        try {
            ...
            try {
                ...
                as.d("[HUAWEIIDSDK]HuaweiIdAuthTool", "JSONException:" + e11.getClass().getSimpleName(), true);
            }
        } catch (Exception e12) {
            as.d("[HUAWEIIDSDK]HuaweiIdAuthTool", "Exception:" + e12.getClass().getSimpleName(), true);
        }
        return intent;
    }
