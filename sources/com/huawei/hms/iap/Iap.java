...
public class Iap {
    ...
    public static IapClient getIapClient(Activity activity, String str, boolean z11) {
        Checker.assertNonNull(activity);
        if (z11) {
            Checker.assertNonNull(str, "Null productAppId is not permitted.");
        }
        return new d(activity, str, z11);
    }
    ...
    public static IapClient getIapClient(Context context, String str, boolean z11) {
        Checker.assertNonNull(context);
        if (z11) {
            Checker.assertNonNull(str, "Null productAppId is not permitted.");
        }
        return new d(context, str, z11);
    }
}
