...
public class q extends a<g, ScanRedeemCodeResult> {
    ...
    public void a(@NonNull fr.l<ScanRedeemCodeResult> lVar, @NonNull ResponseErrorCode responseErrorCode, String str) {
        ...
        if (responseErrorCode.getParcelable() instanceof Intent) {
            ...
            lVar.d(new ScanRedeemCodeResult((Intent) responseErrorCode.getParcelable()));
        } else {
