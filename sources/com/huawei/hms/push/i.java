...
public class i {
    public static void a(Context context, Intent intent) {
        try {
            ...
            HMSLog.e("PushSelfShowLog", "onReceive RuntimeException.", e11);
    ...
    public static void a(Context context, Intent intent, k kVar) {
        ...
        if (j.a(kVar.i())) {
            ...
            q.a(context, intent, a11);
        }
    }

    public static void a(Context context, Intent intent, String str, k kVar, int i11) {
