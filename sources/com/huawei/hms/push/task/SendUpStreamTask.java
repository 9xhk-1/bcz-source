...
public class SendUpStreamTask extends TaskApiCall<PushClient, BaseVoidTask> {
    ...
    public final void a(PushClient pushClient, ResponseErrorCode responseErrorCode) {
        HMSLog.i("SendUpStreamTask", "receive upstream, msgId :" + this.f36226b + " , packageName = " + this.f36225a + " , errorCode = " + responseErrorCode.getErrorCode());
        Intent intent = new Intent("com.huawei.push.action.MESSAGING_EVENT");
        intent.setPackage(this.f36225a);
        Bundle bundle = new Bundle();
        bundle.putString("message_id", this.f36226b);
    ...
    @Override // com.huawei.hms.common.internal.TaskApiCall
    public void doExecute(PushClient pushClient, ResponseErrorCode responseErrorCode, String str, l<BaseVoidTask> lVar) {
