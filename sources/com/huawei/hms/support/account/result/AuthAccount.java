...
public class AuthAccount extends AbstractAuthAccount {
    public static final Parcelable.Creator<AuthAccount> CREATOR = new Parcelable.Creator<AuthAccount>() { // from class: com.huawei.hms.support.account.result.AuthAccount.1
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public AuthAccount[] newArray(int i11) {
            return new AuthAccount[i11];
        }
    };
    ...
    public AuthAccount(String str, String str2, String str3, String str4, String str5, String str6, int i11, int i12, Set<Scope> set, String str7, String str8, String str9, int i13) {
        this.openId = str;
        this.uid = str2;
    ...
    public static AuthAccount build(String str, String str2, String str3, String str4, String str5, String str6, int i11, int i12, Set<Scope> set, String str7, String str8, String str9, int i13) {
        return new AuthAccount(str, str2, str3, str4, str5, str6, i11, i12, set, str7, str8, str9, i13);
    }
    ...
    public void parserJson(JSONObject jSONObject) throws JSONException {
        ...
        this.f36258a = jSONObject.optInt(CommonConstant.KEY_ACCOUNT_FLAG, 0);
    }
    ...
    public String toString() {
        return "{uid: " + this.uid + ",displayName: " + this.displayName + ",photoUriString: " + this.photoUriString + ",status: " + this.status + ",gender: " + this.gender + ",serviceCountryCode: " + this.serviceCountryCode + ",countryCode: " + this.countryCode + CommonConstant.KEY_ACCOUNT_FLAG + this.f36258a + b.f69928j;
    }
