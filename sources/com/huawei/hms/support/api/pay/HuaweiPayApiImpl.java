...
public class HuaweiPayApiImpl implements HuaweiPayApi {
    ...
    public PayResultInfo getPayResultInfoFromIntent(Intent intent) {
        ...
        payResultInfo.setUserName(com.huawei.hms.support.api.pay.util.a.a(intent, "userName"));
        ...
        payResultInfo.setCountry(com.huawei.hms.support.api.pay.util.a.a(intent, HwPayConstant.KEY_COUNTRY));
        ...
        payResultInfo.setRequestId(com.huawei.hms.support.api.pay.util.a.a(intent, HwPayConstant.KEY_REQUESTID));
    ...
    public ProductPayResultInfo getProductPayResultFromIntent(Intent intent) {
        ...
        productPayResultInfo.setRequestId(com.huawei.hms.support.api.pay.util.a.a(intent, HwPayConstant.KEY_REQUESTID));
        ...
        productPayResultInfo.setCountry(com.huawei.hms.support.api.pay.util.a.a(intent, HwPayConstant.KEY_COUNTRY));
    ...
    @Override // com.huawei.hms.support.api.pay.HuaweiPayApi
    public PendingResult<GetWalletUiIntentResult> getWalletUiIntent(HuaweiApiClient huaweiApiClient, int i11) {
        HMSLog.i("HuaweiPayApiImpl", "Enter getWalletUiIntent type:" + i11);
