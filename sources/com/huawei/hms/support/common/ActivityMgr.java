...
public final class ActivityMgr implements Application.ActivityLifecycleCallbacks {
    ...
    private WeakReference<Activity> f36367a;
    ...
    public Activity getCurrentActivity() {
        if (this.f36367a == null) {
            HMSLog.i("ActivityMgr", "mCurrentActivity is " + this.f36367a);
            return null;
        }
        HMSLog.i("ActivityMgr", "mCurrentActivity.get() is " + this.f36367a.get());
        return this.f36367a.get();
    }
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        this.f36367a = new WeakReference<>(activity);
    }
