...
public abstract class AbstractAuthAccount implements Parcelable {
    ...
    public void parserJson(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONArray != null) {
            ...
            for (int i11 = 0; i11 < jSONArray.length(); i11++) {
                String optString = jSONArray.getJSONObject(i11).optString(CommonConstant.KEY_SCOPE_URI, null);
                if (optString != null) {
    ...
    public void setCarrierId(int i11) {
        this.carrierId = i11;
    }
    ...
    public void setExpirationTimeSecs(long j11) {
        this.expirationTimeSecs = j11;
    }
    ...
    public void setHomeZone(int i11) {
        this.homeZone = i11;
    }
    ...
    public String toString() {
        return "{uid: " + this.uid + ",displayName: " + this.displayName + ",photoUriString: " + this.photoUriString + ",status: " + this.status + ",gender: " + this.gender + ",serviceCountryCode: " + this.serviceCountryCode + ",countryCode: " + this.countryCode + b.f69928j;
    }
