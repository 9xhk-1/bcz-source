...
public class HiAnalyticsUtil {
    ...
    private static final Object f36369a = new Object();

    /* renamed from: b, reason: collision with root package name */
    private static HiAnalyticsUtil f36370b;

    /* renamed from: c, reason: collision with root package name */
    private static HiAnalyticsUtils f36371c;

    private String a(Context context, String str) {
        return "01|" + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + context.getPackageName() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + Util.getAppId(context) + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + 61200300 + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str;
    }

    public static HiAnalyticsUtil getInstance() {
        HiAnalyticsUtil hiAnalyticsUtil;
        synchronized (f36369a) {
            try {
                if (f36370b == null) {
                    f36370b = new HiAnalyticsUtil();
                    f36371c = HiAnalyticsUtils.getInstance();
                }
                hiAnalyticsUtil = f36370b;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public void onBuoyEvent(Context context, String str, String str2) {
        f36371c.onBuoyEvent(context, str, str2);
    }

    public void onEvent(Context context, String str, Map<String, String> map) {
        f36371c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f36371c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f36371c.onNewEvent(context, str, map);
    }
    ...
    public boolean hasError(Context context) {
        return f36371c.hasError(context);
    }
