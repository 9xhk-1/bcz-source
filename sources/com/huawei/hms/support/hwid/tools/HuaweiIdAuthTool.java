...
public class HuaweiIdAuthTool {
    ...
    private static void a(final k<Void> kVar) throws HuaweiIdAuthException {
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final a aVar = new a();
        kVar.addOnSuccessListener(new i<Void>() { // from class: com.huawei.hms.support.hwid.tools.HuaweiIdAuthTool.2
            @Override // fr.i
        ...
        }).addOnFailureListener(new h() { // from class: com.huawei.hms.support.hwid.tools.HuaweiIdAuthTool.1
            @Override // fr.h
            public void onFailure(Exception exc) {
                int statusCode = ((ApiException) k.this.getException()).getStatusCode();
    ...
    private static void a(Context context, String str) throws HuaweiIdAuthException {
        ...
        if (context != null) {
            ...
            try {
                ...
                a((k<Void>) huaweiIdAuthServiceImpl.doWrite(new aa(CommonNaming.signout, jSONObject.toString(), HiAnalyticsClient.reportEntry(context, CommonNaming.signout, 60900100))));
                return;
    ...
    private static t a(HuaweiIdAuthService huaweiIdAuthService, String str) throws HuaweiIdAuthException {
        ...
        final t tVar = new t();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        k<AuthHuaweiId> silentSignIn = huaweiIdAuthService.silentSignIn();
        silentSignIn.addOnSuccessListener(new i<AuthHuaweiId>() { // from class: com.huawei.hms.support.hwid.tools.HuaweiIdAuthTool.3
            @Override // fr.i
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
        ...
        silentSignIn.addOnFailureListener(new h() { // from class: com.huawei.hms.support.hwid.tools.HuaweiIdAuthTool.4
            @Override // fr.h
            public void onFailure(Exception exc) {
        ...
        boolean z11 = false;
        try {
            z11 = countDownLatch.await(10L, TimeUnit.SECONDS);
        } catch (InterruptedException unused) {
        ...
        as.b(TAG, str + " end countDownLatch awaitValue:" + z11, true);
        int a11 = tVar.a();
        if (a11 == 0) {
            return tVar;
        }
        as.d(TAG, str + " fail, error code is:" + a11, true);
        throw new HuaweiIdAuthException(str + " error[" + a11 + "]");
    }
}
