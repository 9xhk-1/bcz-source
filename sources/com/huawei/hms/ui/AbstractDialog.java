...
public abstract class AbstractDialog {
    ...
    private Activity f36439a;

    /* renamed from: b, reason: collision with root package name */
    private AlertDialog f36440b;

    /* renamed from: c, reason: collision with root package name */
    private Callback f36441c;
    ...
    public void cancel() {
        AlertDialog alertDialog = this.f36440b;
        if (alertDialog != null) {
            alertDialog.cancel();
        }
    }
    ...
    public void fireCancel() {
        Callback callback = this.f36441c;
        if (callback != null) {
    ...
    public void show(Activity activity, Callback callback) {
        this.f36439a = activity;
        this.f36441c = callback;
        if (activity == null || activity.isFinishing()) {
            HMSLog.e("AbstractDialog", "In show, The activity is null or finishing.");
            return;
        }
        AlertDialog onCreateDialog = onCreateDialog(this.f36439a);
        this.f36440b = onCreateDialog;
        onCreateDialog.setCanceledOnTouchOutside(false);
        this.f36440b.setOnCancelListener(new c());
        this.f36440b.setOnKeyListener(new d());
        this.f36440b.show();
    }
}
