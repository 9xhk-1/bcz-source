...
public class ConfirmInstallWizard extends AbsUpdateWizard {
    ...
    private static final String f36548a;
    ...
    public void getInstallHmsIntent(Activity activity, File file) {
        ...
        try {
            ...
            HMSLog.e("ConfirmInstallWizard", "In getInstallHmsIntent start activity error: " + e11.getMessage());
        }
    }
    ...
    private void a(Activity activity) {
        try {
            String str = activity.getApplicationContext().getExternalCacheDir().getCanonicalPath() + f36548a;
            ...
            HMSLog.e("ConfirmInstallWizard", "getExternalCacheDir fail:  " + e11.getMessage());
        }
    }
    ...
    */
    ...
    private void a() {
        try {
            File file = new File(getActivity().getApplicationContext().getExternalCacheDir().getCanonicalPath() + f36548a);
            if (!file.exists()) {
            ...
            HMSLog.e("ConfirmInstallWizard", "getExternalCacheDir or delete file error:  " + e11.getMessage());
        }
    }

    private String a(Context context) {
        try {
            String str = context.getApplicationContext().getExternalCacheDir().getCanonicalPath() + f36548a;
            File file = new File(str);
            if (!file.exists()) {
            ...
            HMSLog.e("ConfirmInstallWizard", "<getHmsApkSize> getExternalCacheDir fail:  " + e11.getMessage());
            return "";
        }
    }
}
