...
public class WatchProgressDialog extends Dialog {
    ...
    private void a() {
        addContentView(((LayoutInflater) this.f36689a.getSystemService("layout_inflater")).inflate(ResourceLoaderUtil.getLayoutId("hms_installer_progress_dialog_watch"), (ViewGroup) null), new LinearLayout.LayoutParams(-1, -1));
    }
