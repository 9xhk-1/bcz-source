...
public class SafeBase64 {
    ...
    public static final String f36789a = "SafeBase64";

    public static byte[] decode(byte[] bArr, int i11) {
        try {
            return Base64.decode(bArr, i11);
        } catch (Exception e11) {
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message0 : " + e11.getMessage());
            return new byte[0];
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i11) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message3 : " + e11.getMessage());
            return new byte[0];
        }
    }
    ...
    public static String encodeToString(byte[] bArr, int i11) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message5 : " + e11.getMessage());
            return "";
        }
    }
    ...
    public static String encodeToString(byte[] bArr, int i11, int i12, int i13) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message6 : " + e11.getMessage());
            return "";
        }
    }
    ...
    public static byte[] decode(byte[] bArr, int i11, int i12, int i13) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message1 : " + e11.getMessage());
            return new byte[0];
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i11, int i12, int i13) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message4 : " + e11.getMessage());
            return new byte[0];
        }
    }
    ...
    public static byte[] decode(String str, int i11) {
        try {
            ...
            Log.e(f36789a, e11.getClass().getSimpleName() + " , message2 : " + e11.getMessage());
            return new byte[0];
        }
    }
}
