...
public final class UpdateSdkAPI {
    public static void checkAppUpdate(Context context, CheckUpdateCallBack checkUpdateCallBack, boolean z11, boolean z12) {
        g.a(context, checkUpdateCallBack, z11, z12);
    }
    ...
    public static void checkClientOTAUpdate(Context context, CheckUpdateCallBack checkUpdateCallBack, boolean z11, int i11, boolean z12) {
        g.a(context, checkUpdateCallBack, z11, i11, z12);
    }
    ...
    public static void showUpdateDialog(Context context, ApkUpgradeInfo apkUpgradeInfo, boolean z11) {
        g.a(context, apkUpgradeInfo, z11);
    }
