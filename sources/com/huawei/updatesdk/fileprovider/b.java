...
class b implements a {
    ...
    private final HashMap<String, File> f36937b = new HashMap<>();
    ...
    public Uri a(File file) {
        try {
            ...
            for (Map.Entry<String, File> entry2 : this.f36937b.entrySet()) {
            ...
            return new Uri.Builder().scheme("content").authority(this.f36936a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(canonicalPath.substring(length), "/")).build();
    ...
    public File a(Uri uri) {
        try {
            ...
            File file = this.f36937b.get(decode);
            if (file == null) {
            ...
            throw new IllegalArgumentException("UpdateSDKFileProvider error: " + e11.getMessage());
        }
    }
    ...
    public void a(String str, File file) {
        ...
        try {
            this.f36937b.put(str, file.getCanonicalFile());
        } catch (Exception unused) {
