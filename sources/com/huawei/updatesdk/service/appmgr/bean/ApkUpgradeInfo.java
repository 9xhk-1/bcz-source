...
public class ApkUpgradeInfo extends com.huawei.updatesdk.a.b.c.c.b implements Serializable, Parcelable {
    public static final int APP_MUST_UPDATE = 1;
    public static final Parcelable.Creator<ApkUpgradeInfo> CREATOR = new a();
    public static final int HUAWEI_NOT_OFFICIAL_APP = 2;
    ...
    public static class a implements Parcelable.Creator<ApkUpgradeInfo> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ApkUpgradeInfo[] newArray(int i11) {
            return new ApkUpgradeInfo[i11];
        }
    }
    ...
    public void setBundleSize_(long j11) {
        this.bundleSize_ = j11;
    }
    ...
    public void setDevType_(int i11) {
        this.devType_ = i11;
    }
    ...
    public void setDiffSize_(int i11) {
        this.diffSize_ = i11;
    }
    ...
    public void setIsAutoUpdate_(int i11) {
        this.isAutoUpdate_ = i11;
    }

    public void setIsCompulsoryUpdate_(int i11) {
        this.isCompulsoryUpdate_ = i11;
    }

    public void setMaple_(int i11) {
        this.maple_ = i11;
    }
    ...
    public void setObbSize_(long j11) {
        this.obbSize_ = j11;
    }

    public void setOldVersionCode_(int i11) {
        this.oldVersionCode_ = i11;
    }
    ...
    public void setPackingType_(int i11) {
        this.packingType_ = i11;
    }
    ...
    public void setVersionCode_(int i11) {
