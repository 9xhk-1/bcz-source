...
public final class c extends com.igexin.push.f.a.d {
    ...
    public static final String f38177a = "GetIDCConfigHttpPlugin";

    /* renamed from: b, reason: collision with root package name */
    public static JSONArray f38178b;
    ...
    public final void a(byte[] bArr) throws Exception {
        if (bArr != null) {
            try {
                ...
                g.a(str, true);
                f.a().b(0L);
                com.igexin.c.a.b.e.a().a((com.igexin.c.a.d.f) com.igexin.push.config.a.a().new AnonymousClass6(f38178b.toString()), true, false);
                SDKUrlConfig.setIdcConfigUrl(h.a(f38178b));
            } catch (Exception e11) {
                f.a().b(System.currentTimeMillis());
                throw e11;
            }
