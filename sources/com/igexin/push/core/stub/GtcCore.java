...
public class GtcCore implements IPushCore {
    ...
    private static final String f38364a = "GtcCore";
    ...
    public static /* synthetic */ void a(String str) {
        try {
            ...
            f a11 = f.a();
            e.C = str;
            com.igexin.c.a.b.e.a().a((com.igexin.c.a.d.f) a11.new AnonymousClass31(), false, true);
            if (e.f38044u) {
                b.d().i();
            }
        } catch (Exception e11) {
    ...
    public boolean start(Context context) {
        ...
        try {
            n.u();
            String initialize = GtcManager.getInstance().initialize(context, Caller.PUSH, new GtcIdCallback.Stub() { // from class: com.igexin.push.core.stub.GtcCore.1
            ...
            a.a("GtcCore|init gtc error =  " + th2.toString(), new Object[0]);
        }
        System.currentTimeMillis();
        return true;
    }
