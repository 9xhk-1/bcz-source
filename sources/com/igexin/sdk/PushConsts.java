...
public class PushConsts {
    ...
    public static final String ACTION_BROADCAST_NOTIFICATION_DELETE = "com.igexin.action.notification.delete";
    public static final String ACTION_BROADCAST_PUSHMANAGER = "com.igexin.sdk.action.pushmanager";
    public static final String ACTION_BROADCAST_UPLOAD_TYPE253 = "com.igexin.action.update.type253";
    ...
    public static final int ACTION_NOTIFICATION_ENABLE = 10014;
    public static final int ACTION_POPUP_CLICKED = 10016;
    public static final int ACTION_POPUP_SHOW = 10015;
    ...
    public static final int GET_DEVICETOKEN = 10013;
    ...
    public static final String KEY_POPUP_CLICKED = "popup_click";
    public static final String KEY_POPUP_SHOW = "popup_show";
    public static final String KEY_SERVICE_PIT = "pid";
    public static final int MAX_FEEDBACK_ACTION = 90999;
    public static final int MAX_OPEN_FEEDBACK_ACTION = 60999;
    public static final int MIN_FEEDBACK_ACTION = 90001;
    public static final int MIN_OPEN_FEEDBACK_ACTION = 60001;
    public static final int QUERYTAG_ERROR_FREQUENCY = 20002;
    public static final int QUERYTAG_SN_NULL = 20007;
    public static final int QUERYTAG_SUCCESS = 0;
    public static final String QUERY_TAG = "queryTag";
    public static final int QUERY_TAG_RESULT = 10012;
