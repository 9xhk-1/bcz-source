...
public class FeedbackImpl {
    ...
    public void clearFeedbackMessage() {
        ...
        Iterator<Map.Entry<String, Long>> it = e.f38010al.entrySet().iterator();
        while (it.hasNext()) {
    ...
    public void feedbackMessageAction(PushTaskBean pushTaskBean, String str, String str2) {
        ...
        try {
            ...
            jSONObject.put(com.alipay.sdk.m.s.a.f11004r, pushTaskBean.getAppKey());
        ...
        bVar.f38423h = e.A;
        com.igexin.push.core.e.e.a().b(new n(currentTimeMillis, jSONObject2, (byte) 3, e.f38044u ? currentTimeMillis : 0L));
        if (d.a.f37956a.f37949h != null) {
            d.a.f37956a.f37949h.a("C-" + e.A, bVar, false);
        }
        com.igexin.c.a.c.a.a("feedback|" + pushTaskBean.getTaskId() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + pushTaskBean.getMessageId() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str, new Object[0]);
    }
