...
public class GTPopupMessage extends BaseMessage implements Serializable {
    ...
    public static class EventProperties implements Serializable {
        ...
        public String toString() {
            return "{\"$popup_plan_name\":\"" + this.$popup_plan_name + "\", \"$popup_node_name\":\"" + this.$popup_node_name + "\", \"$popup_click_modal\":\"" + this.$popup_click_modal + "\", \"$popup_node_modal_name\":\"" + this.$popup_node_modal_name + '\"' + b.f69928j;
        }
    }
    ...
    public static class GtAction implements Serializable {
        ...
        public GtAction(String str, String str2, String str3, boolean z11) {
            this.actionType = str;
            this.intent = str2;
            this.url = str3;
            this.closePopup = z11;
