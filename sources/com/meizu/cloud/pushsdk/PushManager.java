...
public class PushManager {
    ...
    public static void checkNotificationMessage(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start check notification message service error " + e11.getMessage());
        }
    }
    ...
    public static void enableCacheRequest(Context context, boolean z11) {
        com.meizu.cloud.pushsdk.platform.a.b.a(context).a(z11);
    }

    public static String getPushId(Context context) {
        int b11 = com.meizu.cloud.pushsdk.util.b.b(context, context.getPackageName());
        if (b11 == 0 || System.currentTimeMillis() / 1000 <= b11) {
    ...
    public static void register(Context context) {
        ...
        if (MzSystemUtils.isBrandMeizu(context)) {
            String str2 = PushConstants.PUSH_PACKAGE_NAME;
            String appVersionName = MzSystemUtils.getAppVersionName(context, PushConstants.PUSH_PACKAGE_NAME);
            ...
            try {
                ...
                str = "start register service error " + e11.getMessage();
            }
            intent.setClassName(str2, PushConstants.MZ_PUSH_SERVICE_NAME);
            intent.putExtra("sender", context.getPackageName());
        } else {
            str = "please invoke register on meizu device Build-in FlymeOS";
        }
    ...
    public static void switchPush(Context context, String str, String str2, String str3, int i11, boolean z11) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.a.b.a(context).a(str, str2, context.getPackageName(), str3, i11, z11);
        } else {
    ...
    public static void unRegister(Context context) {
        ...
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            try {
                ...
                str = "start unRegister service error " + e11.getMessage();
            }
            intent.setClassName(str2, PushConstants.MZ_PUSH_SERVICE_NAME);
            intent.putExtra("sender", context.getPackageName());
        } else {
            str = "please invoke unRegister on meizu device Build-in FlymeOS";
        }
        DebugLogger.e(TAG, str);
    }
    ...
    public static void switchPush(Context context, String str, String str2, String str3, boolean z11) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.a.b.a(context).a(str, str2, context.getPackageName(), str3, z11);
        } else {
            DebugLogger.e(TAG, "please invoke switchPush on meizu device Build-in FlymeOS");
        }
    }
