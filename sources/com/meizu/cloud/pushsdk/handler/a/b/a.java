...
public class a extends com.meizu.cloud.pushsdk.handler.a.a<g> {
    ...
    public void a(g gVar, c cVar) {
        ...
        String str2;
        DebugLogger.flush();
        String a11 = gVar.d().b().a();
        String d11 = gVar.d().b().d();
        if (Build.VERSION.SDK_INT >= 29) {
            str = MzSystemUtils.getDocumentsPath(d()) + "/pushSdktmp/" + a11 + "_" + d11 + ".zip";
        } else {
            str = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/pushSdktmp/" + a11 + "_" + d11 + ".zip";
        }
        File file = null;
        try {
            new b(str).a(gVar.c());
        ...
        com.meizu.cloud.pushsdk.c.a.c<String> a12 = com.meizu.cloud.pushsdk.platform.a.b.a(d()).a(gVar.d().b().a(), gVar.d().b().d(), message, file);
        if (a12 == null || !a12.b()) {
            if (a12 != null) {
                str2 = "upload error code " + a12.c() + a12.a();
            } else {
                str2 = "upload error";
            }
        ...
        DebugLogger.e("AbstractMessageHandler", "upload success " + a12.a());
    }
    ...
    public boolean a(Intent intent) {
        ...
        if (!TextUtils.isEmpty(stringExtra)) {
            ...
            if (a11.a() != null) {
                i11 = a11.a().a();
                return !PushConstants.MZ_PUSH_ON_MESSAGE_ACTION.equals(intent.getAction()) && "2".equals(String.valueOf(i11));
            }
        }
        i11 = 0;
