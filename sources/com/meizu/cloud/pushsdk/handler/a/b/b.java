...
public class b {
    ...
    private final File f39846a;

    public b(String str) {
        this.f39846a = new File(str);
    }
    ...
    private void a(File file, ZipOutputStream zipOutputStream, String str) throws Exception {
        ...
        DebugLogger.i("ZipTask", "current file " + sb3 + "/" + file.getName() + " size is " + (file.length() / 1024) + "KB");
    ...
    public void a(List<String> list) throws Exception {
        if (!this.f39846a.exists()) {
            this.f39846a.getParentFile().mkdirs();
        }
