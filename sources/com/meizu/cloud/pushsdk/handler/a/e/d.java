...
public class d extends com.meizu.cloud.pushsdk.handler.a.a<SubAliasStatus> {
    ...
    public SubAliasStatus c(Intent intent) {
        ...
        SubAliasStatus d11 = !TextUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.d(stringExtra) : (SubAliasStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_SUBALIAS_STATUS);
        if (BasicPushStatus.SUCCESS_CODE.equals(d11.getCode())) {
            c(d11.getAlias());
        }
        return d11;
    }
