...
public class MPushMessage implements Serializable {
    ...
    public static MPushMessage parsePushMessage(String str, String str2, String str3, String str4) {
        ...
        try {
                ...
                if (!jSONObject.isNull(PushConstants.PARAMS)) {
                    try {
                        try {
                            ...
                            DebugLogger.i(TAG, "parameter parse error message " + e11.getMessage());
                        }
            ...
            DebugLogger.i(TAG, "parse push message error " + e12.getMessage());
        }
    ...
    public String toString() {
        return "MPushMessage{taskId='" + this.taskId + "', pushType='" + this.pushType + "', packageName='" + this.packageName + "', title='" + this.title + "', content='" + this.content + "', notifyType='" + this.notifyType + "', clickType='" + this.clickType + "', isDiscard='" + this.isDiscard + "', extra=" + this.extra + ", params=" + this.params + l50.b.f69928j;
    }
}
