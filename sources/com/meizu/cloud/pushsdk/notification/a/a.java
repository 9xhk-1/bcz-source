...
public class a extends c {
    ...
    public void a(Notification.Builder builder, MessageV3 messageV3) {
        ...
        if (MinSdkChecker.isSupportNotificationBuild()) {
            ...
            if (messageV3.getNotificationStyle() == null || a() || TextUtils.isEmpty(messageV3.getNotificationStyle().getExpandableImageUrl()) || (a11 = a(messageV3.getNotificationStyle().getExpandableImageUrl())) == null) {
                return;
            }
