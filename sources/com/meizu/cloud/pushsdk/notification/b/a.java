...
public class a extends c {
    ...
    private void b(RemoteViews remoteViews, MessageV3 messageV3) {
        ...
        if (TextUtils.isEmpty(messageV3.getNotificationStyle().getExpandableImageUrl())) {
        ...
        if (a11 == null) {
            ...
            remoteViews.setViewVisibility(com.meizu.cloud.pushsdk.notification.c.c.g(this.f39897a), 0);
            remoteViews.setImageViewBitmap(com.meizu.cloud.pushsdk.notification.c.c.g(this.f39897a), a11);
        }
    }
