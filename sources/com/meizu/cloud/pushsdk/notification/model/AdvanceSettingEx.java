...
public class AdvanceSettingEx implements Parcelable {
    ...
    public static final Parcelable.Creator<AdvanceSettingEx> CREATOR = new Parcelable.Creator<AdvanceSettingEx>() { // from class: com.meizu.cloud.pushsdk.notification.model.AdvanceSettingEx.1
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public AdvanceSettingEx[] newArray(int i11) {
            return new AdvanceSettingEx[i11];
        }
    };
    ...
    public void setPriorityDisplay(int i11) {
        if (i11 < -2 || i11 > 2) {
            i11 = 0;
        }
        this.priorityDisplay = i11;
    }
    ...
    public String toString() {
        return "AdvanceSettingEx{, priorityDisplay=" + this.priorityDisplay + ", soundTitle=" + this.soundTitle + b.f69928j;
    }
