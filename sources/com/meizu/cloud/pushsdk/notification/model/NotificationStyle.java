...
public class NotificationStyle implements Parcelable {
    ...
    public static final Parcelable.Creator<NotificationStyle> CREATOR = new Parcelable.Creator<NotificationStyle>() { // from class: com.meizu.cloud.pushsdk.notification.model.NotificationStyle.1
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public NotificationStyle[] newArray(int i11) {
            return new NotificationStyle[i11];
        }
    };
    ...
    public void setBaseStyle(int i11) {
        this.baseStyle = i11;
    }
    ...
    public void setInnerStyle(int i11) {
        this.innerStyle = i11;
    }

    public String toString() {
        return "NotificationStyle{baseStyle=" + this.baseStyle + ", innerStyle=" + this.innerStyle + ", expandableText='" + this.expandableText + "', expandableImageUrl='" + this.expandableImageUrl + "', bannerImageUrl='" + this.bannerImageUrl + '\'' + b.f69928j;
    }
