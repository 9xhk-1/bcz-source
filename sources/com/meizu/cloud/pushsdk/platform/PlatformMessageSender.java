...
public class PlatformMessageSender {
    ...
    public static void a(Context context, int i11, boolean z11, String str) {
        ...
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_SWITCH_SETTING_TYPE, i11);
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_SWITCH_SETTING_STATUS, z11);
        ...
        try {
            ...
            DebugLogger.e("PlatformMessageSender", "start switch push message setting service error " + e11.getMessage());
        }
    }

    public static void launchStartActivity(Context context, String str, String str2, String str3) {
        d a11 = com.meizu.cloud.pushsdk.util.d.a(str3);
        MessageV3 parse = MessageV3.parse(str, str, a11.e(), a11.f(), a11.c(), a11.d(), str2);
        ...
        try {
            ...
            DebugLogger.e("PlatformMessageSender", "launchStartActivity error " + e11.getMessage());
        }
    }

    public static void showQuickNotification(Context context, String str, String str2) {
        d a11 = com.meizu.cloud.pushsdk.util.d.a(str2);
        Intent intent = new Intent();
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_SEQ_ID, a11.d());
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_TASK_ID, a11.c());
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_TASK_TIMES_TAMP, a11.e());
        ...
        intent.putExtra(PushConstants.MZ_PUSH_MESSAGE_STATISTICS_IMEI_KEY, a11.f());
        ...
        try {
            ...
            DebugLogger.e("PlatformMessageSender", "showNotification error " + e11.getMessage());
        }
    }
