...
public class a {
    public static RegisterStatus a(String str) {
        ...
        try {
            ...
            DebugLogger.e("StatusSerialize", "register status serialize stringToRegisterStatus error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static PushSwitchStatus c(String str) {
        ...
        try {
            ...
            DebugLogger.e("StatusSerialize", "register status serialize stringToPushSwitchStatus error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static SubAliasStatus d(String str) {
        ...
        try {
            ...
            DebugLogger.e("StatusSerialize", "register status serialize stringToSubAliasStatus error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static SubTagsStatus e(String str) {
        ...
        try {
            ...
            DebugLogger.e("StatusSerialize", "register status serialize stringToSubTagsStatus error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(PushSwitchStatus pushSwitchStatus) {
        ...
        try {
            JSONObject a11 = a(new JSONObject(), pushSwitchStatus);
            if (!TextUtils.isEmpty(pushSwitchStatus.getPushId())) {
                a11.put(PushConstants.REGISTER_STATUS_PUSH_ID, pushSwitchStatus.getPushId());
            }
            a11.put(PushConstants.PUSH_SWITCH_STATUS_IS_NOTIFICATION_SWITCH, pushSwitchStatus.isSwitchNotificationMessage());
            a11.put(PushConstants.PUSH_SWITCH_STATUS_IS_THROUGH_SWITCH, pushSwitchStatus.isSwitchThroughMessage());
            ...
            DebugLogger.e("StatusSerialize", "register status serialize pushSwitchStatusToString error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static UnRegisterStatus b(String str) {
        ...
        try {
            ...
            DebugLogger.e("StatusSerialize", "register status serialize stringToUnregisterStatus error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(RegisterStatus registerStatus) {
        ...
        try {
            JSONObject a11 = a(new JSONObject(), registerStatus);
            if (!TextUtils.isEmpty(registerStatus.getPushId())) {
                a11.put(PushConstants.REGISTER_STATUS_PUSH_ID, registerStatus.getPushId());
            }
            if (registerStatus.getExpireTime() > 0) {
                a11.put(PushConstants.REGISTER_STATUS_EXPIRE_TIME, registerStatus.getExpireTime());
            }
            String jSONObject = a11.toString();
            DebugLogger.i("StatusSerialize", "register status serialize registerStatusToString success, statusText=" + jSONObject);
            return jSONObject;
        } catch (JSONException e11) {
            DebugLogger.e("StatusSerialize", "register status serialize registerStatusToString error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(SubAliasStatus subAliasStatus) {
        ...
        try {
            JSONObject a11 = a(new JSONObject(), subAliasStatus);
            if (!TextUtils.isEmpty(subAliasStatus.getPushId())) {
                a11.put(PushConstants.REGISTER_STATUS_PUSH_ID, subAliasStatus.getPushId());
            }
            a11.put(PushConstants.SUB_ALIAS_STATUS_NAME, subAliasStatus.getAlias());
            String jSONObject = a11.toString();
            DebugLogger.i("StatusSerialize", "register status serialize subAliasStatusToString success, statusText=" + jSONObject);
            return jSONObject;
        } catch (JSONException e11) {
            DebugLogger.e("StatusSerialize", "register status serialize subAliasStatusToString error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(SubTagsStatus subTagsStatus) {
        ...
        try {
            JSONObject a11 = a(new JSONObject(), subTagsStatus);
            if (!TextUtils.isEmpty(subTagsStatus.getPushId())) {
                a11.put(PushConstants.REGISTER_STATUS_PUSH_ID, subTagsStatus.getPushId());
            }
            if (subTagsStatus.getTagList() != null) {
                JSONArray jSONArray = new JSONArray();
                for (int i11 = 0; i11 < subTagsStatus.getTagList().size(); i11++) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put("tag_id", subTagsStatus.getTagList().get(i11).getTagId());
                    jSONObject.put(PushConstants.SUB_TAGS_STATUS_NAME, subTagsStatus.getTagList().get(i11).getTagName());
                    jSONArray.put(jSONObject);
                }
                a11.put(PushConstants.SUB_TAGS_STATUS_LIST, jSONArray);
            }
            ...
            DebugLogger.e("StatusSerialize", "register status serialize subTagsStatusToString error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(UnRegisterStatus unRegisterStatus) {
        ...
        try {
            JSONObject a11 = a(new JSONObject(), unRegisterStatus);
            a11.put(PushConstants.UNREGISTER_STATUS_IS_SUCCESS, unRegisterStatus.isUnRegisterSuccess());
            String jSONObject = a11.toString();
            DebugLogger.i("StatusSerialize", "register status serialize unregisterStatusToString success, statusText=" + jSONObject);
            return jSONObject;
        } catch (JSONException e11) {
            DebugLogger.e("StatusSerialize", "register status serialize unregisterStatusToString error, " + e11.getMessage());
            e11.printStackTrace();
            return null;
        }
    }
