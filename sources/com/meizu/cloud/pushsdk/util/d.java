...
public class d {
    ...
    private static Intent a(Context context, Map<String, String> map) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                e11.printStackTrace();
                DebugLogger.e("UxIPUtils", "getRemotePushTrackerIntent error " + e11.getMessage());
            }
        }
        return null;
    }

    public static void b(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, false, str, str2, str3, str4, "rpe", str5, j11);
    }

    public static void c(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, false, str, str2, str3, str4, "sipm", str5, j11);
    }

    public static void d(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, false, str, str2, str3, str4, "nspm", str5, j11);
    }

    public static void e(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, false, str, str2, str3, str4, "fspm", str5, j11);
    }

    public static void f(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, false, str, str2, str3, str4, "npm", str5, j11);
    }
    ...
    public static String a(Intent intent) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            try {
                ...
                DebugLogger.e("UxIPUtils", "parse MessageV2 error " + e11.getMessage());
    ...
    public static void a(Context context, Intent intent, String str, int i11) {
        a(context, intent, PushManager.TAG, str, i11);
    }

    public static void a(Context context, Intent intent, String str, String str2, int i11) {
        if (TextUtils.isEmpty(a(intent))) {
            return;
        }
        a(context, context.getPackageName(), intent.getStringExtra(PushConstants.MZ_PUSH_MESSAGE_STATISTICS_IMEI_KEY), a(intent), str, str2, i11);
    }

    public static void a(Context context, String str, int i11, String str2, String str3) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        a(context, context.getPackageName(), str3, str2, PushManager.TAG, str, i11);
    }
    ...
    public static void a(Context context, String str, String str2, String str3, String str4, String str5, int i11) {
        HashMap hashMap = new HashMap(8);
        hashMap.put("taskId", str3);
        hashMap.put("deviceId", str2);
        hashMap.put(com.alipay.sdk.m.t.a.f11034k, String.valueOf(System.currentTimeMillis() / 1000));
    ...
    public static void a(Context context, String str, String str2, String str3, String str4, String str5, long j11) {
        a(context, true, str, str2, str3, str4, "spm", str5, j11);
    }

    public static void a(Context context, boolean z11, String str, String str2, String str3, String str4, String str5, String str6) {
        a(context, z11, str, str2, str3, str4, str5, str6, 0L);
    }

    public static void a(Context context, boolean z11, String str, String str2, String str3, String str4, String str5, String str6, long j11) {
        HashMap hashMap = new HashMap(8);
        hashMap.put("en", str5);
        hashMap.put("ti", str3);
    ...
    private static boolean a(final Context context, final Intent intent, final boolean z11, final Map<String, String> map, final long j11) {
        ...
        if (intent == null) {
                ...
                new Handler(context.getMainLooper()).postDelayed(new Runnable() { // from class: com.meizu.cloud.pushsdk.util.d.1
                    ...
                    public void run() {
                        try {
                            ...
                            DebugLogger.i("UxIPUtils", "delayed " + j11 + " ms start tracker data in mz_tracker process " + intent.getStringExtra(PushConstants.EXTRA_PUSH_TRACKER_JSON_DATA));
                        } catch (Exception e11) {
                            e11.printStackTrace();
                            DebugLogger.e("UxIPUtils", "delayed startRemotePushTracker error " + e11.getMessage());
                            d.a(context, z11, (String) map.get("en"), (Map<String, String>) map);
                        }
                    }
                }, j11);
                return true;
            ...
            try {
                ...
                e11.printStackTrace();
                str = "startRemotePushTracker error " + e11.getMessage();
            }
        }
    ...
    private static boolean a(Context context, Map<String, String> map, boolean z11, long j11) {
        return a(context, a(context, map), z11, map, j11);
    }
}
