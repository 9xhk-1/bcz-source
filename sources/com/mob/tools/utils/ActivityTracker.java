...
public class ActivityTracker implements PublicMemberKeeper {
    ...
    private static ActivityTracker f41357a;

    /* renamed from: b, reason: collision with root package name */
    private HashSet<Tracker> f41358b = new HashSet<>();
    ...
    public static synchronized ActivityTracker getInstance(Context context) {
        ...
        synchronized (ActivityTracker.class) {
            try {
                if (f41357a == null) {
                    f41357a = new ActivityTracker(context);
                }
                activityTracker = f41357a;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public void addTracker(Tracker tracker) {
        synchronized (this.f41358b) {
            this.f41358b.add(tracker);
        }
    }

    public void removeTracker(Tracker tracker) {
        synchronized (this.f41358b) {
            this.f41358b.remove(tracker);
        }
    }
    ...
    private void a(EachTracker eachTracker) {
        ...
        try {
            synchronized (this.f41358b) {
                HashSet<Tracker> hashSet = this.f41358b;
