...
public class CrashModule extends o {
    ...
    private static int f42049c;

    /* renamed from: e, reason: collision with root package name */
    private static CrashModule f42050e = new CrashModule();

    /* renamed from: a, reason: collision with root package name */
    private long f42051a;

    /* renamed from: b, reason: collision with root package name */
    private BuglyStrategy.a f42052b;

    /* renamed from: d, reason: collision with root package name */
    private boolean f42053d = false;
    ...
    public static CrashModule getInstance() {
        CrashModule crashModule = f42050e;
        crashModule.f42618id = 1004;
        return crashModule;
    }
    ...
    */
    public synchronized void init(android.content.Context r5, boolean r6, com.tencent.bugly.BuglyStrategy r7) {
        /*
            ...
            monitor-enter(r4)
            if (r5 == 0) goto Le6
            boolean r0 = r4.f42053d     // Catch: java.lang.Throwable -> L5b
            if (r0 == 0) goto L9
            goto Le6
        L9:
            ...
            int r2 = com.tencent.bugly.CrashModule.f42049c     // Catch: java.lang.Throwable -> L5b
            r3 = 1
            int r2 = r2 + r3
            com.tencent.bugly.CrashModule.f42049c = r2     // Catch: java.lang.Throwable -> L5b
            r0.a(r2)     // Catch: java.lang.Throwable -> L5b
            r4.f42053d = r3     // Catch: java.lang.Throwable -> L5b
            ...
            com.tencent.bugly.BuglyStrategy$a r0 = r4.f42052b     // Catch: java.lang.Throwable -> L5b
            com.tencent.bugly.proguard.at r6 = com.tencent.bugly.proguard.at.a(r5, r6, r0)     // Catch: java.lang.Throwable -> L5b
            com.tencent.bugly.proguard.av r0 = r6.f42365t     // Catch: java.lang.Throwable -> L5b
            ...
            com.tencent.bugly.proguard.at.f42359o = r0     // Catch: java.lang.Throwable -> L5b
            ...
            if (r0 != 0) goto L5e
            com.tencent.bugly.crashreport.crash.jni.NativeCrashHandler r0 = r6.f42366u     // Catch: java.lang.Throwable -> L5b
        ...
        L69:
            ...
            java.lang.String r0 = r0.f42187d     // Catch: java.lang.Throwable -> L5b
            android.content.Context r2 = r6.f42363c     // Catch: java.lang.Throwable -> L5b
        ...
        Lae:
            ...
            com.tencent.bugly.proguard.at.f42349e = r0     // Catch: java.lang.Throwable -> L5b
        Lb6:
            if (r7 == 0) goto Lbd
        ...
        Lbf:
            ...
            com.tencent.bugly.crashreport.crash.jni.NativeCrashHandler r6 = r6.f42366u     // Catch: java.lang.Throwable -> L5b
            ...
            int r6 = com.tencent.bugly.CrashModule.f42049c     // Catch: java.lang.Throwable -> L5b
            int r6 = r6 - r3
            com.tencent.bugly.CrashModule.f42049c = r6     // Catch: java.lang.Throwable -> L5b
    ...
    public void onServerStrategyChanged(StrategyBean strategyBean) {
        at a11;
        if (strategyBean == null || (a11 = at.a()) == null) {
            return;
        }
        a11.f42365t.a(strategyBean);
        a11.f42366u.onStrategyChanged(strategyBean);
        a11.f42369x.b();
    }
}
