...
public final class ap {
    ...
    private static Map<String, String> f42315a;
    ...
    public static byte[] b(byte[] bArr) {
        ...
        try {
            ...
            if (th2.getMessage() != null && th2.getMessage().contains("Not in GZIP format")) {
                al.d(th2.getMessage(), new Object[0]);
                return null;
            }
            if (al.a(th2)) {
                return null;
    ...
    public static String a(long j11) {
        try {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US).format(new Date(j11));
    ...
    public static byte[] c(long j11) {
        try {
            return String.valueOf(j11).getBytes("utf-8");
        } catch (UnsupportedEncodingException e11) {
            e11.printStackTrace();
            return null;
        }
    ...
    public static String a(String str) {
        ...
        try {
            ...
            if (f42315a.containsKey(str)) {
                return f42315a.get(str);
            }
            ...
            if (!TextUtils.isEmpty(systemProperty) && !systemProperty.equals("fail")) {
                f42315a.put(str, systemProperty);
            }
    ...
    public static void a(Parcel parcel, Map<String, PlugInBean> map) {
        if (map != null && map.size() > 0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                bundle.putString("pluginKey".concat(String.valueOf(i11)), (String) arrayList.get(i11));
            }
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                bundle.putString("pluginVal" + i12 + "plugInId", ((PlugInBean) arrayList2.get(i12)).f42076a);
                bundle.putString("pluginVal" + i12 + "plugInUUID", ((PlugInBean) arrayList2.get(i12)).f42078c);
                bundle.putString("pluginVal" + i12 + "plugInVersion", ((PlugInBean) arrayList2.get(i12)).f42077b);
            }
            parcel.writeBundle(bundle);
            return;
        }
    ...
    public static Map<String, PlugInBean> a(Parcel parcel) {
        ...
        for (int i11 = 0; i11 < intValue; i11++) {
            arrayList.add(readBundle.getString("pluginKey".concat(String.valueOf(i11))));
        }
        for (int i12 = 0; i12 < intValue; i12++) {
            arrayList2.add(new PlugInBean(readBundle.getString("pluginVal" + i12 + "plugInId"), readBundle.getString("pluginVal" + i12 + "plugInVersion"), readBundle.getString("pluginVal" + i12 + "plugInUUID")));
        }
        if (arrayList.size() == arrayList2.size()) {
            HashMap hashMap = new HashMap(arrayList.size());
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                hashMap.put(arrayList.get(i13), PlugInBean.class.cast(arrayList2.get(i13)));
            }
            return hashMap;
        }
    ...
    public static Map<String, String> a(boolean z11, int i11) {
        if (!z11) {
    ...
    private static Map<String, String> a(int i11) {
        ...
        for (Map.Entry<Thread, StackTraceElement[]> entry : allStackTraces.entrySet()) {
            ...
            if (entry.getValue() != null && entry.getValue().length != 0) {
                ...
                while (true) {
                    ...
                    StackTraceElement stackTraceElement = value[i12];
                    if (i11 > 0 && sb2.length() >= i11) {
                        sb2.append("\n[Stack over limit size :" + i11 + " , has been cut!]");
                        break;
                    }
                ...
                hashMap.put(entry.getKey().getName() + pn.j.f81006c + entry.getKey().getId() + pn.j.f81007d, sb2.toString());
            }
        }
        return hashMap;
    }
    ...
    public static String a(File file, int i11, boolean z11) {
    ...
    public static Thread a(Runnable runnable, String str) {
        try {
            ...
            al.e("[Util] Failed to start a thread to execute task with message: %s", th2.getMessage());
            return null;
        }
    }
