...
public class QQAvatar extends BaseApi {
    ...
    public void setAvatar(Activity activity, Uri uri, IUiListener iUiListener, int i11) {
        if (com.tencent.connect.a.a("QQAvatar", iUiListener)) {
            return;
        }
        IUiListener iUiListener2 = this.f42834a;
        if (iUiListener2 != null) {
            iUiListener2.onCancel();
        }
        this.f42834a = iUiListener;
        ...
        bundle.putLong("expires_in", this.f42865c.getExpireTimeInSecond());
        bundle.putString("openid", this.f42865c.getOpenId());
        Intent a11 = a(activity);
        if (!a(a11)) {
            e.a().a(this.f42865c.getOpenId(), this.f42865c.getAppId(), Constants.VIA_SET_AVATAR, Constants.VIA_REPORT_TYPE_SET_AVATAR, "18", "1");
        } else {
            a(activity, bundle, a11);
            e.a().a(this.f42865c.getOpenId(), this.f42865c.getAppId(), Constants.VIA_SET_AVATAR, Constants.VIA_REPORT_TYPE_SET_AVATAR, "18", "0");
        }
    }
    ...
    public void setAvatarByQQ(Activity activity, Uri uri, IUiListener iUiListener) {
        ...
        if (!TextUtils.isEmpty(b11)) {
            try {
                ...
                SLog.e("QQAvatar", "Exception", e11);
            }
        }
        if (!TextUtils.isEmpty(b11)) {
            stringBuffer.append("&set_path=" + Base64.encodeToString(m.j(b11), 2));
        }
    ...
    public void setDynamicAvatar(Activity activity, Uri uri, IUiListener iUiListener) {
        ...
        if (!TextUtils.isEmpty(b11)) {
            stringBuffer.append("&video_path=" + Base64.encodeToString(m.j(b11), 2));
        }
        stringBuffer.append("&sdk_version=" + Base64.encodeToString(m.j(Constants.SDK_VERSION), 2));
    ...
    private void a(Activity activity, Bundle bundle, Intent intent) {
        ...
        UIListenerManager.getInstance().setListenerWithRequestcode(Constants.REQUEST_AVATER, this.f42834a);
