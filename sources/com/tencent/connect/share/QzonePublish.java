...
public class QzonePublish extends BaseApi {
    ...
    */
    public void b(android.app.Activity r31, android.os.Bundle r32, com.tencent.tauth.IUiListener r33) {
        /*
    ...
    public void publishToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (bundle == null) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f42865c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_PARAM_NULL_ERROR);
            return;
        }
        if (!m.f(activity)) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f42865c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publicToQzone, this is not support below qq 5.9.5");
        ...
        int i11 = 0;
        if (a11 == null) {
            a11 = bundle.getString("appName");
        } else if (a11.length() > 20) {
        ...
        if (i12 == 3) {
            ...
            if (stringArrayList != null && stringArrayList.size() > 0) {
                while (i11 < stringArrayList.size()) {
                    if (!m.i(stringArrayList.get(i11))) {
        ...
        if (i12 != 4) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f42865c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publishToQzone() 请选择支持的分享类型");
            return;
        }
        ...
        mediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: com.tencent.connect.share.QzonePublish.2
            ...
            public boolean onError(MediaPlayer mediaPlayer2, int i13, int i14) {
