...
public class a {
    ...
    public static final boolean b(String str, int i11, int i12) {
        ...
        try {
            ...
            SLog.e("openSDK_LOG.AsynScaleCompressImage", "isBitMapNeedToCompress exception:", e11);
        }
        int i13 = options.outWidth;
        int i14 = options.outHeight;
        if (options.mCancel || i13 == -1 || i14 == -1) {
            return false;
        }
        ...
        SLog.d("openSDK_LOG.AsynScaleCompressImage", "longSide=" + i15 + "shortSide=" + i13);
        options.inPreferredConfig = Bitmap.Config.RGB_565;
        return i15 > i12 || i13 > i11;
    }
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (a11 != null) {
                            ...
                            boolean m11 = m.m(str8);
                            SLog.i("openSDK_LOG.AsynScaleCompressImage", "scaleCompressImage() check file isAppSpecificDir=" + m11);
                            ArrayList arrayList = new ArrayList(2);
                            if (m11) {
                                str4 = str8;
                            } else if (TextUtils.isEmpty(str2)) {
                                String str9 = str3 + str7;
                                boolean a14 = m.a(context, str8, str9);
                                SLog.i("openSDK_LOG.AsynScaleCompressImage", "scaleCompressImage() sd permission not denied. copy to app sepcific:" + str9 + ",isSuccess=" + a14);
                                if (a14) {
                                    str4 = str9;
                                }
                            }
                        ...
                        SLog.e("openSDK_LOG.AsynScaleCompressImage", "scaleCompressImage runnable exception e:", e11);
                    }
