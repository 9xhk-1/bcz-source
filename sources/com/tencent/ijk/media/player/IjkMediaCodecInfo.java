...
public class IjkMediaCodecInfo {
    ...
    public static String getProfileLevelName(int i11, int i12) {
        return String.format(Locale.US, " %s Profile Level %s (%d,%d)", getProfileName(i11), getLevelName(i12), Integer.valueOf(i11), Integer.valueOf(i12));
    }

    public static String getProfileName(int i11) {
        return i11 != 1 ? i11 != 2 ? i11 != 4 ? i11 != 8 ? i11 != 16 ? i11 != 32 ? i11 != 64 ? PermissionStatusUtilKt.PERMISSION_STATUS_UNKNOWN : "High444" : "High422" : "High10" : "High" : "Extends" : h0.f41868j : "Baseline";
    }
    ...
    public void dumpProfileLevels(String str) {
        ...
        try {
            ...
            Log.i(TAG, String.format(Locale.US, "%s", getProfileLevelName(i12, i11)));
        } catch (Throwable unused) {
