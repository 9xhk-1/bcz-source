...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public IjkStreamMeta(int i11) {
            this.mIndex = i11;
        }

        public String getBitrateInline() {
            long j11 = this.mBitrate;
        ...
        public String getFpsInline() {
            int i11;
            int i12 = this.mFpsNum;
            return (i12 <= 0 || (i11 = this.mFpsDen) <= 0) ? "N/A" : String.valueOf(i12 / i11);
        }
        ...
        public String getResolutionInline() {
            int i11 = this.mWidth;
            return (i11 <= 0 || this.mHeight <= 0) ? "N/A" : (this.mSarNum <= 0 || this.mSarDen <= 0) ? String.format(Locale.US, "%d x %d", Integer.valueOf(i11), Integer.valueOf(this.mHeight)) : String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i11), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        int i11 = -1;
        int i12 = ijkMediaMeta.getInt("video", -1);
        int i13 = ijkMediaMeta.getInt("audio", -1);
        ...
        if (parcelableArrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                i11++;
                if (next != null) {
                    IjkStreamMeta ijkStreamMeta = new IjkStreamMeta(i11);
            ...
            ArrayList<Bundle> parcelableArrayList2 = ijkMediaMeta.getParcelableArrayList(IJKM_KEY_PROGRAMS);
            if (parcelableArrayList2 != null) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (next2 != null) {
                        ...
                        ijkBitrateItem.index = Integer.parseInt(next2.getString(IJKM_KEY_BITRATE_INDEX, "0"));
                        ...
                        ijkBitrateItem.bitrate = Integer.parseInt(next2.getString(IJKM_KEY_BITRATE, "0"));
    ...
    public String getDurationInline() {
        long j11 = (this.mDurationUS + 5000) / 1000000;
        long j12 = j11 / 60;
