...
public class IjkMediaFormat implements IMediaFormat {
    ...
    public IjkMediaFormat(IjkMediaMeta.IjkStreamMeta ijkStreamMeta) {
        ...
        map.put(KEY_IJK_CODEC_LONG_NAME_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.1
        ...
        map.put(KEY_IJK_CODEC_NAME_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.2
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
                return IjkMediaFormat.this.mMediaFormat.getString(IjkMediaMeta.IJKM_KEY_CODEC_NAME);
            }
        });
        map.put(KEY_IJK_BIT_RATE_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.3
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        map.put(KEY_IJK_CODEC_PROFILE_LEVEL_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.4
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
                String str;
        ...
        map.put(KEY_IJK_CODEC_PIXEL_FORMAT_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.5
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
                return ijkMediaFormat.getString(IjkMediaMeta.IJKM_KEY_CODEC_PIXEL_FORMAT);
            }
        });
        map.put(KEY_IJK_RESOLUTION_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.6
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        map.put(KEY_IJK_FRAME_RATE_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.7
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        map.put(KEY_IJK_SAMPLE_RATE_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.8
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        map.put(KEY_IJK_CHANNEL_UI, new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.9
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
