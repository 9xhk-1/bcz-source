...
public class f {
    ...
    private Thread f43779g;

    /* renamed from: h, reason: collision with root package name */
    private boolean f43780h;

    /* renamed from: c, reason: collision with root package name */
    private final String f43775c = "http://playvideo.qcloud.com/getplayinfo/v2";

    /* renamed from: d, reason: collision with root package name */
    private final String f43776d = "https://playvideo.qcloud.com/getplayinfo/v2";

    /* renamed from: e, reason: collision with root package name */
    private final int f43777e = 0;

    /* renamed from: f, reason: collision with root package name */
    private final int f43778f = 1;

    /* renamed from: i, reason: collision with root package name */
    private Handler f43781i = new Handler(Looper.getMainLooper()) { // from class: com.tencent.liteav.network.f.1
        ...
        Thread thread = new Thread("getPlayInfo") { // from class: com.tencent.liteav.network.f.2
            ...
            public void run() {
                try {
                    ...
                    TXCLog.d("TXCVodPlayerNetApi", "http exception: " + e11.getMessage());
    ...
    public String a(String str, String str2, int i11, String str3) {
        StringBuilder sb2 = new StringBuilder();
        if (str != null) {
            sb2.append("t=" + str + "&");
        }
    ...
    public void a(String str, int i11) {
        ...
        message.arg1 = i11;
        message.obj = str;
        this.f43781i.sendMessage(message);
    }
    ...
    public void a(String str) throws JSONException {
        ...
        if (i11 != 0) {
            ...
            if (jVar.a() == null) {
                ...
                this.f43781i.sendEmptyMessage(0);
            }
        }
    }
