...
public final class WXMediaMessage {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e11.getMessage());
                }
            }
            return wXMediaMessage;
        }
    ...
    public boolean checkArgs() {
        ...
        } else if (b.a(getType()) && ((bArr3 = this.thumbData) == null || bArr3.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (getType() == 101 && ((bArr2 = this.thumbData) == null || bArr2.length > 262144)) {
            str = "checkArgs fail, thumbData should not be null or exceed 256KB";
        } else if (b.a(getType()) || getType() == 101 || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.e(TAG, "setThumbImage exception:" + e11.getMessage());
        }
    }
