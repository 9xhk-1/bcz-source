...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z11, int i11) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z11 + ", launchMode = " + i11);
        this.context = context;
        this.appId = str;
        this.checkSignature = z11;
        this.launchMode = i11;
        b.f44378a = context.getApplicationContext();
        this.securityHelper = new WXAPiSecurityHelper(context.getApplicationContext());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void callbackReq(SendReqCallback sendReqCallback, boolean z11) {
        if (sendReqCallback != null) {
            sendReqCallback.onSendFinish(z11);
        }
    }
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    jSONObject.put(HintConstants.AUTOFILL_HINT_USERNAME, ((WXChannelJumpMiniProgramInfo) iWXChannelJumpInfo).username);
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638064384"}, null);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            Log.e(TAG, "handleWxInternalRespType fail, ex = " + e11.getMessage());
        }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), C.BUFFER_FLAG_FIRST_SAMPLE).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
                @Override // android.app.PendingIntent.OnFinished
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i11, String str, Bundle bundle) {
                    Log.d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i11 + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e11) {
            Log.e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e11.getMessage());
            openWXApp();
        }
    }
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        ...
        try {
            ...
            Log.e(TAG, "getTokenFromWX fail, exception = " + e12);
        }
    ...
    public int getWXAppSupportAPI() {
        ...
        if (this.wxSdkVersion == 0) {
            ...
            b.f44379b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                ...
                public void run() {
                    try {
                        ...
                        Log.w(BaseWXApiImplV10.TAG, e12.getMessage());
                    }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.e(TAG, "handleIntent fail, ex = " + e11.getMessage());
        }
                ...
                case 4:
                    ...
                    if (str != null && str.contains("openbusinesswebview")) {
                        try {
                            ...
                            Log.e(TAG, "parse fail, ex = " + e12.getMessage());
                        }
                    }
    ...
    public void unregisterApp() {
        ...
        c0520a.f44336a = "com.tencent.mm";
        c0520a.f44337b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0520a.f44338c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0520a);
    }
    ...
    public boolean registerApp(String str, long j11) {
        ...
        a.C0520a c0520a = new a.C0520a();
        c0520a.f44336a = "com.tencent.mm";
        c0520a.f44337b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0520a.f44338c = "weixin://registerapp?appid=" + this.appId;
        c0520a.f44339d = j11;
        return a.a(this.context, c0520a);
    }
    ...
    public boolean sendReq(BaseReq baseReq, final SendReqCallback sendReqCallback) {
        ...
        int doExtraSecurityCheck = this.securityHelper.doExtraSecurityCheck(this.appId, "638064384", extractMayNeedDoSecurityCheckUrl, new WXAPiSecurityHelper.ISecurityCheck() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
            @Override // com.tencent.mm.opensdk.openapi.WXAPiSecurityHelper.ISecurityCheck
            public void onCheckFinish(boolean z11) {
                if (!z11) {
