...
class WXAPiSecurityHelper {
    ...
    private final SharedPreferences f44376sp;
    ...
    public static class WXSecurityData {
        ...
        public boolean isBasicParamsAllowed() {
            ...
            return (!((j11 > 0L ? 1 : (j11 == 0L ? 0 : -1)) > 0 && (j11 > (System.currentTimeMillis() / 1000) ? 1 : (j11 == (System.currentTimeMillis() / 1000) ? 0 : -1)) < 0) || b.b(this.appid) || b.b(this.respDataJson)) ? false : true;
        }
    }

    public WXAPiSecurityHelper(Context context) {
        this.context = context;
        this.f44376sp = context.getSharedPreferences("__wx_opensdk_sp__", 0);
    }
    ...
    public int checkRuleCanPass(String str, PromiseShareRule promiseShareRule) {
        ...
        if (i11 == 2) {
            ...
            if (i11 != 1 || !promiseShareRule.appidInRule.equals(promiseShareRule.reqAppid)) {
    ...
    private void doRequest(final PassContext passContext, final IHttpCheckCallback iHttpCheckCallback) {
        b.f44379b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.WXAPiSecurityHelper.6
    ...
    public void commitSp(String str, String str2) {
        SharedPreferences.Editor edit = this.f44376sp.edit();
    ...
    public String cookStoreJson(String str, PromiseShareRule promiseShareRule) {
        if (promiseShareRule != null && !b.b(str)) {
            try {
                int i11 = promiseShareRule.state;
                if (i11 != 2) {
                    return i11 == 1 ? covertShareRule2Json(promiseShareRule) : "";
                }
                JSONObject jSONObject = new JSONObject();
    ...
    public WXSecurityData getStoredData(String str) {
        ...
        try {
            if (this.f44376sp.contains(getStoreKey(str))) {
                JSONObject jSONObject = new JSONObject(this.f44376sp.getString(getStoreKey(str), ""));
    ...
    public StringBuffer postHttpRequest(String str, String str2, String str3) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("Content-Type", r0.f68791f);
