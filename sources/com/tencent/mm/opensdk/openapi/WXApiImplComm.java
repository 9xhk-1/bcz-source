...
class WXApiImplComm {
    ...
    public static boolean validateAppSignature(Context context, Signature[] signatureArr, boolean z11) {
        String str;
        if (z11) {
            for (Signature signature : signatureArr) {
                if (signature == null) {
                    Log.i(TAG, "validateAppSignature signature is null");
                } else {
    ...
    public static boolean validateAppSignatureForPackage(Context context, String str, boolean z11) {
        StringBuilder sb2;
        if (!z11) {
        ...
        try {
            return validateAppSignature(context, context.getPackageManager().getPackageInfo(str, 64).signatures, z11);
        } catch (PackageManager.NameNotFoundException e11) {
            e = e11;
            sb2 = new StringBuilder();
            sb2.append("validateAppSignatureForPackage ex ");
