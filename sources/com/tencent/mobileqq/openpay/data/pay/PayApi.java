...
public class PayApi extends BaseApi {
    ...
    public boolean checkParams() {
        return (TextUtils.isEmpty(this.appId) || TextUtils.isEmpty("native") || TextUtils.isEmpty(this.callbackScheme) || TextUtils.isEmpty(this.tokenId) || TextUtils.isEmpty(this.bargainorId) || TextUtils.isEmpty(this.nonce) || TextUtils.isEmpty(this.sig) || TextUtils.isEmpty(this.sigType) || this.timeStamp <= 0 || TextUtils.isEmpty(this.serialNumber)) ? false : true;
    }
