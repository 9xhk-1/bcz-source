...
public abstract class c extends Dialog {
    ...
    @SuppressLint({"NewApi"})
    protected final WebChromeClient f44485b;

    public c(Context context, int i11) {
        super(context, i11);
        this.f44485b = new WebChromeClient() { // from class: com.tencent.open.c.1
            ...
            public void onConsoleMessage(String str, int i12, String str2) {
                SLog.i("openSDK_LOG.JsDialog", "WebChromeClient onConsoleMessage" + str + " -- From 222 line " + i12 + " of " + str2);
            }
        };
    }
