...
public class d extends b {
    ...
    public static boolean f44491a;

    /* renamed from: b, reason: collision with root package name */
    private KeyEvent f44492b;

    /* renamed from: c, reason: collision with root package name */
    private com.tencent.open.web.security.a f44493c;
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        int unicodeChar;
        SLog.d("openSDK_LOG.SecureWebView", "-->dispatchKeyEvent, is device support: " + f44491a);
        if (!f44491a) {
        ...
        if (keyCode == 67) {
            com.tencent.open.web.security.a.f44622b = true;
            return super.dispatchKeyEvent(keyEvent);
        }
    ...
    public boolean onKeyDown(int i11, KeyEvent keyEvent) {
        int unicodeChar;
        SLog.d("openSDK_LOG.SecureWebView", "-->onKeyDown, is device support: " + f44491a);
        if (!f44491a) {
        ...
        KeyEvent keyEvent2 = new KeyEvent(0, 17);
        this.f44492b = keyEvent2;
        return super.onKeyDown(keyEvent2.getKeyCode(), this.f44492b);
    }
}
