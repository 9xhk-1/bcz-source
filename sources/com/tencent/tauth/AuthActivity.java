...
public class AuthActivity extends Activity {
    ...
    private static int f44711a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, ActionHandler> f44712b = new HashMap();
    ...
    private void a() {
        this.f44712b.put("action_common_channel", new ActionHandler() { // from class: com.tencent.tauth.AuthActivity.1
    ...
    public void finish() {
        try {
            ...
            SLog.e("openSDK_LOG.AuthActivity", "activity finish exception: ", e11);
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            SLog.e("openSDK_LOG.AuthActivity", "onCreate exception: ", e12);
            finish();
        }
    }
    ...
    private void a(Uri uri) {
        ...
        if (uri != null && uri.toString() != null) {
            ...
            if (!uri.toString().equals("")) {
                ...
                Bundle a11 = m.a(uri2.substring(uri2.indexOf("#") + 1));
                if (a11 == null) {
                    SLog.w("openSDK_LOG.AuthActivity", "-->handleActionUri, bundle is null");
                    finish();
                    return;
                }
                String string = a11.getString("action");
                ...
                if (string.equals(ACTION_SHARE_PRIZE)) {
                    ...
                    try {
                        str = m.d(a11.getString("response")).getString("activityid");
                    } catch (Exception e11) {
                        SLog.e("openSDK_LOG.AuthActivity", "sharePrize parseJson has exception.", e11);
                    }
                ...
                if (!"guildOpen".equals(string)) {
                    ActionHandler actionHandler = this.f44712b.get(string);
                    if (actionHandler != null) {
                        actionHandler.handleAction(this, a11);
                        return;
                    } else {
                        finish();
                        return;
