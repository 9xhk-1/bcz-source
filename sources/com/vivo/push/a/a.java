...
public final class a {
    public static void a(Context context, String str, o oVar) {
        boolean c11 = oVar.c();
        b a11 = b.a(context, c11 ? "com.vivo.vms.upstageservice" : "com.vivo.vms.aidlservice");
        boolean a12 = a11.a();
        if (TextUtils.isEmpty(oVar.a())) {
            oVar.a(context.getPackageName());
        }
        if (a12 && !"com.vivo.pushservice".equals(context.getPackageName())) {
        ...
        intent.setClassName(str, c11 ? "com.vivo.push.sdk.service.UpstageService" : "com.vivo.push.sdk.service.PushService");
        oVar.a(intent);
        try {
            a(context, intent);
        } catch (Exception e11) {
            p.a("CommandBridge", "CommandBridge startService exception: ", e11);
        }
    }
    ...
    private static void a(Context context, Intent intent) throws Exception {
        ...
        try {
            ...
            p.a("CommandBridge", "start service error", e11);
    ...
    public static void a(Context context, o oVar, String str) {
        try {
            boolean d11 = t.d(context, str);
            String str2 = d11 ? "com.vivo.pushservice.action.RECEIVE" : "com.vivo.pushclient.action.RECEIVE";
            if (!TextUtils.isEmpty(str)) {
                if (!d11 && !a(context, str2, str)) {
                    return;
                }
                if (TextUtils.isEmpty(oVar.a())) {
                    oVar.a(context.getPackageName());
                ...
                intent.setPackage(str);
                intent.setClassName(str, d11 ? "com.vivo.push.sdk.service.CommandService" : "com.vivo.push.sdk.service.CommandClientService");
            ...
            p.a("CommandBridge", "CommandBridge sendCommandToClient exception", e11);
        }
    }
