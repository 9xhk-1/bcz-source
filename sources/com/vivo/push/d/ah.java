...
final class ah extends com.vivo.push.l {
    ...
    public final void a(com.vivo.push.o oVar) {
        ...
        com.vivo.push.model.b a11 = com.vivo.push.util.t.a(context);
        int b11 = oVar.b();
        if (b11 == 2009) {
            com.vivo.push.util.p.a(ClientConfigManagerImpl.getInstance(this.f45035a).isDebug());
            if (com.vivo.push.util.p.a()) {
                com.vivo.push.e.a().i();
                com.vivo.push.util.b bVar = new com.vivo.push.util.b();
                bVar.a(this.f45035a, "com.vivo.push_preferences.hybridapptoken_v1");
                bVar.a();
                com.vivo.push.util.b bVar2 = new com.vivo.push.util.b();
                bVar2.a(this.f45035a, "com.vivo.push_preferences.appconfig_v1");
                bVar2.a();
                if (!com.vivo.push.e.a().e()) {
                    ClientConfigManagerImpl.getInstance(this.f45035a).clearPush();
                }
            }
        } else if (b11 != 2011) {
            switch (b11) {
                ...
                case 2005:
                    if (a11 == null || a11.c()) {
                        ...
                        if (a12 != 0) {
                            com.vivo.push.e.a().a(cVar.h(), a12);
                            return;
                        }
                    }
                    break;
            ...
            com.vivo.push.util.p.a(ClientConfigManagerImpl.getInstance(this.f45035a).isDebug(((com.vivo.push.b.w) oVar).d()));
        }
        if (a11 == null) {
        ...
        com.vivo.push.a.a.a(this.f45035a, a13, oVar);
    }
}
