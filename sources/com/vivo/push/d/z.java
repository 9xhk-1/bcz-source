...
public abstract class z extends com.vivo.push.l {
    ...
    protected PushMessageCallback f44994b;
    ...
    public final void a(PushMessageCallback pushMessageCallback) {
        this.f44994b = pushMessageCallback;
    }
    ...
    public final int b() {
        ...
        NotificationManager notificationManager = (NotificationManager) this.f45035a.getSystemService("notification");
    ...
    public final boolean a(PublicKey publicKey, String str, String str2) {
        ...
        try {
            ...
            com.vivo.push.util.p.c(this.f45035a, "vertify fail srcDigest is ".concat(str));
            return false;
        } catch (Exception e11) {
            e11.printStackTrace();
