...
public final class k extends AsyncTask<String, Void, List<Bitmap>> {
    ...
    private Context f45104a;

    /* renamed from: b, reason: collision with root package name */
    private InsideNotificationItem f45105b;

    /* renamed from: c, reason: collision with root package name */
    private long f45106c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f45107d;

    /* renamed from: e, reason: collision with root package name */
    private int f45108e = 0;

    /* renamed from: f, reason: collision with root package name */
    private r.a f45109f;

    public k(Context context, InsideNotificationItem insideNotificationItem, long j11, boolean z11, r.a aVar) {
        this.f45104a = context;
        this.f45105b = insideNotificationItem;
        this.f45106c = j11;
        this.f45107d = z11;
        this.f45109f = aVar;
    }
    ...
    */
    public java.util.List<android.graphics.Bitmap> doInBackground(java.lang.String... r10) {
        /*
            r9 = this;
            com.vivo.push.model.InsideNotificationItem r0 = r9.f45105b
            int r0 = r0.getNotifyDisplayStatus()
            r9.f45108e = r0
            boolean r0 = r9.f45107d
            r1 = 0
