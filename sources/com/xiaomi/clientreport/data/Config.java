...
public class Config {
    ...
    public static class Builder {
        ...
        public Builder setEventEncrypted(boolean z11) {
            this.mEventEncrypted = z11 ? 1 : 0;
            return this;
        }

        public Builder setEventUploadFrequency(long j11) {
            this.mEventUploadFrequency = j11;
            return this;
        }

        public Builder setEventUploadSwitchOpen(boolean z11) {
            this.mEventUploadSwitchOpen = z11 ? 1 : 0;
            return this;
        }

        public Builder setMaxFileLength(long j11) {
            this.mMaxFileLength = j11;
            return this;
        }

        public Builder setPerfUploadFrequency(long j11) {
            this.mPerfUploadFrequency = j11;
            return this;
        }

        public Builder setPerfUploadSwitchOpen(boolean z11) {
            this.mPerfUploadSwitchOpen = z11 ? 1 : 0;
            return this;
        }
    }
