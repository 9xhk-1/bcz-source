...
public class MessageHandleService extends BaseService {
    ...
    private static ConcurrentLinkedQueue<a> f45165a = new ConcurrentLinkedQueue<>();

    /* renamed from: a, reason: collision with other field name */
    private static ExecutorService f64a = new ThreadPoolExecutor(1, 1, 15, TimeUnit.SECONDS, new LinkedBlockingQueue());

    public static class a {

        /* renamed from: a, reason: collision with root package name */
        private Intent f45166a;

        /* renamed from: a, reason: collision with other field name */
        private PushMessageReceiver f65a;

        public a(Intent intent, PushMessageReceiver pushMessageReceiver) {
            this.f65a = pushMessageReceiver;
            this.f45166a = intent;
        }
        ...
        public PushMessageReceiver m5653a() {
            return this.f65a;
        }
    }
    ...
    private static void b(Context context) {
        ...
        f64a.execute(new z(context));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void c(Context context) {
        try {
            a(context, f45165a.poll());
    ...
    public static void a(Context context, a aVar) {
        ...
        try {
            PushMessageReceiver m5653a = aVar.m5653a();
            Intent a11 = aVar.a();
            ...
            if (intExtra == 1) {
                ...
                if (a12 instanceof MiPushMessage) {
                    ...
                    if (!miPushMessage.isArrivedMessage()) {
                        m5653a.onReceiveMessage(context, miPushMessage);
                    }
                    if (miPushMessage.getPassThrough() == 1) {
                        en.a(context.getApplicationContext()).a(context.getPackageName(), a11, 2004, (String) null);
                        com.xiaomi.channel.commonutils.logger.b.e("begin execute onReceivePassThroughMessage from " + miPushMessage.getMessageId());
                        m5653a.onReceivePassThroughMessage(context, miPushMessage);
                        return;
                    }
                    if (!miPushMessage.isNotified()) {
                        ...
                        m5653a.onNotificationMessageArrived(context, miPushMessage);
                        return;
                    }
                    if (intExtra2 == 1000) {
                        en.a(context.getApplicationContext()).a(context.getPackageName(), a11, 1007, (String) null);
                    } else {
                        en.a(context.getApplicationContext()).a(context.getPackageName(), a11, TXLiteAVCode.WARNING_RTMP_READ_FAIL, (String) null);
                    }
                    com.xiaomi.channel.commonutils.logger.b.e("begin execute onNotificationMessageClicked from\u3000" + miPushMessage.getMessageId());
                    m5653a.onNotificationMessageClicked(context, miPushMessage);
                    return;
                }
                ...
                m5653a.onCommandResult(context, miPushCommandMessage);
                if (!TextUtils.equals(miPushCommandMessage.getCommand(), ex.COMMAND_REGISTER.f366a)) {
                    return;
                }
                m5653a.onReceiveRegisterResult(context, miPushCommandMessage);
                ...
                if (intExtra != 3) {
                    if (intExtra == 5 && PushMessageHelper.ERROR_TYPE_NEED_PERMISSION.equals(a11.getStringExtra(PushMessageHelper.ERROR_TYPE)) && (stringArrayExtra = a11.getStringArrayExtra(PushMessageHelper.ERROR_MESSAGE)) != null) {
                        ...
                        m5653a.onRequirePermissions(context, stringArrayExtra);
                        return;
                    }
                    return;
                }
                ...
                m5653a.onCommandResult(context, miPushCommandMessage2);
                if (!TextUtils.equals(miPushCommandMessage2.getCommand(), ex.COMMAND_REGISTER.f366a)) {
                    return;
                }
                m5653a.onReceiveRegisterResult(context, miPushCommandMessage2);
    ...
    public boolean mo5659a() {
        ConcurrentLinkedQueue<a> concurrentLinkedQueue = f45165a;
