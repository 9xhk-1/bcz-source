...
public enum ey {
    ...
    CONN_BOSH_ERR(20499),
    BIND_SUCCESS(30000),
    BIND_TCP_READ_TIMEOUT_DEPRECTED(PayStatusCodes.PAY_GAME_ACCOUNT_ERROR),
    BIND_TCP_CONNRESET_DEPRECTED(PayStatusCodes.PAY_GAME_REALNAME_ERROR),
