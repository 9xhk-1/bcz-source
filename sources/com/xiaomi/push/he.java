...
public class he {
    ...
    public static void a(Context context, hg hgVar, List<hl> list) {
        HashMap<String, ArrayList<hl>> a11 = a(context, list);
        if (a11 != null && a11.size() != 0) {
            a(context, hgVar, a11);
            return;
        }
        com.xiaomi.channel.commonutils.logger.b.m5639a("TinyData TinyDataCacheUploader.uploadTinyData itemsUploading == null || itemsUploading.size() == 0  ts:" + System.currentTimeMillis());
    }
