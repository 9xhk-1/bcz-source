...
public class b2 {
    ...
    public static SecretKey f46486a;

    /* renamed from: b, reason: collision with root package name */
    public static byte[] f46487b;

    /* renamed from: c, reason: collision with root package name */
    public static final SecureRandom f46488c = new SecureRandom();
    ...
    public static String c() throws Exception {
        ...
        q1.a a11 = aVar.a("https://zxid-m.mobileservice.cn/sdk/extend/tag");
        a11.f46665b = "POST";
        a11.f46667d = s1.a(x0.b("application/json; charset=utf-8"), b());
        a11.f46668e = "tagInfoRequest get api";
        o2 o2Var = i0.f46543a;
        q1 q1Var = new q1(aVar);
        o2Var.getClass();
        t1 a12 = new i1(o2Var, q1Var).a();
        if (a12.f46691b == 200) {
            return p.a(Base64.decode(new JSONObject(a12.f46694e.b()).getString("data"), 2), f46486a, "UDID_ENC_AUTHTAG");
        }
