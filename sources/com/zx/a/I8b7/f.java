    ...
    public class a implements m2.b {
        ...
        public void a(Network network) {
            try {
                ...
                p.b(bArr, m3.a(m3.f46592h));
                HashMap<String, String> b11 = i0.b(new String(Base64.encode(bArr, 2), StandardCharsets.UTF_8));
                httpURLConnection.setRequestMethod("POST");
                for (String str : b11.keySet()) {
                    httpURLConnection.setRequestProperty(str, b11.get(str));
                }
