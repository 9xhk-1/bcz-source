...
public class l3 extends Dialog {
    ...
    public View.OnClickListener f46574a;

    /* renamed from: b, reason: collision with root package name */
    public View.OnClickListener f46575b;

    /* renamed from: c, reason: collision with root package name */
    public View.OnClickListener f46576c;
    ...
    public void onCreate(Bundle bundle) {
        ...
        int a13 = s.a(context, 12.0f);
        layoutParams4.setMargins(0, a13, 0, a13);
        textView4.setTextColor(Color.parseColor("#FF111111"));
        textView4.setTextSize(2, 18.0f);
        int a14 = s.a(context, 10.0f);
        textView4.setPadding(a14, a14, a14, a14);
        textView4.setText("拒绝");
        linearLayout.addView(textView3);
        linearLayout.addView(textView4);
        setContentView(linearLayout);
        textView4.setOnClickListener(this.f46574a);
        textView3.setOnClickListener(this.f46575b);
        textView2.setOnClickListener(this.f46576c);
        setCancelable(false);
    }
}
