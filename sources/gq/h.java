...
public final class h {
    ...
    public static final int[] f54013e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    public static final h[] f54014f = b();
    ...
    public static final class b {
        ...
        public int d() {
            return this.f54021a * c();
        }
    }

    public h(int i11, int[] iArr, b... bVarArr) {
        this.f54015a = i11;
        this.f54016b = iArr;
        this.f54017c = bVarArr;
        int b11 = bVarArr[0].b();
        int i12 = 0;
    ...
    public static h g(int i11) throws FormatException {
        if (i11 % 4 != 1) {
    ...
    public static h i(int i11) {
        ...
        return f54014f[i11 - 1];
    }

    public kp.b a() {
        int e11 = e();
        kp.b bVar = new kp.b(e11);
        bVar.s(0, 0, 9, 9);
        int i11 = e11 - 8;
        bVar.s(i11, 0, 8, 9);
        bVar.s(0, i11, 9, 8);
        int length = this.f54016b.length;
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = this.f54016b[i12] - 2;
            for (int i14 = 0; i14 < length; i14++) {
                if ((i12 != 0 || (i14 != 0 && i14 != length - 1)) && (i12 != length - 1 || i14 != 0)) {
                    bVar.s(this.f54016b[i14] - 2, i13, 5, 5);
                }
            }
        }
        int i15 = e11 - 17;
    ...
    public int e() {
        return (this.f54015a * 4) + 17;
    }

    public b f(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.f54017c[errorCorrectionLevel.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f54015a);
    }
}
