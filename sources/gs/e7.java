...
public final class e7 implements ViewBinding {
    ...
    @NonNull
    public final TextView f54752a;

    /* renamed from: b, reason: collision with root package name */
    @NonNull
    public final TextView f54753b;

    public e7(@NonNull TextView rootView, @NonNull TextView text1) {
        this.f54752a = rootView;
        this.f54753b = text1;
    }
    ...
    public static e7 d(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.exam_item, parent, false);
        if (attachToParent) {
