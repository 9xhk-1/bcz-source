...
public final class yo implements ViewBinding {
    ...
    @NonNull
    public final SwipeRevealLayout f57663a;

    /* renamed from: b, reason: collision with root package name */
    @NonNull
    public final RelativeLayout f57664b;

    /* renamed from: c, reason: collision with root package name */
    @NonNull
    public final ImageView f57665c;

    /* renamed from: d, reason: collision with root package name */
    @NonNull
    public final ImageView f57666d;

    /* renamed from: e, reason: collision with root package name */
    @NonNull
    public final ImageView f57667e;

    /* renamed from: f, reason: collision with root package name */
    @NonNull
    public final ImageView f57668f;

    /* renamed from: g, reason: collision with root package name */
    @NonNull
    public final ImageView f57669g;

    /* renamed from: h, reason: collision with root package name */
    @NonNull
    public final View f57670h;

    /* renamed from: i, reason: collision with root package name */
    @NonNull
    public final View f57671i;

    /* renamed from: j, reason: collision with root package name */
    @NonNull
    public final ImageView f57672j;

    /* renamed from: k, reason: collision with root package name */
    @NonNull
    public final ImageView f57673k;

    /* renamed from: l, reason: collision with root package name */
    @NonNull
    public final FrameLayout f57674l;

    /* renamed from: m, reason: collision with root package name */
    @NonNull
    public final FrameLayout f57675m;

    /* renamed from: n, reason: collision with root package name */
    @NonNull
    public final RelativeLayout f57676n;

    /* renamed from: o, reason: collision with root package name */
    @NonNull
    public final TextView f57677o;

    /* renamed from: p, reason: collision with root package name */
    @NonNull
    public final LinearLayout f57678p;

    /* renamed from: q, reason: collision with root package name */
    @NonNull
    public final SwipeRevealLayout f57679q;

    /* renamed from: r, reason: collision with root package name */
    @NonNull
    public final AutofitTextView f57680r;

    public yo(@NonNull SwipeRevealLayout rootView, @NonNull RelativeLayout bottomView, @NonNull ImageView cancelKill, @NonNull ImageView cancelKillR, @NonNull ImageView collect, @NonNull ImageView collectR, @NonNull ImageView detail, @NonNull View divider, @NonNull View dividerBottom, @NonNull ImageView kill, @NonNull ImageView killR, @NonNull FrameLayout killSwitcher, @NonNull FrameLayout killSwitcherR, @NonNull RelativeLayout mainItem, @NonNull TextView meanCn, @NonNull LinearLayout right, @NonNull SwipeRevealLayout swipeLayout, @NonNull AutofitTextView word) {
        this.f57663a = rootView;
        this.f57664b = bottomView;
        this.f57665c = cancelKill;
        this.f57666d = cancelKillR;
        this.f57667e = collect;
        this.f57668f = collectR;
        this.f57669g = detail;
        this.f57670h = divider;
        this.f57671i = dividerBottom;
        this.f57672j = kill;
        this.f57673k = killR;
        this.f57674l = killSwitcher;
        this.f57675m = killSwitcherR;
        this.f57676n = mainItem;
        this.f57677o = meanCn;
        this.f57678p = right;
        this.f57679q = swipeLayout;
        this.f57680r = word;
    }

    @NonNull
    public static yo a(@NonNull View rootView) {
                                                            ...
                                                            if (textView != null) {
                                                                ...
                                                                if (linearLayout != null) {
                                                                    ...
                                                                    if (autofitTextView != null) {
                                                                        return new yo(swipeRevealLayout, relativeLayout, imageView, imageView2, imageView3, imageView4, imageView5, findChildViewById, findChildViewById2, imageView6, imageView7, frameLayout, frameLayout2, relativeLayout2, textView, linearLayout, swipeRevealLayout, autofitTextView);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    @NonNull
    public static yo c(@NonNull LayoutInflater inflater) {
        return d(inflater, null, false);
    }

    @NonNull
    public static yo d(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.wordlist_item_without_theme_colloction, parent, false);
        if (attachToParent) {
