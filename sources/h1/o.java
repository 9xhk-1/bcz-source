...
public class o implements n0<e1.d> {
    ...
    public final e1.d b(e1.d dVar, List<Float> list) {
        int i11 = this.f57929a * 4;
        if (list.size() <= i11) {
            return dVar;
        }
        float[] b11 = dVar.b();
        ...
        float[] e11 = e(dVar.b(), fArr);
        int length = e11.length;
        int[] iArr = new int[length];
        for (int i13 = 0; i13 < length; i13++) {
            float f11 = e11[i13];
            int binarySearch = Arrays.binarySearch(b11, f11);
            int binarySearch2 = Arrays.binarySearch(fArr, f11);
            if (binarySearch < 0 || binarySearch2 > 0) {
                if (binarySearch2 < 0) {
                    binarySearch2 = -(binarySearch2 + 1);
                }
                iArr[i13] = c(f11, fArr2[binarySearch2], b11, a11);
            } else {
                iArr[i13] = d(f11, a11[binarySearch], fArr, fArr2);
            }
        }
        return new e1.d(e11, iArr);
    }

    public final int c(float f11, float f12, float[] fArr, int[] iArr) {
        ...
        for (int i11 = 1; i11 < fArr.length; i11++) {
            ...
            if (f13 >= f11 || i11 == fArr.length - 1) {
                ...
                int i13 = iArr[i11];
                int i14 = iArr[i12];
                return Color.argb((int) (f12 * 255.0f), j1.i.l(Color.red(i14), Color.red(i13), f15), j1.i.l(Color.green(i14), Color.green(i13), f15), j1.i.l(Color.blue(i14), Color.blue(i13), f15));
            }
        }
        throw new IllegalArgumentException("Unreachable code.");
    }

    public final int d(float f11, int i11, float[] fArr, float[] fArr2) {
        float k11;
        ...
        for (int i12 = 1; i12 < fArr.length; i12++) {
            ...
            if (f12 >= f11 || i12 == fArr.length - 1) {
                if (f12 <= f11) {
                    ...
                    int i13 = i12 - 1;
                    float f13 = fArr[i13];
                    k11 = j1.i.k(fArr2[i13], fArr2[i12], (f11 - f13) / (f12 - f13));
                }
                return Color.argb((int) (k11 * 255.0f), Color.red(i11), Color.green(i11), Color.blue(i11));
            }
        }
        throw new IllegalArgumentException("Unreachable code.");
    }
    ...
    public e1.d a(JsonReader jsonReader, float f11) throws IOException {
        ...
        int i12 = 0;
        int i13 = 0;
        for (int i14 = 0; i14 < this.f57929a * 4; i14++) {
            int i15 = i14 / 4;
        ...
        return b(new e1.d(fArr, iArr), arrayList);
    }
}
