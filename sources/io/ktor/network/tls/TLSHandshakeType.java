...
public final class TLSHandshakeType {
    ...
    public static final class a {
        ...
        @k
        public final TLSHandshakeType a(int i11) {
            TLSHandshakeType tLSHandshakeType = (i11 < 0 || i11 >= 256) ? null : TLSHandshakeType.byCode[i11];
            if (tLSHandshakeType != null) {
                return tLSHandshakeType;
            }
            throw new IllegalArgumentException("Invalid TLS handshake type code: " + i11);
        }
    ...
    static {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            ...
            while (true) {
                if (it.hasNext()) {
                    obj = it.next();
                    if (((TLSHandshakeType) obj).code == i11) {
                        break;
                    }
                } else {
                    obj = null;
            ...
            tLSHandshakeTypeArr[i11] = obj;
        }
        byCode = tLSHandshakeTypeArr;
    }

    private TLSHandshakeType(String str, int i11, int i12) {
        this.code = i12;
    }

    @k
    public static m00.a<TLSHandshakeType> getEntries() {
        return $ENTRIES;
    }
