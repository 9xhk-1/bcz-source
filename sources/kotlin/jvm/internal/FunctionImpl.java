...
@yz.n(level = DeprecationLevel.ERROR, message = "This class is no longer supported, do not use it.")
@Deprecated
/* loaded from: classes8.dex */
public abstract class FunctionImpl implements yz.w, Serializable, x00.a, x00.l, x00.p, x00.q, x00.r, x00.s, x00.t, x00.u, x00.v, x00.w, x00.b, x00.c, x00.d, x00.e, x00.f, x00.g, x00.h, x00.i, x00.j, x00.k, x00.m, x00.n, x00.o {
    private void checkArity(int i11) {
        if (getArity() != i11) {
            throwWrongArity(i11);
        }
    }

    private void throwWrongArity(int i11) {
