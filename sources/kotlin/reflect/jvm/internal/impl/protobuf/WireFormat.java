...
public final class WireFormat {
    ...
    public static final int f67531a = c(1, 3);

    /* renamed from: b, reason: collision with root package name */
    public static final int f67532b = c(1, 4);

    /* renamed from: c, reason: collision with root package name */
    public static final int f67533c = c(2, 0);

    /* renamed from: d, reason: collision with root package name */
    public static final int f67534d = c(3, 2);
    ...
    public static class FieldType {
        ...
        public enum a extends FieldType {
            public a(String str, int i11, JavaType javaType, int i12) {
        ...
        public enum b extends FieldType {
            public b(String str, int i11, JavaType javaType, int i12) {
                super(str, i11, javaType, i12);
            }
        ...
        public enum c extends FieldType {
            public c(String str, int i11, JavaType javaType, int i12) {
                super(str, i11, javaType, i12);
            }
        ...
        public enum d extends FieldType {
            public d(String str, int i11, JavaType javaType, int i12) {
                super(str, i11, javaType, i12);
            }
