...
public final class DescriptorRendererModifier {
    ...
    public static final DescriptorRendererModifier VALUE = new DescriptorRendererModifier(a.h.C0249a.f16197b, 13, true);
    ...
    static {
        ...
        ALL_EXCEPT_ANNOTATIONS = r0.f6(arrayList);
        ALL = a0.Fz(values());
    }

    private DescriptorRendererModifier(String str, int i11, boolean z11) {
