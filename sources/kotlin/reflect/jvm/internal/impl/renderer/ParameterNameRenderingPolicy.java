...
public final class ParameterNameRenderingPolicy {
    ...
    public static final ParameterNameRenderingPolicy ALL = new ParameterNameRenderingPolicy(f.f83306f, 0);
    ...
    private ParameterNameRenderingPolicy(String str, int i11) {
    }
