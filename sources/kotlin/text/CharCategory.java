...
public final class CharCategory {
    ...
    public static final class a {
        ...
        @k
        public final CharCategory a(int i11) {
            if (i11 >= 0 && i11 < 17) {
                return (CharCategory) CharCategory.getEntries().get(i11);
            }
            if (18 <= i11 && i11 < 31) {
                return (CharCategory) CharCategory.getEntries().get(i11 - 1);
            }
            throw new IllegalArgumentException("Category #" + i11 + " is not defined.");
        }
    ...
    @k
    public static m00.a<CharCategory> getEntries() {
        return $ENTRIES;
    }
