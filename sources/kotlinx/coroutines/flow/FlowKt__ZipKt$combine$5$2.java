...
@l00.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$2", f = "Zip.kt", i = {}, l = {R.styleable.Theme_drawable_tab_lecture_new, R.styleable.Theme_drawable_tab_lecture_new}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes8.dex */
public final class FlowKt__ZipKt$combine$5$2<R, T> extends SuspendLambda implements x00.q<j<? super R>, T[], j00.c<? super g2>, Object> {
    ...
    public FlowKt__ZipKt$combine$5$2(x00.p<? super T[], ? super j00.c<? super R>, ? extends Object> pVar, j00.c<? super FlowKt__ZipKt$combine$5$2> cVar) {
        super(3, cVar);
        this.$transform = pVar;
    }
    ...
    */
    ...
    public final Object invoke(j<? super R> jVar, T[] tArr, j00.c<? super g2> cVar) {
        ...
        flowKt__ZipKt$combine$5$2.L$0 = jVar;
        flowKt__ZipKt$combine$5$2.L$1 = tArr;
        return flowKt__ZipKt$combine$5$2.invokeSuspend(g2.f100423a);
    }
}
