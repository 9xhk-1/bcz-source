...
@l00.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", f = "Zip.kt", i = {}, l = {R.styleable.Theme_drawable_walk_sound3}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes8.dex */
public final class FlowKt__ZipKt$combineTransform$6<R> extends SuspendLambda implements x00.p<j<? super R>, j00.c<? super g2>, Object> {
    ...
    /* compiled from: r8-map-id-edd0706d8ade6e5fa050dcf48a624fb4468a151a6c9a3ed423de0572ab36a89c */
    @l00.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", f = "Zip.kt", i = {}, l = {R.styleable.Theme_drawable_walk_sound3}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class a<T> implements x00.a<T[]> {
        ...
        public final /* synthetic */ i<T>[] f68086a;
        ...
        public final T[] invoke() {
            int length = this.f68086a.length;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$6(i<? extends T>[] iVarArr, x00.q<? super j<? super R>, ? super T[], ? super j00.c<? super g2>, ? extends Object> qVar, j00.c<? super FlowKt__ZipKt$combineTransform$6> cVar) {
        super(2, cVar);
        this.$flows = iVarArr;
        this.$transform = qVar;
    }
    ...
    public final Object invoke(j<? super R> jVar, j00.c<? super g2> cVar) {
        return ((FlowKt__ZipKt$combineTransform$6) create(jVar, cVar)).invokeSuspend(g2.f100423a);
    }
}
