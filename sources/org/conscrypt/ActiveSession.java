...
final class ActiveSession implements ConscryptSession {
    ...
    private void configurePeer(String str, int i11, X509Certificate[] x509CertificateArr) {
        this.peerHost = str;
        this.peerPort = i11;
    ...
    @Override // javax.net.ssl.SSLSession
    public byte[] getId() {
        if (this.f77770id == null) {
            synchronized (this.ssl) {
                this.f77770id = this.ssl.getSessionId();
            }
        }
        byte[] bArr = this.f77770id;
    ...
    public boolean isValid() {
        boolean z11;
        synchronized (this.ssl) {
            z11 = System.currentTimeMillis() - this.ssl.getTimeout() < this.ssl.getTime();
        }
        return z11;
    }

    public void onPeerCertificateAvailable(String str, int i11) throws CertificateException {
        synchronized (this.ssl) {
            try {
                this.f77770id = null;
                if (this.localCertificates == null) {
                ...
                if (this.peerCertificates == null) {
                    configurePeer(str, i11, this.ssl.getPeerCertificates());
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void onPeerCertificatesReceived(String str, int i11, X509Certificate[] x509CertificateArr) {
        configurePeer(str, i11, x509CertificateArr);
    }
