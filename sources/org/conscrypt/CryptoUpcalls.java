...
final class CryptoUpcalls {
    ...
    public static byte[] rsaDecryptWithPrivateKey(PrivateKey privateKey, int i11, byte[] bArr) {
        return rsaOpWithPrivateKey(privateKey, i11, 2, bArr);
    }
    ...
    */
    ...
    public static byte[] rsaSignDigestWithPrivateKey(PrivateKey privateKey, int i11, byte[] bArr) {
        return rsaOpWithPrivateKey(privateKey, i11, 1, bArr);
    }
