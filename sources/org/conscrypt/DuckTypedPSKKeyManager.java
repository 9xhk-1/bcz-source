...
final class DuckTypedPSKKeyManager implements PSKKeyManager {
        ...
        for (Method method : PSKKeyManager.class.getMethods()) {
            if (!method.isSynthetic()) {
                ...
                if (!returnType2.isAssignableFrom(returnType)) {
                    throw new NoSuchMethodException(method2 + " return value (" + returnType + ") incompatible with target return value (" + returnType2 + j.f81007d);
                }
            }
        }
    ...
    public String chooseClientKeyIdentity(String str, Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke chooseClientKeyIdentity", e11);
        }
    }
    ...
    public String chooseServerKeyIdentityHint(Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke chooseServerKeyIdentityHint", e11);
        }
    }
    ...
    public SecretKey getKey(String str, String str2, Socket socket) {
        try {
            ...
            throw new RuntimeException("Failed to invoke getKey", e11);
        }
    }
