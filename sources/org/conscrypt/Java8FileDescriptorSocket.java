...
final class Java8FileDescriptorSocket extends ConscryptFileDescriptorSocket {
    ...
    public Java8FileDescriptorSocket(String str, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i11, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(InetAddress inetAddress, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i11, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(String str, int i11, InetAddress inetAddress, int i12, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i11, inetAddress, i12, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(InetAddress inetAddress, int i11, InetAddress inetAddress2, int i12, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i11, inetAddress2, i12, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(Socket socket, String str, int i11, boolean z11, SSLParametersImpl sSLParametersImpl) throws IOException {
