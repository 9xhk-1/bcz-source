...
abstract class NativeSslSession {
    ...
    public static final class Impl extends NativeSslSession {
        ...
        public byte[] toBytes() {
            try {
                ...
                NativeSslSession.logger.log(Level.WARNING, "Failed to convert saved SSL Session: ", (Throwable) e11);
                return null;
            } catch (CertificateEncodingException e12) {
                NativeSslSession.log(e12);
                return null;
            }
        }
        ...
        private Impl(AbstractSessionContext abstractSessionContext, NativeRef.SSL_SESSION ssl_session, String str, int i11, X509Certificate[] x509CertificateArr, byte[] bArr, byte[] bArr2) {
    ...
    private static void checkRemaining(ByteBuffer byteBuffer, int i11) throws IOException {
        if (i11 < 0) {
            throw new IOException("Length is negative: " + i11);
        }
        if (i11 <= byteBuffer.remaining()) {
            return;
        }
        throw new IOException("Length of blob is longer than available: " + i11 + " > " + byteBuffer.remaining());
    }
    ...
    public static void log(Throwable th2) {
        logger.log(Level.INFO, "Error inflating SSL session: {0}", th2.getMessage() != null ? th2.getMessage() : th2.getClass().getName());
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x009c A[Catch: BufferUnderflowException -> 0x005b, IOException -> 0x005f, TryCatch #3 {IOException -> 0x005f, BufferUnderflowException -> 0x005b, blocks: (B:3:0x0005, B:5:0x000f, B:7:0x0027, B:12:0x003c, B:13:0x005a, B:16:0x0063, B:18:0x0069, B:20:0x0073, B:22:0x0081, B:25:0x0096, B:27:0x009c, B:29:0x00a5, B:30:0x00ad, B:32:0x00b3, B:34:0x00be, B:38:0x00d2, B:39:0x00e8, B:9:0x0033), top: B:2:0x0005, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00b3 A[Catch: BufferUnderflowException -> 0x005b, IOException -> 0x005f, TryCatch #3 {IOException -> 0x005f, BufferUnderflowException -> 0x005b, blocks: (B:3:0x0005, B:5:0x000f, B:7:0x0027, B:12:0x003c, B:13:0x005a, B:16:0x0063, B:18:0x0069, B:20:0x0073, B:22:0x0081, B:25:0x0096, B:27:0x009c, B:29:0x00a5, B:30:0x00ad, B:32:0x00b3, B:34:0x00be, B:38:0x00d2, B:39:0x00e8, B:9:0x0033), top: B:2:0x0005, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:34:0x00be A[Catch: BufferUnderflowException -> 0x005b, IOException -> 0x005f, TryCatch #3 {IOException -> 0x005f, BufferUnderflowException -> 0x005b, blocks: (B:3:0x0005, B:5:0x000f, B:7:0x0027, B:12:0x003c, B:13:0x005a, B:16:0x0063, B:18:0x0069, B:20:0x0073, B:22:0x0081, B:25:0x0096, B:27:0x009c, B:29:0x00a5, B:30:0x00ad, B:32:0x00b3, B:34:0x00be, B:38:0x00d2, B:39:0x00e8, B:9:0x0033), top: B:2:0x0005, inners: #0 }] */
    /*
