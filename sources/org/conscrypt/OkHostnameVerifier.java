...
public final class OkHostnameVerifier implements ConscryptHostnameVerifier {
    ...
    private OkHostnameVerifier(boolean z11) {
        this.strictWildcardMode = z11;
    }
    ...
    private static List<String> getSubjectAltNames(X509Certificate x509Certificate, int i11) {
        Integer num;
        String str;
    ...
    private boolean verifyHostName(String str, X509Certificate x509Certificate) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            if (verifyHostName(lowerCase, subjectAltNames.get(i11))) {
                return true;
            }
        }
        return false;
    ...
    private boolean verifyIpAddress(String str, X509Certificate x509Certificate) {
        ...
        int size = subjectAltNames.size();
        for (int i11 = 0; i11 < size; i11++) {
            if (str.equalsIgnoreCase(subjectAltNames.get(i11))) {
                return true;
            }
        }
        return false;
    ...
    private boolean verifyHostName(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(".") && !str.endsWith(m.f102856e) && str2 != null && str2.length() != 0 && !str2.startsWith(".") && !str2.endsWith(m.f102856e)) {
            if (!str.endsWith(".")) {
                str = str + '.';
            }
            if (!str2.endsWith(".")) {
