...
public abstract class OpenSSLContextImpl extends SSLContextSpi {
    ...
    public SSLEngine engineCreateSSLEngine(String str, int i11) {
        ...
        return Platform.wrapEngine(new ConscryptEngine(str, i11, sSLParametersImpl2));
    }
    ...
    public OpenSSLContextImpl(String[] strArr, boolean z11) throws GeneralSecurityException, IOException {
