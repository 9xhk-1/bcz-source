...
public final class OpenSSLECKeyFactory extends KeyFactorySpi {
    ...
    public <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> cls) throws InvalidKeySpecException {
        ...
        if (z11 && ECPublicKeySpec.class.isAssignableFrom(cls)) {
        ...
        boolean z12 = key instanceof PrivateKey;
        if (z12 && ECPrivateKeySpec.class.isAssignableFrom(cls)) {
        ...
        if (z12 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
    ...
    public Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        if (key instanceof OpenSSLECPublicKey) {
            return key;
        }
        if (key instanceof OpenSSLECPrivateKey) {
            return key;
        }
