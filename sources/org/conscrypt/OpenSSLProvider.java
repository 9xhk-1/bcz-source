...
public final class OpenSSLProvider extends Provider {
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        String str2 = PREFIX;
        sb2.append(str2);
        sb2.append("OpenSSLKeyHolder|");
        sb2.append(STANDARD_EC_PRIVATE_KEY_INTERFACE_CLASS_NAME);
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", str2 + str, sb2.toString(), "PKCS#8");
    }
    ...
    private void putMacImplClass(String str, String str2) {
        ...
        sb2.append("OpenSSLKeyHolder");
        String str4 = "Mac." + str;
        putImplClassWithKeyConstraints(str4, str3 + str2, sb2.toString(), "RAW");
    }
    ...
    private void putRAWRSASignatureImplClass(String str) {
        ...
        String str2 = PREFIX;
        sb2.append(str2);
        sb2.append("OpenSSLRSAPrivateKey|");
        sb2.append(STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME);
        sb2.append(HiAnalyticsConstant.REPORT_VAL_SEPARATOR);
        sb2.append(str2);
        sb2.append("OpenSSLRSAPublicKey|");
        sb2.append(STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME);
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", str2 + str, sb2.toString(), null);
    }
    ...
    private void putRSACipherImplClass(String str, String str2) {
        ...
        putImplClassWithKeyConstraints(str4, str3 + str2, sb2.toString(), null);
    }
    ...
    private void putSignatureImplClass(String str, String str2) {
        ...
        putImplClassWithKeyConstraints(str4, str3 + str2, sb2.toString(), "PKCS#8|X.509");
    }
    ...
    public OpenSSLProvider(String str) {
        this(str, Platform.provideTrustManagerByDefault(), f.f96679b);
    }

    public OpenSSLProvider(String str, boolean z11, String str2) {
        ...
        str2.getClass();
        if (str2.equals(f.f96680c)) {
            str3 = "$TLSv12";
        } else {
            if (!str2.equals(f.f96679b)) {
                throw new IllegalArgumentException("Choice of default protocol is unsupported: " + str2);
            }
            str3 = "$TLSv13";
        }
        put("SSLContext.SSL", sb3 + str3);
        put("SSLContext.TLS", sb3 + str3);
        put("SSLContext.TLSv1", sb3 + "$TLSv1");
        put("SSLContext.TLSv1.1", sb3 + "$TLSv11");
        put("SSLContext.TLSv1.2", sb3 + "$TLSv12");
        put("SSLContext.TLSv1.3", sb3 + "$TLSv13");
        ...
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.6", b.f81166d);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", b.f81166d);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", b.f81166d);
        ...
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.9", qr.b.f82657b);
        put("Alg.Alias.KeyGenerator.2.16.840.1.101.3.4.2.1", qr.b.f82657b);
        put("Alg.Alias.KeyGenerator.HMAC-SHA256", qr.b.f82657b);
        put("Alg.Alias.KeyGenerator.HMAC/SHA256", qr.b.f82657b);
        ...
        putSignatureImplClass(sr.b.f88908c, "OpenSSLSignature$SHA256RSAPSS");
        put("Alg.Alias.Signature.SHA256withRSAandMGF1", sr.b.f88908c);
        ...
        putMacImplClass(qr.b.f82657b, "OpenSSLMac$HmacSHA256");
        put("Alg.Alias.Mac.1.2.840.113549.2.9", qr.b.f82657b);
        put("Alg.Alias.Mac.2.16.840.1.101.3.4.2.1", qr.b.f82657b);
        put("Alg.Alias.Mac.HMAC-SHA256", qr.b.f82657b);
        put("Alg.Alias.Mac.HMAC/SHA256", qr.b.f82657b);
        put("Alg.Alias.Mac.PBEWITHHMACSHA256", qr.b.f82657b);
        ...
        put("Alg.Alias.CertificateFactory.X.509", k.f96725f);
    }
}
