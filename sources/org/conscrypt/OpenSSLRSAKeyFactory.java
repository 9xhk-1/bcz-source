...
public final class OpenSSLRSAKeyFactory extends KeyFactorySpi {
    ...
    public <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> cls) throws InvalidKeySpecException {
        ...
        if (z11 && RSAPublicKeySpec.class.isAssignableFrom(cls)) {
        ...
        boolean z12 = key instanceof RSAPrivateCrtKey;
        if (z12 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
            RSAPrivateCrtKey rSAPrivateCrtKey = (RSAPrivateCrtKey) key;
            return new RSAPrivateCrtKeySpec(rSAPrivateCrtKey.getModulus(), rSAPrivateCrtKey.getPublicExponent(), rSAPrivateCrtKey.getPrivateExponent(), rSAPrivateCrtKey.getPrimeP(), rSAPrivateCrtKey.getPrimeQ(), rSAPrivateCrtKey.getPrimeExponentP(), rSAPrivateCrtKey.getPrimeExponentQ(), rSAPrivateCrtKey.getCrtCoefficient());
        }
        if (z12 && RSAPrivateKeySpec.class.isAssignableFrom(cls)) {
        ...
        boolean z13 = key instanceof PrivateKey;
        if (z13 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
        ...
        if (z13 && RSAPrivateKeySpec.class.isAssignableFrom(cls)) {
        ...
        if (z13 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
        ...
        if (!z11 || !X509EncodedKeySpec.class.isAssignableFrom(cls)) {
    ...
    public Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        if ((key instanceof PrivateKey) && "PKCS#8".equals(key.getFormat())) {
            ...
            try {
                ...
                throw new InvalidKeyException(e14);
            }
        }
