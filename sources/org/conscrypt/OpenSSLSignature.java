...
public class OpenSSLSignature extends SignatureSpi {
    ...
    public static abstract class RSAPKCS1Padding extends OpenSSLSignature {
        public RSAPKCS1Padding(long j11) {
            super(j11, EngineType.RSA, null);
        }

        @Override // org.conscrypt.OpenSSLSignature
        public final void configureEVP_PKEY_CTX(long j11) throws InvalidAlgorithmParameterException {
            NativeCrypto.EVP_PKEY_CTX_set_rsa_padding(j11, 1);
        }
    }
    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public RSAPSSPadding(long j11, String str, int i11) {
            super(j11, EngineType.RSA, null);
            this.contentDigestAlgorithm = str;
            this.mgf1DigestAlgorithm = str;
            this.mgf1EvpMdRef = j11;
            this.saltSizeBytes = i11;
        }

        @Override // org.conscrypt.OpenSSLSignature
        public final void configureEVP_PKEY_CTX(long j11) throws InvalidAlgorithmParameterException {
            NativeCrypto.EVP_PKEY_CTX_set_rsa_padding(j11, 6);
            NativeCrypto.EVP_PKEY_CTX_set_rsa_mgf1_md(j11, this.mgf1EvpMdRef);
            NativeCrypto.EVP_PKEY_CTX_set_rsa_pss_saltlen(j11, this.saltSizeBytes);
        }
        ...
        public final AlgorithmParameters engineGetParameters() {
            try {
                ...
                throw new ProviderException("Failed to create PSS AlgorithmParameters", e12);
            }
        }
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            try {
                ...
                throw new ProviderException("Failed to obtain EVP_MD for " + jcaDigestAlgorithmStandardName2, e11);
            }
        }
    }
    ...
    public /* synthetic */ OpenSSLSignature(long j11, EngineType engineType, AnonymousClass1 anonymousClass1) {
        this(j11, engineType);
    }
    ...
    private void checkEngineType(OpenSSLKey openSSLKey) throws InvalidKeyException {
        ...
        int i11 = AnonymousClass1.$SwitchMap$org$conscrypt$OpenSSLSignature$EngineType[this.engineType.ordinal()];
        if (i11 == 1) {
            if (EVP_PKEY_type == 6) {
                return;
            }
    ...
    private void initInternal(OpenSSLKey openSSLKey, boolean z11) throws InvalidKeyException {
    ...
    private OpenSSLSignature(long j11, EngineType engineType) {
    ...
    public void engineUpdate(byte[] bArr, int i11, int i12) {
        ...
        if (this.signing) {
            NativeCrypto.EVP_DigestSignUpdate(evp_md_ctx, bArr, i11, i12);
        } else {
            NativeCrypto.EVP_DigestVerifyUpdate(evp_md_ctx, bArr, i11, i12);
        }
    }
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (position >= 0) {
                ...
                if (remaining >= 0) {
                    NativeRef.EVP_MD_CTX evp_md_ctx = this.ctx;
                    if (this.signing) {
                        NativeCrypto.EVP_DigestSignUpdateDirect(evp_md_ctx, j11, remaining);
                    } else {
                        NativeCrypto.EVP_DigestVerifyUpdateDirect(evp_md_ctx, j11, remaining);
                    }
    ...
    public void configureEVP_PKEY_CTX(long j11) throws InvalidAlgorithmParameterException {
    }
