...
final class SSLParametersImpl implements Cloneable {
    ...
    private static String[] getDefaultCipherSuites(boolean z11, boolean z12) {
        return z11 ? z12 ? SSLUtils.concat(NativeCrypto.DEFAULT_PSK_CIPHER_SUITES, NativeCrypto.DEFAULT_X509_CIPHER_SUITES, new String[]{"TLS_EMPTY_RENEGOTIATION_INFO_SCSV"}) : SSLUtils.concat(NativeCrypto.DEFAULT_X509_CIPHER_SUITES, new String[]{"TLS_EMPTY_RENEGOTIATION_INFO_SCSV"}) : z12 ? SSLUtils.concat(NativeCrypto.DEFAULT_PSK_CIPHER_SUITES, new String[]{"TLS_EMPTY_RENEGOTIATION_INFO_SCSV"}) : new String[]{"TLS_EMPTY_RENEGOTIATION_INFO_SCSV"};
    }
    ...
    private boolean isSniEnabledByDefault() {
        try {
            String property = System.getProperty("jsse.enableSNIExtension", m.f74525c);
            if (m.f74525c.equalsIgnoreCase(property)) {
                return true;
            }
    ...
    public String[] getEnabledCipherSuites() {
        return Arrays.asList(this.enabledProtocols).contains(f.f96679b) ? SSLUtils.concat(NativeCrypto.SUPPORTED_TLS_1_3_CIPHER_SUITES, this.enabledCipherSuites) : (String[]) this.enabledCipherSuites.clone();
    }
    ...
    public void setCTVerificationEnabled(boolean z11) {
        this.ctVerificationEnabled = z11;
    }

    public void setEnableSessionCreation(boolean z11) {
        this.enable_session_creation = z11;
    }
    ...
    public void setUseCipherSuitesOrder(boolean z11) {
        this.useCipherSuitesOrder = z11;
    }

    public void setUseClientMode(boolean z11) {
        this.client_mode = z11;
    }

    public void setUseSessionTickets(boolean z11) {
        this.useSessionTickets = z11;
    }

    public void setUseSni(boolean z11) {
        this.useSni = Boolean.valueOf(z11);
    }

    public void setWantClientAuth(boolean z11) {
        this.want_client_auth = z11;
        this.need_client_auth = false;
    }
