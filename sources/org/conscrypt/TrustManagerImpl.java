...
public final class TrustManagerImpl extends X509ExtendedTrustManager {
    ...
    public static class ExtendedKeyUsagePKIXCertPathChecker extends PKIXCertPathChecker {
        ...
        private ExtendedKeyUsagePKIXCertPathChecker(boolean z11, X509Certificate x509Certificate) {
            this.clientAuth = z11;
    ...
    private List<X509Certificate> checkTrusted(X509Certificate[] x509CertificateArr, String str, SSLSession sSLSession, SSLParameters sSLParameters, boolean z11) throws CertificateException {
        byte[] bArr;
        byte[] bArr2;
        String str2;
        if (sSLSession != null) {
        ...
        if (sSLSession == null || sSLParameters == null || !"HTTPS".equalsIgnoreCase(sSLParameters.getEndpointIdentificationAlgorithm()) || getHttpsVerifier().verify(x509CertificateArr, str2, sSLSession)) {
            return checkTrusted(x509CertificateArr, bArr, bArr2, str, str2, z11);
        }
        throw new CertificateException("No subjectAltNames on the certificate match");
    }

    private List<X509Certificate> checkTrustedRecursive(X509Certificate[] x509CertificateArr, byte[] bArr, byte[] bArr2, String str, boolean z11, ArrayList<X509Certificate> arrayList, ArrayList<TrustAnchor> arrayList2, Set<X509Certificate> set) throws CertificateException {
        ...
        if (trustedCert.getIssuerDN().equals(trustedCert.getSubjectDN())) {
            return verifyChain(arrayList, arrayList2, str, z11, bArr, bArr2);
        }
        boolean z12 = false;
        ...
        for (TrustAnchor trustAnchor : sortPotentialAnchors(findAllTrustAnchorsByIssuerAndSignature(trustedCert))) {
            ...
            if (!set.contains(trustedCert2)) {
                ...
                try {
                    return checkTrustedRecursive(x509CertificateArr, bArr, bArr2, str, z11, arrayList, arrayList2, set);
        ...
        for (int i11 = 1; i11 < x509CertificateArr.length; i11++) {
            ...
            if (!set.contains(x509Certificate) && trustedCert.getIssuerDN().equals(x509Certificate.getSubjectDN())) {
                try {
                    ...
                    certificateException = new CertificateException("Unacceptable certificate: " + x509Certificate.getSubjectX500Principal(), e13);
                }
            }
        }
    ...
    private List<X509Certificate> verifyChain(List<X509Certificate> list, List<TrustAnchor> list2, String str, boolean z11, byte[] bArr, byte[] bArr2) throws CertificateException {
        try {
            ...
            if (!z11 && (this.ctEnabledOverride || (str != null && Platform.isCTVerificationRequired(str)))) {
            ...
            if (!list.isEmpty()) {
                ...
                try {
                    try {
                        ...
                        pKIXParameters.addCertPathChecker(new ExtendedKeyUsagePKIXCertPathChecker(z11, x509Certificate));
                        this.validator.validate(generateCertPath, pKIXParameters);
                        for (int i11 = 1; i11 < list.size(); i11++) {
                            this.intermediateIndex.index(list.get(i11));
                        }
            ...
            logger.fine("Rejected candidate cert chain due to error: " + e13.getMessage());
            throw e13;
        }
    }
    ...
    public void setCTEnabledOverride(boolean z11) {
        this.ctEnabledOverride = z11;
    }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(16:0|1|(5:2|3|4|5|(2:7|8))|(2:10|(10:(2:13|14)|29|30|31|32|(1:21)|(1:23)|(1:25)|26|27))|37|38|39|40|41|32|(0)|(0)|(0)|26|27|(1:(0))) */
    ...
    */
    ...
    private List<X509Certificate> checkTrusted(X509Certificate[] x509CertificateArr, byte[] bArr, byte[] bArr2, String str, String str2, boolean z11) throws CertificateException {
        if (x509CertificateArr != null && x509CertificateArr.length != 0 && str != null && str.length() != 0) {
            if (this.err == null) {
                ...
                return checkTrustedRecursive(x509CertificateArr, bArr, bArr2, str2, z11, arrayList, arrayList2, hashSet);
            }
