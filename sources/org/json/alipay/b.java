...
public class b {
    ...
    public static final Object f77914a = new a(0);
    ...
    */
    ...
    public final Object a(String str) {
        Object obj = str == null ? null : this.f77915b.get(str);
        if (obj != null) {
            return obj;
        }
    ...
    public String toString() {
        try {
            ...
            while (a11.hasNext()) {
                ...
                stringBuffer.append(':');
                stringBuffer.append(a(this.f77915b.get(next)));
            }
            stringBuffer.append(l50.b.f69928j);
    ...
    public final boolean b(String str) {
        return this.f77915b.containsKey(str);
    }

    public b(Map map) {
        this.f77915b = map == null ? new HashMap() : map;
    }

    public final Iterator a() {
        return this.f77915b.keySet().iterator();
    }
    ...
    public b(c cVar) {
        ...
        while (true) {
            ...
            if (d11 != null) {
                b(d11);
                this.f77915b.put(obj, d11);
            } else {
                this.f77915b.remove(obj);
            }
            char c13 = cVar.c();
            if (c13 != ',' && c13 != ';') {
                if (c13 != '}') {
