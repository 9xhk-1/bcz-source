...
public final class c {
    ...
    public c(Reader reader) {
        this.f77917b = reader.markSupported() ? reader : new BufferedReader(reader);
        this.f77919d = false;
        this.f77916a = 0;
    }
    ...
    private String a(int i11) {
        ...
        while (i12 < i11) {
            try {
                int read = this.f77917b.read(cArr, i12, i11 - i12);
                if (read == -1) {
                    break;
                }
                i12 += read;
    ...
    */
    ...
    public final String toString() {
        return " at character " + this.f77916a;
    }
    ...
    public final void a() {
        int i11;
        if (this.f77919d || (i11 = this.f77916a) <= 0) {
