...
public class Context {
    ...
    public static void addContextListener(ContextListener contextListener) {
        ...
        try {
            ...
            Kit.initCause(runtimeException, e11);
    ...
    private Object compileImpl(Scriptable scriptable, Reader reader, String str, String str2, int i11, Object obj, boolean z11, Evaluator evaluator, ErrorReporter errorReporter) throws IOException {
        if (str2 == null) {
            str2 = "unnamed script";
        }
        ...
        AstRoot parse = str != null ? parser.parse(str, str2, i11) : parser.parse(reader, str2, i11);
        if (z11 && (parse.getFirstChild() == null || parse.getFirstChild().getType() != 109)) {
        ...
        Object compile = evaluator.compile(compilerEnvirons, transformTree, transformTree.getEncodedSource(), z11);
        ...
        return z11 ? evaluator.createFunctionObject(this, scriptable, compile, obj) : evaluator.createScriptObject(compile, obj);
    }
    ...
    public static void exit() {
        ...
        int i11 = context.enterCount - 1;
        context.enterCount = i11;
        if (i11 == 0) {
    ...
    private void firePropertyChangeImpl(Object obj, String str, Object obj2, Object obj3) {
        int i11 = 0;
        while (true) {
            Object listener = Kit.getListener(obj, i11);
            if (listener == null) {
                return;
            }
    ...
    public static boolean isValidLanguageVersion(int i11) {
        return i11 == 0 || i11 == 100 || i11 == 110 || i11 == 120 || i11 == 130 || i11 == 140 || i11 == 150 || i11 == 160 || i11 == 170 || i11 == 180;
    }
    ...
    private static void notifyDebugger_r(Context context, DebuggableScript debuggableScript, String str) {
        ...
        for (int i11 = 0; i11 != debuggableScript.getFunctionCount(); i11++) {
            notifyDebugger_r(context, debuggableScript.getFunction(i11), str);
        }
    }
    ...
    public static void reportError(String str, String str2, int i11, String str3, int i12) {
        ...
        currentContext.getErrorReporter().error(str, str2, i11, str3, i12);
    }

    public static EvaluatorException reportRuntimeError(String str, String str2, int i11, String str3, int i12) {
        Context currentContext = getCurrentContext();
        if (currentContext != null) {
            return currentContext.getErrorReporter().runtimeError(str, str2, i11, str3, i12);
        }
        throw new EvaluatorException(str, str2, i11, str3, i12);
    }
    ...
    public static void reportWarning(String str, String str2, int i11, String str3, int i12) {
        ...
        if (context.hasFeature(12)) {
            ...
            context.getErrorReporter().warning(str, str2, i11, str3, i12);
        }
    }
    ...
    public static Object toType(Object obj, Class<?> cls) throws IllegalArgumentException {
        try {
            ...
            Kit.initCause(illegalArgumentException, e11);
    ...
    public final Function compileFunction(Scriptable scriptable, String str, String str2, int i11, Object obj) {
        return compileFunction(scriptable, str, null, null, str2, i11, obj);
    }

    public final Script compileReader(Scriptable scriptable, Reader reader, String str, int i11, Object obj) throws IOException {
        return compileReader(reader, str, i11, obj);
    }

    public final Script compileString(String str, String str2, int i11, Object obj) {
        if (i11 < 0) {
            i11 = 0;
        }
        return compileString(str, null, null, str2, i11, obj);
    }
    ...
    public final String decompileFunction(Function function, int i11) {
        if (function instanceof BaseFunction) {
            return ((BaseFunction) function).decompile(i11, 0);
        }
        return "function " + function.getClassName() + "() {\n\t[native code]\n}\n";
    }

    public final String decompileFunctionBody(Function function, int i11) {
        return function instanceof BaseFunction ? ((BaseFunction) function).decompile(i11, 1) : "[native code]\n";
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final String decompileScript(Script script, int i11) {
        return ((NativeFunction) script).decompile(i11, 0);
    }

    public final Object evaluateReader(Scriptable scriptable, Reader reader, String str, int i11, Object obj) throws IOException {
        Script compileReader = compileReader(scriptable, reader, str, i11, obj);
    ...
    public final Object evaluateString(Scriptable scriptable, String str, String str2, int i11, Object obj) {
        Script compileString = compileString(str, str2, i11, obj);
    ...
    public Scriptable newArray(Scriptable scriptable, int i11) {
    ...
    public final void setOptimizationLevel(int i11) {
        ...
        checkOptimizationLevel(i11);
        this.optimizationLevel = codegenClass != null ? i11 : -1;
    }
    ...
    public final Function compileFunction(Scriptable scriptable, String str, Evaluator evaluator, ErrorReporter errorReporter, String str2, int i11, Object obj) {
        try {
            return (Function) compileImpl(scriptable, null, str, str2, i11, obj, true, evaluator, errorReporter);
        } catch (IOException unused) {
            throw new RuntimeException();
        }
    }

    public final Script compileReader(Reader reader, String str, int i11, Object obj) throws IOException {
        if (i11 < 0) {
            i11 = 0;
        }
        return (Script) compileImpl(null, reader, null, str, i11, obj, false, null, null);
    }

    public final Script compileString(String str, Evaluator evaluator, ErrorReporter errorReporter, String str2, int i11, Object obj) {
        try {
            return (Script) compileImpl(null, null, str, str2, i11, obj, false, evaluator, errorReporter);
        } catch (IOException unused) {
            throw new RuntimeException();
        }
    }
