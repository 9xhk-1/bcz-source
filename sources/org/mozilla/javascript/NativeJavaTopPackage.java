...
public class NativeJavaTopPackage extends NativeJavaPackage implements Function, IdFunctionCall {
    ...
    private static final String[][] commonPackages = {new String[]{"java", CommonConstant.ReqAccessTokenParam.LANGUAGE_LABEL, "reflect"}, new String[]{"java", "io"}, new String[]{"java", "math"}, new String[]{"java", b.f10651k}, new String[]{"java", "util", "zip"}, new String[]{"java", "text", "resources"}, new String[]{"java", "applet"}, new String[]{"javax", "swing"}};
    ...
    public static void init(Context context, Scriptable scriptable, boolean z11) {
        ...
        for (int i11 = 0; i11 != commonPackages.length; i11++) {
            int i12 = 0;
            NativeJavaPackage nativeJavaPackage = nativeJavaTopPackage;
            while (true) {
                String[] strArr = commonPackages[i11];
                if (i12 != strArr.length) {
                    nativeJavaPackage = nativeJavaPackage.forcePackage(strArr[i12], scriptable);
                    i12++;
                }
            }
        }
        ...
        for (int i13 = 0; i13 < topPackageNames.length; i13++) {
            objArr[i13] = (NativeJavaPackage) nativeJavaTopPackage.get(topPackageNames[i13], nativeJavaTopPackage);
        }
        ...
        for (int i14 = 0; i14 < topPackageNames.length; i14++) {
            scriptableObject.defineProperty(topPackageNames[i14], objArr[i14], 2);
        }
    }
    ...
    private Scriptable js_getClass(Context context, Scriptable scriptable, Object[] objArr) {
        if (objArr.length > 0) {
            ...
            if (obj instanceof Wrapper) {
                ...
                while (true) {
                    int indexOf = name.indexOf(46, i11);
                    Object obj2 = scriptable2.get(indexOf == -1 ? name.substring(i11) : name.substring(i11, indexOf), scriptable2);
