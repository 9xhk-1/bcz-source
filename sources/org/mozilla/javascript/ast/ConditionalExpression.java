...
public class ConditionalExpression extends AstNode {
    ...
    public void setColonPosition(int i11) {
        this.colonPosition = i11;
    }
    ...
    public void setQuestionMarkPosition(int i11) {
        this.questionMarkPosition = i11;
    }
    ...
    public String toSource(int i11) {
        return makeIndent(i11) + this.testExpression.toSource(i11) + " ? " + this.trueExpression.toSource(0) + " : " + this.falseExpression.toSource(0);
    }
    ...
    public ConditionalExpression(int i11) {
        super(i11);
        this.questionMarkPosition = -1;
        this.colonPosition = -1;
        this.type = 102;
