...
class ContextWindow extends JPanel implements ActionListener {
    ...
    public ContextWindow(final SwingGui swingGui) {
        ...
        ComponentListener componentListener = new ComponentListener() { // from class: org.mozilla.javascript.tools.debugger.ContextWindow.1
            ...
            public void check(Component component) {
                ...
                if (z11 && (z12 = this.t2Docked) && z13 && z12) {
                    return;
                }
                this.t2Docked = z13;
    ...
    public void setEnabled(boolean z11) {
        this.context.setEnabled(z11);
        this.thisTable.setEnabled(z11);
        this.localsTable.setEnabled(z11);
        this.evaluator.setEnabled(z11);
        this.cmdLine.setEnabled(z11);
    }
}
