...
public class Main {
    ...
    public void setBreakOnEnter(boolean z11) {
        this.dim.setBreakOnEnter(z11);
        this.debugGui.getMenubar().getBreakOnEnter().setSelected(z11);
    }

    public void setBreakOnExceptions(boolean z11) {
        this.dim.setBreakOnExceptions(z11);
        this.debugGui.getMenubar().getBreakOnExceptions().setSelected(z11);
    }

    public void setBreakOnReturn(boolean z11) {
        this.dim.setBreakOnReturn(z11);
        this.debugGui.getMenubar().getBreakOnReturn().setSelected(z11);
    }
