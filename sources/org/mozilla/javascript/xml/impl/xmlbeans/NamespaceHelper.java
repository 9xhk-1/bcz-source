...
class NamespaceHelper {
    ...
    public static Namespace getNamespace(XMLLibImpl xMLLibImpl, XmlCursor xmlCursor, Object[] objArr) {
        ...
        if (objArr == null) {
            return new Namespace(xMLLibImpl, prefix, namespaceURI);
        }
        ...
        while (true) {
            ...
            Namespace namespace2 = (Namespace) objArr[i11];
            if (namespace2 != null && namespace2.uri().equals(namespaceURI)) {
                if (prefix.equals(namespace2.prefix())) {
                    namespace = namespace2;
                    break;
                }
                if (namespace == null || (namespace.prefix() == null && namespace2.prefix() != null)) {
                    namespace = namespace2;
                }
            }
            i11++;
        }
        return namespace == null ? new Namespace(xMLLibImpl, prefix, namespaceURI) : namespace;
    }
    ...
    public static Object[] inScopeNamespaces(XMLLibImpl xMLLibImpl, XmlCursor xmlCursor) {
        ...
        Iterator it = namespaceHelper.undeclared.iterator();
        while (it.hasNext()) {
