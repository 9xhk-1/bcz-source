...
class XMLCtor extends IdFunctionObject {
    ...
    public Object getInstanceIdValue(int i11) {
        int maxInstanceId = i11 - super.getMaxInstanceId();
        return maxInstanceId != 1 ? maxInstanceId != 2 ? maxInstanceId != 3 ? maxInstanceId != 4 ? maxInstanceId != 5 ? super.getInstanceIdValue(i11) : ScriptRuntime.wrapBoolean(this.lib.prettyPrinting) : ScriptRuntime.wrapInt(this.lib.prettyIndent) : ScriptRuntime.wrapBoolean(this.lib.ignoreWhitespace) : ScriptRuntime.wrapBoolean(this.lib.ignoreProcessingInstructions) : ScriptRuntime.wrapBoolean(this.lib.ignoreComments);
    }
