...
public abstract class AbstractLogger implements Logger, Serializable {
    ...
    private void handle_0ArgsCall(Level level, Marker marker, String str, Throwable th2) {
    ...
    public void debug(String str, Throwable th2) {
        if (isDebugEnabled()) {
            handle_0ArgsCall(Level.DEBUG, null, str, th2);
        }
    }
    ...
    public void error(String str, Throwable th2) {
        if (isErrorEnabled()) {
            handle_0ArgsCall(Level.ERROR, null, str, th2);
        }
    }
    ...
    public void info(String str, Throwable th2) {
        if (isInfoEnabled()) {
            handle_0ArgsCall(Level.INFO, null, str, th2);
        }
    }
    ...
    public void trace(String str, Throwable th2) {
        if (isTraceEnabled()) {
            handle_0ArgsCall(Level.TRACE, null, str, th2);
        }
    }
    ...
    public void warn(String str, Throwable th2) {
        if (isWarnEnabled()) {
            handle_0ArgsCall(Level.WARN, null, str, th2);
        }
    }
    ...
    public void debug(Marker marker, String str, Throwable th2) {
        if (isDebugEnabled(marker)) {
            handle_0ArgsCall(Level.DEBUG, marker, str, th2);
        }
    }
    ...
    public void error(Marker marker, String str, Throwable th2) {
        if (isErrorEnabled(marker)) {
            handle_0ArgsCall(Level.ERROR, marker, str, th2);
        }
    }
    ...
    public void info(Marker marker, String str, Throwable th2) {
        if (isInfoEnabled(marker)) {
            handle_0ArgsCall(Level.INFO, marker, str, th2);
        }
    }
    ...
    public void trace(Marker marker, String str, Throwable th2) {
        if (isTraceEnabled(marker)) {
            handle_0ArgsCall(Level.TRACE, marker, str, th2);
        }
    }
    ...
    public void warn(Marker marker, String str, Throwable th2) {
        if (isWarnEnabled(marker)) {
            handle_0ArgsCall(Level.WARN, marker, str, th2);
        }
    }
}
