...
public final class m {
    ...
    public final List<int[]> f96614a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final List<String> f96615b = new ArrayList();

    public final void a(int[] iArr, String str) {
        this.f96614a.add(iArr);
        this.f96615b.add(str);
    }

    public final synchronized void b() {
        if (this.f96614a.isEmpty()) {
            ...
            a(new int[]{com.alipay.sdk.m.u.n.f11119i, 469}, "RU");
            a(new int[]{471}, "TW");
            a(new int[]{474}, "EE");
            a(new int[]{475}, "LV");
            a(new int[]{476}, "AZ");
            ...
            a(new int[]{520}, "GR");
            a(new int[]{528}, jp.k.f64572r);
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            a(new int[]{535}, "MT");
            a(new int[]{539}, "IE");
            a(new int[]{540, 549}, "BE/LU");
            a(new int[]{560}, AssistPushConsts.MSG_VALUE_PAYLOAD);
            a(new int[]{569}, "IS");
            ...
            a(new int[]{740}, com.igexin.push.core.b.f37738j);
            a(new int[]{741}, "SV");
            a(new int[]{742}, "HN");
            a(new int[]{743}, "NI");
            a(new int[]{744}, "CR");
            ...
            a(new int[]{759}, "VE");
            a(new int[]{760, com.badlogic.gdx.graphics.f.f11647q}, "CH");
            a(new int[]{com.badlogic.gdx.graphics.f.f11653r}, "CO");
            a(new int[]{com.badlogic.gdx.graphics.f.f11671u}, "UY");
            a(new int[]{com.badlogic.gdx.graphics.f.f11683w}, "PE");
            a(new int[]{777}, "BO");
            a(new int[]{779}, "AR");
            a(new int[]{780}, "CL");
            a(new int[]{784}, "PY");
    ...
    public String c(String str) {
        ...
        int size = this.f96614a.size();
        for (int i12 = 0; i12 < size && parseInt >= (i11 = (iArr = this.f96614a.get(i12))[0]); i12++) {
            if (iArr.length != 1) {
                i11 = iArr[1];
            }
            if (parseInt <= i11) {
                return this.f96615b.get(i12);
            }
        }
        return null;
    }
