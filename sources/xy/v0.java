...
public final class v0 extends c {
    ...
    @m80.k
    public final Map<a<?>, Object> f98660a = new HashMap();
    ...
    public <T> T i(@m80.k a<T> key, @m80.k x00.a<? extends T> block) {
        ...
        kotlin.jvm.internal.g0.n(invoke, "null cannot be cast to non-null type T of io.ktor.util.HashMapAttributes.computeIfAbsent");
        return invoke;
    }
